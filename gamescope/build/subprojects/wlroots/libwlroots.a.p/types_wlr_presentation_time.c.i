# 1 "../subprojects/wlroots/types/wlr_presentation_time.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_presentation_time.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_presentation_time.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_presentation_time.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/wlr_presentation_time.c" 2
...
_Bool wlr_backend_commit(struct wlr_backend *backend,
 const struct wlr_backend_output_state *states, size_t states_len);
# 5 "../subprojects/wlroots/types/wlr_presentation_time.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 6 "../subprojects/wlroots/types/wlr_presentation_time.c" 2
...
void wlr_presentation_surface_scanned_out_on_output(struct wlr_surface *surface,
 struct wlr_output *output);
# 7 "../subprojects/wlroots/types/wlr_presentation_time.c" 2
# 1 "../subprojects/wlroots/include/wlr/util/addon.h" 1
# 8 "../subprojects/wlroots/types/wlr_presentation_time.c" 2
# 1 "subprojects/wlroots/protocol/presentation-time-protocol.h" 1
...
# 1 "/usr/lib/clang/17/include/stddef.h" 1 3
# 8 "subprojects/wlroots/protocol/presentation-time-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 47 "subprojects/wlroots/protocol/presentation-time-protocol.h"
struct wl_output;
struct wl_surface;
struct wp_presentation;
struct wp_presentation_feedback;
# 109 "subprojects/wlroots/protocol/presentation-time-protocol.h"
extern const struct wl_interface wp_presentation_interface;
# 146 "subprojects/wlroots/protocol/presentation-time-protocol.h"
extern const struct wl_interface wp_presentation_feedback_interface;
# 158 "subprojects/wlroots/protocol/presentation-time-protocol.h"
...
struct wp_presentation_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 199 "subprojects/wlroots/protocol/presentation-time-protocol.h"
 void (*feedback)(struct wl_client *client,
    struct wl_resource *resource,
    struct wl_resource *surface,
    uint32_t callback);
};
# 227 "subprojects/wlroots/protocol/presentation-time-protocol.h"
static inline void
wp_presentation_send_clock_id(struct wl_resource *resource_, uint32_t clk_id)
{
 wl_resource_post_event(resource_, 0, clk_id);
}
# 244 "subprojects/wlroots/protocol/presentation-time-protocol.h"
enum wp_presentation_feedback_kind {
# 254 "subprojects/wlroots/protocol/presentation-time-protocol.h"
...
# 271 "subprojects/wlroots/protocol/presentation-time-protocol.h"
 WP_PRESENTATION_FEEDBACK_KIND_HW_COMPLETION = 0x4,
# 282 "subprojects/wlroots/protocol/presentation-time-protocol.h"
 WP_PRESENTATION_FEEDBACK_KIND_ZERO_COPY = 0x8,
};
# 310 "subprojects/wlroots/protocol/presentation-time-protocol.h"
static inline void
wp_presentation_feedback_send_sync_output(struct wl_resource *resource_, struct wl_resource *output)
{
 wl_resource_post_event(resource_, 0, output);
}
# 328 "subprojects/wlroots/protocol/presentation-time-protocol.h"
static inline void
...
{
 wl_resource_post_event(resource_, 1, tv_sec_hi, tv_sec_lo, tv_nsec, refresh, seq_hi, seq_lo, flags);
}
...
# 9 "../subprojects/wlroots/types/wlr_presentation_time.c" 2
...
static void feedback_resource_send_presented(
 ...
 for (output_resource = 0, output_resource = wl_resource_from_link((&event->output->resources)->next); wl_resource_get_link(output_resource) != (&event->output->resources); output_resource = wl_resource_from_link(wl_resource_get_link(output_resource)->next)) {
...
static void presentation_surface_addon_destroy(struct wlr_addon *addon) {
 struct wlr_presentation_surface *p_surface =
  (__typeof__(p_surface))((char *)(addon) - __builtin_offsetof(__typeof__(*p_surface), addon));
...
static void presentation_handle_feedback(struct wl_client *client,
 ...
 struct wlr_addon *addon =
  wlr_addon_find(&surface->addons, ((void*)0), &presentation_surface_addon_impl);
 struct wlr_presentation_surface *p_surface = ((void*)0);
 if (addon != ((void*)0)) {
  p_surface = (__typeof__(p_surface))((char *)(addon) - __builtin_offsetof(__typeof__(*p_surface), addon));
 } else {
  ...
  wlr_addon_init(&p_surface->addon, &surface->addons,
   ((void*)0), &presentation_surface_addon_impl);
 ...
 wl_resource_set_implementation(resource, ((void*)0), feedback,
...
static void presentation_bind(struct wl_client *client, void *data,
 ...
 wl_resource_set_implementation(resource, &presentation_impl, ((void*)0), ((void*)0));
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_presentation *presentation =
  (__typeof__(presentation))((char *)(listener) - __builtin_offsetof(__typeof__(*presentation), display_destroy));
...
struct wlr_presentation *wlr_presentation_create(struct wl_display *display,
 ...
 presentation->global = wl_global_create(display, &wp_presentation_interface,
  1, ((void*)0), presentation_bind);
 if (presentation->global == ((void*)0)) {
  free(presentation);
  return ((void*)0);
 }
...
void wlr_presentation_feedback_send_presented(
 ...
 for (resource = 0, tmp = 0, resource = wl_resource_from_link((&feedback->resources)->next), tmp = wl_resource_from_link((&feedback->resources)->next->next); wl_resource_get_link(resource) != (&feedback->resources); resource = tmp, tmp = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
...
struct wlr_presentation_feedback *wlr_presentation_surface_sampled(
 ...
 if (addon != ((void*)0)) {
  ...
  p_surface->current.feedback = ((void*)0);
  return sampled;
 }
 return ((void*)0);
}
...
void wlr_presentation_feedback_destroy(
 ...
 ((wl_list_empty(&feedback->resources)) ? (void) (0) : __assert_fail ("wl_list_empty(&feedback->resources)", "types/wlr_presentation_time.c", 232, __extension__ __PRETTY_FUNCTION__));
...
static void feedback_unset_output(struct wlr_presentation_feedback *feedback) {
 if (feedback->output == ((void*)0)) {
  return;
 }

 feedback->output = ((void*)0);
...
static void feedback_handle_output_commit(struct wl_listener *listener,
  void *data) {
 struct wlr_presentation_feedback *feedback =
  (__typeof__(feedback))((char *)(listener) - __builtin_offsetof(__typeof__(*feedback), output_commit));
 if (feedback->output_committed) {
  return;
 }
 feedback->output_committed = 1;
...
static void feedback_handle_output_present(struct wl_listener *listener,
  void *data) {
 struct wlr_presentation_feedback *feedback =
  (__typeof__(feedback))((char *)(listener) - __builtin_offsetof(__typeof__(*feedback), output_present));
...
static void feedback_handle_output_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_presentation_feedback *feedback =
  (__typeof__(feedback))((char *)(listener) - __builtin_offsetof(__typeof__(*feedback), output_destroy));
 wlr_presentation_feedback_destroy(feedback);
}

static void presentation_surface_queued_on_output(struct wlr_surface *surface,
  struct wlr_output *output, _Bool zero_copy) {
 struct wlr_presentation_feedback *feedback =
 ...
 ((feedback->output == ((void*)0)) ? (void) (0) : __assert_fail ("feedback->output == NULL", "types/wlr_presentation_time.c", 309, __extension__ __PRETTY_FUNCTION__));
...
void wlr_presentation_surface_textured_on_output(struct wlr_surface *surface,
  struct wlr_output *output) {
 return presentation_surface_queued_on_output(surface, output, 0);
}

void wlr_presentation_surface_scanned_out_on_output(struct wlr_surface *surface,
  struct wlr_output *output) {
 return presentation_surface_queued_on_output(surface, output, 1);
}
