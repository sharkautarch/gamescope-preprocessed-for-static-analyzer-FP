# 1 "../subprojects/wlroots/types/scene/drag_icon.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/scene/drag_icon.c" 2
...
# 2 "../subprojects/wlroots/types/scene/drag_icon.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 3 "../subprojects/wlroots/types/scene/drag_icon.c" 2
...
# 4 "../subprojects/wlroots/types/scene/drag_icon.c" 2
...
void wlr_data_source_dnd_action(struct wlr_data_source *source,
 enum wl_data_device_manager_dnd_action action);
# 5 "../subprojects/wlroots/types/scene/drag_icon.c" 2
...
static void drag_icon_handle_surface_commit(struct wl_listener *listener, void *data) {
 struct wlr_scene_drag_icon *icon =
  (__typeof__(icon))((char *)(listener) - __builtin_offsetof(__typeof__(*icon), drag_icon_surface_commit));
...
static void drag_icon_handle_surface_map(struct wl_listener *listener, void *data) {
 struct wlr_scene_drag_icon *icon =
  (__typeof__(icon))((char *)(listener) - __builtin_offsetof(__typeof__(*icon), drag_icon_surface_map));
 wlr_scene_node_set_enabled(&icon->tree->node, 1);
}

static void drag_icon_handle_surface_unmap(struct wl_listener *listener, void *data) {
 struct wlr_scene_drag_icon *icon =
  (__typeof__(icon))((char *)(listener) - __builtin_offsetof(__typeof__(*icon), drag_icon_surface_unmap));
 wlr_scene_node_set_enabled(&icon->tree->node, 0);
}

static void drag_icon_handle_tree_destroy(struct wl_listener *listener, void *data) {
 struct wlr_scene_drag_icon *icon =
  (__typeof__(icon))((char *)(listener) - __builtin_offsetof(__typeof__(*icon), tree_destroy));
...
static void drag_icon_handle_destroy(struct wl_listener *listener, void *data) {
 struct wlr_scene_drag_icon *icon =
  (__typeof__(icon))((char *)(listener) - __builtin_offsetof(__typeof__(*icon), drag_icon_destroy));
