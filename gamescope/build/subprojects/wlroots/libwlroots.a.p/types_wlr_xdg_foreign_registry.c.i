# 1 "../subprojects/wlroots/types/wlr_xdg_foreign_registry.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_xdg_foreign_registry.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_xdg_foreign_registry.h" 1
# 12 "../subprojects/wlroots/include/wlr/types/wlr_xdg_foreign_registry.h"
...
# 13 "../subprojects/wlroots/include/wlr/types/wlr_xdg_foreign_registry.h" 2
...
# 2 "../subprojects/wlroots/types/wlr_xdg_foreign_registry.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_xdg_foreign_registry.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 4 "../subprojects/wlroots/types/wlr_xdg_foreign_registry.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_xdg_foreign_registry.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 6 "../subprojects/wlroots/types/wlr_xdg_foreign_registry.c" 2

_Bool wlr_xdg_foreign_exported_init(
 ...
 } while (wlr_xdg_foreign_registry_find_by_handle(registry, exported->handle) != ((void*)0));
...
struct wlr_xdg_foreign_exported *wlr_xdg_foreign_registry_find_by_handle(
  struct wlr_xdg_foreign_registry *registry, const char *handle) {
 if (handle == ((void*)0) || strlen(handle) >= 37) {
  return ((void*)0);
 }

 struct wlr_xdg_foreign_exported *exported;
 for (exported = (__typeof__(exported))((char *)((&registry->exported_surfaces)->next) - __builtin_offsetof(__typeof__(*exported), link)); &exported->link != (&registry->exported_surfaces); exported = (__typeof__(exported))((char *)(exported->link.next) - __builtin_offsetof(__typeof__(*exported), link))) {
...
static void foreign_registry_handle_display_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_xdg_foreign_registry *registry =
  (__typeof__(registry))((char *)(listener) - __builtin_offsetof(__typeof__(*registry), display_destroy));

 wl_signal_emit_mutable(&registry->events.destroy, ((void*)0));


 ((wl_list_empty(&registry->exported_surfaces)) ? (void) (0) : __assert_fail ("wl_list_empty(&registry->exported_surfaces)", "types/wlr_xdg_foreign_registry.c", 54, __extension__ __PRETTY_FUNCTION__));
 free(registry);
}
