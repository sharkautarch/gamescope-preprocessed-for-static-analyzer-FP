# 1 "../subprojects/wlroots/types/wlr_text_input_v3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_text_input_v3.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_text_input_v3.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_text_input_v3.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_text_input_v3.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 5 "../subprojects/wlroots/types/wlr_text_input_v3.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_text_input_v3.h" 1
# 13 "../subprojects/wlroots/include/wlr/types/wlr_text_input_v3.h"
...
# 14 "../subprojects/wlroots/include/wlr/types/wlr_text_input_v3.h" 2
...
struct wlr_text_input_v3 {
 ...
 _Bool pending_enabled;
 _Bool current_enabled;
...
# 6 "../subprojects/wlroots/types/wlr_text_input_v3.c" 2
...
# 7 "../subprojects/wlroots/types/wlr_text_input_v3.c" 2
# 1 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h" 1
...
# 1 "/usr/lib/clang/17/include/stddef.h" 1 3
# 8 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 72 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
struct wl_seat;
struct wl_surface;
struct zwp_text_input_manager_v3;
struct zwp_text_input_v3;
# 142 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
extern const struct wl_interface zwp_text_input_v3_interface;
# 159 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
extern const struct wl_interface zwp_text_input_manager_v3_interface;
# 170 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
...
# 191 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
...
# 251 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
...
struct zwp_text_input_v3_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 359 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
 void (*enable)(struct wl_client *client,
         struct wl_resource *resource);
# 371 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
 void (*disable)(struct wl_client *client,
   struct wl_resource *resource);
# 411 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
 void (*set_surrounding_text)(struct wl_client *client,
         struct wl_resource *resource,
         const char *text,
         int32_t cursor,
         int32_t anchor);
# 436 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
 void (*set_text_change_cause)(struct wl_client *client,
          struct wl_resource *resource,
          uint32_t cause);
# 454 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
 void (*set_content_type)(struct wl_client *client,
     struct wl_resource *resource,
     uint32_t hint,
     uint32_t purpose);
# 480 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
 void (*set_cursor_rectangle)(struct wl_client *client,
         ...
         int32_t width,
         int32_t height);
# 516 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
 void (*commit)(struct wl_client *client,
         struct wl_resource *resource);
};
# 590 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
static inline void
zwp_text_input_v3_send_enter(struct wl_resource *resource_, struct wl_resource *surface)
{
 wl_resource_post_event(resource_, 0, surface);
}
...
{
 wl_resource_post_event(resource_, 1, surface);
}
...
{
 wl_resource_post_event(resource_, 2, text, cursor_begin, cursor_end);
}
...
{
 wl_resource_post_event(resource_, 3, text);
}
# 636 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.h"
static inline void
zwp_text_input_v3_send_delete_surrounding_text(struct wl_resource *resource_, uint32_t before_length, uint32_t after_length)
{
 wl_resource_post_event(resource_, 4, before_length, after_length);
}
...
{
 wl_resource_post_event(resource_, 5, serial);
}
...
# 8 "../subprojects/wlroots/types/wlr_text_input_v3.c" 2
...
static void text_input_clear_focused_surface(struct wlr_text_input_v3 *text_input) {
 ...
 text_input->focused_surface = ((void*)0);
}
...
static struct wlr_text_input_v3 *text_input_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwp_text_input_v3_interface, &text_input_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwp_text_input_v3_interface, &text_input_impl)", "types/wlr_text_input_v3.c", 20, __extension__ __PRETTY_FUNCTION__));
...
void wlr_text_input_v3_send_enter(struct wlr_text_input_v3 *text_input,
  struct wlr_surface *surface) {
 ((wl_resource_get_client(text_input->resource) == wl_resource_get_client(surface->resource)) ? (void) (0) : __assert_fail ("wl_resource_get_client(text_input->resource) == wl_resource_get_client(surface->resource)", "types/wlr_text_input_v3.c", 27, __extension__ __PRETTY_FUNCTION__));
...
static void text_input_commit(struct wl_client *client,
 ...
 if (text_input->pending.surrounding.text) {
  ...
  if (text_input->current.surrounding.text == ((void*)0)) {
   wl_client_post_no_memory(client);
   return;
  }
 }

 _Bool old_enabled = text_input->current_enabled;
 text_input->current_enabled = text_input->pending_enabled;
 text_input->current_serial++;

 if (text_input->focused_surface == ((void*)0)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Text input commit received without focus", "types/wlr_text_input_v3.c", 182);
 }
...
static struct wlr_text_input_manager_v3 *text_input_manager_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwp_text_input_manager_v3_interface, &text_input_manager_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwp_text_input_manager_v3_interface, &text_input_manager_impl)", "types/wlr_text_input_v3.c", 212, __extension__ __PRETTY_FUNCTION__));
...
static void text_input_handle_seat_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_text_input_v3 *text_input = (__typeof__(text_input))((char *)(listener) - __builtin_offsetof(__typeof__(*text_input), seat_destroy));
...
static void text_input_handle_focused_surface_destroy(
 ...
 struct wlr_text_input_v3 *text_input = (__typeof__(text_input))((char *)(listener) - __builtin_offsetof(__typeof__(*text_input), surface_destroy));
