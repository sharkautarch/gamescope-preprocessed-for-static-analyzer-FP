# 1 "../subprojects/wlroots/types/wlr_keyboard_group.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 5 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
# 7 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
# 8 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
# 1 "../subprojects/wlroots/include/types/wlr_keyboard.h" 1
...
# 2 "../subprojects/wlroots/include/types/wlr_keyboard.h" 2

void keyboard_key_update(struct wlr_keyboard *keyboard,
  struct wlr_keyboard_key_event *event);

_Bool keyboard_modifier_update(struct wlr_keyboard *keyboard);

void keyboard_led_update(struct wlr_keyboard *keyboard);
# 9 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
void wlr_keyboard_notify_modifiers(struct wlr_keyboard *keyboard,
  ...
  uint32_t group);
# 10 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_keyboard.h" 1
# 11 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_group.h" 1
# 13 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_group.h"
# 1 "../subprojects/wlroots/include/wlr/types/wlr_keyboard.h" 1
# 14 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_group.h" 2
...
struct wlr_keyboard_group {
 ...
 struct {
# 29 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_group.h"
  struct wl_signal enter;
# 40 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_group.h"
...
_Bool wlr_keyboard_group_add_keyboard(struct wlr_keyboard_group *group,
  struct wlr_keyboard *keyboard);
...
# 12 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
# 13 "../subprojects/wlroots/types/wlr_keyboard_group.c" 2
...
static void keyboard_set_leds(struct wlr_keyboard *kb, uint32_t leds) {
 ...
 for (device = (__typeof__(device))((char *)((&group->devices)->next) - __builtin_offsetof(__typeof__(*device), link)); &device->link != (&group->devices); device = (__typeof__(device))((char *)(device->link.next) - __builtin_offsetof(__typeof__(*device), link))) {
...
struct wlr_keyboard_group *wlr_keyboard_group_create(void) {
 ...
 if (!group) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to allocate wlr_keyboard_group", "types/wlr_keyboard_group.c", 46);
  return ((void*)0);
 }
...
struct wlr_keyboard_group *wlr_keyboard_group_from_wlr_keyboard(
 ...
 struct wlr_keyboard_group *group = (__typeof__(group))((char *)(keyboard) - __builtin_offsetof(__typeof__(*group), keyboard));
 return group;
}

static _Bool process_key(struct keyboard_group_device *group_device,
  struct wlr_keyboard_key_event *event) {
 struct wlr_keyboard_group *group = group_device->keyboard->group;

 struct keyboard_group_key *key, *tmp;
 for (key = (__typeof__(key))((char *)((&group->keys)->next) - __builtin_offsetof(__typeof__(*key), link)), tmp = (__typeof__(tmp))((char *)((key)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &key->link != (&group->keys); key = tmp, tmp = (__typeof__(tmp))((char *)(key->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
 ...
 if (event->state == WL_KEYBOARD_KEY_STATE_PRESSED) {
  ...
  if (!key) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to allocate keyboard_group_key", "types/wlr_keyboard_group.c", 96);
   return 0;
  }
...
static void handle_keyboard_key(struct wl_listener *listener, void *data) {
 struct keyboard_group_device *group_device =
  (__typeof__(group_device))((char *)(listener) - __builtin_offsetof(__typeof__(*group_device), key));
...
static void handle_keyboard_modifiers(struct wl_listener *listener,
 ...
 struct keyboard_group_device *group_device =
  (__typeof__(group_device))((char *)(listener) - __builtin_offsetof(__typeof__(*group_device), modifiers));
 struct wlr_keyboard_modifiers mods = group_device->keyboard->modifiers;

 struct keyboard_group_device *device;
 for (device = (__typeof__(device))((char *)((&group_device->keyboard->group->devices)->next) - __builtin_offsetof(__typeof__(*device), link)); &device->link != (&group_device->keyboard->group->devices); device = (__typeof__(device))((char *)(device->link.next) - __builtin_offsetof(__typeof__(*device), link))) {
...
static void handle_keyboard_keymap(struct wl_listener *listener, void *data) {
 struct keyboard_group_device *group_device =
  (__typeof__(group_device))((char *)(listener) - __builtin_offsetof(__typeof__(*group_device), keymap));
 struct wlr_keyboard *keyboard = group_device->keyboard;

 if (!wlr_keyboard_keymaps_match(keyboard->group->keyboard.keymap,
    keyboard->keymap)) {
  struct keyboard_group_device *device;
  for (device = (__typeof__(device))((char *)((&keyboard->group->devices)->next) - __builtin_offsetof(__typeof__(*device), link)); &device->link != (&keyboard->group->devices); device = (__typeof__(device))((char *)(device->link.next) - __builtin_offsetof(__typeof__(*device), link))) {
...
static void handle_keyboard_repeat_info(struct wl_listener *listener,
  void *data) {
 struct keyboard_group_device *group_device =
  (__typeof__(group_device))((char *)(listener) - __builtin_offsetof(__typeof__(*group_device), repeat_info));
 struct wlr_keyboard *keyboard = group_device->keyboard;
...
static void handle_keyboard_destroy(struct wl_listener *listener, void *data) {
 struct keyboard_group_device *device =
  (__typeof__(device))((char *)(listener) - __builtin_offsetof(__typeof__(*device), destroy));
...
_Bool wlr_keyboard_group_add_keyboard(struct wlr_keyboard_group *group,
  struct wlr_keyboard *keyboard) {
 if (keyboard->group) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "A wlr_keyboard can only belong to one group", "types/wlr_keyboard_group.c", 242);
  return 0;
 }

 if (keyboard->impl == &impl) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Cannot add a group's keyboard to a group", "types/wlr_keyboard_group.c", 247);
  return 0;
 }

 if (!wlr_keyboard_keymaps_match(group->keyboard.keymap, keyboard->keymap)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Device keymap does not match keyboard group's", "types/wlr_keyboard_group.c", 252);
  return 0;
 }

 struct keyboard_group_device *device = calloc(1, sizeof(*device));
 if (!device) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to allocate keyboard_group_device", "types/wlr_keyboard_group.c", 258);
  return 0;
 }
...
void wlr_keyboard_group_remove_keyboard(struct wlr_keyboard_group *group,
 ...
 for (device = (__typeof__(device))((char *)((&group->devices)->next) - __builtin_offsetof(__typeof__(*device), link)), tmp = (__typeof__(tmp))((char *)((device)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &device->link != (&group->devices); device = tmp, tmp = (__typeof__(tmp))((char *)(device->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  if (device->keyboard == keyboard) {
   remove_keyboard_group_device(device);
   return;
  }
 }
 _wlr_log(WLR_ERROR, "[%s:%d] " "keyboard not found in group", "types/wlr_keyboard_group.c", 306);
}
