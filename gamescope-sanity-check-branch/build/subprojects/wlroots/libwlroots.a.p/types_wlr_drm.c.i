# 1 "../subprojects/wlroots/types/wlr_drm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_drm.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_drm.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_drm.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_drm.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_drm.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_drm.c" 2
...
# 7 "../subprojects/wlroots/types/wlr_drm.c" 2
...
_Bool wlr_drm_format_set_union(struct wlr_drm_format_set *dst,
 const struct wlr_drm_format_set *a, const struct wlr_drm_format_set *b);
# 8 "../subprojects/wlroots/types/wlr_drm.c" 2
...
# 9 "../subprojects/wlroots/types/wlr_drm.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_buffer.h" 1
# 10 "../subprojects/wlroots/types/wlr_drm.c" 2
...
struct wlr_drm *wlr_drm_create(struct wl_display *display,
 struct wlr_renderer *renderer);
# 11 "../subprojects/wlroots/types/wlr_drm.c" 2
...
# 12 "../subprojects/wlroots/types/wlr_drm.c" 2
# 1 "subprojects/wlroots/protocol/drm-protocol.h" 1
...
# 1 "/usr/lib/clang/17/include/stddef.h" 1 3
# 8 "subprojects/wlroots/protocol/drm-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 49 "subprojects/wlroots/protocol/drm-protocol.h"
struct wl_buffer;
struct wl_drm;
# 62 "subprojects/wlroots/protocol/drm-protocol.h"
...
# 149 "subprojects/wlroots/protocol/drm-protocol.h"
...
# 254 "subprojects/wlroots/protocol/drm-protocol.h"
static inline void
...
{
 wl_resource_post_event(resource_, 1, format);
}
...
{
 wl_resource_post_event(resource_, 3, value);
}
# 13 "../subprojects/wlroots/types/wlr_drm.c" 2
...
# 14 "../subprojects/wlroots/types/wlr_drm.c" 2
...
static struct wlr_drm_buffer *drm_buffer_from_buffer(
 ...
 ((wlr_buffer->impl == &buffer_impl) ? (void) (0) : __assert_fail ("wlr_buffer->impl == &buffer_impl", "types/wlr_drm.c", 30, __extension__ __PRETTY_FUNCTION__));
 struct wlr_drm_buffer *buffer = (__typeof__(buffer))((char *)(wlr_buffer) - __builtin_offsetof(__typeof__(*buffer), base));
 return buffer;
}
...
static void buffer_handle_resource_destroy(struct wl_resource *resource) {
 ...
 ((buffer != ((void*)0)) ? (void) (0) : __assert_fail ("buffer != NULL", "types/wlr_drm.c", 72, __extension__ __PRETTY_FUNCTION__));
 buffer->resource = ((void*)0);
 wlr_buffer_drop(&buffer->base);
}

static void buffer_handle_release(struct wl_listener *listener, void *data) {
 struct wlr_drm_buffer *buffer = (__typeof__(buffer))((char *)(listener) - __builtin_offsetof(__typeof__(*buffer), release));
 if (buffer->resource != ((void*)0)) {
...
static void drm_handle_create_prime_buffer(struct wl_client *client,
 ...
 struct wlr_dmabuf_attributes dmabuf = {
  ...
  .height = height,
  .format = format,
  .modifier = ((((__u64)0) << 56) | ((((1ULL << 56) - 1)) & 0x00ffffffffffffffULL)),
  .n_planes = 1,
  .offset[0] = offset0,
  .stride[0] = stride0,
  .fd[0] = fd,
...
static void drm_bind(struct wl_client *client, void *data,
 ...
 wl_resource_set_implementation(resource, &drm_impl, drm, ((void*)0));
...
static struct wlr_buffer *buffer_from_resource(struct wl_resource *resource) {
 struct wlr_drm_buffer *buffer = wlr_drm_buffer_try_from_resource(resource);
 ((buffer != ((void*)0)) ? (void) (0) : __assert_fail ("buffer != NULL", "types/wlr_drm.c", 176, __extension__ __PRETTY_FUNCTION__));
 return &buffer->base;
}
...
static void drm_destroy(struct wlr_drm *drm) {
 wl_signal_emit_mutable(&drm->events.destroy, ((void*)0));
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_drm *drm = (__typeof__(drm))((char *)(listener) - __builtin_offsetof(__typeof__(*drm), display_destroy));
 drm_destroy(drm);
}
...
struct wlr_drm *wlr_drm_create(struct wl_display *display,
 ...
 if (drm_fd < 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get DRM FD from renderer", "types/wlr_drm.c", 206);
  return ((void*)0);
 }

 drmDevice *dev = ((void*)0);
 if (drmGetDevice2(drm_fd, 0, &dev) != 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "drmGetDevice2 failed", "types/wlr_drm.c", 212);
  return ((void*)0);
 }

 char *node_name = ((void*)0);
 if (dev->available_nodes & (1 << 2)) {
  node_name = strdup(dev->nodes[2]);
 } else {
  ((dev->available_nodes & (1 << 0)) ? (void) (0) : __assert_fail ("dev->available_nodes & (1 << DRM_NODE_PRIMARY)", "types/wlr_drm.c", 220, __extension__ __PRETTY_FUNCTION__));
  _wlr_log(WLR_DEBUG, "[%s:%d] " "No DRM render node available, " "falling back to primary node '%s'", "types/wlr_drm.c", 222, dev->nodes[0]);

  node_name = strdup(dev->nodes[0]);
 }
 drmFreeDevice(&dev);
 if (node_name == ((void*)0)) {
  return ((void*)0);
 ...
 drm->global = wl_global_create(display, &wl_drm_interface, 2,
  drm, drm_bind);
 if (drm->global == ((void*)0)) {
  goto error;
 }
