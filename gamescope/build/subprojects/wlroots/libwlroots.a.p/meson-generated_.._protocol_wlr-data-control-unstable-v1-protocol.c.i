# 1 "subprojects/wlroots/protocol/wlr-data-control-unstable-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/wlr-data-control-unstable-v1-protocol.c" 2
# 29 "subprojects/wlroots/protocol/wlr-data-control-unstable-v1-protocol.c"
...
# 30 "subprojects/wlroots/protocol/wlr-data-control-unstable-v1-protocol.c" 2
...
# 31 "subprojects/wlroots/protocol/wlr-data-control-unstable-v1-protocol.c" 2
...
# 32 "subprojects/wlroots/protocol/wlr-data-control-unstable-v1-protocol.c" 2
# 43 "subprojects/wlroots/protocol/wlr-data-control-unstable-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwlr_data_control_manager_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwlr_data_control_device_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwlr_data_control_source_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwlr_data_control_offer_v1_interface = {
