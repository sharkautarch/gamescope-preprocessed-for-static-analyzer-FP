# 1 "subprojects/wlroots/protocol/tablet-unstable-v2-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/tablet-unstable-v2-protocol.c" 2
# 29 "subprojects/wlroots/protocol/tablet-unstable-v2-protocol.c"
...
# 30 "subprojects/wlroots/protocol/tablet-unstable-v2-protocol.c" 2
...
# 31 "subprojects/wlroots/protocol/tablet-unstable-v2-protocol.c" 2
...
# 32 "subprojects/wlroots/protocol/tablet-unstable-v2-protocol.c" 2
# 43 "subprojects/wlroots/protocol/tablet-unstable-v2-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_tablet_manager_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_tablet_seat_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_tablet_tool_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_tablet_v2_interface = {
 "zwp_tablet_v2", 1,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_tablet_pad_ring_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_tablet_pad_strip_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_tablet_pad_group_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_tablet_pad_v2_interface = {
 "zwp_tablet_pad_v2", 1,
