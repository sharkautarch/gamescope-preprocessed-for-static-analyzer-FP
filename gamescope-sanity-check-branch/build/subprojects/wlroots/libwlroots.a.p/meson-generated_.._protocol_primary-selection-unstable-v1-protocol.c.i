# 1 "subprojects/wlroots/protocol/primary-selection-unstable-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/primary-selection-unstable-v1-protocol.c" 2
# 26 "subprojects/wlroots/protocol/primary-selection-unstable-v1-protocol.c"
...
# 27 "subprojects/wlroots/protocol/primary-selection-unstable-v1-protocol.c" 2
...
# 28 "subprojects/wlroots/protocol/primary-selection-unstable-v1-protocol.c" 2
...
# 29 "subprojects/wlroots/protocol/primary-selection-unstable-v1-protocol.c" 2
# 40 "subprojects/wlroots/protocol/primary-selection-unstable-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_primary_selection_device_manager_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_primary_selection_device_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_primary_selection_offer_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_primary_selection_source_v1_interface = {
