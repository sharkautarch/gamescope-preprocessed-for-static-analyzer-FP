# 1 "../subprojects/wlroots/types/buffer/buffer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/buffer/buffer.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/buffer/buffer.c" 2
...
# 3 "../subprojects/wlroots/types/buffer/buffer.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/buffer/buffer.c" 2
...
# 5 "../subprojects/wlroots/types/buffer/buffer.c" 2
...
# 6 "../subprojects/wlroots/types/buffer/buffer.c" 2
...
# 7 "../subprojects/wlroots/types/buffer/buffer.c" 2

void wlr_buffer_init(struct wlr_buffer *buffer,
  const struct wlr_buffer_impl *impl, int width, int height) {
 ((impl->destroy) ? (void) (0) : __assert_fail ("impl->destroy", "types/buffer/buffer.c", 10, __extension__ __PRETTY_FUNCTION__));
 if (impl->begin_data_ptr_access || impl->end_data_ptr_access) {
  ((impl->begin_data_ptr_access && impl->end_data_ptr_access) ? (void) (0) : __assert_fail ("impl->begin_data_ptr_access && impl->end_data_ptr_access", "types/buffer/buffer.c", 12, __extension__ __PRETTY_FUNCTION__));
 }
...
static void buffer_consider_destroy(struct wlr_buffer *buffer) {
 ...
 ((!buffer->accessing_data_ptr) ? (void) (0) : __assert_fail ("!buffer->accessing_data_ptr", "types/buffer/buffer.c", 30, __extension__ __PRETTY_FUNCTION__));

 wl_signal_emit_mutable(&buffer->events.destroy, ((void*)0));
...
void wlr_buffer_drop(struct wlr_buffer *buffer) {
 ...
 ((!buffer->dropped) ? (void) (0) : __assert_fail ("!buffer->dropped", "types/buffer/buffer.c", 43, __extension__ __PRETTY_FUNCTION__));
 buffer->dropped = 1;
...
void wlr_buffer_unlock(struct wlr_buffer *buffer) {
 ...
 ((buffer->n_locks > 0) ? (void) (0) : __assert_fail ("buffer->n_locks > 0", "types/buffer/buffer.c", 58, __extension__ __PRETTY_FUNCTION__));
 buffer->n_locks--;

 if (buffer->n_locks == 0) {
  wl_signal_emit_mutable(&buffer->events.release, ((void*)0));
 }
...
_Bool wlr_buffer_begin_data_ptr_access(struct wlr_buffer *buffer, uint32_t flags,
  void **data, uint32_t *format, size_t *stride) {
 ((!buffer->accessing_data_ptr) ? (void) (0) : __assert_fail ("!buffer->accessing_data_ptr", "types/buffer/buffer.c", 78, __extension__ __PRETTY_FUNCTION__));
 ...
 buffer->accessing_data_ptr = 1;
 return 1;
}

void wlr_buffer_end_data_ptr_access(struct wlr_buffer *buffer) {
 ((buffer->accessing_data_ptr) ? (void) (0) : __assert_fail ("buffer->accessing_data_ptr", "types/buffer/buffer.c", 90, __extension__ __PRETTY_FUNCTION__));
 buffer->impl->end_data_ptr_access(buffer);
 buffer->accessing_data_ptr = 0;
}
...
_Bool buffer_is_opaque(struct wlr_buffer *buffer) {
 ...
 if (wlr_buffer_get_dmabuf(buffer, &dmabuf)) {
  ...
  _Bool opaque = 0;
  if (buffer->width == 1 && buffer->height == 1 && format == ((__u32)('A') | ((__u32)('R') << 8) | ((__u32)('2') << 16) | ((__u32)('4') << 24))) {

   const uint8_t *argb8888 = data;
