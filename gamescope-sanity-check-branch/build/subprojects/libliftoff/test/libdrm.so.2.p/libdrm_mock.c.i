# 1 "../subprojects/libliftoff/test/libdrm_mock.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/libliftoff/test/libdrm_mock.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/libliftoff/test/libdrm_mock.c" 2
...
# 3 "../subprojects/libliftoff/test/libdrm_mock.c" 2
...
# 4 "../subprojects/libliftoff/test/libdrm_mock.c" 2
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 5 "../subprojects/libliftoff/test/libdrm_mock.c" 2
...
# 6 "../subprojects/libliftoff/test/libdrm_mock.c" 2
...
# 7 "../subprojects/libliftoff/test/libdrm_mock.c" 2
...
# 8 "../subprojects/libliftoff/test/libdrm_mock.c" 2
...
# 81 "/usr/include/bits/struct_stat.h" 3 4
    __time_t st_atime;
...
extern int mkfifo (const char *__path, __mode_t __mode)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 9 "../subprojects/libliftoff/test/libdrm_mock.c" 2
...
# 10 "../subprojects/libliftoff/test/libdrm_mock.c" 2
...
# 8 "../subprojects/libliftoff/test/libdrm_mock.h" 2
...
liftoff_mock_plane_add_in_formats(struct liftoff_mock_plane *plane,
      ...
      size_t size);
# 11 "../subprojects/libliftoff/test/libdrm_mock.c" 2
# 20 "../subprojects/libliftoff/test/libdrm_mock.c"
uint32_t liftoff_mock_drm_crtc_id = 0xcccccccc & 0xFF000000;
size_t liftoff_mock_commit_count = 0;
_Bool liftoff_mock_require_primary_plane = 0;

struct liftoff_mock_plane {
 uint32_t id;
 struct liftoff_layer *compatible_layers[512];
 _Bool enabled_props[64];
 uint64_t prop_values[64];
};
...
struct _drmModeAtomicReq {
 struct liftoff_mock_prop props[1024];
 int cursor;
};

static int mock_pipe[2] = {-1, -1};
static struct liftoff_mock_plane mock_planes[64];
static struct liftoff_mock_fb mock_fbs[512];
static drmModePropertyBlobRes mock_blobs[64];
...
static drmModePropertyRes plane_props[64] = {0};
...
{
 (((type & 0xFF000000) != 0) ? (void) (0) : __assert_fail ("(type & OBJ_TYPE_MASK) != 0", "../subprojects/libliftoff/test/libdrm_mock.c", 81, __extension__ __PRETTY_FUNCTION__));
 return index | (type & 0xFF000000);
}

static size_t
object_index(uint32_t id, uint32_t type)
{
 (((id & 0xFF000000) == (type & 0xFF000000)) ? (void) (0) : __assert_fail ("(id & OBJ_TYPE_MASK) == (type & OBJ_TYPE_MASK)", "../subprojects/libliftoff/test/libdrm_mock.c", 88, __extension__ __PRETTY_FUNCTION__));
...
assert_drm_fd(int fd)
{
 ...
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/libdrm_mock.c", 99, __extension__ __PRETTY_FUNCTION__));
 ret = fstat(fd, &stat_got);
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/libdrm_mock.c", 101, __extension__ __PRETTY_FUNCTION__));

 ((stat_got.st_dev == stat_want.st_dev && stat_got.st_ino == stat_want.st_ino) ? (void) (0) : __assert_fail ("stat_got.st_dev == stat_want.st_dev && stat_got.st_ino == stat_want.st_ino", "../subprojects/libliftoff/test/libdrm_mock.c", 104, __extension__ __PRETTY_FUNCTION__));
...
register_prop(const drmModePropertyRes *prop)
{
 ...
 ((plane_props_len < 64) ? (void) (0) : __assert_fail ("plane_props_len < MAX_PLANE_PROPS", "../subprojects/libliftoff/test/libdrm_mock.c", 112, __extension__ __PRETTY_FUNCTION__));
 dst = &plane_props[plane_props_len];
 memcpy(dst, prop, sizeof(*dst));
 dst->prop_id = object_id(plane_props_len, 0xb0b0b0b0);
 plane_props_len++;
...
liftoff_mock_drm_open(void)
{
 ...
 ((mock_pipe[0] < 0) ? (void) (0) : __assert_fail ("mock_pipe[0] < 0", "../subprojects/libliftoff/test/libdrm_mock.c", 142, __extension__ __PRETTY_FUNCTION__));
 ret = pipe(mock_pipe);
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/libdrm_mock.c", 144, __extension__ __PRETTY_FUNCTION__));
...
liftoff_mock_drm_create_plane(uint64_t type)
{
 ...
 ((mock_pipe[0] < 0) ? (void) (0) : __assert_fail ("mock_pipe[0] < 0", "../subprojects/libliftoff/test/libdrm_mock.c", 157, __extension__ __PRETTY_FUNCTION__));
     ...
     struct liftoff_layer *layer)
{
 ...
 for (i = 0; i < 512; i++) {
  if (plane->compatible_layers[i] == ((void*)0)) {
...
liftoff_mock_drm_create_fb(struct liftoff_layer *layer)
{
 ...
 i = 0;
 while (mock_fbs[i].layer != ((void*)0)) {
  i++;
 }

 fb_id = object_id(i, 0xfbfbfbfb);
...
liftoff_mock_drm_set_fb_info(const drmModeFB2 *fb_info)
{
 ...
 i = object_index(fb_info->fb_id, 0xfbfbfbfb);
        ...
        enum plane_prop prop, uint64_t *value)
{
 ...
 prop_id = object_id(prop, 0xb0b0b0b0);
...
mock_fb_get_layer(uint32_t fb_id)
{
 ...
 i = object_index(fb_id, 0xfbfbfbfb);
 ((i < 512) ? (void) (0) : __assert_fail ("i < MAX_LAYERS", "../subprojects/libliftoff/test/libdrm_mock.c", 274, __extension__ __PRETTY_FUNCTION__));
...
get_prop_index(uint32_t id)
{
 ...
 i = object_index(id, 0xb0b0b0b0);
 ((i < plane_props_len) ? (void) (0) : __assert_fail ("i < plane_props_len", "../subprojects/libliftoff/test/libdrm_mock.c", 291, __extension__ __PRETTY_FUNCTION__));
    ...
    uint64_t value)
{
 ...
 plane->enabled_props[get_prop_index(prop_id)] = 1;
...
register_blob(size_t size, const void *data)
{
 ...
 while (mock_blobs[i].id != 0) {
  i++;
  ((i < sizeof(mock_blobs) / sizeof(mock_blobs[0])) ? (void) (0) : __assert_fail ("i < sizeof(mock_blobs) / sizeof(mock_blobs[0])", "../subprojects/libliftoff/test/libdrm_mock.c", 319, __extension__ __PRETTY_FUNCTION__));
 }

 copy = malloc(size);
 memcpy(copy, data, size);

 blob_id = object_id(i, 0xbbbbbbbb);
      ...
      void *user_data)
{
 ...
 _Bool has_fb, has_crtc, found;
 _Bool any_plane_enabled, primary_plane_enabled;
 struct liftoff_layer *layer;

 assert_drm_fd(fd);
 ((flags == 0x0100 || flags == 0) ? (void) (0) : __assert_fail ("flags == DRM_MODE_ATOMIC_TEST_ONLY || flags == 0", "../subprojects/libliftoff/test/libdrm_mock.c", 380, __extension__ __PRETTY_FUNCTION__));

 liftoff_mock_commit_count++;

 any_plane_enabled = 0;
 primary_plane_enabled = 0;
 for (i = 0; i < 64; i++) {
  plane = &mock_planes[i];
  if (plane->id == 0) {
   break;
...
drmModeObjectGetProperties(int fd, uint32_t obj_id, uint32_t obj_type)
{
 ...
 assert_drm_fd(fd);
 ((obj_type == 0xeeeeeeee) ? (void) (0) : __assert_fail ("obj_type == DRM_MODE_OBJECT_PLANE", "../subprojects/libliftoff/test/libdrm_mock.c", 531, __extension__ __PRETTY_FUNCTION__));
 ...
 ((plane != ((void*)0)) ? (void) (0) : __assert_fail ("plane != NULL", "../subprojects/libliftoff/test/libdrm_mock.c", 540, __extension__ __PRETTY_FUNCTION__));
...
{
 (((size_t)req->cursor < sizeof(req->props) / sizeof(req->props[0])) ? (void) (0) : __assert_fail ("(size_t)req->cursor < sizeof(req->props) / sizeof(req->props[0])", "../subprojects/libliftoff/test/libdrm_mock.c", 591, __extension__ __PRETTY_FUNCTION__));
...
drmModeGetFB2(int fd, uint32_t fb_id)
{
 ...
 i = object_index(fb_id, 0xfbfbfbfb);
 ((i < 512) ? (void) (0) : __assert_fail ("i < MAX_LAYERS", "../subprojects/libliftoff/test/libdrm_mock.c", 618, __extension__ __PRETTY_FUNCTION__));
...
drmModeGetPropertyBlob(int fd, uint32_t blob_id)
{
 ...
 i = object_index(blob_id, 0xbbbbbbbb);
 ((i < sizeof(mock_blobs) / sizeof(mock_blobs[0])) ? (void) (0) : __assert_fail ("i < sizeof(mock_blobs) / sizeof(mock_blobs[0])", "../subprojects/libliftoff/test/libdrm_mock.c", 654, __extension__ __PRETTY_FUNCTION__));
