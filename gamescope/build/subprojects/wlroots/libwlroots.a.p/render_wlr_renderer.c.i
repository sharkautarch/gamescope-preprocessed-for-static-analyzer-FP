# 1 "../subprojects/wlroots/render/wlr_renderer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
# 3 "../subprojects/wlroots/render/wlr_renderer.c" 2
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 4 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
# 5 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
# 6 "../subprojects/wlroots/render/wlr_renderer.c" 2
# 1 "../subprojects/wlroots/include/wlr/render/interface.h" 1
# 13 "../subprojects/wlroots/include/wlr/render/interface.h"
...
# 14 "../subprojects/wlroots/include/wlr/render/interface.h" 2
...
void *wlr_texture_read_pixel_options_get_data(
 const struct wlr_texture_read_pixels_options *options);
# 7 "../subprojects/wlroots/render/wlr_renderer.c" 2
# 1 "../subprojects/wlroots/include/wlr/render/pixman.h" 1
# 13 "../subprojects/wlroots/include/wlr/render/pixman.h"
# 1 "../subprojects/wlroots/include/wlr/render/wlr_renderer.h" 1
# 14 "../subprojects/wlroots/include/wlr/render/pixman.h" 2

struct wlr_renderer *wlr_pixman_renderer_create(void);

_Bool wlr_renderer_is_pixman(struct wlr_renderer *wlr_renderer);
_Bool wlr_texture_is_pixman(struct wlr_texture *texture);
...
# 8 "../subprojects/wlroots/render/wlr_renderer.c" 2
# 1 "../subprojects/wlroots/include/wlr/render/wlr_renderer.h" 1
# 9 "../subprojects/wlroots/render/wlr_renderer.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_drm.h" 1
# 13 "../subprojects/wlroots/include/wlr/types/wlr_drm.h"
...
_Bool wlr_drm_format_set_union(struct wlr_drm_format_set *dst,
 const struct wlr_drm_format_set *a, const struct wlr_drm_format_set *b);
# 14 "../subprojects/wlroots/include/wlr/types/wlr_drm.h" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_buffer.h" 1
# 15 "../subprojects/wlroots/include/wlr/types/wlr_drm.h" 2
...
# 36 "../subprojects/wlroots/include/wlr/types/wlr_drm.h"
struct wlr_drm {
 struct wl_global *global;
...
struct wlr_drm *wlr_drm_create(struct wl_display *display,
 struct wlr_renderer *renderer);
# 10 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
# 11 "../subprojects/wlroots/render/wlr_renderer.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_shm.h" 1
# 14 "../subprojects/wlroots/include/wlr/types/wlr_shm.h"
struct wlr_renderer;
# 25 "../subprojects/wlroots/include/wlr/types/wlr_shm.h"
struct wlr_shm {
 struct wl_global *global;
...
struct wlr_shm *wlr_shm_create_with_renderer(struct wl_display *display,
 uint32_t version, struct wlr_renderer *renderer);
# 12 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
# 14 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
# 15 "../subprojects/wlroots/render/wlr_renderer.c" 2

# 1 "subprojects/wlroots/include/wlr/config.h" 1
# 17 "../subprojects/wlroots/render/wlr_renderer.c" 2
# 27 "../subprojects/wlroots/render/wlr_renderer.c"
...
# 28 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
# 29 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
# 30 "../subprojects/wlroots/render/wlr_renderer.c" 2
...
# 31 "../subprojects/wlroots/render/wlr_renderer.c" 2

void wlr_renderer_init(struct wlr_renderer *renderer,
  const struct wlr_renderer_impl *impl) {
 ((impl->begin_buffer_pass) ? (void) (0) : __assert_fail ("impl->begin_buffer_pass", "render/wlr_renderer.c", 34, __extension__ __PRETTY_FUNCTION__));
 ((impl->get_shm_texture_formats) ? (void) (0) : __assert_fail ("impl->get_shm_texture_formats", "render/wlr_renderer.c", 35, __extension__ __PRETTY_FUNCTION__));
 ((impl->get_render_buffer_caps) ? (void) (0) : __assert_fail ("impl->get_render_buffer_caps", "render/wlr_renderer.c", 36, __extension__ __PRETTY_FUNCTION__));
...
_Bool wlr_renderer_init_wl_shm(struct wlr_renderer *r,
  struct wl_display *wl_display) {
 return wlr_shm_create_with_renderer(wl_display, 1, r) != ((void*)0);
}
...
_Bool wlr_renderer_init_wl_display(struct wlr_renderer *r,
 ...
 if (wlr_renderer_get_dmabuf_texture_formats(r) != ((void*)0) &&
   wlr_renderer_get_drm_fd(r) >= 0 &&
   wlr_linux_dmabuf_v1_create_with_renderer(wl_display, 4, r) == ((void*)0)) {
  return 0;
 }
...
static int open_drm_render_node(void) {
 ...
 if (devices_len < 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "drmGetDevices2 failed: %s", "render/wlr_renderer.c", 109, strerror(-devices_len));
  return -1;
 }
 drmDevice **devices = calloc(devices_len, sizeof(*devices));
 if (devices == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Allocation failed" ": %s", "render/wlr_renderer.c", 114, strerror((*__errno_location ())));
  return -1;
 }
 devices_len = drmGetDevices2(flags, devices, devices_len);
 if (devices_len < 0) {
  free(devices);
  _wlr_log(WLR_ERROR, "[%s:%d] " "drmGetDevices2 failed: %s", "render/wlr_renderer.c", 120, strerror(-devices_len));
  return -1;
 }
 ...
 for (int i = 0; i < devices_len; i++) {
  ...
  if (dev->available_nodes & (1 << 2)) {
   const char *name = dev->nodes[2];
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Opening DRM render node '%s'", "render/wlr_renderer.c", 129, name);
   fd = open(name, 02 | 02000000);
   if (fd < 0) {
    _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to open '%s'" ": %s", "render/wlr_renderer.c", 132, name, strerror((*__errno_location ())));
    goto out;
   }
   break;
  }
 ...
 if (fd < 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to find any DRM render node", "render/wlr_renderer.c", 139);
 }
...
static _Bool open_preferred_drm_fd(struct wlr_backend *backend, int *drm_fd_ptr,
  _Bool *own_drm_fd) {
 if (*drm_fd_ptr >= 0) {
  return 1;
 }
 ...
 if (render_name != ((void*)0)) {
  _wlr_log(WLR_INFO, "[%s:%d] " "Opening DRM render node '%s' from WLR_RENDER_DRM_DEVICE", "render/wlr_renderer.c", 162, render_name);


  int drm_fd = open(render_name, 02 | 02000000);
  if (drm_fd < 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to open '%s'" ": %s", "render/wlr_renderer.c", 165, render_name, strerror((*__errno_location ())));
   return 0;
  }
  if (drmGetNodeTypeFromFd(drm_fd) != 2) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "'%s' is not a DRM render node", "render/wlr_renderer.c", 169, render_name);
   close(drm_fd);
   return 0;
  }
  *drm_fd_ptr = drm_fd;
...
static void log_creation_failure(_Bool is_auto, const char *msg) {
 _wlr_log(is_auto ? WLR_DEBUG : WLR_ERROR, "[%s:%d] " "%s%s", "render/wlr_renderer.c", 203, msg, is_auto ? ". Skipping!" : "");
}

static _Bool has_render_node(struct wlr_backend *backend) {
 if (!backend) {
  return 0;
 }
 ...
 _Bool has_render_node = render_node != ((void*)0);
 free(render_node);
...
static struct wlr_renderer *renderer_autocreate(struct wlr_backend *backend, int drm_fd) {
 ...
 _Bool is_auto = strcmp(renderer_name, "auto") == 0;
 struct wlr_renderer *renderer = ((void*)0);

 _Bool own_drm_fd = 0;

 if ((is_auto && 0) || strcmp(renderer_name, "gles2") == 0) {
  if (!open_preferred_drm_fd(backend, &drm_fd, &own_drm_fd)) {
   ...
   _wlr_log(WLR_ERROR, "[%s:%d] " "Cannot create GLES renderer: disabled at compile-time", "render/wlr_renderer.c", 245);
 ...
 if (strcmp(renderer_name, "vulkan") == 0) {
  if (!open_preferred_drm_fd(backend, &drm_fd, &own_drm_fd)) {
   ...
   _wlr_log(WLR_ERROR, "[%s:%d] " "Cannot create Vulkan renderer: disabled at compile-time", "render/wlr_renderer.c", 262);
...
out:
 if (renderer == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Could not initialize renderer", "render/wlr_renderer.c", 283);
 }
...
struct wlr_renderer *renderer_autocreate_with_drm_fd(int drm_fd) {
 ((drm_fd >= 0) ? (void) (0) : __assert_fail ("drm_fd >= 0", "render/wlr_renderer.c", 292, __extension__ __PRETTY_FUNCTION__));

 return renderer_autocreate(((void*)0), drm_fd);
}
