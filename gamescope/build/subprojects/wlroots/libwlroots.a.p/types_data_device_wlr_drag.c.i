# 1 "../subprojects/wlroots/types/data_device/wlr_drag.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
# 3 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
# 5 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
# 6 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
# 7 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 8 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
void wlr_data_source_dnd_action(struct wlr_data_source *source,
 enum wl_data_device_manager_dnd_action action);
# 9 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_seat.h" 1
# 10 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
# 11 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2
...
# 12 "../subprojects/wlroots/types/data_device/wlr_drag.c" 2

static void drag_handle_seat_client_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_drag *drag =
  (__typeof__(drag))((char *)(listener) - __builtin_offsetof(__typeof__(*drag), seat_client_destroy));

 drag->focus_client = ((void*)0);
...
static void drag_set_focus(struct wlr_drag *drag,
 ...
 if (drag->focus_client) {
  ...
  for (offer = (__typeof__(offer))((char *)((&drag->focus_client->seat->drag_offers)->next) - __builtin_offsetof(__typeof__(*offer), link)), tmp = (__typeof__(tmp))((char *)((offer)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &offer->link != (&drag->focus_client->seat->drag_offers); offer = tmp, tmp = (__typeof__(tmp))((char *)(offer->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  ...
  struct wl_resource *resource;
  for (resource = 0, resource = wl_resource_from_link((&drag->focus_client->data_devices)->next); wl_resource_get_link(resource) != (&drag->focus_client->data_devices); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
 ...
 if (drag->source != ((void*)0)) {
  drag->source->accepted = 0;

  uint32_t serial =
   wl_display_next_serial(drag->seat->display);

  struct wl_resource *device_resource;
  for (device_resource = 0, device_resource = wl_resource_from_link((&focus_client->data_devices)->next); wl_resource_get_link(device_resource) != (&focus_client->data_devices); device_resource = wl_resource_from_link(wl_resource_get_link(device_resource)->next)) {
...
static void drag_destroy(struct wlr_drag *drag) {
 ...
 if (drag->started) {
  drag_set_focus(drag, ((void*)0), 0, 0);

  ((drag->seat->drag == drag) ? (void) (0) : __assert_fail ("drag->seat->drag == drag", "types/data_device/wlr_drag.c", 139, __extension__ __PRETTY_FUNCTION__));
  drag->seat->drag = ((void*)0);
 }
...
static void drag_handle_pointer_motion(struct wlr_seat_pointer_grab *grab,
 ...
 struct wlr_drag *drag = grab->data;
 if (drag->focus != ((void*)0) && drag->focus_client != ((void*)0)) {
  struct wl_resource *resource;
  for (resource = 0, resource = wl_resource_from_link((&drag->focus_client->data_devices)->next); wl_resource_get_link(resource) != (&drag->focus_client->data_devices); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
...
static void drag_drop(struct wlr_drag *drag, uint32_t time) {
 ((drag->focus_client) ? (void) (0) : __assert_fail ("drag->focus_client", "types/data_device/wlr_drag.c", 192, __extension__ __PRETTY_FUNCTION__));
...
static void drag_handle_icon_destroy(struct wl_listener *listener, void *data) {
 struct wlr_drag *drag = (__typeof__(drag))((char *)(listener) - __builtin_offsetof(__typeof__(*drag), icon_destroy));
 drag->icon = ((void*)0);
}

static void drag_handle_drag_source_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_drag *drag = (__typeof__(drag))((char *)(listener) - __builtin_offsetof(__typeof__(*drag), source_destroy));
 drag_destroy(drag);
}

static void drag_icon_surface_role_commit(struct wlr_surface *surface) {
 ((surface->role == &drag_icon_surface_role) ? (void) (0) : __assert_fail ("surface->role == &drag_icon_surface_role", "types/data_device/wlr_drag.c", 359, __extension__ __PRETTY_FUNCTION__));
...
static void drag_icon_handle_surface_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_drag_icon *icon =
  (__typeof__(icon))((char *)(listener) - __builtin_offsetof(__typeof__(*icon), surface_destroy));
...
void wlr_seat_request_start_drag(struct wlr_seat *seat, struct wlr_drag *drag,
  struct wlr_surface *origin, uint32_t serial) {
 ((drag->seat == seat) ? (void) (0) : __assert_fail ("drag->seat == seat", "types/data_device/wlr_drag.c", 448, __extension__ __PRETTY_FUNCTION__));

 if (seat->drag != ((void*)0)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Rejecting start_drag request, " "another drag-and-drop operation is already in progress", "types/data_device/wlr_drag.c", 452);
...
static void seat_handle_drag_source_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_seat *seat =
  (__typeof__(seat))((char *)(listener) - __builtin_offsetof(__typeof__(*seat), drag_source_destroy));
 wl_list_remove(&seat->drag_source_destroy.link);
 seat->drag_source = ((void*)0);
}

void wlr_seat_start_drag(struct wlr_seat *seat, struct wlr_drag *drag,
  uint32_t serial) {
 ((drag->seat == seat) ? (void) (0) : __assert_fail ("drag->seat == seat", "types/data_device/wlr_drag.c", 474, __extension__ __PRETTY_FUNCTION__));
 ((!drag->started) ? (void) (0) : __assert_fail ("!drag->started", "types/data_device/wlr_drag.c", 475, __extension__ __PRETTY_FUNCTION__));
 drag->started = 1;
