# 1 "../subprojects/wlroots/util/region.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/util/region.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/util/region.c" 2
...
# 3 "../subprojects/wlroots/util/region.c" 2
...
# 4 "../subprojects/wlroots/util/region.c" 2
...
# 5 "../subprojects/wlroots/util/region.c" 2
# 1 "../subprojects/wlroots/include/wlr/util/region.h" 1
# 19 "../subprojects/wlroots/include/wlr/util/region.h"
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 20 "../subprojects/wlroots/include/wlr/util/region.h" 2
...
void pixman_add_triangles (pixman_image_t *image,
       ...
       int n_tris,
       const pixman_triangle_t *tris);
# 21 "../subprojects/wlroots/include/wlr/util/region.h" 2
...
# 22 "../subprojects/wlroots/include/wlr/util/region.h" 2
...
# 6 "../subprojects/wlroots/util/region.c" 2
...
void wlr_region_expand(pixman_region32_t *dst, const pixman_region32_t *src,
  int distance) {
 ((distance >= 0) ? (void) (0) : __assert_fail ("distance >= 0", "util/region.c", 114, __extension__ __PRETTY_FUNCTION__));
...
static void region_confine(const pixman_region32_t *region, double x1, double y1, double x2,
  ...
  *y2_out = y;
  ...
  _Bool bordering_x = x == box.x1 || x == box.x2 - 1;
  _Bool bordering_y = y == box.y1 || y == box.y2 - 1;
