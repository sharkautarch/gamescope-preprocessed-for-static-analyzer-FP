# 1 "subprojects/wlroots/protocol/linux-drm-syncobj-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/linux-drm-syncobj-v1-protocol.c" 2
# 29 "subprojects/wlroots/protocol/linux-drm-syncobj-v1-protocol.c"
...
# 30 "subprojects/wlroots/protocol/linux-drm-syncobj-v1-protocol.c" 2
...
# 31 "subprojects/wlroots/protocol/linux-drm-syncobj-v1-protocol.c" 2
...
# 32 "subprojects/wlroots/protocol/linux-drm-syncobj-v1-protocol.c" 2
# 43 "subprojects/wlroots/protocol/linux-drm-syncobj-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_linux_drm_syncobj_manager_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_linux_drm_syncobj_timeline_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_linux_drm_syncobj_surface_v1_interface = {
