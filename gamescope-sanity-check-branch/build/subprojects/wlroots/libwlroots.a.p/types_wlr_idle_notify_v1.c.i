# 1 "../subprojects/wlroots/types/wlr_idle_notify_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_idle_notify_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_idle_notify_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_idle_notify_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_idle_notify_v1.h" 1
# 12 "../subprojects/wlroots/include/wlr/types/wlr_idle_notify_v1.h"
...
# 13 "../subprojects/wlroots/include/wlr/types/wlr_idle_notify_v1.h" 2
...
# 4 "../subprojects/wlroots/types/wlr_idle_notify_v1.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_idle_notify_v1.c" 2
# 1 "subprojects/wlroots/protocol/ext-idle-notify-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/ext-idle-notify-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 48 "subprojects/wlroots/protocol/ext-idle-notify-v1-protocol.h"
struct ext_idle_notification_v1;
struct ext_idle_notifier_v1;
struct wl_seat;
# 73 "subprojects/wlroots/protocol/ext-idle-notify-v1-protocol.h"
extern const struct wl_interface ext_idle_notifier_v1_interface;
# 116 "subprojects/wlroots/protocol/ext-idle-notify-v1-protocol.h"
...
struct ext_idle_notifier_v1_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 146 "subprojects/wlroots/protocol/ext-idle-notify-v1-protocol.h"
...
# 167 "subprojects/wlroots/protocol/ext-idle-notify-v1-protocol.h"
...
# 199 "subprojects/wlroots/protocol/ext-idle-notify-v1-protocol.h"
static inline void
...
# 6 "../subprojects/wlroots/types/wlr_idle_notify_v1.c" 2
...
static struct wlr_idle_notification_v1 *notification_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &ext_idle_notification_v1_interface, &notification_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &ext_idle_notification_v1_interface, &notification_impl)", "types/wlr_idle_notify_v1.c", 38, __extension__ __PRETTY_FUNCTION__));
...
static struct wlr_idle_notifier_v1 *notifier_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &ext_idle_notifier_v1_interface, &notifier_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &ext_idle_notifier_v1_interface, &notifier_impl)", "types/wlr_idle_notify_v1.c", 45, __extension__ __PRETTY_FUNCTION__));
...
static int notification_handle_timer(void *data) {
 ...
 notification_set_idle(notification, 1);
 return 0;
}
...
static void notification_handle_seat_destroy(struct wl_listener *listener,
 ...
 struct wlr_idle_notification_v1 *notification =
  (__typeof__(notification))((char *)(listener) - __builtin_offsetof(__typeof__(*notification), seat_destroy));
...
static void notifier_handle_get_idle_notification(struct wl_client *client,
 ...
 wl_resource_set_implementation(resource, &notification_impl, ((void*)0),
...
static void notifier_bind(struct wl_client *client, void *data,
 ...
 wl_resource_set_implementation(resource, &notifier_impl, notifier, ((void*)0));
}

static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_idle_notifier_v1 *notifier =
  (__typeof__(notifier))((char *)(listener) - __builtin_offsetof(__typeof__(*notifier), display_destroy));
...
struct wlr_idle_notifier_v1 *wlr_idle_notifier_v1_create(struct wl_display *display) {
 ...
 notifier->global = wl_global_create(display,
  &ext_idle_notifier_v1_interface, 1, notifier,
  notifier_bind);
 if (notifier->global == ((void*)0)) {
  free(notifier);
  return ((void*)0);
 }
...
void wlr_idle_notifier_v1_set_inhibited(struct wlr_idle_notifier_v1 *notifier,
 ...
 struct wlr_idle_notification_v1 *notification;
 for (notification = (__typeof__(notification))((char *)((&notifier->notifications)->next) - __builtin_offsetof(__typeof__(*notification), link)); &notification->link != (&notifier->notifications); notification = (__typeof__(notification))((char *)(notification->link.next) - __builtin_offsetof(__typeof__(*notification), link))) {
  notification_reset_timer(notification);
 }
}
