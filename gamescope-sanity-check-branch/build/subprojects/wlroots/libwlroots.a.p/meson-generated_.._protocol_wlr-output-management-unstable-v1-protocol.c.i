# 1 "subprojects/wlroots/protocol/wlr-output-management-unstable-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/wlr-output-management-unstable-v1-protocol.c" 2
# 28 "subprojects/wlroots/protocol/wlr-output-management-unstable-v1-protocol.c"
...
# 29 "subprojects/wlroots/protocol/wlr-output-management-unstable-v1-protocol.c" 2
...
# 30 "subprojects/wlroots/protocol/wlr-output-management-unstable-v1-protocol.c" 2
...
# 31 "subprojects/wlroots/protocol/wlr-output-management-unstable-v1-protocol.c" 2
# 42 "subprojects/wlroots/protocol/wlr-output-management-unstable-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwlr_output_manager_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwlr_output_head_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwlr_output_mode_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwlr_output_configuration_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwlr_output_configuration_head_v1_interface = {
