# 1 "../subprojects/wlroots/util/array.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/util/array.c" 2
...
# 5 "../subprojects/wlroots/include/util/array.h" 2
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 6 "../subprojects/wlroots/include/util/array.h" 2
...
# 7 "../subprojects/wlroots/include/util/array.h" 2
...
# 2 "../subprojects/wlroots/util/array.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 3 "../subprojects/wlroots/util/array.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/util/array.c" 2

void array_remove_at(struct wl_array *arr, size_t offset, size_t size) {
 ((arr->size >= offset + size) ? (void) (0) : __assert_fail ("arr->size >= offset + size", "util/array.c", 6, __extension__ __PRETTY_FUNCTION__));
