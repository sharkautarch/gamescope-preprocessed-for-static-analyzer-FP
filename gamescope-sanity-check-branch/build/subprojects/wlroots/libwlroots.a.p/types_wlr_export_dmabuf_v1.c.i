# 1 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c" 2
...
void wlr_output_send_request_state(struct wlr_output *output,
 const struct wlr_output_state *state);
# 5 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/render/dmabuf.h" 1
# 6 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_export_dmabuf_v1.h" 1
# 14 "../subprojects/wlroots/include/wlr/types/wlr_export_dmabuf_v1.h"
# 1 "../subprojects/wlroots/include/wlr/render/dmabuf.h" 1
# 15 "../subprojects/wlroots/include/wlr/types/wlr_export_dmabuf_v1.h" 2
...
# 7 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c" 2
...
# 8 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c" 2
# 1 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 62 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h"
struct wl_output;
struct zwlr_export_dmabuf_frame_v1;
struct zwlr_export_dmabuf_manager_v1;
# 81 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h"
extern const struct wl_interface zwlr_export_dmabuf_manager_v1_interface;
# 124 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h"
...
# 171 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h"
...
# 187 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h"
...
# 217 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h"
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
};
# 263 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h"
static inline void
...
{
 wl_resource_post_event(resource_, 0, width, height, offset_x, offset_y, buffer_flags, flags, format, mod_high, mod_low, num_objects);
}
# 280 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h"
static inline void
...
{
 wl_resource_post_event(resource_, 1, index, fd, size, offset, stride, plane_index);
}
# 294 "subprojects/wlroots/protocol/wlr-export-dmabuf-unstable-v1-protocol.h"
static inline void
...
{
 wl_resource_post_event(resource_, 3, reason);
}
# 9 "../subprojects/wlroots/types/wlr_export_dmabuf_v1.c" 2
...
static struct wlr_export_dmabuf_frame_v1 *frame_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwlr_export_dmabuf_frame_v1_interface, &frame_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwlr_export_dmabuf_frame_v1_interface, &frame_impl)", "types/wlr_export_dmabuf_v1.c", 18, __extension__ __PRETTY_FUNCTION__));
...
static void frame_output_handle_destroy(struct wl_listener *listener, void *data) {
 struct wlr_export_dmabuf_frame_v1 *frame = (__typeof__(frame))((char *)(listener) - __builtin_offsetof(__typeof__(*frame), output_destroy));
 frame_destroy(frame);
}
...
static struct wlr_export_dmabuf_manager_v1 *manager_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwlr_export_dmabuf_manager_v1_interface, &manager_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwlr_export_dmabuf_manager_v1_interface, &manager_impl)", "types/wlr_export_dmabuf_v1.c", 107, __extension__ __PRETTY_FUNCTION__));
...
static void manager_handle_capture_output(struct wl_client *client,
 ...
 wlr_output_lock_attach_render(frame->output, 1);
 if (overlay_cursor) {
  wlr_output_lock_software_cursors(frame->output, 1);
