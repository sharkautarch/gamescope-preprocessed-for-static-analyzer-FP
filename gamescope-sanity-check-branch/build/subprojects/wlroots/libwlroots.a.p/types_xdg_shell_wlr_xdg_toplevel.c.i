# 1 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_toplevel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_toplevel.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_toplevel.c" 2
...
# 3 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_toplevel.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_toplevel.c" 2
...
# 5 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_toplevel.c" 2
...
# 6 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_toplevel.c" 2
# 1 "../subprojects/wlroots/include/types/wlr_xdg_shell.h" 1
...
# 5 "../subprojects/wlroots/include/types/wlr_xdg_shell.h" 2
...
# 6 "../subprojects/wlroots/include/types/wlr_xdg_shell.h" 2
...
_Bool set_xdg_surface_role(struct wlr_xdg_surface *surface, enum wlr_xdg_surface_role role);
...
# 7 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_toplevel.c" 2
# 1 "../subprojects/wlroots/include/util/utf8.h" 1
...
# 8 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_toplevel.c" 2
...
struct wlr_xdg_toplevel_configure *send_xdg_toplevel_configure(
 ...
 if (configure == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Allocation failed", "types/xdg_shell/wlr_xdg_toplevel.c", 28);
 ...
 *configure = toplevel->scheduled;
 ...
 if ((configure->fields & WLR_XDG_TOPLEVEL_CONFIGURE_WM_CAPABILITIES) &&
  ...
  ((caps_len <= sizeof(caps) / sizeof(caps[0])) ? (void) (0) : __assert_fail ("caps_len <= sizeof(caps) / sizeof(caps[0])", "types/xdg_shell/wlr_xdg_toplevel.c", 58, __extension__ __PRETTY_FUNCTION__));
 ...
 if (configure->suspended && version >= 6) {
  states[nstates++] = XDG_TOPLEVEL_STATE_SUSPENDED;
 }
 ((nstates <= sizeof(states) / sizeof(states[0])) ? (void) (0) : __assert_fail ("nstates <= sizeof(states) / sizeof(states[0])", "types/xdg_shell/wlr_xdg_toplevel.c", 102, __extension__ __PRETTY_FUNCTION__));
...
struct wlr_xdg_toplevel *wlr_xdg_toplevel_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &xdg_toplevel_interface, &xdg_toplevel_implementation)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &xdg_toplevel_interface, &xdg_toplevel_implementation)", "types/xdg_shell/wlr_xdg_toplevel.c", 138, __extension__ __PRETTY_FUNCTION__));
...
static void handle_parent_unmap(struct wl_listener *listener, void *data) {
 struct wlr_xdg_toplevel *toplevel =
  (__typeof__(toplevel))((char *)(listener) - __builtin_offsetof(__typeof__(*toplevel), parent_unmap));
 if (!wlr_xdg_toplevel_set_parent(toplevel, toplevel->parent->parent)) {
  ((0 && "Unreachable") ? (void) (0) : __assert_fail ("0 && \"Unreachable\"", "types/xdg_shell/wlr_xdg_toplevel.c", 154, __extension__ __PRETTY_FUNCTION__));
 }
}
...
_Bool wlr_xdg_toplevel_set_parent(struct wlr_xdg_toplevel *toplevel,
 ...
 if (parent != ((void*)0) && parent->base->surface->mapped) {
 ...
 wl_signal_emit_mutable(&toplevel->events.set_parent, ((void*)0));
 return 1;
}
...
static void xdg_toplevel_handle_set_parent(struct wl_client *client,
 ...
 struct wlr_xdg_toplevel *parent = ((void*)0);

 if (parent_resource != ((void*)0)) {
...
static void xdg_toplevel_handle_set_title(struct wl_client *client,
 ...
 free(toplevel->title);
 toplevel->title = tmp;
 wl_signal_emit_mutable(&toplevel->events.set_title, ((void*)0));
}
...
static void xdg_toplevel_handle_set_app_id(struct wl_client *client,
 ...
 toplevel->app_id = tmp;
 wl_signal_emit_mutable(&toplevel->events.set_app_id, ((void*)0));
}
...
static void xdg_toplevel_handle_set_maximized(struct wl_client *client,
 ...
 wl_signal_emit_mutable(&toplevel->events.request_maximize, ((void*)0));
}
...
static void handle_fullscreen_output_destroy(struct wl_listener *listener,
 ...
 struct wlr_xdg_toplevel_requested *req =
  (__typeof__(req))((char *)(listener) - __builtin_offsetof(__typeof__(*req), fullscreen_output_destroy));
 req->fullscreen_output = ((void*)0);
 wl_list_remove(&req->fullscreen_output_destroy.link);
}

static void store_fullscreen_requested(struct wlr_xdg_toplevel *toplevel,
  _Bool fullscreen, struct wlr_output *output) {
...
static void xdg_toplevel_handle_set_fullscreen(struct wl_client *client,
 ...
 if (output_resource != ((void*)0)) {
  output = wlr_output_from_resource(output_resource);
 }

 store_fullscreen_requested(toplevel, 1, output);

 wl_signal_emit_mutable(&toplevel->events.request_fullscreen, ((void*)0));
}
...
static void xdg_toplevel_handle_unset_fullscreen(struct wl_client *client,
 ...
 store_fullscreen_requested(toplevel, 0, ((void*)0));
...
static void xdg_toplevel_handle_set_minimized(struct wl_client *client,
 ...
 struct wlr_xdg_toplevel *toplevel =
  wlr_xdg_toplevel_from_resource(resource);
 toplevel->requested.minimized = 1;
 wl_signal_emit_mutable(&toplevel->events.request_minimize, ((void*)0));
}
...
void create_xdg_toplevel(struct wlr_xdg_surface *surface,
 ...
 ((surface->toplevel == ((void*)0)) ? (void) (0) : __assert_fail ("surface->toplevel == NULL", "types/xdg_shell/wlr_xdg_toplevel.c", 455, __extension__ __PRETTY_FUNCTION__));
 surface->toplevel = calloc(1, sizeof(*surface->toplevel));
 if (surface->toplevel == ((void*)0)) {
 ...
 if (surface->toplevel->resource == ((void*)0)) {
  goto error_synced;
 }
 wl_resource_set_implementation(surface->toplevel->resource,
  &xdg_toplevel_implementation, surface->toplevel, ((void*)0));

 set_xdg_surface_role_object(surface, surface->toplevel->resource);

 if (surface->client->shell->version >= 5) {
...
void reset_xdg_toplevel(struct wlr_xdg_toplevel *toplevel) {
 ...
 free(toplevel->title);
 toplevel->title = ((void*)0);
 free(toplevel->app_id);
 toplevel->app_id = ((void*)0);

 if (toplevel->requested.fullscreen_output) {
  wl_list_remove(&toplevel->requested.fullscreen_output_destroy.link);
  toplevel->requested.fullscreen_output = ((void*)0);
 }
 toplevel->requested.fullscreen = 0;
 toplevel->requested.maximized = 0;
 toplevel->requested.minimized = 0;
}
...
void destroy_xdg_toplevel(struct wlr_xdg_toplevel *toplevel) {
 ...
 wl_signal_emit_mutable(&toplevel->events.destroy, ((void*)0));

 wlr_surface_synced_finish(&toplevel->synced);
 toplevel->base->toplevel = ((void*)0);
 wl_resource_set_user_data(toplevel->resource, ((void*)0));
 free(toplevel);
}
...
uint32_t wlr_xdg_toplevel_set_size(struct wlr_xdg_toplevel *toplevel,
  int32_t width, int32_t height) {
 ((width >= 0 && height >= 0) ? (void) (0) : __assert_fail ("width >= 0 && height >= 0", "types/xdg_shell/wlr_xdg_toplevel.c", 549, __extension__ __PRETTY_FUNCTION__));
...
uint32_t wlr_xdg_toplevel_set_tiled(struct wlr_xdg_toplevel *toplevel,
  uint32_t tiled) {
 ((toplevel->base->client->shell->version >= 2) ? (void) (0) : __assert_fail ("toplevel->base->client->shell->version >= XDG_TOPLEVEL_STATE_TILED_LEFT_SINCE_VERSION", "types/xdg_shell/wlr_xdg_toplevel.c", 582, __extension__ __PRETTY_FUNCTION__));
...
uint32_t wlr_xdg_toplevel_set_bounds(struct wlr_xdg_toplevel *toplevel,
  int32_t width, int32_t height) {
 ((toplevel->base->client->shell->version >= 4) ? (void) (0) : __assert_fail ("toplevel->base->client->shell->version >= XDG_TOPLEVEL_CONFIGURE_BOUNDS_SINCE_VERSION", "types/xdg_shell/wlr_xdg_toplevel.c", 590, __extension__ __PRETTY_FUNCTION__));

 ((width >= 0 && height >= 0) ? (void) (0) : __assert_fail ("width >= 0 && height >= 0", "types/xdg_shell/wlr_xdg_toplevel.c", 591, __extension__ __PRETTY_FUNCTION__));
...
uint32_t wlr_xdg_toplevel_set_wm_capabilities(struct wlr_xdg_toplevel *toplevel,
  uint32_t caps) {
 ((toplevel->base->client->shell->version >= 5) ? (void) (0) : __assert_fail ("toplevel->base->client->shell->version >= XDG_TOPLEVEL_WM_CAPABILITIES_SINCE_VERSION", "types/xdg_shell/wlr_xdg_toplevel.c", 601, __extension__ __PRETTY_FUNCTION__));
...
uint32_t wlr_xdg_toplevel_set_suspended(struct wlr_xdg_toplevel *toplevel,
  _Bool suspended) {
 ((toplevel->base->client->shell->version >= 6) ? (void) (0) : __assert_fail ("toplevel->base->client->shell->version >= XDG_TOPLEVEL_STATE_SUSPENDED_SINCE_VERSION", "types/xdg_shell/wlr_xdg_toplevel.c", 610, __extension__ __PRETTY_FUNCTION__));
