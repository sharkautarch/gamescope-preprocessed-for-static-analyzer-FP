# 1 "../subprojects/wlroots/render/wlr_texture.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/render/wlr_texture.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/render/wlr_texture.c" 2
...
# 3 "../subprojects/wlroots/render/wlr_texture.c" 2
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 4 "../subprojects/wlroots/render/wlr_texture.c" 2
...
# 5 "../subprojects/wlroots/render/wlr_texture.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 6 "../subprojects/wlroots/render/wlr_texture.c" 2
...
void *wlr_texture_read_pixel_options_get_data(
 const struct wlr_texture_read_pixels_options *options);
# 7 "../subprojects/wlroots/render/wlr_texture.c" 2
# 1 "../subprojects/wlroots/include/wlr/render/wlr_texture.h" 1
# 8 "../subprojects/wlroots/render/wlr_texture.c" 2
...
# 9 "../subprojects/wlroots/render/wlr_texture.c" 2
...
# 10 "../subprojects/wlroots/render/wlr_texture.c" 2

void wlr_texture_init(struct wlr_texture *texture, struct wlr_renderer *renderer,
  const struct wlr_texture_impl *impl, uint32_t width, uint32_t height) {
 ((renderer) ? (void) (0) : __assert_fail ("renderer", "render/wlr_texture.c", 13, __extension__ __PRETTY_FUNCTION__));
...
struct wlr_texture *wlr_texture_from_pixels(struct wlr_renderer *renderer,
  uint32_t fmt, uint32_t stride, uint32_t width, uint32_t height,
  const void *data) {
 ((width > 0) ? (void) (0) : __assert_fail ("width > 0", "render/wlr_texture.c", 76, __extension__ __PRETTY_FUNCTION__));
 ((height > 0) ? (void) (0) : __assert_fail ("height > 0", "render/wlr_texture.c", 77, __extension__ __PRETTY_FUNCTION__));
 ((stride > 0) ? (void) (0) : __assert_fail ("stride > 0", "render/wlr_texture.c", 78, __extension__ __PRETTY_FUNCTION__));
 ((data) ? (void) (0) : __assert_fail ("data", "render/wlr_texture.c", 79, __extension__ __PRETTY_FUNCTION__));
