# 1 "../subprojects/wlroots/xwayland/selection/dnd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
# 3 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
# 4 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 5 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
# 6 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
void wlr_data_source_dnd_action(struct wlr_data_source *source,
 enum wl_data_device_manager_dnd_action action);
# 7 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
# 8 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
xcb_xfixes_get_client_disconnect_mode_reply (xcb_connection_t *c,
                                             ...
                                             xcb_generic_error_t **e);
# 9 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
# 10 "../subprojects/wlroots/xwayland/selection/dnd.c" 2
...
static void xwm_dnd_send_event(struct wlr_xwm *xwm, xcb_atom_t type,
 ...
 ((dest != ((void*)0)) ? (void) (0) : __assert_fail ("dest != NULL", "xwayland/selection/dnd.c", 41, __extension__ __PRETTY_FUNCTION__));
...
static void xwm_dnd_send_enter(struct wlr_xwm *xwm) {
 ...
 ((drag != ((void*)0)) ? (void) (0) : __assert_fail ("drag != NULL", "xwayland/selection/dnd.c", 62, __extension__ __PRETTY_FUNCTION__));
...
static void xwm_dnd_send_position(struct wlr_xwm *xwm, uint32_t time, int16_t x,
  int16_t y) {
 struct wlr_drag *drag = xwm->drag;
 ((drag != ((void*)0)) ? (void) (0) : __assert_fail ("drag != NULL", "xwayland/selection/dnd.c", 109, __extension__ __PRETTY_FUNCTION__));
...
static void xwm_dnd_send_drop(struct wlr_xwm *xwm, uint32_t time) {
 struct wlr_drag *drag = xwm->drag;
 ((drag != ((void*)0)) ? (void) (0) : __assert_fail ("drag != NULL", "xwayland/selection/dnd.c", 123, __extension__ __PRETTY_FUNCTION__));
 struct wlr_xwayland_surface *dest = xwm->drag_focus;
 ((dest != ((void*)0)) ? (void) (0) : __assert_fail ("dest != NULL", "xwayland/selection/dnd.c", 125, __extension__ __PRETTY_FUNCTION__));
...
static void xwm_dnd_send_leave(struct wlr_xwm *xwm) {
 struct wlr_drag *drag = xwm->drag;
 ((drag != ((void*)0)) ? (void) (0) : __assert_fail ("drag != NULL", "xwayland/selection/dnd.c", 136, __extension__ __PRETTY_FUNCTION__));
 struct wlr_xwayland_surface *dest = xwm->drag_focus;
 ((dest != ((void*)0)) ? (void) (0) : __assert_fail ("dest != NULL", "xwayland/selection/dnd.c", 138, __extension__ __PRETTY_FUNCTION__));
...
# 164 "../subprojects/wlroots/xwayland/selection/dnd.c"
int xwm_handle_selection_client_message(struct wlr_xwm *xwm,
  xcb_client_message_event_t *ev) {
 if (ev->type == xwm->atoms[DND_STATUS]) {
  if (xwm->drag == ((void*)0)) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "ignoring XdndStatus client message because " "there's no drag", "xwayland/selection/dnd.c", 169);
  ...
  _Bool accepted = data->data32[1] & 1;
  xcb_atom_t action_atom = data->data32[4];

  if (xwm->drag_focus == ((void*)0) ||
    target_window != xwm->drag_focus->window_id) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "ignoring XdndStatus client message because " "it doesn't match the current drag focus window ID", "xwayland/selection/dnd.c", 181);
  ...
  struct wlr_drag *drag = xwm->drag;
  ((drag != ((void*)0)) ? (void) (0) : __assert_fail ("drag != NULL", "xwayland/selection/dnd.c", 189, __extension__ __PRETTY_FUNCTION__));

  drag->source->accepted = accepted;
  wlr_data_source_dnd_action(drag->source, action);

  _wlr_log(WLR_DEBUG, "[%s:%d] " "DND_STATUS window=%" "u" " accepted=%d action=%d", "xwayland/selection/dnd.c", 195, target_window, accepted, action);

  return 1;
 } else if (ev->type == xwm->atoms[DND_FINISHED]) {


  if (xwm->seat == ((void*)0) || xwm->seat->drag_source == ((void*)0) ||
    xwm->drag != ((void*)0)) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "ignoring XdndFinished client message because " "there's no finished drag", "xwayland/selection/dnd.c", 203);
  ...
  xcb_client_message_data_t *data = &ev->data;
  xcb_window_t target_window = data->data32[0];
  _Bool performed = data->data32[1] & 1;
  xcb_atom_t action_atom = data->data32[2];

  if (xwm->drag_focus == ((void*)0) ||
    target_window != xwm->drag_focus->window_id) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "ignoring XdndFinished client message because " "it doesn't match the finished drag focus window ID", "xwayland/selection/dnd.c", 217);
  ...
  _wlr_log(WLR_DEBUG, "[%s:%d] " "DND_FINISH window=%" "u" " performed=%d action=%d", "xwayland/selection/dnd.c", 229, target_window, performed, action);
...
static void seat_handle_drag_focus(struct wl_listener *listener, void *data) {
 ...
 struct wlr_xwm *xwm = (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), seat_drag_focus));

 struct wlr_xwayland_surface *focus = ((void*)0);
 if (drag->focus != ((void*)0)) {
...
static void seat_handle_drag_motion(struct wl_listener *listener, void *data) {
 struct wlr_xwm *xwm = (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), seat_drag_motion));
...
static void seat_handle_drag_drop(struct wl_listener *listener, void *data) {
 struct wlr_xwm *xwm = (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), seat_drag_drop));
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Wayland drag dropped over an Xwayland window", "xwayland/selection/dnd.c", 290);
 xwm_dnd_send_drop(xwm, event->time);
}

static void seat_handle_drag_destroy(struct wl_listener *listener, void *data) {
 struct wlr_xwm *xwm = (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), seat_drag_destroy));



 if (xwm->drag_focus != ((void*)0) && !xwm->drag->source->accepted) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Wayland drag cancelled over an Xwayland window", "xwayland/selection/dnd.c", 300);
  xwm_dnd_send_leave(xwm);
 }
...
static void seat_handle_drag_source_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_xwm *xwm =
  (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), seat_drag_source_destroy));

 wl_list_remove(&xwm->seat_drag_source_destroy.link);
 xwm->drag_focus = ((void*)0);
}
