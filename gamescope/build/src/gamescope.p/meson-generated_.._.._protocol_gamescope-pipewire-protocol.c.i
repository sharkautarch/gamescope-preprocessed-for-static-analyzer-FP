# 1 "protocol/gamescope-pipewire-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "protocol/gamescope-pipewire-protocol.c" 2
# 26 "protocol/gamescope-pipewire-protocol.c"
...
# 27 "protocol/gamescope-pipewire-protocol.c" 2
...
# 28 "protocol/gamescope-pipewire-protocol.c" 2
...
# 29 "protocol/gamescope-pipewire-protocol.c" 2
# 41 "protocol/gamescope-pipewire-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface gamescope_pipewire_interface = {
