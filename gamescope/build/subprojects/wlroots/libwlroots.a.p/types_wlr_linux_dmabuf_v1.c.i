# 1 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 7 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
_Bool wlr_backend_commit(struct wlr_backend *backend,
 const struct wlr_backend_output_state *states, size_t states_len);
# 8 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
# 1 "subprojects/wlroots/include/wlr/config.h" 1
# 9 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 10 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/render/wlr_renderer.h" 1
# 11 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 12 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 13 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 14 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 15 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 16 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
# 1 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h" 1
...
# 1 "/usr/lib/clang/17/include/stddef.h" 1 3
# 8 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 48 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
struct wl_buffer;
struct wl_surface;
struct zwp_linux_buffer_params_v1;
struct zwp_linux_dmabuf_feedback_v1;
struct zwp_linux_dmabuf_v1;
# 195 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
extern const struct wl_interface zwp_linux_dmabuf_v1_interface;
# 238 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
extern const struct wl_interface zwp_linux_buffer_params_v1_interface;
# 303 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
...
struct zwp_linux_dmabuf_v1_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 328 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
 void (*create_params)(struct wl_client *client,
         struct wl_resource *resource,
         uint32_t params_id);
# 340 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
 void (*get_default_feedback)(struct wl_client *client,
         struct wl_resource *resource,
         uint32_t id);
# 355 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
 void (*get_surface_feedback)(struct wl_client *client,
         struct wl_resource *resource,
         uint32_t id,
         struct wl_resource *surface);
};
# 396 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
static inline void
zwp_linux_dmabuf_v1_send_format(struct wl_resource *resource_, uint32_t format)
{
 wl_resource_post_event(resource_, 0, format);
}
# 410 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
static inline void
zwp_linux_dmabuf_v1_send_modifier(struct wl_resource *resource_, uint32_t format, uint32_t modifier_hi, uint32_t modifier_lo)
{
 wl_resource_post_event(resource_, 1, format, modifier_hi, modifier_lo);
}
...
struct zwp_linux_buffer_params_v1_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 515 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
 void (*add)(struct wl_client *client,
      struct wl_resource *resource,
      int32_t fd,
      uint32_t plane_idx,
...
# 592 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
 void (*create)(struct wl_client *client,
         ...
         uint32_t format,
         uint32_t flags);
# 629 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
...
# 673 "subprojects/wlroots/protocol/linux-dmabuf-v1-protocol.h"
static inline void
zwp_linux_buffer_params_v1_send_created(struct wl_resource *resource_, struct wl_resource *buffer)
{
 wl_resource_post_event(resource_, 0, buffer);
}
...
{
 wl_resource_post_event(resource_, 2, device);
}
...
{
 wl_resource_post_event(resource_, 4, device);
}
...
{
 wl_resource_post_event(resource_, 5, indices);
}
...
{
 wl_resource_post_event(resource_, 6, flags);
}
# 17 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
# 18 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
# 1 "../subprojects/wlroots/include/util/shm.h" 1




# 1 "/usr/lib/clang/17/include/stddef.h" 1 3
# 6 "../subprojects/wlroots/include/util/shm.h" 2

int create_shm_file(void);
int allocate_shm_file(size_t size);
_Bool allocate_shm_file_pair(size_t size, int *rw_fd, int *ro_fd);
# 19 "../subprojects/wlroots/types/wlr_linux_dmabuf_v1.c" 2
...
struct wlr_linux_dmabuf_v1_surface {
 ...
 struct wl_list feedback_resources;
};
...
struct wlr_dmabuf_v1_buffer *wlr_dmabuf_v1_buffer_try_from_buffer_resource(
 ...
 if (!buffer_resource_is_instance(resource) ||
    wl_resource_get_user_data(resource) == ((void*)0)) {
  return ((void*)0);
 }
...
static struct wlr_dmabuf_v1_buffer *dmabuf_v1_buffer_from_buffer(
 ...
 ((wlr_buffer->impl == &buffer_impl) ? (void) (0) : __assert_fail ("wlr_buffer->impl == &buffer_impl", "types/wlr_linux_dmabuf_v1.c", 97, __extension__ __PRETTY_FUNCTION__));
 struct wlr_dmabuf_v1_buffer *buffer = (__typeof__(buffer))((char *)(wlr_buffer) - __builtin_offsetof(__typeof__(*buffer), base));
 return buffer;
}
...
static _Bool buffer_get_dmabuf(struct wlr_buffer *wlr_buffer,
  struct wlr_dmabuf_attributes *attribs) {
 struct wlr_dmabuf_v1_buffer *buffer =
  dmabuf_v1_buffer_from_buffer(wlr_buffer);
...
static void buffer_handle_release(struct wl_listener *listener, void *data) {
 struct wlr_dmabuf_v1_buffer *buffer =
  (__typeof__(buffer))((char *)(listener) - __builtin_offsetof(__typeof__(*buffer), release));
 if (buffer->resource != ((void*)0)) {
...
static struct wlr_linux_buffer_params_v1 *params_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwp_linux_buffer_params_v1_interface, &buffer_params_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwp_linux_buffer_params_v1_interface, &buffer_params_impl)", "types/wlr_linux_dmabuf_v1.c", 139, __extension__ __PRETTY_FUNCTION__));
...
static void params_add(struct wl_client *client,
 ...
 if (params->has_modifier && modifier != params->attributes.modifier) {
  wl_resource_post_error(params_resource,
   ...
   "sent modifier %" "l" "u" " for plane %u, expected"
   " modifier %" "l" "u" " like other planes",
...
static void buffer_handle_resource_destroy(struct wl_resource *buffer_resource) {
 ...
 ((buffer != ((void*)0)) ? (void) (0) : __assert_fail ("buffer != NULL", "types/wlr_linux_dmabuf_v1.c", 202, __extension__ __PRETTY_FUNCTION__));
 buffer->resource = ((void*)0);
 wlr_buffer_drop(&buffer->base);
}

static _Bool check_import_dmabuf(struct wlr_dmabuf_attributes *attribs, void *data) {
 ...
 for (int i = 0; i < attribs->n_planes; i++) {
  ...
  if (drmPrimeFDToHandle(linux_dmabuf->main_device_fd, attribs->fd[i], &handle) != 0) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Failed to import DMA-BUF FD" ": %s", "types/wlr_linux_dmabuf_v1.c", 218, strerror((*__errno_location ())));
   return 0;
  }
  if (drmCloseBufferHandle(linux_dmabuf->main_device_fd, handle) != 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to close buffer handle" ": %s", "types/wlr_linux_dmabuf_v1.c", 222, strerror((*__errno_location ())));
   return 0;
  }
 }
 return 1;
...
static void params_create_common(struct wl_resource *params_resource,
 ...
 wl_resource_set_user_data(params_resource, ((void*)0));
 free(params);
 ...
 if (flags & ~all_flags) {
  wl_resource_post_error(params_resource,
   ZWP_LINUX_BUFFER_PARAMS_V1_ERROR_INVALID_FORMAT,
   "Unknown dmabuf flags %""u", flags);
  goto err_out;
 }

 if (flags != 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "dmabuf flags aren't supported", "types/wlr_linux_dmabuf_v1.c", 282);
  goto err_failed;
 }
 ...
 for (int i = 0; i < attribs.n_planes; i++) {
  ...
  if ((uint64_t)attribs.offset[i]
    + (uint64_t)attribs.stride[i] * height > (4294967295U)) {
   wl_resource_post_error(params_resource,
    ZWP_LINUX_BUFFER_PARAMS_V1_ERROR_OUT_OF_BOUNDS,
    "size overflow for plane %d", i);
   goto err_out;
  ...
  off_t size = lseek(attribs.fd[i], 0, 2);
  if (size == -1) {
...
static struct wlr_linux_dmabuf_v1 *linux_dmabuf_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwp_linux_dmabuf_v1_interface, &linux_dmabuf_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwp_linux_dmabuf_v1_interface, &linux_dmabuf_impl)", "types/wlr_linux_dmabuf_v1.c", 437, __extension__ __PRETTY_FUNCTION__));


 struct wlr_linux_dmabuf_v1 *dmabuf = wl_resource_get_user_data(resource);
 ((dmabuf) ? (void) (0) : __assert_fail ("dmabuf", "types/wlr_linux_dmabuf_v1.c", 440, __extension__ __PRETTY_FUNCTION__));
 return dmabuf;
}
...
static struct wlr_linux_dmabuf_feedback_v1_compiled *feedback_compile(
 ...
 ((tranches_len > 0) ? (void) (0) : __assert_fail ("tranches_len > 0", "types/wlr_linux_dmabuf_v1.c", 514, __extension__ __PRETTY_FUNCTION__));
 ...
 for (size_t i = 0; i < tranches_len; i++) {
  ...
  if (!wlr_drm_format_set_union(&all_formats, &all_formats, &tranche->formats)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to union scanout formats into one tranche", "types/wlr_linux_dmabuf_v1.c", 522);
 ...
 ((table_len > 0) ? (void) (0) : __assert_fail ("table_len > 0", "types/wlr_linux_dmabuf_v1.c", 532, __extension__ __PRETTY_FUNCTION__));

 size_t table_size =
  table_len * sizeof(struct wlr_linux_dmabuf_feedback_v1_table_entry);
 int rw_fd, ro_fd;
 if (!allocate_shm_file_pair(table_size, &rw_fd, &ro_fd)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to allocate shm file for format table", "types/wlr_linux_dmabuf_v1.c", 538);
  return ((void*)0);
 }

 struct wlr_linux_dmabuf_feedback_v1_table_entry *table =
  mmap(((void*)0), table_size, 0x1 | 0x2, 0x01, rw_fd, 0);
 if (table == ((void *) -1)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "mmap failed" ": %s", "types/wlr_linux_dmabuf_v1.c", 545, strerror((*__errno_location ())));
  close(rw_fd);
  close(ro_fd);
  goto err_all_formats;
 }
 ...
 ((n == table_len) ? (void) (0) : __assert_fail ("n == table_len", "types/wlr_linux_dmabuf_v1.c", 565, __extension__ __PRETTY_FUNCTION__));
 ...
 for (size_t i = 0; i < tranches_len; i++) {
  ...
  if (!wl_array_add(&compiled_tranche->indices, table_len * sizeof(uint16_t))) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to allocate tranche indices array", "types/wlr_linux_dmabuf_v1.c", 592);
   goto error_compiled;
  }
  ...
  for (size_t j = 0; j < tranche->formats.len; j++) {
   ...
   for (size_t k = 0; k < fmt->len; k++) {
    ...
    if (index < 0) {
     _wlr_log(WLR_ERROR, "[%s:%d] " "Format 0x%" "X" " and modifier " "0x%" "l" "X" " are in tranche #%zu but are missing " "from the fallback tranche", "types/wlr_linux_dmabuf_v1.c", 607, fmt->format, fmt->modifiers[k], i);
...
static void surface_destroy(struct wlr_linux_dmabuf_v1_surface *surface) {
 ...
 for (resource = 0, resource_tmp = 0, resource = wl_resource_from_link((&surface->feedback_resources)->next), resource_tmp = wl_resource_from_link((&surface->feedback_resources)->next->next); wl_resource_get_link(resource) != (&surface->feedback_resources); resource = resource_tmp, resource_tmp = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
...
static void linux_dmabuf_get_surface_feedback(struct wl_client *client,
 ...
 wl_resource_set_implementation(feedback_resource, &linux_dmabuf_feedback_impl,
  ((void*)0), surface_feedback_handle_resource_destroy);
...
static void linux_dmabuf_send_modifiers(struct wl_resource *resource,
 ...
 if (wl_resource_get_version(resource) < 3) {
  if (wlr_drm_format_has(fmt, ((((__u64)0) << 56) | ((((1ULL << 56) - 1)) & 0x00ffffffffffffffULL)))) {
 ...
 if (fmt->len == 2 && wlr_drm_format_has(fmt, ((((__u64)0) << 56) | ((((1ULL << 56) - 1)) & 0x00ffffffffffffffULL)))
   && wlr_drm_format_has(fmt, ((((__u64)0) << 56) | ((0) & 0x00ffffffffffffffULL)))) {
  uint64_t mod = ((((__u64)0) << 56) | ((((1ULL << 56) - 1)) & 0x00ffffffffffffffULL));
...
static struct wlr_buffer *buffer_from_resource(struct wl_resource *resource) {
 ...
 ((buffer != ((void*)0)) ? (void) (0) : __assert_fail ("buffer != NULL", "types/wlr_linux_dmabuf_v1.c", 850, __extension__ __PRETTY_FUNCTION__));
 return &buffer->base;
}
...
static void linux_dmabuf_v1_destroy(struct wlr_linux_dmabuf_v1 *linux_dmabuf) {
 ...
 for (surface = (__typeof__(surface))((char *)((&linux_dmabuf->surfaces)->next) - __builtin_offsetof(__typeof__(*surface), link)), surface_tmp = (__typeof__(surface_tmp))((char *)((surface)->link.next) - __builtin_offsetof(__typeof__(*surface_tmp), link)); &surface->link != (&linux_dmabuf->surfaces); surface = surface_tmp, surface_tmp = (__typeof__(surface_tmp))((char *)(surface->link.next) - __builtin_offsetof(__typeof__(*surface_tmp), link))) {
  surface_destroy(surface);
 }
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_linux_dmabuf_v1 *linux_dmabuf =
  (__typeof__(linux_dmabuf))((char *)(listener) - __builtin_offsetof(__typeof__(*linux_dmabuf), display_destroy));
 linux_dmabuf_v1_destroy(linux_dmabuf);
}

static _Bool set_default_feedback(struct wlr_linux_dmabuf_v1 *linux_dmabuf,
  const struct wlr_linux_dmabuf_feedback_v1 *feedback) {
 ...
 if (drmGetDeviceFromDevId(feedback->main_device, 0, &device) != 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "drmGetDeviceFromDevId failed" ": %s", "types/wlr_linux_dmabuf_v1.c", 895, strerror((*__errno_location ())));
  goto error_compiled;
 }

 int main_device_fd = -1;
 if (device->available_nodes & (1 << 2)) {
  const char *name = device->nodes[2];
  main_device_fd = open(name, 02 | 02000000);
  drmFreeDevice(&device);
  if (main_device_fd < 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to open DRM device %s" ": %s", "types/wlr_linux_dmabuf_v1.c", 905, name, strerror((*__errno_location ())));
   goto error_compiled;
  }
 } else {
  ...
  ((device->available_nodes & (1 << 0)) ? (void) (0) : __assert_fail ("device->available_nodes & (1 << DRM_NODE_PRIMARY)", "types/wlr_linux_dmabuf_v1.c", 912, __extension__ __PRETTY_FUNCTION__));
  _wlr_log(WLR_DEBUG, "[%s:%d] " "DRM device %s has no render node, " "skipping DMA-BUF import checks", "types/wlr_linux_dmabuf_v1.c", 914, device->nodes[0]);
...
struct wlr_linux_dmabuf_v1 *wlr_linux_dmabuf_v1_create(struct wl_display *display,
  uint32_t version, const struct wlr_linux_dmabuf_feedback_v1 *default_feedback) {
 ((version <= 5) ? (void) (0) : __assert_fail ("version <= LINUX_DMABUF_VERSION", "types/wlr_linux_dmabuf_v1.c", 952, __extension__ __PRETTY_FUNCTION__));

 struct wlr_linux_dmabuf_v1 *linux_dmabuf = calloc(1, sizeof(*linux_dmabuf));
 if (linux_dmabuf == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "could not create simple dmabuf manager", "types/wlr_linux_dmabuf_v1.c", 956);
  return ((void*)0);
 }
 ...
 if (!linux_dmabuf->global) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "could not create linux dmabuf v1 wl global", "types/wlr_linux_dmabuf_v1.c", 967);
...
void wlr_linux_dmabuf_v1_set_check_dmabuf_callback(struct wlr_linux_dmabuf_v1 *linux_dmabuf,
  _Bool (*callback)(struct wlr_dmabuf_attributes *attribs, void *data), void *data) {
 ((callback) ? (void) (0) : __assert_fail ("callback", "types/wlr_linux_dmabuf_v1.c", 1009, __extension__ __PRETTY_FUNCTION__));
...
_Bool wlr_linux_dmabuf_v1_set_surface_feedback(
 ...
 struct wlr_linux_dmabuf_feedback_v1_compiled *compiled = ((void*)0);
 if (feedback != ((void*)0)) {
 ...
 struct wl_resource *resource;
 for (resource = 0, resource = wl_resource_from_link((&surface->feedback_resources)->next); wl_resource_get_link(resource) != (&surface->feedback_resources); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
...
struct wlr_linux_dmabuf_feedback_v1_tranche *wlr_linux_dmabuf_feedback_add_tranche(
 ...
 if (tranche == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Allocation failed" ": %s", "types/wlr_linux_dmabuf_v1.c", 1048, strerror((*__errno_location ())));
  return ((void*)0);
 }
...
void wlr_linux_dmabuf_feedback_v1_finish(struct wlr_linux_dmabuf_feedback_v1 *feedback) {
 struct wlr_linux_dmabuf_feedback_v1_tranche *tranche;
 for (tranche = (&feedback->tranches)->data; (const char *) tranche < ((const char *) (&feedback->tranches)->data + (&feedback->tranches)->size); (tranche)++) {
  wlr_drm_format_set_finish(&tranche->formats);
 }
 wl_array_release(&feedback->tranches);
}

static _Bool devid_from_fd(int fd, dev_t *devid) {
 struct stat stat;
 if (fstat(fd, &stat) != 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "fstat failed" ": %s", "types/wlr_linux_dmabuf_v1.c", 1066, strerror((*__errno_location ())));
  return 0;
 }
 *devid = stat.st_rdev;
 return 1;
...
static _Bool is_secondary_drm_backend(struct wlr_backend *backend) {
...
_Bool wlr_linux_dmabuf_feedback_v1_init_with_options(struct wlr_linux_dmabuf_feedback_v1 *feedback,
  const struct wlr_linux_dmabuf_feedback_v1_init_options *options) {
 ((options->main_renderer != ((void*)0)) ? (void) (0) : __assert_fail ("options->main_renderer != NULL", "types/wlr_linux_dmabuf_v1.c", 1084, __extension__ __PRETTY_FUNCTION__));
 ((options->scanout_primary_output == ((void*)0) || options->output_layer_feedback_event == ((void*)0)) ? (void) (0) : __assert_fail ("options->scanout_primary_output == NULL || options->output_layer_feedback_event == NULL", "types/wlr_linux_dmabuf_v1.c", 1086, __extension__ __PRETTY_FUNCTION__));
 ...
 *feedback = (struct wlr_linux_dmabuf_feedback_v1){0};
 ...
 if (renderer_drm_fd < 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get renderer DRM FD", "types/wlr_linux_dmabuf_v1.c", 1092);
  goto error;
 }
 dev_t renderer_dev;
 ...
 if (renderer_formats == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get renderer DMA-BUF texture formats", "types/wlr_linux_dmabuf_v1.c", 1105);
  goto error;
 }

 if (options->output_layer_feedback_event != ((void*)0)) {
  ...
  if (!wlr_drm_format_set_intersect(&tranche->formats, event->formats, renderer_formats)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to intersect renderer and scanout formats", "types/wlr_linux_dmabuf_v1.c", 1121);
   goto error;
  }
 } else if (options->scanout_primary_output != ((void*)0) &&
  ...
  if (backend_drm_fd < 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get backend DRM FD", "types/wlr_linux_dmabuf_v1.c", 1128);
   goto error;
  }
  dev_t backend_dev;
  ...
  if (scanout_formats == ((void*)0)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get output primary DMA-BUF formats", "types/wlr_linux_dmabuf_v1.c", 1139);
   goto error;
  }
  ...
  if (!wlr_drm_format_set_intersect(&tranche->formats, scanout_formats, renderer_formats)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to intersect renderer and scanout formats", "types/wlr_linux_dmabuf_v1.c", 1152);
   goto error;
  }
 }
