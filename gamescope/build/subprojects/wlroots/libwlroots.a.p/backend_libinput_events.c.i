# 1 "../subprojects/wlroots/backend/libinput/events.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/backend/libinput/events.c" 2
...
# 3 "../subprojects/wlroots/backend/libinput/events.c" 2
...
# 5 "../subprojects/wlroots/include/wlr/backend/session.h" 2
...
# 7 "../subprojects/wlroots/include/wlr/backend/session.h" 2
...
# 5 "../subprojects/wlroots/backend/libinput/events.c" 2
...
void wlr_keyboard_notify_modifiers(struct wlr_keyboard *keyboard,
  ...
  uint32_t group);
# 6 "../subprojects/wlroots/backend/libinput/events.c" 2
...
# 7 "../subprojects/wlroots/backend/libinput/events.c" 2
...
# 8 "../subprojects/wlroots/backend/libinput/events.c" 2
...
# 9 "../subprojects/wlroots/backend/libinput/events.c" 2
...
# 10 "../subprojects/wlroots/backend/libinput/events.c" 2
# 1 "../subprojects/wlroots/include/wlr/interfaces/wlr_switch.h" 1
# 12 "../subprojects/wlroots/include/wlr/interfaces/wlr_switch.h"
...
struct wlr_switch *wlr_switch_from_input_device(
 struct wlr_input_device *input_device);
# 13 "../subprojects/wlroots/include/wlr/interfaces/wlr_switch.h" 2
...
# 11 "../subprojects/wlroots/backend/libinput/events.c" 2
...
# 12 "../subprojects/wlroots/backend/libinput/events.c" 2
...
void handle_tablet_pad_strip(struct libinput_event *event,
 struct wlr_tablet_pad *tablet_pad);
# 13 "../subprojects/wlroots/backend/libinput/events.c" 2
...
_Bool wlr_input_device_is_libinput(struct wlr_input_device *wlr_dev) {
 switch (wlr_dev->type) {
...
static void handle_device_added(struct wlr_libinput_backend *backend,
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Adding %s [%d:%d]", "backend/libinput/events.c", 69, name, vendor, product);

 struct wlr_libinput_input_device *dev = calloc(1, sizeof(*dev));
 if (dev == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "failed to allocate wlr_libinput_input_device" ": %s", "backend/libinput/events.c", 73, strerror((*__errno_location ())));
  return;
 }
...
static void handle_device_removed(struct wlr_libinput_backend *backend,
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Removing %s [%d:%d]", "backend/libinput/events.c", 133, name, vendor, product);
...
void handle_libinput_event(struct wlr_libinput_backend *backend,
 ...
 if (dev == ((void*)0) && event_type != LIBINPUT_EVENT_DEVICE_ADDED) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "libinput_device has no wlr_libinput_input_device", "backend/libinput/events.c", 146);
  return;
 }
 ...
 default:
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Unknown libinput event %d", "backend/libinput/events.c", 255, event_type);
  break;
 }
}
