# 1 "../subprojects/wlroots/types/wlr_tablet_pad.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_tablet_pad.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_tablet_pad.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_tablet_pad.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/wlr_tablet_pad.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_tablet_pad.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_tablet_pad.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_tablet_pad.h" 1
# 7 "../subprojects/wlroots/types/wlr_tablet_pad.c" 2
...
# 8 "../subprojects/wlroots/types/wlr_tablet_pad.c" 2
...
# 10 "../subprojects/wlroots/types/wlr_tablet_pad.c" 2

struct wlr_tablet_pad *wlr_tablet_pad_from_input_device(
  struct wlr_input_device *input_device) {
 ((input_device->type == WLR_INPUT_DEVICE_TABLET_PAD) ? (void) (0) : __assert_fail ("input_device->type == WLR_INPUT_DEVICE_TABLET_PAD", "types/wlr_tablet_pad.c", 13, __extension__ __PRETTY_FUNCTION__));
 return (__typeof__((struct wlr_tablet_pad *)((void*)0)))((char *)(input_device) - __builtin_offsetof(__typeof__(*(struct wlr_tablet_pad *)((void*)0)), base));
}
...
void wlr_tablet_pad_finish(struct wlr_tablet_pad *pad) {
 ...
 char **path_ptr;
 for (path_ptr = (&pad->paths)->data; (const char *) path_ptr < ((const char *) (&pad->paths)->data + (&pad->paths)->size); (path_ptr)++) {
  free(*path_ptr);
 }
 ...
 if (!wl_list_empty(&pad->groups)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "wlr_tablet_pad groups is not empty", "types/wlr_tablet_pad.c", 44);
 }
}
