# 1 "../subprojects/wlroots/types/scene/subsurface_tree.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/scene/subsurface_tree.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/scene/subsurface_tree.c" 2
...
# 3 "../subprojects/wlroots/types/scene/subsurface_tree.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 4 "../subprojects/wlroots/types/scene/subsurface_tree.c" 2
...
# 5 "../subprojects/wlroots/types/scene/subsurface_tree.c" 2
...
# 6 "../subprojects/wlroots/types/scene/subsurface_tree.c" 2
# 1 "../subprojects/wlroots/include/wlr/util/addon.h" 1
# 7 "../subprojects/wlroots/types/scene/subsurface_tree.c" 2
...
# 8 "../subprojects/wlroots/types/scene/subsurface_tree.c" 2
...
static void subsurface_tree_addon_destroy(struct wlr_addon *addon) {
 struct wlr_scene_subsurface_tree *subsurface_tree =
  (__typeof__(subsurface_tree))((char *)(addon) - __builtin_offsetof(__typeof__(*subsurface_tree), scene_addon));
...
static struct wlr_scene_subsurface_tree *subsurface_tree_from_subsurface(
 ...
 ((addon != ((void*)0)) ? (void) (0) : __assert_fail ("addon != NULL", "types/scene/subsurface_tree.c", 62, __extension__ __PRETTY_FUNCTION__));
 struct wlr_scene_subsurface_tree *subsurface_tree =
  (__typeof__(subsurface_tree))((char *)(addon) - __builtin_offsetof(__typeof__(*subsurface_tree), surface_addon));
 return subsurface_tree;
}

static _Bool subsurface_tree_reconfigure_clip(
  struct wlr_scene_subsurface_tree *subsurface_tree) {
 if (subsurface_tree->parent) {
 ...
 if (wlr_box_empty(&subsurface_tree->clip)) {
  scene_surface_set_clip(subsurface_tree->scene_surface, ((void*)0));
  wlr_scene_node_set_enabled(&subsurface_tree->scene_surface->buffer->node, 1);
  ...
  _Bool intersects = wlr_box_intersection(&clip, &clip, &surface_box);
...
static void subsurface_tree_reconfigure(
  struct wlr_scene_subsurface_tree *subsurface_tree) {
 _Bool has_clip = subsurface_tree_reconfigure_clip(subsurface_tree);

 struct wlr_surface *surface = subsurface_tree->surface;

 struct wlr_scene_node *prev = ((void*)0);
 struct wlr_subsurface *subsurface;
...
static void subsurface_tree_handle_surface_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_scene_subsurface_tree *subsurface_tree =
  (__typeof__(subsurface_tree))((char *)(listener) - __builtin_offsetof(__typeof__(*subsurface_tree), surface_destroy));
...
static void subsurface_tree_handle_surface_commit(struct wl_listener *listener,
  void *data) {
 struct wlr_scene_subsurface_tree *subsurface_tree =
  (__typeof__(subsurface_tree))((char *)(listener) - __builtin_offsetof(__typeof__(*subsurface_tree), surface_commit));
...
static void subsurface_tree_handle_subsurface_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_scene_subsurface_tree *subsurface_tree =
  (__typeof__(subsurface_tree))((char *)(listener) - __builtin_offsetof(__typeof__(*subsurface_tree), subsurface_destroy));
 wlr_scene_node_destroy(&subsurface_tree->tree->node);
}
...
static void subsurface_tree_handle_surface_map(struct wl_listener *listener,
  void *data) {
 struct wlr_scene_subsurface_tree *subsurface_tree =
  (__typeof__(subsurface_tree))((char *)(listener) - __builtin_offsetof(__typeof__(*subsurface_tree), surface_map));

 wlr_scene_node_set_enabled(&subsurface_tree->tree->node, 1);
}

static void subsurface_tree_handle_surface_unmap(struct wl_listener *listener,
  void *data) {
 struct wlr_scene_subsurface_tree *subsurface_tree =
  (__typeof__(subsurface_tree))((char *)(listener) - __builtin_offsetof(__typeof__(*subsurface_tree), surface_unmap));

 wlr_scene_node_set_enabled(&subsurface_tree->tree->node, 0);
}
...
static _Bool subsurface_tree_create_subsurface(
  struct wlr_scene_subsurface_tree *parent,
  struct wlr_subsurface *subsurface) {
...
static void subsurface_tree_handle_surface_new_subsurface(
 ...
 struct wlr_scene_subsurface_tree *subsurface_tree =
  (__typeof__(subsurface_tree))((char *)(listener) - __builtin_offsetof(__typeof__(*subsurface_tree), surface_new_subsurface));
...
static struct wlr_scene_subsurface_tree *scene_surface_tree_create(
 ...
 wlr_addon_init(&subsurface_tree->scene_addon, &subsurface_tree->tree->node.addons,
  ((void*)0), &subsurface_tree_addon_impl);
...
static struct wlr_scene_subsurface_tree *get_subsurface_tree_from_node(
  struct wlr_scene_node *node) {
 struct wlr_addon *addon = wlr_addon_find(&node->addons, ((void*)0), &subsurface_tree_addon_impl);
 if (!addon) {
  return ((void*)0);
 }

 struct wlr_scene_subsurface_tree *tree =
  (__typeof__(tree))((char *)(addon) - __builtin_offsetof(__typeof__(*tree), scene_addon));
 return tree;
}

static _Bool subsurface_tree_set_clip(struct wlr_scene_node *node,
  const struct wlr_box *clip) {
 if (node->type != WLR_SCENE_NODE_TREE) {
  return 0;
 }

 _Bool discovered_subsurface_tree = 0;
...
void wlr_scene_subsurface_tree_set_clip(struct wlr_scene_node *node,
 ...
 ((found) ? (void) (0) : __assert_fail ("found", "types/scene/subsurface_tree.c", 369, __extension__ __PRETTY_FUNCTION__));
}
