# 1 "../subprojects/wlroots/backend/wayland/pointer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/backend/wayland/pointer.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 3 "../subprojects/wlroots/backend/wayland/pointer.c" 2
...
# 30 "/usr/include/wayland-client-core.h" 2 3 4
...
# 5 "../subprojects/wlroots/backend/wayland/pointer.c" 2
...
# 6 "../subprojects/wlroots/backend/wayland/pointer.c" 2
...
# 7 "../subprojects/wlroots/backend/wayland/pointer.c" 2
...
# 9 "../subprojects/wlroots/backend/wayland/pointer.c" 2
...
# 11 "../subprojects/wlroots/backend/wayland/pointer.c" 2
...
# 12 "../subprojects/wlroots/backend/wayland/pointer.c" 2

static struct wlr_wl_pointer *output_get_pointer(struct wlr_wl_output *output,
  const struct wl_pointer *wl_pointer) {
 struct wlr_wl_seat *seat;
 for (seat = (__typeof__(seat))((char *)((&output->backend->seats)->next) - __builtin_offsetof(__typeof__(*seat), link)); &seat->link != (&output->backend->seats); seat = (__typeof__(seat))((char *)(seat->link.next) - __builtin_offsetof(__typeof__(*seat), link))) {
  if (seat->wl_pointer != wl_pointer) {
   continue;
  }

  struct wlr_wl_pointer *pointer;
  for (pointer = (__typeof__(pointer))((char *)((&seat->pointers)->next) - __builtin_offsetof(__typeof__(*pointer), link)); &pointer->link != (&seat->pointers); pointer = (__typeof__(pointer))((char *)(pointer->link.next) - __builtin_offsetof(__typeof__(*pointer), link))) {
...
static void pointer_handle_enter(void *data, struct wl_pointer *wl_pointer,
 ...
 if (current && current != pointer) {
  _wlr_log(WLR_INFO, "[%s:%d] " "Ignoring seat '%s' pointer in favor of seat '%s'", "backend/wayland/pointer.c", 52, seat->name, current->seat->name);
...
static void pointer_handle_axis_discrete(void *data,
 ...
 pointer->axis_discrete = discrete * 120;
}
...
static void destroy_pointer(struct wlr_wl_pointer *pointer) {
 if (pointer->output->cursor.pointer == pointer) {
  pointer->output->cursor.pointer = ((void*)0);
 }
 if (pointer->seat->active_pointer == pointer) {
  pointer->seat->active_pointer = ((void*)0);
 }
...
static void pointer_output_destroy(struct wl_listener *listener, void *data) {
 struct wlr_wl_pointer *pointer =
  (__typeof__(pointer))((char *)(listener) - __builtin_offsetof(__typeof__(*pointer), output_destroy));
 destroy_pointer(pointer);
}

void create_pointer(struct wlr_wl_seat *seat, struct wlr_wl_output *output) {
 ((seat->wl_pointer) ? (void) (0) : __assert_fail ("seat->wl_pointer", "backend/wayland/pointer.c", 451, __extension__ __PRETTY_FUNCTION__));

 if (output_get_pointer(output, seat->wl_pointer)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "pointer for output '%s' from seat '%s' already exists", "backend/wayland/pointer.c", 456, output->wlr_output.name, seat->name);


  return;
 }

 _wlr_log(WLR_DEBUG, "[%s:%d] " "creating pointer for output '%s' from seat '%s'", "backend/wayland/pointer.c", 461, output->wlr_output.name, seat->name);


 struct wlr_wl_pointer *pointer = calloc(1, sizeof(*pointer));
 if (pointer == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "failed to allocate wlr_wl_pointer", "backend/wayland/pointer.c", 465);
  return;
 }
...
void init_seat_pointer(struct wlr_wl_seat *seat) {
 ((seat->wl_pointer) ? (void) (0) : __assert_fail ("seat->wl_pointer", "backend/wayland/pointer.c", 488, __extension__ __PRETTY_FUNCTION__));
 ...
 struct wlr_wl_output *output;
 for (output = (__typeof__(output))((char *)((&backend->outputs)->next) - __builtin_offsetof(__typeof__(*output), link)); &output->link != (&backend->outputs); output = (__typeof__(output))((char *)(output->link.next) - __builtin_offsetof(__typeof__(*output), link))) {
...
void finish_seat_pointer(struct wlr_wl_seat *seat) {
 ((seat->wl_pointer) ? (void) (0) : __assert_fail ("seat->wl_pointer", "backend/wayland/pointer.c", 533, __extension__ __PRETTY_FUNCTION__));

 wl_pointer_release(seat->wl_pointer);

 struct wlr_wl_pointer *pointer, *tmp;
 for (pointer = (__typeof__(pointer))((char *)((&seat->pointers)->next) - __builtin_offsetof(__typeof__(*pointer), link)), tmp = (__typeof__(tmp))((char *)((pointer)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &pointer->link != (&seat->pointers); pointer = tmp, tmp = (__typeof__(tmp))((char *)(pointer->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  destroy_pointer(pointer);
 }

 if (seat->gesture_swipe != ((void*)0)) {
  zwp_pointer_gesture_swipe_v1_destroy(seat->gesture_swipe);
 }
 if (seat->gesture_pinch != ((void*)0)) {
  zwp_pointer_gesture_pinch_v1_destroy(seat->gesture_pinch);
 }
 if (seat->gesture_hold != ((void*)0)) {
  zwp_pointer_gesture_hold_v1_destroy(seat->gesture_hold);
 }
 if (seat->relative_pointer != ((void*)0)) {
  zwp_relative_pointer_v1_destroy(seat->relative_pointer);
 }

 seat->wl_pointer = ((void*)0);
 seat->active_pointer = ((void*)0);
}
