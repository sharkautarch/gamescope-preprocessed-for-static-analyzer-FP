# 1 "../subprojects/libliftoff/example/compositor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/libliftoff/example/compositor.c" 2
...
# 7 "../subprojects/libliftoff/example/compositor.c" 2
...
# 8 "../subprojects/libliftoff/example/compositor.c" 2
...
# 9 "../subprojects/libliftoff/example/compositor.c" 2
...
# 10 "../subprojects/libliftoff/example/compositor.c" 2
...
# 11 "../subprojects/libliftoff/example/compositor.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 12 "../subprojects/libliftoff/example/compositor.c" 2
...
# 13 "../subprojects/libliftoff/example/compositor.c" 2
...
# 14 "../subprojects/libliftoff/example/compositor.c" 2
...
# 15 "../subprojects/libliftoff/example/compositor.c" 2
...
# 17 "../subprojects/libliftoff/example/compositor.c" 2
...
add_layer(int drm_fd, struct liftoff_output *output, int x, int y, uint32_t width,
   uint32_t height, _Bool with_alpha, _Bool white, struct dumb_fb *fb)
{
 static size_t color_idx = 0;
 uint32_t color;
 struct liftoff_layer *layer;

 uint32_t format = with_alpha ? ((__u32)('A') | ((__u32)('R') << 8) | ((__u32)('2') << 16) | ((__u32)('4') << 24)) : ((__u32)('X') | ((__u32)('R') << 8) | ((__u32)('2') << 16) | ((__u32)('4') << 24));
...
main(int argc, char *argv[])
{
 ...
 struct dumb_fb fbs[16] = {0};
 struct liftoff_layer *layers[16];
 struct liftoff_plane *plane;
