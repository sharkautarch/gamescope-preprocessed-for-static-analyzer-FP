# 1 "../subprojects/wlroots/types/wlr_server_decoration.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_server_decoration.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_server_decoration.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_server_decoration.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 4 "../subprojects/wlroots/types/wlr_server_decoration.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_server_decoration.h" 1
# 23 "../subprojects/wlroots/include/wlr/types/wlr_server_decoration.h"
...
# 5 "../subprojects/wlroots/types/wlr_server_decoration.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_server_decoration.c" 2
# 1 "subprojects/wlroots/protocol/server-decoration-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/server-decoration-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 41 "subprojects/wlroots/protocol/server-decoration-protocol.h"
struct org_kde_kwin_server_decoration;
struct org_kde_kwin_server_decoration_manager;
struct wl_surface;
# 68 "subprojects/wlroots/protocol/server-decoration-protocol.h"
extern const struct wl_interface org_kde_kwin_server_decoration_manager_interface;
# 80 "subprojects/wlroots/protocol/server-decoration-protocol.h"
extern const struct wl_interface org_kde_kwin_server_decoration_interface;
# 89 "subprojects/wlroots/protocol/server-decoration-protocol.h"
...
# 125 "subprojects/wlroots/protocol/server-decoration-protocol.h"
 void (*create)(struct wl_client *client,
         struct wl_resource *resource,
         uint32_t id,
         struct wl_resource *surface);
};
# 149 "subprojects/wlroots/protocol/server-decoration-protocol.h"
static inline void
...
# 222 "subprojects/wlroots/protocol/server-decoration-protocol.h"
static inline void
org_kde_kwin_server_decoration_send_mode(struct wl_resource *resource_, uint32_t mode)
{
 wl_resource_post_event(resource_, 0, mode);
}
# 7 "../subprojects/wlroots/types/wlr_server_decoration.c" 2
...
static struct wlr_server_decoration *decoration_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &org_kde_kwin_server_decoration_interface, &server_decoration_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &org_kde_kwin_server_decoration_interface, &server_decoration_impl)", "types/wlr_server_decoration.c", 14, __extension__ __PRETTY_FUNCTION__));
...
static void server_decoration_handle_request_mode(struct wl_client *client,
 ...
 if (decoration == ((void*)0) || decoration->mode == mode) {
  return;
 }
...
static void server_decoration_destroy(
 ...
 wl_resource_set_user_data(decoration->resource, ((void*)0));
...
static void server_decoration_handle_surface_destroy(
 ...
 struct wlr_server_decoration *decoration =
  (__typeof__(decoration))((char *)(listener) - __builtin_offsetof(__typeof__(*decoration), surface_destroy_listener));
 server_decoration_destroy(decoration);
}
...
static struct wlr_server_decoration_manager *manager_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &org_kde_kwin_server_decoration_manager_interface, &server_decoration_manager_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &org_kde_kwin_server_decoration_manager_interface, &server_decoration_manager_impl)", "types/wlr_server_decoration.c", 73, __extension__ __PRETTY_FUNCTION__));
...
static void server_decoration_manager_handle_create(struct wl_client *client,
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "new server_decoration %p (res %p)", "types/wlr_server_decoration.c", 105, decoration, decoration->resource);
...
void wlr_server_decoration_manager_set_default_mode(
 ...
 struct wl_resource *resource;
 for (resource = 0, resource = wl_resource_from_link((&manager->resources)->next); wl_resource_get_link(resource) != (&manager->resources); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
