# 1 "subprojects/wlroots/protocol/content-type-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/content-type-v1-protocol.c" 2
# 27 "subprojects/wlroots/protocol/content-type-v1-protocol.c"
...
# 28 "subprojects/wlroots/protocol/content-type-v1-protocol.c" 2
...
# 29 "subprojects/wlroots/protocol/content-type-v1-protocol.c" 2
...
# 30 "subprojects/wlroots/protocol/content-type-v1-protocol.c" 2
# 41 "subprojects/wlroots/protocol/content-type-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_content_type_manager_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_content_type_v1_interface = {
