# 1 "subprojects/wlroots/protocol/server-decoration-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/server-decoration-protocol.c" 2
# 20 "subprojects/wlroots/protocol/server-decoration-protocol.c"
...
# 21 "subprojects/wlroots/protocol/server-decoration-protocol.c" 2
...
# 22 "subprojects/wlroots/protocol/server-decoration-protocol.c" 2
...
# 23 "subprojects/wlroots/protocol/server-decoration-protocol.c" 2
# 34 "subprojects/wlroots/protocol/server-decoration-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface org_kde_kwin_server_decoration_manager_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface org_kde_kwin_server_decoration_interface = {
