# 1 "../subprojects/wlroots/render/pass.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/render/pass.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/render/pass.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 3 "../subprojects/wlroots/render/pass.c" 2
# 1 "../subprojects/wlroots/include/wlr/render/interface.h" 1
# 12 "../subprojects/wlroots/include/wlr/render/interface.h"
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 13 "../subprojects/wlroots/include/wlr/render/interface.h" 2
...
void *wlr_texture_read_pixel_options_get_data(
 const struct wlr_texture_read_pixels_options *options);
# 4 "../subprojects/wlroots/render/pass.c" 2

void wlr_render_pass_init(struct wlr_render_pass *render_pass,
  const struct wlr_render_pass_impl *impl) {
 ((impl->submit && impl->add_texture && impl->add_rect) ? (void) (0) : __assert_fail ("impl->submit && impl->add_texture && impl->add_rect", "render/pass.c", 7, __extension__ __PRETTY_FUNCTION__));
...
void wlr_render_pass_add_texture(struct wlr_render_pass *render_pass,
 ...
 if (!wlr_fbox_empty(&options->src_box)) {
  ...
  ((box->x >= 0 && box->y >= 0 && box->x + box->width <= options->texture->width && box->y + box->height <= options->texture->height) ? (void) (0) : __assert_fail ("box->x >= 0 && box->y >= 0 && box->x + box->width <= options->texture->width && box->y + box->height <= options->texture->height", "render/pass.c", 25, __extension__ __PRETTY_FUNCTION__));
...
void wlr_render_pass_add_rect(struct wlr_render_pass *render_pass,
  const struct wlr_render_rect_options *options) {
 ((options->box.width >= 0 && options->box.height >= 0) ? (void) (0) : __assert_fail ("options->box.width >= 0 && options->box.height >= 0", "render/pass.c", 33, __extension__ __PRETTY_FUNCTION__));
