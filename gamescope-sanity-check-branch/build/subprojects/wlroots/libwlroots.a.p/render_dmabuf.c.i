# 1 "../subprojects/wlroots/render/dmabuf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/render/dmabuf.c" 2
...
# 2 "../subprojects/wlroots/render/dmabuf.c" 2
...
# 3 "../subprojects/wlroots/render/dmabuf.c" 2
# 1 "../subprojects/wlroots/include/wlr/render/dmabuf.h" 1
# 12 "../subprojects/wlroots/include/wlr/render/dmabuf.h"
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 13 "../subprojects/wlroots/include/wlr/render/dmabuf.h" 2
...
# 14 "../subprojects/wlroots/include/wlr/render/dmabuf.h" 2
...
# 4 "../subprojects/wlroots/render/dmabuf.c" 2
...
# 5 "../subprojects/wlroots/render/dmabuf.c" 2
...
# 6 "../subprojects/wlroots/render/dmabuf.c" 2
 ...
 *dst = *src;
 ...
 for (i = 0; i < src->n_planes; ++i) {
  dst->fd[i] = fcntl(src->fd[i], 1030, 0);
  if (dst->fd[i] < 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "fcntl(F_DUPFD_CLOEXEC) failed" ": %s", "render/dmabuf.c", 23, strerror((*__errno_location ())));
   goto error;
  }
 }
