# 1 "../subprojects/wlroots/util/global.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/util/global.c" 2
...
# 2 "../subprojects/wlroots/util/global.c" 2
...
# 5 "../subprojects/wlroots/include/util/global.h" 2
...
# 3 "../subprojects/wlroots/util/global.c" 2
...
static void handle_display_destroy(struct wl_listener *listener, void *_data) {
 struct destroy_global_data *data =
  (__typeof__(data))((char *)(listener) - __builtin_offsetof(__typeof__(*data), display_destroy));
 destroy_global(data);
}
...
void wlr_global_destroy_safe(struct wl_global *global) {
 ...
 wl_global_set_user_data(global, ((void*)0));
