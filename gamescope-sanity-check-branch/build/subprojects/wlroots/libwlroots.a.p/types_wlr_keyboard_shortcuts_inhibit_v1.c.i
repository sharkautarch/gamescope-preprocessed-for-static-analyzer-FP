# 1 "../subprojects/wlroots/types/wlr_keyboard_shortcuts_inhibit_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_keyboard_shortcuts_inhibit_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_keyboard_shortcuts_inhibit_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_keyboard_shortcuts_inhibit_v1.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 4 "../subprojects/wlroots/types/wlr_keyboard_shortcuts_inhibit_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_shortcuts_inhibit_v1.h" 1
# 13 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_shortcuts_inhibit_v1.h"
...
# 14 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_shortcuts_inhibit_v1.h" 2
# 25 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_shortcuts_inhibit_v1.h"
...
# 76 "../subprojects/wlroots/include/wlr/types/wlr_keyboard_shortcuts_inhibit_v1.h"
struct wlr_keyboard_shortcuts_inhibit_manager_v1 *
...
void wlr_keyboard_shortcuts_inhibitor_v1_deactivate(
 struct wlr_keyboard_shortcuts_inhibitor_v1 *inhibitor);
# 5 "../subprojects/wlroots/types/wlr_keyboard_shortcuts_inhibit_v1.c" 2
# 1 "subprojects/wlroots/protocol/keyboard-shortcuts-inhibit-unstable-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/keyboard-shortcuts-inhibit-unstable-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 66 "subprojects/wlroots/protocol/keyboard-shortcuts-inhibit-unstable-v1-protocol.h"
struct wl_seat;
struct wl_surface;
struct zwp_keyboard_shortcuts_inhibit_manager_v1;
struct zwp_keyboard_shortcuts_inhibitor_v1;
# 86 "subprojects/wlroots/protocol/keyboard-shortcuts-inhibit-unstable-v1-protocol.h"
extern const struct wl_interface zwp_keyboard_shortcuts_inhibit_manager_v1_interface;
# 167 "subprojects/wlroots/protocol/keyboard-shortcuts-inhibit-unstable-v1-protocol.h"
...
struct zwp_keyboard_shortcuts_inhibit_manager_v1_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 204 "subprojects/wlroots/protocol/keyboard-shortcuts-inhibit-unstable-v1-protocol.h"
...
# 225 "subprojects/wlroots/protocol/keyboard-shortcuts-inhibit-unstable-v1-protocol.h"
...
# 258 "subprojects/wlroots/protocol/keyboard-shortcuts-inhibit-unstable-v1-protocol.h"
static inline void
...
# 6 "../subprojects/wlroots/types/wlr_keyboard_shortcuts_inhibit_v1.c" 2
...
wlr_keyboard_shortcuts_inhibit_manager_v1_from_resource(
 ...
 ((wl_resource_instance_of(manager_resource, &zwp_keyboard_shortcuts_inhibit_manager_v1_interface, &keyboard_shortcuts_inhibit_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(manager_resource, &zwp_keyboard_shortcuts_inhibit_manager_v1_interface, &keyboard_shortcuts_inhibit_impl)", "types/wlr_keyboard_shortcuts_inhibit_v1.c", 18, __extension__ __PRETTY_FUNCTION__));
...
wlr_keyboard_shortcuts_inhibitor_v1_from_resource(
 ...
 ((wl_resource_instance_of(inhibitor_resource, &zwp_keyboard_shortcuts_inhibitor_v1_interface, &keyboard_shortcuts_inhibitor_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(inhibitor_resource, &zwp_keyboard_shortcuts_inhibitor_v1_interface, &keyboard_shortcuts_inhibitor_impl)", "types/wlr_keyboard_shortcuts_inhibit_v1.c", 27, __extension__ __PRETTY_FUNCTION__));
...
static void keyboard_shortcuts_inhibitor_v1_destroy(
 ...
 wl_resource_set_user_data(inhibitor->resource, ((void*)0));
...
static void keyboard_shortcuts_inhibitor_handle_surface_destroy(
 ...
 struct wlr_keyboard_shortcuts_inhibitor_v1 *inhibitor =
  (__typeof__(inhibitor))((char *)(listener) - __builtin_offsetof(__typeof__(*inhibitor), surface_destroy));
...
static void keyboard_shortcuts_inhibitor_handle_seat_destroy(
  struct wl_listener *listener, void *data) {
 struct wlr_keyboard_shortcuts_inhibitor_v1 *inhibitor =
  (__typeof__(inhibitor))((char *)(listener) - __builtin_offsetof(__typeof__(*inhibitor), seat_destroy));
 wlr_keyboard_shortcuts_inhibitor_v1_deactivate(inhibitor);
 keyboard_shortcuts_inhibitor_v1_destroy(inhibitor);
}
...
static void manager_handle_inhibit_shortcuts(struct wl_client *client,
 ...
 if (inhibitor_resource == ((void*)0)) {
  wl_client_post_no_memory(client);
  return;
 }
 wl_resource_set_implementation(inhibitor_resource,
  &keyboard_shortcuts_inhibitor_impl, ((void*)0),
 ...
 for (existing_inhibitor = (__typeof__(existing_inhibitor))((char *)((&manager->inhibitors)->next) - __builtin_offsetof(__typeof__(*existing_inhibitor), link)); &existing_inhibitor->link != (&manager->inhibitors); existing_inhibitor = (__typeof__(existing_inhibitor))((char *)(existing_inhibitor->link.next) - __builtin_offsetof(__typeof__(*existing_inhibitor), link))) {
...
static void keyboard_shortcuts_inhibit_bind(struct wl_client *wl_client,
 ...
 wl_resource_set_implementation(manager_resource,
  &keyboard_shortcuts_inhibit_impl, manager, ((void*)0));
}
