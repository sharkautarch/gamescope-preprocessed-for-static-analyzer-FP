# 1 "../subprojects/libliftoff/test/test_candidate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/libliftoff/test/test_candidate.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/libliftoff/test/test_candidate.c" 2
...
# 3 "../subprojects/libliftoff/test/test_candidate.c" 2
...
# 4 "../subprojects/libliftoff/test/test_candidate.c" 2
...
# 5 "../subprojects/libliftoff/test/test_candidate.c" 2
...
# 6 "../subprojects/libliftoff/test/test_candidate.c" 2
...
liftoff_mock_plane_add_in_formats(struct liftoff_mock_plane *plane,
      ...
      size_t size);
# 7 "../subprojects/libliftoff/test/test_candidate.c" 2
...
test_basic(void)
{
 ...
 mock_plane_ok = liftoff_mock_drm_create_plane(0);
 mock_plane_ko = liftoff_mock_drm_create_plane(0);
 ...
 ((device != ((void*)0)) ? (void) (0) : __assert_fail ("device != NULL", "../subprojects/libliftoff/test/test_candidate.c", 53, __extension__ __PRETTY_FUNCTION__));
 ...
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_candidate.c", 64, __extension__ __PRETTY_FUNCTION__));
 ret = drmModeAtomicCommit(drm_fd, req, 0, ((void*)0));
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_candidate.c", 66, __extension__ __PRETTY_FUNCTION__));
 ((liftoff_mock_plane_get_layer(mock_plane_ok) == ((void*)0)) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(mock_plane_ok) == NULL", "../subprojects/libliftoff/test/test_candidate.c", 67, __extension__ __PRETTY_FUNCTION__));
 ((liftoff_mock_plane_get_layer(mock_plane_ko) == ((void*)0)) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(mock_plane_ko) == NULL", "../subprojects/libliftoff/test/test_candidate.c", 68, __extension__ __PRETTY_FUNCTION__));
 ((liftoff_layer_is_candidate_plane(layer, plane_ok)) ? (void) (0) : __assert_fail ("liftoff_layer_is_candidate_plane(layer, plane_ok)", "../subprojects/libliftoff/test/test_candidate.c", 69, __extension__ __PRETTY_FUNCTION__));
 ((!liftoff_layer_is_candidate_plane(layer, plane_ko)) ? (void) (0) : __assert_fail ("!liftoff_layer_is_candidate_plane(layer, plane_ko)", "../subprojects/libliftoff/test/test_candidate.c", 70, __extension__ __PRETTY_FUNCTION__));
