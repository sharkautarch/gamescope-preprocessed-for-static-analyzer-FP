# 1 "../subprojects/wlroots/xwayland/shell.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/xwayland/shell.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/xwayland/shell.c" 2
...
# 3 "../subprojects/wlroots/xwayland/shell.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 4 "../subprojects/wlroots/xwayland/shell.c" 2
...
# 5 "../subprojects/wlroots/xwayland/shell.c" 2

# 1 "subprojects/wlroots/protocol/xwayland-shell-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/xwayland-shell-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 81 "subprojects/wlroots/protocol/xwayland-shell-v1-protocol.h"
struct wl_surface;
struct xwayland_shell_v1;
struct xwayland_surface_v1;
# 128 "subprojects/wlroots/protocol/xwayland-shell-v1-protocol.h"
extern const struct wl_interface xwayland_shell_v1_interface;
# 159 "subprojects/wlroots/protocol/xwayland-shell-v1-protocol.h"
...
struct xwayland_shell_v1_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 199 "subprojects/wlroots/protocol/xwayland-shell-v1-protocol.h"
 void (*get_xwayland_surface)(struct wl_client *client,
         struct wl_resource *resource,
         uint32_t id,
         struct wl_resource *surface);
};
# 217 "subprojects/wlroots/protocol/xwayland-shell-v1-protocol.h"
...
# 263 "subprojects/wlroots/protocol/xwayland-shell-v1-protocol.h"
...
# 7 "../subprojects/wlroots/xwayland/shell.c" 2
...
static void xwl_surface_destroy(struct wlr_xwayland_surface_v1 *xwl_surface) {
 ...
 wl_resource_set_user_data(xwl_surface->resource, ((void*)0));
 free(xwl_surface);
}
...
static struct wlr_xwayland_shell_v1 *shell_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &xwayland_shell_v1_interface, &shell_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &xwayland_shell_v1_interface, &shell_impl)", "xwayland/shell.c", 30, __extension__ __PRETTY_FUNCTION__));
...
static struct wlr_xwayland_surface_v1 *xwl_surface_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &xwayland_surface_v1_interface, &xwl_surface_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &xwayland_surface_v1_interface, &xwl_surface_impl)", "xwayland/shell.c", 42, __extension__ __PRETTY_FUNCTION__));
...
static void shell_handle_get_xwayland_surface(struct wl_client *client,
 ...
 if (xwl_surface->resource == ((void*)0)) {
  free(xwl_surface);
  wl_client_post_no_memory(client);
  return;
 }
...
static void shell_bind(struct wl_client *client, void *data, uint32_t version,
 ...
 wl_resource_set_implementation(resource, &shell_impl, shell, ((void*)0));
}

static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_xwayland_shell_v1 *shell =
  (__typeof__(shell))((char *)(listener) - __builtin_offsetof(__typeof__(*shell), display_destroy));
 wlr_xwayland_shell_v1_destroy(shell);
}

struct wlr_xwayland_shell_v1 *wlr_xwayland_shell_v1_create(
  struct wl_display *display, uint32_t version) {
 ((version <= 1) ? (void) (0) : __assert_fail ("version <= SHELL_VERSION", "xwayland/shell.c", 166, __extension__ __PRETTY_FUNCTION__));
...
void wlr_xwayland_shell_v1_destroy(struct wlr_xwayland_shell_v1 *shell) {
 ...
 wl_signal_emit_mutable(&shell->events.destroy, ((void*)0));

 struct wlr_xwayland_surface_v1 *xwl_surface, *tmp;
 for (xwl_surface = (__typeof__(xwl_surface))((char *)((&shell->surfaces)->next) - __builtin_offsetof(__typeof__(*xwl_surface), link)), tmp = (__typeof__(tmp))((char *)((xwl_surface)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &xwl_surface->link != (&shell->surfaces); xwl_surface = tmp, tmp = (__typeof__(tmp))((char *)(xwl_surface->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  xwl_surface_destroy(xwl_surface);
 }
...
static void shell_handle_client_destroy(struct wl_listener *listener, void *data) {
 struct wlr_xwayland_shell_v1 *shell =
  (__typeof__(shell))((char *)(listener) - __builtin_offsetof(__typeof__(*shell), client_destroy));
 wlr_xwayland_shell_v1_set_client(shell, ((void*)0));
}
...
struct wlr_surface *wlr_xwayland_shell_v1_surface_from_serial(
  struct wlr_xwayland_shell_v1 *shell, uint64_t serial) {
 struct wlr_xwayland_surface_v1 *xwl_surface;
 for (xwl_surface = (__typeof__(xwl_surface))((char *)((&shell->surfaces)->next) - __builtin_offsetof(__typeof__(*xwl_surface), link)); &xwl_surface->link != (&shell->surfaces); xwl_surface = (__typeof__(xwl_surface))((char *)(xwl_surface->link.next) - __builtin_offsetof(__typeof__(*xwl_surface), link))) {
