# 1 "../subprojects/wlroots/types/buffer/dmabuf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/buffer/dmabuf.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/buffer/dmabuf.c" 2
...
# 3 "../subprojects/wlroots/types/buffer/dmabuf.c" 2
...
# 4 "../subprojects/wlroots/types/buffer/dmabuf.c" 2
...
# 5 "../subprojects/wlroots/types/buffer/dmabuf.c" 2
...
# 6 "../subprojects/wlroots/types/buffer/dmabuf.c" 2

static const struct wlr_buffer_impl dmabuf_buffer_impl;

static struct wlr_dmabuf_buffer *dmabuf_buffer_from_buffer(
  struct wlr_buffer *wlr_buffer) {
 ((wlr_buffer->impl == &dmabuf_buffer_impl) ? (void) (0) : __assert_fail ("wlr_buffer->impl == &dmabuf_buffer_impl", "types/buffer/dmabuf.c", 11, __extension__ __PRETTY_FUNCTION__));
 struct wlr_dmabuf_buffer *buffer = (__typeof__(buffer))((char *)(wlr_buffer) - __builtin_offsetof(__typeof__(*buffer), base));
 return buffer;
}
...
static _Bool dmabuf_buffer_get_dmabuf(struct wlr_buffer *wlr_buffer,
  struct wlr_dmabuf_attributes *dmabuf) {
 struct wlr_dmabuf_buffer *buffer = dmabuf_buffer_from_buffer(wlr_buffer);
...
_Bool dmabuf_buffer_drop(struct wlr_dmabuf_buffer *buffer) {
 ...
 if (buffer->base.n_locks > 0) {
  ...
  if (!wlr_dmabuf_attributes_copy(&saved_dmabuf, &buffer->dmabuf)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to save DMA-BUF", "types/buffer/dmabuf.c", 59);
   ok = 0;
