# 1 "../subprojects/libliftoff/test/test_alloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/libliftoff/test/test_alloc.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/libliftoff/test/test_alloc.c" 2
...
# 3 "../subprojects/libliftoff/test/test_alloc.c" 2
...
# 4 "../subprojects/libliftoff/test/test_alloc.c" 2
...
# 6 "../subprojects/libliftoff/test/test_alloc.c" 2
...
# 7 "../subprojects/libliftoff/test/test_alloc.c" 2
...
liftoff_mock_plane_add_in_formats(struct liftoff_mock_plane *plane,
      ...
      size_t size);
# 8 "../subprojects/libliftoff/test/test_alloc.c" 2
...
# 83 "../subprojects/libliftoff/test/test_alloc.c"
 ...
 },
 {
  ...
  .layers = {
   ...
   },
   {
    ...
    .height = 100,
    .props = {{ "zpos", 2 }},
    .compat = { &test_setup[1], &test_setup[2] },
    .result = &test_setup[2],
   },
   {
    .width = 100,
 ...
 },
 {
  ...
  .layers = {
   ...
   },
   {
    ...
    .height = 100,
    .props = {{ "zpos", 4 }},
    .compat = { &test_setup[1], &test_setup[2], &test_setup[3] },
    .result = &test_setup[1],
   },
   {
    .width = 100,
  ...
  .layers = {
   {
    ...
    .height = 100,
    .props = {{ "zpos", 2 }},
    .compat = { &test_setup[0], &test_setup[2] },
    .result = &test_setup[2],
   },
   {
    .width = 1920,
...
run_test(const struct test_case *test)
{
 ...
 liftoff_mock_require_primary_plane = 1;
 ...
 ((device != ((void*)0)) ? (void) (0) : __assert_fail ("device != NULL", "../subprojects/libliftoff/test/test_alloc.c", 771, __extension__ __PRETTY_FUNCTION__));
 ...
 for (i = 0; test->layers[i].width > 0; i++) {
  ...
  for (j = 0; j < len && test_layer->props[j].name != ((void*)0); j++) {
  ...
  for (j = 0; j < len && test_layer->compat[j] != ((void*)0); j++) {
 ...
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_alloc.c", 807, __extension__ __PRETTY_FUNCTION__));
 ret = drmModeAtomicCommit(drm_fd, req, 0, ((void*)0));
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_alloc.c", 809, __extension__ __PRETTY_FUNCTION__));
 ...
 for (i = 0; test->layers[i].width > 0; i++) {
  ...
  ((mock_plane == ((void*)0) || plane_index_got >= 0) ? (void) (0) : __assert_fail ("mock_plane == NULL || plane_index_got >= 0", "../subprojects/libliftoff/test/test_alloc.c", 827, __extension__ __PRETTY_FUNCTION__));

  fprintf(stderr, "layer %zu got assigned to plane %d\n",
   i, (int)plane_index_got);

  plane_index_want = -1;
  if (test->layers[i].result != ((void*)0)) {
 ...
 ((ok) ? (void) (0) : __assert_fail ("ok", "../subprojects/libliftoff/test/test_alloc.c", 843, __extension__ __PRETTY_FUNCTION__));

 ((test->needs_composition == liftoff_output_needs_composition(output)) ? (void) (0) : __assert_fail ("test->needs_composition == liftoff_output_needs_composition(output)", "../subprojects/libliftoff/test/test_alloc.c", 846, __extension__ __PRETTY_FUNCTION__));
...
test_basic(void)
{
 ...
 drm_fd = liftoff_mock_drm_open();
 device = liftoff_device_create(drm_fd);
 ((device != ((void*)0)) ? (void) (0) : __assert_fail ("device != NULL", "../subprojects/libliftoff/test/test_alloc.c", 868, __extension__ __PRETTY_FUNCTION__));
 ...
 req = drmModeAtomicAlloc();
 ret = liftoff_output_apply(output, req, 0);
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_alloc.c", 879, __extension__ __PRETTY_FUNCTION__));
 ret = drmModeAtomicCommit(drm_fd, req, 0, ((void*)0));
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_alloc.c", 881, __extension__ __PRETTY_FUNCTION__));
 ((liftoff_mock_plane_get_layer(mock_plane) == layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(mock_plane) == layer", "../subprojects/libliftoff/test/test_alloc.c", 882, __extension__ __PRETTY_FUNCTION__));
 drmModeAtomicFree(req);
...
test_no_props_fail(void)
{
 ...
 drm_fd = liftoff_mock_drm_open();
 device = liftoff_device_create(drm_fd);
 ((device != ((void*)0)) ? (void) (0) : __assert_fail ("device != NULL", "../subprojects/libliftoff/test/test_alloc.c", 906, __extension__ __PRETTY_FUNCTION__));
 ...
 req = drmModeAtomicAlloc();
 ret = liftoff_output_apply(output, req, 0);
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_alloc.c", 917, __extension__ __PRETTY_FUNCTION__));
 ret = drmModeAtomicCommit(drm_fd, req, 0, ((void*)0));
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_alloc.c", 919, __extension__ __PRETTY_FUNCTION__));
 ((liftoff_mock_plane_get_layer(mock_plane) == ((void*)0)) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(mock_plane) == NULL", "../subprojects/libliftoff/test/test_alloc.c", 920, __extension__ __PRETTY_FUNCTION__));
 drmModeAtomicFree(req);
...
test_composition_no_props(void)
{
 ...
 drm_fd = liftoff_mock_drm_open();
 device = liftoff_device_create(drm_fd);
 ((device != ((void*)0)) ? (void) (0) : __assert_fail ("device != NULL", "../subprojects/libliftoff/test/test_alloc.c", 945, __extension__ __PRETTY_FUNCTION__));
 ...
 req = drmModeAtomicAlloc();
 ret = liftoff_output_apply(output, req, 0);
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_alloc.c", 963, __extension__ __PRETTY_FUNCTION__));
 ret = drmModeAtomicCommit(drm_fd, req, 0, ((void*)0));
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_alloc.c", 965, __extension__ __PRETTY_FUNCTION__));
 ((liftoff_mock_plane_get_layer(mock_plane) == layer_with_fb) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(mock_plane) == layer_with_fb", "../subprojects/libliftoff/test/test_alloc.c", 966, __extension__ __PRETTY_FUNCTION__));
 drmModeAtomicFree(req);
