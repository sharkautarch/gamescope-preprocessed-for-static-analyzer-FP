# 1 "../subprojects/wlroots/types/wlr_output_layout.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_output_layout.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_output_layout.c" 2
# 1 "/usr/lib/clang/17/include/float.h" 1 3
# 3 "../subprojects/wlroots/types/wlr_output_layout.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_output_layout.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_output_layout.c" 2
...
struct wlr_output *wlr_output_layout_farthest_output(
 struct wlr_output_layout *layout, enum wlr_direction direction,
 struct wlr_output *reference, double ref_lx, double ref_ly);
# 6 "../subprojects/wlroots/types/wlr_output_layout.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_output.h" 1
# 7 "../subprojects/wlroots/types/wlr_output_layout.c" 2
...
# 9 "../subprojects/wlroots/types/wlr_output_layout.c" 2
...
static void output_layout_handle_display_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_output_layout *layout = (__typeof__(layout))((char *)(listener) - __builtin_offsetof(__typeof__(*layout), display_destroy));
...
void wlr_output_layout_destroy(struct wlr_output_layout *layout) {
 ...
 for (l_output = (__typeof__(l_output))((char *)((&layout->outputs)->next) - __builtin_offsetof(__typeof__(*l_output), link)), temp = (__typeof__(temp))((char *)((l_output)->link.next) - __builtin_offsetof(__typeof__(*temp), link)); &l_output->link != (&layout->outputs); l_output = temp, temp = (__typeof__(temp))((char *)(l_output->link.next) - __builtin_offsetof(__typeof__(*temp), link))) {
...
# 78 "../subprojects/wlroots/types/wlr_output_layout.c"
static void output_layout_reconfigure(struct wlr_output_layout *layout) {
 int max_x = (-2147483647 -1);
 int max_x_y = (-2147483647 -1);
 ...
 for (l_output = (__typeof__(l_output))((char *)((&layout->outputs)->next) - __builtin_offsetof(__typeof__(*l_output), link)); &l_output->link != (&layout->outputs); l_output = (__typeof__(l_output))((char *)(l_output->link.next) - __builtin_offsetof(__typeof__(*l_output), link))) {
...
static void handle_output_commit(struct wl_listener *listener, void *data) {
 struct wlr_output_layout_output *l_output =
  (__typeof__(l_output))((char *)(listener) - __builtin_offsetof(__typeof__(*l_output), commit));
...
static void addon_destroy(struct wlr_addon *addon) {
 ((addon->impl == &addon_impl) ? (void) (0) : __assert_fail ("addon->impl == &addon_impl", "types/wlr_output_layout.c", 142, __extension__ __PRETTY_FUNCTION__));
 struct wlr_output_layout_output *l_output =
  (__typeof__(l_output))((char *)(addon) - __builtin_offsetof(__typeof__(*l_output), addon));
...
struct wlr_output_layout_output *wlr_output_layout_add(struct wlr_output_layout *layout,
  struct wlr_output *output, int lx, int ly) {
 return output_layout_add(layout, output, lx, ly, 0);
}

struct wlr_output_layout_output *wlr_output_layout_add_auto(struct wlr_output_layout *layout,
  struct wlr_output *output) {
 return output_layout_add(layout, output, 0, 0, 1);
}
...
struct wlr_output_layout_output *wlr_output_layout_get(
  struct wlr_output_layout *layout, struct wlr_output *reference) {
 struct wlr_output_layout_output *l_output = ((void*)0);
 struct wlr_addon *addon =
  wlr_addon_find(&reference->addons, layout, &addon_impl);
 if (addon) {
  l_output = (__typeof__(l_output))((char *)(addon) - __builtin_offsetof(__typeof__(*l_output), addon));
 }
 return l_output;
}
...
void wlr_output_layout_output_coords(struct wlr_output_layout *layout,
  struct wlr_output *reference, double *lx, double *ly) {
 ((layout && reference) ? (void) (0) : __assert_fail ("layout && reference", "types/wlr_output_layout.c", 295, __extension__ __PRETTY_FUNCTION__));
 double src_x = *lx;
 double src_y = *ly;
...
void wlr_output_layout_closest_point(struct wlr_output_layout *layout,
  ...
  double *dest_ly) {
 if (dest_lx == ((void*)0) && dest_ly == ((void*)0)) {
  return;
 }

 double min_x = lx, min_y = ly, min_distance = 1.7976931348623157e+308;
 struct wlr_output_layout_output *l_output;
 for (l_output = (__typeof__(l_output))((char *)((&layout->outputs)->next) - __builtin_offsetof(__typeof__(*l_output), link)); &l_output->link != (&layout->outputs); l_output = (__typeof__(l_output))((char *)(l_output->link.next) - __builtin_offsetof(__typeof__(*l_output), link))) {
  if (reference != ((void*)0) && reference != l_output->output) {
   continue;
  }
  ...
  if (!__builtin_isfinite (output_distance)) {
   output_distance = 1.7976931348623157e+308;
  }
...
struct wlr_output *wlr_output_layout_get_center_output(
 ...
 wlr_output_layout_get_box(layout, ((void*)0), &extents);
 double center_x = extents.width / 2. + extents.x;
 double center_y = extents.height / 2. + extents.y;

 double dest_x = 0, dest_y = 0;
 wlr_output_layout_closest_point(layout, ((void*)0), center_x, center_y,
  &dest_x, &dest_y);
...
static struct wlr_output *wlr_output_layout_output_in_direction(
 ...
 ((reference) ? (void) (0) : __assert_fail ("reference", "types/wlr_output_layout.c", 421, __extension__ __PRETTY_FUNCTION__));
 ...
 double min_distance = (distance_method == NEAREST) ? 1.7976931348623157e+308 : 2.2250738585072014e-308;
 struct wlr_output *closest_output = ((void*)0);
 struct wlr_output_layout_output *l_output;
 for (l_output = (__typeof__(l_output))((char *)((&layout->outputs)->next) - __builtin_offsetof(__typeof__(*l_output), link)); &l_output->link != (&layout->outputs); l_output = (__typeof__(l_output))((char *)(l_output->link.next) - __builtin_offsetof(__typeof__(*l_output), link))) {
  if (reference != ((void*)0) && reference == l_output->output) {
   continue;
