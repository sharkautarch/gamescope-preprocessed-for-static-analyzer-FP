# 1 "../subprojects/wlroots/types/data_device/wlr_data_source.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
...
# 3 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
...
# 5 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
...
# 6 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
...
# 7 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
...
void wlr_data_source_dnd_action(struct wlr_data_source *source,
 enum wl_data_device_manager_dnd_action action);
# 8 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_seat.h" 1
# 9 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
...
# 10 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2
...
# 11 "../subprojects/wlroots/types/data_device/wlr_data_source.c" 2

void wlr_data_source_init(struct wlr_data_source *source,
  const struct wlr_data_source_impl *impl) {
 ((impl->send) ? (void) (0) : __assert_fail ("impl->send", "types/data_device/wlr_data_source.c", 14, __extension__ __PRETTY_FUNCTION__));
...
void wlr_data_source_accept(struct wlr_data_source *source, uint32_t serial,
  const char *mime_type) {
 source->accepted = (mime_type != ((void*)0));
...
struct wlr_client_data_source *client_data_source_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_data_source_interface, &data_source_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_data_source_interface, &data_source_impl)", "types/data_device/wlr_data_source.c", 83, __extension__ __PRETTY_FUNCTION__));
...
static struct wlr_client_data_source *client_data_source_from_wlr_data_source(
 ...
 ((wlr_source->impl->accept == client_data_source_accept) ? (void) (0) : __assert_fail ("wlr_source->impl->accept == client_data_source_accept", "types/data_device/wlr_data_source.c", 92, __extension__ __PRETTY_FUNCTION__));
 struct wlr_client_data_source *source = (__typeof__(source))((char *)(wlr_source) - __builtin_offsetof(__typeof__(*source), source));
 return source;
}
...
static void client_data_source_dnd_drop(struct wlr_data_source *wlr_source) {
 struct wlr_client_data_source *source =
  client_data_source_from_wlr_data_source(wlr_source);
 ((wl_resource_get_version(source->resource) >= 3) ? (void) (0) : __assert_fail ("wl_resource_get_version(source->resource) >= WL_DATA_SOURCE_DND_DROP_PERFORMED_SINCE_VERSION", "types/data_device/wlr_data_source.c", 124, __extension__ __PRETTY_FUNCTION__));
...
static void client_data_source_dnd_finish(struct wlr_data_source *wlr_source) {
 struct wlr_client_data_source *source =
  client_data_source_from_wlr_data_source(wlr_source);
 ((wl_resource_get_version(source->resource) >= 3) ? (void) (0) : __assert_fail ("wl_resource_get_version(source->resource) >= WL_DATA_SOURCE_DND_FINISHED_SINCE_VERSION", "types/data_device/wlr_data_source.c", 132, __extension__ __PRETTY_FUNCTION__));
...
static void client_data_source_dnd_action(struct wlr_data_source *wlr_source,
 ...
 struct wlr_client_data_source *source =
  client_data_source_from_wlr_data_source(wlr_source);
 ((wl_resource_get_version(source->resource) >= 3) ? (void) (0) : __assert_fail ("wl_resource_get_version(source->resource) >= WL_DATA_SOURCE_ACTION_SINCE_VERSION", "types/data_device/wlr_data_source.c", 141, __extension__ __PRETTY_FUNCTION__));
...
static void data_source_offer(struct wl_client *client,
 ...
 if (source->finalized) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Offering additional MIME type after " "wl_data_device.set_selection", "types/data_device/wlr_data_source.c", 191);
 ...
 for (mime_type_ptr = (&source->source.mime_types)->data; (const char *) mime_type_ptr < ((const char *) (&source->source.mime_types)->data + (&source->source.mime_types)->size); (mime_type_ptr)++) {
  if (strcmp(*mime_type_ptr, mime_type) == 0) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Ignoring duplicate MIME type offer %s", "types/data_device/wlr_data_source.c", 198, mime_type);
