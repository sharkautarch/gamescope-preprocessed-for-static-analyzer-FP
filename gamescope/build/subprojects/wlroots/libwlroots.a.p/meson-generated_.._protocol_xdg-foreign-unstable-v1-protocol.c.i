# 1 "subprojects/wlroots/protocol/xdg-foreign-unstable-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/xdg-foreign-unstable-v1-protocol.c" 2
# 26 "subprojects/wlroots/protocol/xdg-foreign-unstable-v1-protocol.c"
...
# 27 "subprojects/wlroots/protocol/xdg-foreign-unstable-v1-protocol.c" 2
...
# 28 "subprojects/wlroots/protocol/xdg-foreign-unstable-v1-protocol.c" 2
...
# 29 "subprojects/wlroots/protocol/xdg-foreign-unstable-v1-protocol.c" 2
# 40 "subprojects/wlroots/protocol/xdg-foreign-unstable-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zxdg_exporter_v1_interface = {
 "zxdg_exporter_v1", 1,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zxdg_importer_v1_interface = {
 "zxdg_importer_v1", 1,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zxdg_exported_v1_interface = {
 "zxdg_exported_v1", 1,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zxdg_imported_v1_interface = {
 "zxdg_imported_v1", 1,
