# 1 "subprojects/wlroots/protocol/drm-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/drm-protocol.c" 2
# 29 "subprojects/wlroots/protocol/drm-protocol.c"
...
# 30 "subprojects/wlroots/protocol/drm-protocol.c" 2
...
# 31 "subprojects/wlroots/protocol/drm-protocol.c" 2
...
# 32 "subprojects/wlroots/protocol/drm-protocol.c" 2
# 43 "subprojects/wlroots/protocol/drm-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wl_drm_interface = {
 "wl_drm", 2,
 4, wl_drm_requests,
 4, wl_drm_events,
};
