# 1 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
# 3 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
# 4 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 5 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
# 6 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
# 7 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 8 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
void wlr_data_source_dnd_action(struct wlr_data_source *source,
 enum wl_data_device_manager_dnd_action action);
# 9 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
# 10 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
# 1 "../subprojects/wlroots/include/types/wlr_data_device.h" 1




# 1 "../subprojects/wlroots/include/wlr/types/wlr_data_device.h" 1
# 6 "../subprojects/wlroots/include/types/wlr_data_device.h" 2
...
# 11 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
# 12 "../subprojects/wlroots/types/seat/wlr_seat_keyboard.c" 2
...
static struct wlr_seat_client *seat_client_from_keyboard_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_keyboard_interface, &keyboard_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_keyboard_interface, &keyboard_impl)", "types/seat/wlr_seat_keyboard.c", 58, __extension__ __PRETTY_FUNCTION__));
...
void wlr_seat_keyboard_send_key(struct wlr_seat *wlr_seat, uint32_t time,
 ...
 struct wl_resource *resource;
 for (resource = 0, resource = wl_resource_from_link((&client->keyboards)->next); wl_resource_get_link(resource) != (&client->keyboards); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
  if (seat_client_from_keyboard_resource(resource) == ((void*)0)) {
   continue;
  }
...
static void handle_keyboard_keymap(struct wl_listener *listener, void *data) {
 struct wlr_seat_keyboard_state *state =
  (__typeof__(state))((char *)(listener) - __builtin_offsetof(__typeof__(*state), keyboard_keymap));
 struct wlr_seat_client *client;
 struct wlr_keyboard *keyboard = data;
 if (keyboard == state->keyboard) {
  for (client = (__typeof__(client))((char *)((&state->seat->clients)->next) - __builtin_offsetof(__typeof__(*client), link)); &client->link != (&state->seat->clients); client = (__typeof__(client))((char *)(client->link.next) - __builtin_offsetof(__typeof__(*client), link))) {
...
static void handle_keyboard_repeat_info(struct wl_listener *listener,
  void *data) {
 struct wlr_seat_keyboard_state *state =
  (__typeof__(state))((char *)(listener) - __builtin_offsetof(__typeof__(*state), keyboard_repeat_info));
 struct wlr_seat_client *client;
 for (client = (__typeof__(client))((char *)((&state->seat->clients)->next) - __builtin_offsetof(__typeof__(*client), link)); &client->link != (&state->seat->clients); client = (__typeof__(client))((char *)(client->link.next) - __builtin_offsetof(__typeof__(*client), link))) {
...
static void handle_keyboard_destroy(struct wl_listener *listener, void *data) {
 struct wlr_seat_keyboard_state *state =
  (__typeof__(state))((char *)(listener) - __builtin_offsetof(__typeof__(*state), keyboard_destroy));
 wlr_seat_set_keyboard(state->seat, ((void*)0));
}
...
void wlr_seat_set_keyboard(struct wlr_seat *seat,
 ...
 if (seat->keyboard_state.keyboard) {
  ...
  seat->keyboard_state.keyboard = ((void*)0);
 }
 ...
 if (keyboard) {
  ...
  struct wlr_seat_client *client;
  for (client = (__typeof__(client))((char *)((&seat->clients)->next) - __builtin_offsetof(__typeof__(*client), link)); &client->link != (&seat->clients); client = (__typeof__(client))((char *)(client->link.next) - __builtin_offsetof(__typeof__(*client), link))) {
...
static void seat_keyboard_handle_surface_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_seat_keyboard_state *state = (__typeof__(state))((char *)(listener) - __builtin_offsetof(__typeof__(*state), surface_destroy));
...
void seat_client_send_keyboard_leave_raw(struct wlr_seat_client *seat_client,
 ...
 struct wl_resource *resource;
 for (resource = 0, resource = wl_resource_from_link((&seat_client->keyboards)->next); wl_resource_get_link(resource) != (&seat_client->keyboards); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
  if (seat_client_from_keyboard_resource(resource) == ((void*)0)) {
   continue;
  }
...
void wlr_seat_keyboard_enter(struct wlr_seat *seat,
 ...
 struct wlr_seat_client *client = ((void*)0);
...
void wlr_seat_keyboard_notify_enter(struct wlr_seat *seat,
 ...
 ((surface) ? (void) (0) : __assert_fail ("surface", "types/seat/wlr_seat_keyboard.c", 305, __extension__ __PRETTY_FUNCTION__));
...
void wlr_seat_keyboard_clear_focus(struct wlr_seat *seat) {
 wlr_seat_keyboard_enter(seat, ((void*)0), ((void*)0), 0, ((void*)0));
}
...
static void seat_client_send_keymap(struct wlr_seat_client *client,
 ...
 if (keyboard->keymap != ((void*)0)) {
  ...
  devnull = open("/dev/null", 00 | 02000000);
  if (devnull < 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to open /dev/null" ": %s", "types/seat/wlr_seat_keyboard.c", 355, strerror((*__errno_location ())));
   return;
  }
  fd = devnull;
  size = 0;
...
void seat_client_create_keyboard(struct wlr_seat_client *seat_client,
 ...
 if (focused_client == seat_client && focused_surface != ((void*)0)) {
  ...
  for (size_t i = 0; i < num_keycodes; ++i) {
   ...
   if (!p) {
    _wlr_log(WLR_ERROR, "[%s:%d] " "Cannot allocate memory, skipping keycode: %" "u" "\n", "types/seat/wlr_seat_keyboard.c", 438, keycodes[i]);
  ...
  struct wl_resource *resource;
  for (resource = 0, resource = wl_resource_from_link((&focused_client->keyboards)->next); wl_resource_get_link(resource) != (&focused_client->keyboards); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
...
void seat_client_create_inert_keyboard(struct wl_client *client,
 ...
 wl_resource_set_implementation(resource, &keyboard_impl, ((void*)0), ((void*)0));
}
