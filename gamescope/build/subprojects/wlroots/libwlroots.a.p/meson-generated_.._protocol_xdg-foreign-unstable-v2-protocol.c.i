# 1 "subprojects/wlroots/protocol/xdg-foreign-unstable-v2-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/xdg-foreign-unstable-v2-protocol.c" 2
# 26 "subprojects/wlroots/protocol/xdg-foreign-unstable-v2-protocol.c"
...
# 27 "subprojects/wlroots/protocol/xdg-foreign-unstable-v2-protocol.c" 2
...
# 28 "subprojects/wlroots/protocol/xdg-foreign-unstable-v2-protocol.c" 2
...
# 29 "subprojects/wlroots/protocol/xdg-foreign-unstable-v2-protocol.c" 2
# 40 "subprojects/wlroots/protocol/xdg-foreign-unstable-v2-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zxdg_exporter_v2_interface = {
 "zxdg_exporter_v2", 1,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zxdg_importer_v2_interface = {
 "zxdg_importer_v2", 1,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zxdg_exported_v2_interface = {
 "zxdg_exported_v2", 1,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zxdg_imported_v2_interface = {
 "zxdg_imported_v2", 1,
