# 1 "../subprojects/wlroots/types/wlr_transient_seat_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_transient_seat_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_transient_seat_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_transient_seat_v1.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_transient_seat_v1.c" 2
...
# 14 "../subprojects/wlroots/include/wlr/types/wlr_seat.h" 2
...
# 5 "../subprojects/wlroots/types/wlr_transient_seat_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_transient_seat_v1.h" 1
# 14 "../subprojects/wlroots/include/wlr/types/wlr_transient_seat_v1.h"
struct wlr_seat;
...
struct wlr_transient_seat_manager_v1 *wlr_transient_seat_manager_v1_create(
  struct wl_display *display);
# 52 "../subprojects/wlroots/include/wlr/types/wlr_transient_seat_v1.h"
...
# 6 "../subprojects/wlroots/types/wlr_transient_seat_v1.c" 2
# 1 "subprojects/wlroots/protocol/ext-transient-seat-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/ext-transient-seat-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 70 "subprojects/wlroots/protocol/ext-transient-seat-v1-protocol.h"
struct ext_transient_seat_manager_v1;
struct ext_transient_seat_v1;
# 88 "subprojects/wlroots/protocol/ext-transient-seat-v1-protocol.h"
extern const struct wl_interface ext_transient_seat_manager_v1_interface;
# 107 "subprojects/wlroots/protocol/ext-transient-seat-v1-protocol.h"
...
# 124 "subprojects/wlroots/protocol/ext-transient-seat-v1-protocol.h"
 void (*create)(struct wl_client *client,
         struct wl_resource *resource,
         uint32_t seat);
# 135 "subprojects/wlroots/protocol/ext-transient-seat-v1-protocol.h"
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
};
# 153 "subprojects/wlroots/protocol/ext-transient-seat-v1-protocol.h"
...
# 186 "subprojects/wlroots/protocol/ext-transient-seat-v1-protocol.h"
static inline void
ext_transient_seat_v1_send_ready(struct wl_resource *resource_, uint32_t global_name)
{
 wl_resource_post_event(resource_, 0, global_name);
}
...
# 7 "../subprojects/wlroots/types/wlr_transient_seat_v1.c" 2
...
static struct wlr_transient_seat_manager_v1 *manager_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &ext_transient_seat_manager_v1_interface, &manager_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &ext_transient_seat_manager_v1_interface, &manager_impl)", "types/wlr_transient_seat_v1.c", 14, __extension__ __PRETTY_FUNCTION__));
...
static struct wlr_transient_seat_v1 *transient_seat_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &ext_transient_seat_v1_interface, &transient_seat_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &ext_transient_seat_v1_interface, &transient_seat_impl)", "types/wlr_transient_seat_v1.c", 21, __extension__ __PRETTY_FUNCTION__));
...
static void transient_seat_handle_seat_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_transient_seat_v1 *seat = (__typeof__(seat))((char *)(listener) - __builtin_offsetof(__typeof__(*seat), seat_destroy));

 seat->seat = ((void*)0);
 wl_resource_set_user_data(seat->resource, ((void*)0));
 transient_seat_destroy(seat);
}

void wlr_transient_seat_v1_ready(struct wlr_transient_seat_v1 *seat,
  struct wlr_seat *wlr_seat) {
 ((wlr_seat) ? (void) (0) : __assert_fail ("wlr_seat", "types/wlr_transient_seat_v1.c", 87, __extension__ __PRETTY_FUNCTION__));
 ...
 ((global_name != 0) ? (void) (0) : __assert_fail ("global_name != 0", "types/wlr_transient_seat_v1.c", 96, __extension__ __PRETTY_FUNCTION__));
