# 1 "../subprojects/wlroots/types/wlr_region.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_region.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_region.c" 2
...
void pixman_add_triangles (pixman_image_t *image,
       ...
       int n_tris,
       const pixman_triangle_t *tris);
# 3 "../subprojects/wlroots/types/wlr_region.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_region.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_region.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_region.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 7 "../subprojects/wlroots/types/wlr_region.c" 2
...
struct wl_resource *region_create(struct wl_client *client,
 uint32_t version, uint32_t id);
# 8 "../subprojects/wlroots/types/wlr_region.c" 2

static const struct wl_region_interface region_impl;

static pixman_region32_t *region_from_resource(struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_region_interface, &region_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_region_interface, &region_impl)", "types/wlr_region.c", 13, __extension__ __PRETTY_FUNCTION__));
