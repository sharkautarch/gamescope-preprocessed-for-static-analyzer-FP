# 1 "subprojects/wlroots/protocol/drm-lease-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/drm-lease-v1-protocol.c" 2
# 28 "subprojects/wlroots/protocol/drm-lease-v1-protocol.c"
...
# 29 "subprojects/wlroots/protocol/drm-lease-v1-protocol.c" 2
...
# 30 "subprojects/wlroots/protocol/drm-lease-v1-protocol.c" 2
...
# 31 "subprojects/wlroots/protocol/drm-lease-v1-protocol.c" 2
# 42 "subprojects/wlroots/protocol/drm-lease-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_drm_lease_device_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_drm_lease_connector_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_drm_lease_request_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_drm_lease_v1_interface = {
 "wp_drm_lease_v1", 1,
