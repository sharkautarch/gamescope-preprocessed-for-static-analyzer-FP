# 1 "../subprojects/wlroots/types/wlr_xcursor_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_xcursor_manager.c" 2
...
# 2 "../subprojects/wlroots/types/wlr_xcursor_manager.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 3 "../subprojects/wlroots/types/wlr_xcursor_manager.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_xcursor_manager.h" 1
# 12 "../subprojects/wlroots/include/wlr/types/wlr_xcursor_manager.h"
...
# 13 "../subprojects/wlroots/include/wlr/types/wlr_xcursor_manager.h" 2
...
# 4 "../subprojects/wlroots/types/wlr_xcursor_manager.c" 2
...
void wlr_xcursor_manager_destroy(struct wlr_xcursor_manager *manager) {
 ...
 for (theme = (__typeof__(theme))((char *)((&manager->scaled_themes)->next) - __builtin_offsetof(__typeof__(*theme), link)), tmp = (__typeof__(tmp))((char *)((theme)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &theme->link != (&manager->scaled_themes); theme = tmp, tmp = (__typeof__(tmp))((char *)(theme->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
...
_Bool wlr_xcursor_manager_load(struct wlr_xcursor_manager *manager,
 ...
 for (theme = (__typeof__(theme))((char *)((&manager->scaled_themes)->next) - __builtin_offsetof(__typeof__(*theme), link)); &theme->link != (&manager->scaled_themes); theme = (__typeof__(theme))((char *)(theme->link.next) - __builtin_offsetof(__typeof__(*theme), link))) {
