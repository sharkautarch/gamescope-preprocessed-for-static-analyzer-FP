# 1 "../subprojects/wlroots/types/seat/wlr_seat_touch.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/seat/wlr_seat_touch.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/seat/wlr_seat_touch.c" 2
...
# 3 "../subprojects/wlroots/types/seat/wlr_seat_touch.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/seat/wlr_seat_touch.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 5 "../subprojects/wlroots/types/seat/wlr_seat_touch.c" 2
...
# 6 "../subprojects/wlroots/types/seat/wlr_seat_touch.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 7 "../subprojects/wlroots/types/seat/wlr_seat_touch.c" 2
...
# 8 "../subprojects/wlroots/types/seat/wlr_seat_touch.c" 2
...
# 9 "../subprojects/wlroots/types/seat/wlr_seat_touch.c" 2
...
static struct wlr_seat_client *seat_client_from_touch_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_touch_interface, &touch_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_touch_interface, &touch_impl)", "types/seat/wlr_seat_touch.c", 74, __extension__ __PRETTY_FUNCTION__));
...
static void touch_point_clear_focus(struct wlr_touch_point *point) {
 if (point->focus_surface) {
  ...
  point->focus_client = ((void*)0);
  point->focus_surface = ((void*)0);
 }
}
...
static void touch_point_handle_surface_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_touch_point *point =
  (__typeof__(point))((char *)(listener) - __builtin_offsetof(__typeof__(*point), surface_destroy));

 point->surface = ((void*)0);
 wl_list_remove(&point->surface_destroy.link);
...
static void touch_point_handle_client_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_touch_point *point =
  (__typeof__(point))((char *)(listener) - __builtin_offsetof(__typeof__(*point), client_destroy));
...
static struct wlr_touch_point *touch_point_create(
 ...
 if (client == ((void*)0) || wl_list_empty(&client->touches)) {
...
struct wlr_touch_point *wlr_seat_touch_get_point(
  struct wlr_seat *seat, int32_t touch_id) {
 struct wlr_touch_point *point = ((void*)0);
...
uint32_t wlr_seat_touch_notify_down(struct wlr_seat *seat,
  ...
  double sy) {
 clock_gettime(1, &seat->last_event);
 struct wlr_seat_touch_grab *grab = seat->touch_state.grab;
 struct wlr_touch_point *point =
  touch_point_create(seat, touch_id, surface, sx, sy);
 if (!point) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "could not create touch point", "types/seat/wlr_seat_touch.c", 189);
  return 0;
 }
...
void wlr_seat_touch_notify_cancel(struct wlr_seat *seat,
 ...
 for (point = (__typeof__(point))((char *)((&seat->touch_state.touch_points)->next) - __builtin_offsetof(__typeof__(*point), link)), tmp = (__typeof__(tmp))((char *)((point)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &point->link != (&seat->touch_state.touch_points); point = tmp, tmp = (__typeof__(tmp))((char *)(point->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
...
static void handle_point_focus_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_touch_point *point =
  (__typeof__(point))((char *)(listener) - __builtin_offsetof(__typeof__(*point), focus_surface_destroy));
 touch_point_clear_focus(point);
}
...
void wlr_seat_touch_point_focus(struct wlr_seat *seat,
  struct wlr_surface *surface, uint32_t time, int32_t touch_id, double sx,
  double sy) {
 ((surface) ? (void) (0) : __assert_fail ("surface", "types/seat/wlr_seat_touch.c", 298, __extension__ __PRETTY_FUNCTION__));
 struct wlr_touch_point *point = wlr_seat_touch_get_point(seat, touch_id);
 if (!point) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "got touch point focus for unknown touch point", "types/seat/wlr_seat_touch.c", 301);
  return;
 }
...
void wlr_seat_touch_point_clear_focus(struct wlr_seat *seat, uint32_t time,
 ...
 struct wlr_touch_point *point = wlr_seat_touch_get_point(seat, touch_id);
 if (!point) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "got touch point focus for unknown touch point", "types/seat/wlr_seat_touch.c", 317);
  return;
 }
...
uint32_t wlr_seat_touch_send_down(struct wlr_seat *seat,
 ...
 struct wlr_touch_point *point = wlr_seat_touch_get_point(seat, touch_id);
 if (!point) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "got touch down for unknown touch point", "types/seat/wlr_seat_touch.c", 329);
  return 0;
 }

 uint32_t serial = wlr_seat_client_next_serial(point->client);
 struct wl_resource *resource;
 for (resource = 0, resource = wl_resource_from_link((&point->client->touches)->next); wl_resource_get_link(resource) != (&point->client->touches); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
  if (seat_client_from_touch_resource(resource) == ((void*)0)) {
   continue;
  }
 ...
 point->client->needs_touch_frame = 1;
...
void wlr_seat_touch_send_up(struct wlr_seat *seat, uint32_t time, int32_t touch_id) {
 struct wlr_touch_point *point = wlr_seat_touch_get_point(seat, touch_id);
 if (!point) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "got touch up for unknown touch point", "types/seat/wlr_seat_touch.c", 351);
  return;
 }
...
void wlr_seat_touch_send_motion(struct wlr_seat *seat, uint32_t time, int32_t touch_id,
 ...
 struct wlr_touch_point *point = wlr_seat_touch_get_point(seat, touch_id);
 if (!point) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "got touch motion for unknown touch point", "types/seat/wlr_seat_touch.c", 371);
  return;
 }
...
void wlr_seat_touch_send_frame(struct wlr_seat *seat) {
 struct wlr_seat_client *seat_client;
 for (seat_client = (__typeof__(seat_client))((char *)((&seat->clients)->next) - __builtin_offsetof(__typeof__(*seat_client), link)); &seat_client->link != (&seat->clients); seat_client = (__typeof__(seat_client))((char *)(seat_client->link.next) - __builtin_offsetof(__typeof__(*seat_client), link))) {
  if (!seat_client->needs_touch_frame) {
   continue;
  }

  struct wl_resource *resource;
  for (resource = 0, resource = wl_resource_from_link((&seat_client->touches)->next); wl_resource_get_link(resource) != (&seat_client->touches); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
   wl_touch_send_frame(resource);
  }
  seat_client->needs_touch_frame = 0;
 }
}
...
void seat_client_create_inert_touch(struct wl_client *client, uint32_t version,
 ...
 wl_resource_set_implementation(resource, &touch_impl, ((void*)0), ((void*)0));
}
...
_Bool wlr_seat_validate_touch_grab_serial(struct wlr_seat *seat,
 ...
 if (wlr_seat_touch_num_points(seat) != 1 ||
   seat->touch_state.grab_serial != serial) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Touch grab serial validation failed: " "num_points=%d grab_serial=%""u"" (got %""u"")", "types/seat/wlr_seat_touch.c", 469, wlr_seat_touch_num_points(seat), seat->touch_state.grab_serial, serial);
 ...
 struct wlr_touch_point *point;
 for (point = (__typeof__(point))((char *)((&seat->touch_state.touch_points)->next) - __builtin_offsetof(__typeof__(*point), link)); &point->link != (&seat->touch_state.touch_points); point = (__typeof__(point))((char *)(point->link.next) - __builtin_offsetof(__typeof__(*point), link))) {
  if (origin == ((void*)0) || point->surface == origin) {
   if (point_ptr != ((void*)0)) {
    *point_ptr = point;
   }
   return 1;
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Touch grab serial validation failed: " "invalid origin surface", "types/seat/wlr_seat_touch.c", 484);
