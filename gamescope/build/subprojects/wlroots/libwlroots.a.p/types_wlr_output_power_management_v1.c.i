# 1 "../subprojects/wlroots/types/wlr_output_power_management_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
...
void wlr_output_send_request_state(struct wlr_output *output,
 const struct wlr_output_state *state);
# 7 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_output_power_management_v1.h" 1




# 1 "subprojects/wlroots/protocol/wlr-output-power-management-unstable-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/wlr-output-power-management-unstable-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 68 "subprojects/wlroots/protocol/wlr-output-power-management-unstable-v1-protocol.h"
struct wl_output;
struct zwlr_output_power_manager_v1;
struct zwlr_output_power_v1;
# 89 "subprojects/wlroots/protocol/wlr-output-power-management-unstable-v1-protocol.h"
extern const struct wl_interface zwlr_output_power_manager_v1_interface;
# 108 "subprojects/wlroots/protocol/wlr-output-power-management-unstable-v1-protocol.h"
...
# 148 "subprojects/wlroots/protocol/wlr-output-power-management-unstable-v1-protocol.h"
...
# 183 "subprojects/wlroots/protocol/wlr-output-power-management-unstable-v1-protocol.h"
...
# 222 "subprojects/wlroots/protocol/wlr-output-power-management-unstable-v1-protocol.h"
static inline void
...
# 6 "../subprojects/wlroots/include/wlr/types/wlr_output_power_management_v1.h" 2
...
# 8 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_output.h" 1
# 9 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
...
# 10 "../subprojects/wlroots/types/wlr_output_power_management_v1.c" 2
...
static void output_power_destroy(struct wlr_output_power_v1 *output_power) {
 if (output_power == ((void*)0)) {
  return;
 }
 wl_resource_set_user_data(output_power->resource, ((void*)0));
...
static struct wlr_output_power_v1 *output_power_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwlr_output_power_v1_interface, &output_power_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwlr_output_power_v1_interface, &output_power_impl)", "types/wlr_output_power_management_v1.c", 35, __extension__ __PRETTY_FUNCTION__));
...
static void output_power_handle_output_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_output_power_v1 *output_power =
  (__typeof__(output_power))((char *)(listener) - __builtin_offsetof(__typeof__(*output_power), output_destroy_listener));
 output_power_destroy(output_power);
}
...
static void output_power_handle_output_commit(struct wl_listener *listener,
  void *data) {
 struct wlr_output_power_v1 *output_power =
  (__typeof__(output_power))((char *)(listener) - __builtin_offsetof(__typeof__(*output_power), output_commit_listener));
...
static void output_power_handle_set_mode(struct wl_client *client,
 ...
 case ZWLR_OUTPUT_POWER_V1_MODE_ON:
  break;
 default:
  _wlr_log(WLR_ERROR, "[%s:%d] " "Invalid power mode %d", "types/wlr_output_power_management_v1.c", 84, mode);
...
static struct wlr_output_power_manager_v1 *output_power_manager_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwlr_output_power_manager_v1_interface, &output_power_manager_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwlr_output_power_manager_v1_interface, &output_power_manager_impl)", "types/wlr_output_power_management_v1.c", 109, __extension__ __PRETTY_FUNCTION__));
...
static void output_power_manager_get_output_power(struct wl_client *client,
 ...
 if (output_power->resource == ((void*)0)) {
  free(output_power);
  wl_client_post_no_memory(client);
  return;
 }
 ...
 for (mgmt = (__typeof__(mgmt))((char *)((&manager->output_powers)->next) - __builtin_offsetof(__typeof__(*mgmt), link)); &mgmt->link != (&manager->output_powers); mgmt = (__typeof__(mgmt))((char *)(mgmt->link.next) - __builtin_offsetof(__typeof__(*mgmt), link))) {
...
struct wlr_output_power_manager_v1 *wlr_output_power_manager_v1_create(
 ...
 manager->global = wl_global_create(display,
  ...
  1, manager, output_power_manager_bind);
