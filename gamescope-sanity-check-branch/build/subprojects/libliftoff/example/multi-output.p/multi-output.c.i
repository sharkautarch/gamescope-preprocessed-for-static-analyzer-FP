# 1 "../subprojects/libliftoff/example/multi-output.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/libliftoff/example/multi-output.c" 2
...
# 7 "../subprojects/libliftoff/example/multi-output.c" 2
...
# 8 "../subprojects/libliftoff/example/multi-output.c" 2
...
# 9 "../subprojects/libliftoff/example/multi-output.c" 2
...
# 10 "../subprojects/libliftoff/example/multi-output.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 11 "../subprojects/libliftoff/example/multi-output.c" 2
...
# 12 "../subprojects/libliftoff/example/multi-output.c" 2
...
# 13 "../subprojects/libliftoff/example/multi-output.c" 2
...
# 15 "../subprojects/libliftoff/example/multi-output.c" 2
...
add_layer(int drm_fd, struct liftoff_output *output, int x, int y, uint32_t width,
   uint32_t height, _Bool with_alpha)
{
...
main(int argc, char *argv[])
{
 ...
 drmModeCrtc *crtcs[32], *crtc;
 struct liftoff_output *outputs[32], *output;
 struct liftoff_layer *layers[32 * 4];
 struct liftoff_plane *plane;
