# 1 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
...
# 3 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
...
struct wlr_tablet_seat_v2 *get_or_create_tablet_seat(
 struct wlr_tablet_manager_v2 *manager,
 struct wlr_seat *wlr_seat);
# 4 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 6 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
...
struct wlr_tablet *wlr_tablet_from_input_device(
 struct wlr_input_device *input_device);
# 7 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_tablet_v2.h" 1
# 8 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
...
# 9 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
...
# 10 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
...
# 11 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tool.c" 2
...
void destroy_tablet_tool_v2(struct wl_resource *resource) {
 ...
 if (client->tool && client->tool->current_client == client) {
  client->tool->current_client = ((void*)0);
 }
...
static void handle_wlr_tablet_tool_destroy(struct wl_listener *listener, void *data) {
 struct wlr_tablet_v2_tablet_tool *tool =
  (__typeof__(tool))((char *)(listener) - __builtin_offsetof(__typeof__(*tool), tool_destroy));

 struct wlr_tablet_tool_client_v2 *pos;
 struct wlr_tablet_tool_client_v2 *tmp;
 for (pos = (__typeof__(pos))((char *)((&tool->clients)->next) - __builtin_offsetof(__typeof__(*pos), tool_link)), tmp = (__typeof__(tmp))((char *)((pos)->tool_link.next) - __builtin_offsetof(__typeof__(*tmp), tool_link)); &pos->tool_link != (&tool->clients); pos = tmp, tmp = (__typeof__(tmp))((char *)(pos->tool_link.next) - __builtin_offsetof(__typeof__(*tmp), tool_link))) {
...
struct wlr_tablet_tool_client_v2 *tablet_tool_client_from_resource(struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwp_tablet_tool_v2_interface, &tablet_tool_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwp_tablet_tool_v2_interface, &tablet_tool_impl)", "types/tablet_v2/wlr_tablet_v2_tool.c", 261, __extension__ __PRETTY_FUNCTION__));
...
static ssize_t tablet_tool_button_update(struct wlr_tablet_v2_tablet_tool *tool,
 ...
 if (state == ZWP_TABLET_PAD_V2_BUTTON_STATE_PRESSED) {
  ...
  if (i != -1) {
   ...
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to add tablet tool button %x", "types/tablet_v2/wlr_tablet_v2_tool.c", 274, button);
  }
 } else {
  ...
  if (i != -1) {
   ...
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to remove tablet tool button %x", "types/tablet_v2/wlr_tablet_v2_tool.c", 282, button);
  }
 }
 return i;
}
...
static void handle_tablet_tool_surface_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_tablet_v2_tablet_tool *tool =
  (__typeof__(tool))((char *)(listener) - __builtin_offsetof(__typeof__(*tool), surface_destroy));
...
void wlr_send_tablet_v2_tablet_tool_proximity_in(
 ...
 struct wlr_tablet_tool_client_v2 *tool_tmp = ((void*)0);
 struct wlr_tablet_tool_client_v2 *tool_client = ((void*)0);
 for (tool_tmp = (__typeof__(tool_tmp))((char *)((&tool->clients)->next) - __builtin_offsetof(__typeof__(*tool_tmp), tool_link)); &tool_tmp->tool_link != (&tool->clients); tool_tmp = (__typeof__(tool_tmp))((char *)(tool_tmp->tool_link.next) - __builtin_offsetof(__typeof__(*tool_tmp), tool_link))) {
...
void wlr_send_tablet_v2_tablet_tool_proximity_out(
 ...
 if (tool->current_client) {
  ...
  wl_list_remove(&tool->surface_destroy.link);
  wl_list_init(&tool->surface_destroy.link);
  tool->current_client = ((void*)0);
  tool->focused_surface = ((void*)0);
 }
}
