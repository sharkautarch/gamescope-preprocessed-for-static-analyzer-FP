# 1 "../subprojects/wlroots/backend/libinput/touch.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/backend/libinput/touch.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/backend/libinput/touch.c" 2
...
# 3 "../subprojects/wlroots/backend/libinput/touch.c" 2
...
# 12 "../subprojects/wlroots/include/wlr/types/wlr_input_device.h"
...
# 13 "../subprojects/wlroots/include/wlr/types/wlr_input_device.h" 2
...
# 4 "../subprojects/wlroots/backend/libinput/touch.c" 2
...
void handle_tablet_pad_strip(struct libinput_event *event,
 struct wlr_tablet_pad *tablet_pad);
# 5 "../subprojects/wlroots/backend/libinput/touch.c" 2
...
struct wlr_libinput_input_device *device_from_touch(
 ...
 ((wlr_touch->impl == &libinput_touch_impl) ? (void) (0) : __assert_fail ("wlr_touch->impl == &libinput_touch_impl", "backend/libinput/touch.c", 21, __extension__ __PRETTY_FUNCTION__));

 struct wlr_libinput_input_device *dev =
  (__typeof__(dev))((char *)(wlr_touch) - __builtin_offsetof(__typeof__(*dev), touch));
 return dev;
}
...
void handle_touch_frame(struct libinput_event *event,
  struct wlr_touch *touch) {
 wl_signal_emit_mutable(&touch->events.frame, ((void*)0));
}
