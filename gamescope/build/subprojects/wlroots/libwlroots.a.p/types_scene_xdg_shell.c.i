# 1 "../subprojects/wlroots/types/scene/xdg_shell.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/scene/xdg_shell.c" 2
...
# 2 "../subprojects/wlroots/types/scene/xdg_shell.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_scene.h" 1
# 22 "../subprojects/wlroots/include/wlr/types/wlr_scene.h"
...
void pixman_add_triangles (pixman_image_t *image,
       ...
       int n_tris,
       const pixman_triangle_t *tris);
# 23 "../subprojects/wlroots/include/wlr/types/wlr_scene.h" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 24 "../subprojects/wlroots/include/wlr/types/wlr_scene.h" 2
...
# 25 "../subprojects/wlroots/include/wlr/types/wlr_scene.h" 2
...
# 3 "../subprojects/wlroots/types/scene/xdg_shell.c" 2
...
# 4 "../subprojects/wlroots/types/scene/xdg_shell.c" 2
...
static void scene_xdg_surface_handle_tree_destroy(struct wl_listener *listener,
 ...
 struct wlr_scene_xdg_surface *scene_xdg_surface =
  (__typeof__(scene_xdg_surface))((char *)(listener) - __builtin_offsetof(__typeof__(*scene_xdg_surface), tree_destroy));
...
static void scene_xdg_surface_handle_xdg_surface_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_scene_xdg_surface *scene_xdg_surface =
  (__typeof__(scene_xdg_surface))((char *)(listener) - __builtin_offsetof(__typeof__(*scene_xdg_surface), xdg_surface_destroy));
...
static void scene_xdg_surface_handle_xdg_surface_map(struct wl_listener *listener,
  void *data) {
 struct wlr_scene_xdg_surface *scene_xdg_surface =
  (__typeof__(scene_xdg_surface))((char *)(listener) - __builtin_offsetof(__typeof__(*scene_xdg_surface), xdg_surface_map));
 wlr_scene_node_set_enabled(&scene_xdg_surface->tree->node, 1);
}

static void scene_xdg_surface_handle_xdg_surface_unmap(struct wl_listener *listener,
  void *data) {
 struct wlr_scene_xdg_surface *scene_xdg_surface =
  (__typeof__(scene_xdg_surface))((char *)(listener) - __builtin_offsetof(__typeof__(*scene_xdg_surface), xdg_surface_unmap));
 wlr_scene_node_set_enabled(&scene_xdg_surface->tree->node, 0);
}
...
static void scene_xdg_surface_handle_xdg_surface_commit(struct wl_listener *listener,
  void *data) {
 struct wlr_scene_xdg_surface *scene_xdg_surface =
  (__typeof__(scene_xdg_surface))((char *)(listener) - __builtin_offsetof(__typeof__(*scene_xdg_surface), xdg_surface_commit));
...
struct wlr_scene_tree *wlr_scene_xdg_surface_create(
 ...
 if (scene_xdg_surface->tree == ((void*)0)) {
  free(scene_xdg_surface);
  return ((void*)0);
 }
 ...
 if (scene_xdg_surface->surface_tree == ((void*)0)) {
  wlr_scene_node_destroy(&scene_xdg_surface->tree->node);
  free(scene_xdg_surface);
  return ((void*)0);
 }
