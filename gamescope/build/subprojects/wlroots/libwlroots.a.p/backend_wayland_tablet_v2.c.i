# 1 "../subprojects/wlroots/backend/wayland/tablet_v2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 3 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
# 4 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
# 5 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 6 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
# 12 "../subprojects/wlroots/include/wlr/types/wlr_tablet_pad.h"
...
# 13 "../subprojects/wlroots/include/wlr/types/wlr_tablet_pad.h" 2
...
# 14 "../subprojects/wlroots/include/wlr/types/wlr_tablet_pad.h" 2
...
# 7 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
# 8 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
# 9 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
# 11 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
# 12 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
# 14 "../subprojects/wlroots/backend/wayland/tablet_v2.c" 2
...
static void destroy_tablet_pad_group(struct tablet_pad_group *group) {
 ...
 for (ring = (__typeof__(ring))((char *)((&group->rings)->next) - __builtin_offsetof(__typeof__(*ring), link)), tmp_ring = (__typeof__(tmp_ring))((char *)((ring)->link.next) - __builtin_offsetof(__typeof__(*tmp_ring), link)); &ring->link != (&group->rings); ring = tmp_ring, tmp_ring = (__typeof__(tmp_ring))((char *)(ring->link.next) - __builtin_offsetof(__typeof__(*tmp_ring), link))) {
  zwp_tablet_pad_ring_v2_destroy(ring->ring);
  free(ring);
 }

 struct tablet_pad_strip *strip, *tmp_strip;
 for (strip = (__typeof__(strip))((char *)((&group->strips)->next) - __builtin_offsetof(__typeof__(*strip), link)), tmp_strip = (__typeof__(tmp_strip))((char *)((strip)->link.next) - __builtin_offsetof(__typeof__(*tmp_strip), link)); &strip->link != (&group->strips); strip = tmp_strip, tmp_strip = (__typeof__(tmp_strip))((char *)(strip->link.next) - __builtin_offsetof(__typeof__(*tmp_strip), link))) {
...
static void handle_tablet_pad_group(void *data,
 ...
 if (!group) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "failed to allocate tablet_pad_group" ": %s", "backend/wayland/tablet_v2.c", 298, strerror((*__errno_location ())));
...
static void handle_tablet_pad_enter(void *data,
  ...
  struct wl_surface *surface) {
 struct wlr_wl_seat *seat = data;
 ((seat->zwp_tablet_v2 == tablet_p) ? (void) (0) : __assert_fail ("seat->zwp_tablet_v2 == tablet_p", "backend/wayland/tablet_v2.c", 358, __extension__ __PRETTY_FUNCTION__));
...
static void handle_tablet_pad_removed(void *data,
 ...
 for (group = (__typeof__(group))((char *)((&tablet_pad->groups)->next) - __builtin_offsetof(__typeof__(*group), group.link)), it = (__typeof__(it))((char *)((group)->group.link.next) - __builtin_offsetof(__typeof__(*it), group.link)); &group->group.link != (&tablet_pad->groups); group = it, it = (__typeof__(it))((char *)(group->group.link.next) - __builtin_offsetof(__typeof__(*it), group.link))) {
  destroy_tablet_pad_group(group);
 }

 wlr_tablet_pad_finish(tablet_pad);
 zwp_tablet_pad_v2_destroy(seat->zwp_tablet_pad_v2);
 seat->zwp_tablet_pad_v2 = ((void*)0);
}
...
static void handle_pad_added(void *data,
  ...
  struct zwp_tablet_pad_v2 *zwp_tablet_pad_v2) {
 struct wlr_wl_seat *seat = data;
 if (seat->zwp_tablet_pad_v2 != ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "zwp_tablet_pad_v2 is already present", "backend/wayland/tablet_v2.c", 406);
  return;
 }
...
static void handle_tablet_tool_proximity_in(void *data,
 ...
 struct tablet_tool *tool = data;
 ((tablet_id == tool->seat->zwp_tablet_v2) ? (void) (0) : __assert_fail ("tablet_id == tool->seat->zwp_tablet_v2", "backend/wayland/tablet_v2.c", 501, __extension__ __PRETTY_FUNCTION__));
...
static void handle_tablet_tool_motion(void *data, struct zwp_tablet_tool_v2 *id,
 ...
 ((output) ? (void) (0) : __assert_fail ("output", "backend/wayland/tablet_v2.c", 534, __extension__ __PRETTY_FUNCTION__));
...
static void clear_tablet_tool_values(struct tablet_tool *tool) {
 tool->is_out = tool->is_in = 0;
 tool->is_up = tool->is_down = 0;
 tool->x = tool->y = (__builtin_nanf (""));
 tool->pressure = (__builtin_nanf (""));
 tool->distance = (__builtin_nanf (""));
 tool->tilt_x = tool->tilt_y = (__builtin_nanf (""));
 tool->rotation = (__builtin_nanf (""));
 tool->slider = (__builtin_nanf (""));
 tool->wheel_delta = (__builtin_nanf (""));
}
...
static void handle_tablet_tool_removed(void *data,
 ...
 seat->zwp_tablet_tool_v2 = ((void*)0);
...
static void handle_tool_added(void *data,
  ...
  struct zwp_tablet_tool_v2 *zwp_tablet_tool_v2) {
 struct wlr_wl_seat *seat = data;
 if (seat->zwp_tablet_tool_v2 != ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "zwp_tablet_tool_v2 already present", "backend/wayland/tablet_v2.c", 781);
  return;
 }
 ...
 if (tool == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "failed to allocate tablet_tool" ": %s", "backend/wayland/tablet_v2.c", 789, strerror((*__errno_location ())));
...
static void handle_tab_added(void *data,
  ...
  struct zwp_tablet_v2 *zwp_tablet_v2) {
 struct wlr_wl_seat *seat = data;
 if (seat->zwp_tablet_v2 != ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "zwp_tablet_v2 already present", "backend/wayland/tablet_v2.c", 862);
  return;
 }
...
void init_seat_tablet(struct wlr_wl_seat *seat) {
 ...
 ((manager) ? (void) (0) : __assert_fail ("manager", "backend/wayland/tablet_v2.c", 880, __extension__ __PRETTY_FUNCTION__));
# 890 "../subprojects/wlroots/backend/wayland/tablet_v2.c"
 seat->zwp_tablet_seat_v2 =
  zwp_tablet_manager_v2_get_tablet_seat(manager, seat->wl_seat);
 if (seat->zwp_tablet_seat_v2 == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "failed to get zwp_tablet_manager_v2 from seat '%s'", "backend/wayland/tablet_v2.c", 894, seat->name);
...
void finish_seat_tablet(struct wlr_wl_seat *seat) {
 ...
 seat->zwp_tablet_seat_v2 = ((void*)0);
}
