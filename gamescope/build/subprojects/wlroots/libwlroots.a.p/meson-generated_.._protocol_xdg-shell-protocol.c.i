# 1 "subprojects/wlroots/protocol/xdg-shell-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/xdg-shell-protocol.c" 2
# 31 "subprojects/wlroots/protocol/xdg-shell-protocol.c"
...
# 32 "subprojects/wlroots/protocol/xdg-shell-protocol.c" 2
...
# 33 "subprojects/wlroots/protocol/xdg-shell-protocol.c" 2
...
# 34 "subprojects/wlroots/protocol/xdg-shell-protocol.c" 2
# 45 "subprojects/wlroots/protocol/xdg-shell-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface xdg_wm_base_interface = {
 "xdg_wm_base", 6,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface xdg_positioner_interface = {
 "xdg_positioner", 6,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface xdg_surface_interface = {
 "xdg_surface", 6,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface xdg_toplevel_interface = {
 "xdg_toplevel", 6,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface xdg_popup_interface = {
 "xdg_popup", 6,
