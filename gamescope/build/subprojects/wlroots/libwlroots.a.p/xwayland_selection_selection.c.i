# 1 "../subprojects/wlroots/xwayland/selection/selection.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
# 3 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
# 4 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 5 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
# 6 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
void wlr_data_source_dnd_action(struct wlr_data_source *source,
 enum wl_data_device_manager_dnd_action action);
# 7 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
# 8 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
xcb_xfixes_get_client_disconnect_mode_reply (xcb_connection_t *c,
                                             ...
                                             xcb_generic_error_t **e);
# 9 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
# 10 "../subprojects/wlroots/xwayland/selection/selection.c" 2
...
# 11 "../subprojects/wlroots/xwayland/selection/selection.c" 2

void xwm_selection_transfer_remove_event_source(
  struct wlr_xwm_selection_transfer *transfer) {
 if (transfer->event_source != ((void*)0)) {
  wl_event_source_remove(transfer->event_source);
  transfer->event_source = ((void*)0);
 }
}
...
void xwm_selection_transfer_destroy_property_reply(
 ...
 transfer->property_reply = ((void*)0);
}
...
xcb_atom_t xwm_mime_type_to_atom(struct wlr_xwm *xwm, char *mime_type) {
 ...
 xcb_intern_atom_reply_t *reply =
  xcb_intern_atom_reply(xwm->xcb_conn, cookie, ((void*)0));
 if (reply == ((void*)0)) {
...
static int xwm_handle_selection_property_notify(struct wlr_xwm *xwm,
 ...
 for (size_t i = 0; i < sizeof(selections)/sizeof(selections[0]); ++i) {
  ...
  for (outgoing = (__typeof__(outgoing))((char *)((&selection->outgoing)->next) - __builtin_offsetof(__typeof__(*outgoing), link)); &outgoing->link != (&selection->outgoing); outgoing = (__typeof__(outgoing))((char *)(outgoing->link.next) - __builtin_offsetof(__typeof__(*outgoing), link))) {
...
int xwm_handle_selection_event(struct wlr_xwm *xwm,
 ...
 if (xwm->seat == ((void*)0)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "not handling selection events: " "no seat assigned to xwayland", "xwayland/selection/selection.c", 149);
 ...
 *selection = (struct wlr_xwm_selection){
 ...
 if (atom == xwm->atoms[DND_SELECTION]) {
  ...
  if (atom == xwm->atoms[CLIPBOARD]) {
   ...
   ((atom == xwm->atoms[PRIMARY]) ? (void) (0) : __assert_fail ("atom == xwm->atoms[PRIMARY]", "xwayland/selection/selection.c", 234, __extension__ __PRETTY_FUNCTION__));
  }
 }
...
void xwm_selection_finish(struct wlr_xwm_selection *selection) {
 ...
 for (outgoing = (__typeof__(outgoing))((char *)((&selection->outgoing)->next) - __builtin_offsetof(__typeof__(*outgoing), link)), tmp = (__typeof__(tmp))((char *)((outgoing)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &outgoing->link != (&selection->outgoing); outgoing = tmp, tmp = (__typeof__(tmp))((char *)(outgoing->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  _wlr_log(WLR_INFO, "[%s:%d] " "destroyed pending transfer %p", "xwayland/selection/selection.c", 253, outgoing);
  xwm_selection_transfer_destroy_outgoing(outgoing);
 }

 struct wlr_xwm_selection_transfer *incoming;
 for (incoming = (__typeof__(incoming))((char *)((&selection->incoming)->next) - __builtin_offsetof(__typeof__(*incoming), link)), tmp = (__typeof__(tmp))((char *)((incoming)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &incoming->link != (&selection->incoming); incoming = tmp, tmp = (__typeof__(tmp))((char *)(incoming->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
...
static void handle_seat_set_selection(struct wl_listener *listener,
 ...
 struct wlr_xwm *xwm =
  (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), seat_set_selection));
 struct wlr_data_source *source = seat->selection_source;

 if (source != ((void*)0) && data_source_is_xwayland(source)) {
  return;
 }

 xwm_selection_set_owner(&xwm->clipboard_selection, source != ((void*)0));
}
...
static void handle_seat_set_primary_selection(struct wl_listener *listener,
 ...
 struct wlr_seat *seat = data;
 struct wlr_xwm *xwm =
  (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), seat_set_primary_selection));
 struct wlr_primary_selection_source *source =
  seat->primary_selection_source;

 if (source != ((void*)0) && primary_selection_source_is_xwayland(source)) {
  return;
 }

 xwm_selection_set_owner(&xwm->primary_selection, source != ((void*)0));
}

static void seat_handle_start_drag(struct wl_listener *listener, void *data) {
 struct wlr_xwm *xwm = (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), seat_start_drag));
 struct wlr_drag *drag = data;

 xwm_selection_set_owner(&xwm->dnd_selection, drag != ((void*)0));
