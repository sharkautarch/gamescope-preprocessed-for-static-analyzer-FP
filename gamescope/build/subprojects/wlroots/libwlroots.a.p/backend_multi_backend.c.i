# 1 "../subprojects/wlroots/backend/multi/backend.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/backend/multi/backend.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/backend/multi/backend.c" 2
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 3 "../subprojects/wlroots/backend/multi/backend.c" 2
...
# 4 "../subprojects/wlroots/backend/multi/backend.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 5 "../subprojects/wlroots/backend/multi/backend.c" 2
...
# 6 "../subprojects/wlroots/backend/multi/backend.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_buffer.h" 1
# 7 "../subprojects/wlroots/backend/multi/backend.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_output.h" 1
# 8 "../subprojects/wlroots/backend/multi/backend.c" 2
...
# 9 "../subprojects/wlroots/backend/multi/backend.c" 2
...
# 10 "../subprojects/wlroots/backend/multi/backend.c" 2
...
# 11 "../subprojects/wlroots/backend/multi/backend.c" 2
...
static struct wlr_multi_backend *multi_backend_from_backend(
 ...
 ((wlr_backend_is_multi(wlr_backend)) ? (void) (0) : __assert_fail ("wlr_backend_is_multi(wlr_backend)", "backend/multi/backend.c", 23, __extension__ __PRETTY_FUNCTION__));
 struct wlr_multi_backend *backend = (__typeof__(backend))((char *)(wlr_backend) - __builtin_offsetof(__typeof__(*backend), backend));
 return backend;
}

static _Bool multi_backend_start(struct wlr_backend *wlr_backend) {
 struct wlr_multi_backend *backend = multi_backend_from_backend(wlr_backend);
 struct subbackend_state *sub;
 for (sub = (__typeof__(sub))((char *)((&backend->backends)->next) - __builtin_offsetof(__typeof__(*sub), link)); &sub->link != (&backend->backends); sub = (__typeof__(sub))((char *)(sub->link.next) - __builtin_offsetof(__typeof__(*sub), link))) {
  if (!wlr_backend_start(sub->backend)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to initialize backend.", "backend/multi/backend.c", 33);
   return 0;
  }
 }
 return 1;
...
static void multi_backend_destroy(struct wlr_backend *wlr_backend) {
 ...
 while (!wl_list_empty(&backend->backends)) {
  struct subbackend_state *sub =
   (__typeof__(sub))((char *)(backend->backends.next) - __builtin_offsetof(__typeof__(*sub), link));
...
static int multi_backend_get_drm_fd(struct wlr_backend *backend) {
 ...
 struct subbackend_state *sub;
 for (sub = (__typeof__(sub))((char *)((&multi->backends)->next) - __builtin_offsetof(__typeof__(*sub), link)); &sub->link != (&multi->backends); sub = (__typeof__(sub))((char *)(sub->link.next) - __builtin_offsetof(__typeof__(*sub), link))) {
...
static _Bool multi_backend_test(struct wlr_backend *backend,
  const struct wlr_backend_output_state *states, size_t states_len) {
 return commit(backend, states, states_len, 1);
}

static _Bool multi_backend_commit(struct wlr_backend *backend,
  const struct wlr_backend_output_state *states, size_t states_len) {
 return commit(backend, states, states_len, 0);
}
...
static void handle_event_loop_destroy(struct wl_listener *listener, void *data) {
 struct wlr_multi_backend *backend =
  (__typeof__(backend))((char *)(listener) - __builtin_offsetof(__typeof__(*backend), event_loop_destroy));
...
struct wlr_backend *wlr_multi_backend_create(struct wl_event_loop *loop) {
 ...
 if (!backend) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Backend allocation failed", "backend/multi/backend.c", 179);
  return ((void*)0);
 }
...
_Bool wlr_backend_is_multi(struct wlr_backend *b) {
 return b->impl == &backend_impl;
}

static void new_input_reemit(struct wl_listener *listener, void *data) {
 struct subbackend_state *state = (__typeof__(state))((char *)(listener) - __builtin_offsetof(__typeof__(*state), new_input));
...
static void new_output_reemit(struct wl_listener *listener, void *data) {
 struct subbackend_state *state = (__typeof__(state))((char *)(listener) - __builtin_offsetof(__typeof__(*state), new_output));
...
static void handle_subbackend_destroy(struct wl_listener *listener,
  void *data) {
 struct subbackend_state *state = (__typeof__(state))((char *)(listener) - __builtin_offsetof(__typeof__(*state), destroy));
 subbackend_state_destroy(state);
}

static struct subbackend_state *multi_backend_get_subbackend(struct wlr_multi_backend *multi,
  struct wlr_backend *backend) {
 struct subbackend_state *sub = ((void*)0);
 for (sub = (__typeof__(sub))((char *)((&multi->backends)->next) - __builtin_offsetof(__typeof__(*sub), link)); &sub->link != (&multi->backends); sub = (__typeof__(sub))((char *)(sub->link.next) - __builtin_offsetof(__typeof__(*sub), link))) {
...
_Bool wlr_multi_backend_add(struct wlr_backend *_multi,
  struct wlr_backend *backend) {
 ((_multi && backend) ? (void) (0) : __assert_fail ("_multi && backend", "backend/multi/backend.c", 230, __extension__ __PRETTY_FUNCTION__));
 ((_multi != backend) ? (void) (0) : __assert_fail ("_multi != backend", "backend/multi/backend.c", 231, __extension__ __PRETTY_FUNCTION__));
 ...
 if (sub == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Could not add backend: allocation failed", "backend/multi/backend.c", 242);
  return 0;
 }
...
_Bool wlr_multi_is_empty(struct wlr_backend *_backend) {
 ((wlr_backend_is_multi(_backend)) ? (void) (0) : __assert_fail ("wlr_backend_is_multi(_backend)", "backend/multi/backend.c", 277, __extension__ __PRETTY_FUNCTION__));
...
void wlr_multi_for_each_backend(struct wlr_backend *_backend,
  void (*callback)(struct wlr_backend *backend, void *data), void *data) {
 ((wlr_backend_is_multi(_backend)) ? (void) (0) : __assert_fail ("wlr_backend_is_multi(_backend)", "backend/multi/backend.c", 284, __extension__ __PRETTY_FUNCTION__));
 struct wlr_multi_backend *backend = (struct wlr_multi_backend *)_backend;
 struct subbackend_state *sub;
 for (sub = (__typeof__(sub))((char *)((&backend->backends)->next) - __builtin_offsetof(__typeof__(*sub), link)); &sub->link != (&backend->backends); sub = (__typeof__(sub))((char *)(sub->link.next) - __builtin_offsetof(__typeof__(*sub), link))) {
