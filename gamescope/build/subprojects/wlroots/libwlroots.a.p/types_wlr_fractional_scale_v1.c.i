# 1 "../subprojects/wlroots/types/wlr_fractional_scale_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_fractional_scale_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_fractional_scale_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_fractional_scale_v1.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 4 "../subprojects/wlroots/types/wlr_fractional_scale_v1.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_fractional_scale_v1.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_fractional_scale_v1.c" 2

# 1 "subprojects/wlroots/protocol/fractional-scale-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/fractional-scale-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 70 "subprojects/wlroots/protocol/fractional-scale-v1-protocol.h"
struct wl_surface;
struct wp_fractional_scale_manager_v1;
struct wp_fractional_scale_v1;
# 89 "subprojects/wlroots/protocol/fractional-scale-v1-protocol.h"
extern const struct wl_interface wp_fractional_scale_manager_v1_interface;
# 108 "subprojects/wlroots/protocol/fractional-scale-v1-protocol.h"
...
struct wp_fractional_scale_manager_v1_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 145 "subprojects/wlroots/protocol/fractional-scale-v1-protocol.h"
 void (*get_fractional_scale)(struct wl_client *client,
         struct wl_resource *resource,
         uint32_t id,
         struct wl_resource *surface);
};
# 165 "subprojects/wlroots/protocol/fractional-scale-v1-protocol.h"
...
# 194 "subprojects/wlroots/protocol/fractional-scale-v1-protocol.h"
static inline void
wp_fractional_scale_v1_send_preferred_scale(struct wl_resource *resource_, uint32_t scale)
{
 wl_resource_post_event(resource_, 0, scale);
}
# 8 "../subprojects/wlroots/types/wlr_fractional_scale_v1.c" 2
...
static struct wlr_fractional_scale_v1 *fractional_scale_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wp_fractional_scale_v1_interface, &fractional_scale_interface)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wp_fractional_scale_v1_interface, &fractional_scale_interface)", "types/wlr_fractional_scale_v1.c", 24, __extension__ __PRETTY_FUNCTION__));
...
static void fractional_scale_destroy(struct wlr_fractional_scale_v1 *info) {
 ...
 if (info->resource != ((void*)0)) {
  wl_resource_set_user_data(info->resource, ((void*)0));
 }
...
static void fractional_scale_addon_destroy(struct wlr_addon *addon) {
 struct wlr_fractional_scale_v1 *info = (__typeof__(info))((char *)(addon) - __builtin_offsetof(__typeof__(*info), addon));
 fractional_scale_destroy(info);
}
...
void wlr_fractional_scale_v1_notify_scale(struct wlr_surface *surface, double scale) {
 struct wlr_addon *addon = wlr_addon_find(&surface->addons,
  ((void*)0), &fractional_scale_addon_impl);
 ...
 if (addon == ((void*)0)) {
  ...
  wlr_addon_init(&info->addon, &surface->addons, ((void*)0), &fractional_scale_addon_impl);
  info->scale = scale;
  return;
 }
...
static void handle_get_fractional_scale(struct wl_client *client,
 ...
 struct wlr_fractional_scale_v1 *info = ((void*)0);




 struct wlr_addon *addon = wlr_addon_find(&surface->addons, ((void*)0), &fractional_scale_addon_impl);

 if (addon != ((void*)0)) {
  info = (__typeof__(info))((char *)(addon) - __builtin_offsetof(__typeof__(*info), addon));
  if (info->resource != ((void*)0)) {
...
static void fractional_scale_manager_bind(struct wl_client *client, void *data,
 ...
 wl_resource_set_implementation(resource, &scale_manager_interface, mgr, ((void*)0));
}

static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_fractional_scale_manager_v1 *mgr =
  (__typeof__(mgr))((char *)(listener) - __builtin_offsetof(__typeof__(*mgr), display_destroy));
 wl_signal_emit_mutable(&mgr->events.destroy, ((void*)0));
 ((wl_list_empty(&mgr->events.destroy.listener_list)) ? (void) (0) : __assert_fail ("wl_list_empty(&mgr->events.destroy.listener_list)", "types/wlr_fractional_scale_v1.c", 176, __extension__ __PRETTY_FUNCTION__));
...
struct wlr_fractional_scale_manager_v1 *wlr_fractional_scale_manager_v1_create(
  struct wl_display *display, uint32_t version) {
 ((version <= 1) ? (void) (0) : __assert_fail ("version <= FRACTIONAL_SCALE_VERSION", "types/wlr_fractional_scale_v1.c", 183, __extension__ __PRETTY_FUNCTION__));
