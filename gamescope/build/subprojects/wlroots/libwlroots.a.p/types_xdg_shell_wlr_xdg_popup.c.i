# 1 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_popup.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_popup.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_popup.c" 2
...
# 3 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_popup.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_popup.c" 2
...
# 5 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_popup.c" 2
 ...
 *configure = popup->scheduled;
 ...
 ((geometry->width > 0 && geometry->height > 0) ? (void) (0) : __assert_fail ("geometry->width > 0 && geometry->height > 0", "types/xdg_shell/wlr_xdg_popup.c", 31, __extension__ __PRETTY_FUNCTION__));
...
static void xdg_popup_grab_end(struct wlr_xdg_popup_grab *popup_grab) {
 ...
 for (popup = (__typeof__(popup))((char *)((&popup_grab->popups)->next) - __builtin_offsetof(__typeof__(*popup), grab_link)), tmp = (__typeof__(tmp))((char *)((popup)->grab_link.next) - __builtin_offsetof(__typeof__(*tmp), grab_link)); &popup->grab_link != (&popup_grab->popups); popup = tmp, tmp = (__typeof__(tmp))((char *)(popup->grab_link.next) - __builtin_offsetof(__typeof__(*tmp), grab_link))) {
...
static void destroy_xdg_popup_grab(struct wlr_xdg_popup_grab *xdg_grab) {
 ...
 struct wlr_xdg_popup *popup, *tmp;
 for (popup = (__typeof__(popup))((char *)((&xdg_grab->popups)->next) - __builtin_offsetof(__typeof__(*popup), grab_link)), tmp = (__typeof__(tmp))((char *)((popup)->grab_link.next) - __builtin_offsetof(__typeof__(*tmp), grab_link)); &popup->grab_link != (&xdg_grab->popups); popup = tmp, tmp = (__typeof__(tmp))((char *)(popup->grab_link.next) - __builtin_offsetof(__typeof__(*tmp), grab_link))) {
...
static void xdg_popup_grab_handle_seat_destroy(
 ...
 struct wlr_xdg_popup_grab *xdg_grab =
  (__typeof__(xdg_grab))((char *)(listener) - __builtin_offsetof(__typeof__(*xdg_grab), seat_destroy));
...
static struct wlr_xdg_popup_grab *get_xdg_shell_popup_grab_from_seat(
 ...
 struct wlr_xdg_popup_grab *xdg_grab;
 for (xdg_grab = (__typeof__(xdg_grab))((char *)((&shell->popup_grabs)->next) - __builtin_offsetof(__typeof__(*xdg_grab), link)); &xdg_grab->link != (&shell->popup_grabs); xdg_grab = (__typeof__(xdg_grab))((char *)(xdg_grab->link.next) - __builtin_offsetof(__typeof__(*xdg_grab), link))) {
...
struct wlr_xdg_popup *wlr_xdg_popup_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &xdg_popup_interface, &xdg_popup_implementation)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &xdg_popup_interface, &xdg_popup_implementation)", "types/xdg_shell/wlr_xdg_popup.c", 254, __extension__ __PRETTY_FUNCTION__));
...
struct wlr_xdg_popup *wlr_xdg_popup_try_from_wlr_surface(struct wlr_surface *surface) {
 ...
 if (xdg_surface == ((void*)0) || xdg_surface->role != WLR_XDG_SURFACE_ROLE_POPUP) {
  return ((void*)0);
 }
...
static void xdg_popup_handle_reposition(
 ...
 wl_signal_emit_mutable(&popup->events.reposition, ((void*)0));
}
...
void create_xdg_popup(struct wlr_xdg_surface *surface,
 ...
 if (parent != ((void*)0) && parent->role == WLR_XDG_SURFACE_ROLE_NONE) {
  wl_resource_post_error(surface->client->resource, XDG_WM_BASE_ERROR_INVALID_POPUP_PARENT,
   "a popup parent must have a role");
  return;
 }

 ((surface->popup == ((void*)0)) ? (void) (0) : __assert_fail ("surface->popup == NULL", "types/xdg_shell/wlr_xdg_popup.c", 389, __extension__ __PRETTY_FUNCTION__));
 ...
 if (surface->popup->resource == ((void*)0)) {
  goto error_synced;
 }
...
error_popup:
 free(surface->popup);
 surface->popup = ((void*)0);
 wl_resource_post_no_memory(surface->resource);
}

void reset_xdg_popup(struct wlr_xdg_popup *popup) {
 if (popup->seat != ((void*)0)) {
...
void destroy_xdg_popup(struct wlr_xdg_popup *popup) {
 ...
 wl_signal_emit_mutable(&popup->events.destroy, ((void*)0));

 wlr_surface_synced_finish(&popup->synced);
 popup->base->popup = ((void*)0);
 wl_list_remove(&popup->link);
 wl_resource_set_user_data(popup->resource, ((void*)0));
 free(popup);
}
...
void wlr_xdg_popup_destroy(struct wlr_xdg_popup *popup) {
 ...
 for (child = (__typeof__(child))((char *)((&popup->base->popups)->next) - __builtin_offsetof(__typeof__(*child), link)), child_tmp = (__typeof__(child_tmp))((char *)((child)->link.next) - __builtin_offsetof(__typeof__(*child_tmp), link)); &child->link != (&popup->base->popups); child = child_tmp, child_tmp = (__typeof__(child_tmp))((char *)(child->link.next) - __builtin_offsetof(__typeof__(*child_tmp), link))) {
...
void wlr_xdg_popup_get_toplevel_coords(struct wlr_xdg_popup *popup,
 ...
 while ((xdg_surface = wlr_xdg_surface_try_from_wlr_surface(parent))) {
  if (xdg_surface->role == WLR_XDG_SURFACE_ROLE_POPUP && xdg_surface->popup != ((void*)0)) {
 ...
 ((parent) ? (void) (0) : __assert_fail ("parent", "types/xdg_shell/wlr_xdg_popup.c", 512, __extension__ __PRETTY_FUNCTION__));
