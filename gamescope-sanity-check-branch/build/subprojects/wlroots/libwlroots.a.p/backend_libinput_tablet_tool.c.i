# 1 "../subprojects/wlroots/backend/libinput/tablet_tool.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/backend/libinput/tablet_tool.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 2 "../subprojects/wlroots/backend/libinput/tablet_tool.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 3 "../subprojects/wlroots/backend/libinput/tablet_tool.c" 2
...
# 4 "../subprojects/wlroots/backend/libinput/tablet_tool.c" 2
# 1 "/usr/include/linux/input.h" 1 3 4
# 13 "/usr/include/linux/input.h" 3 4
...
# 15 "/usr/include/linux/input.h" 2 3 4
...
# 17 "/usr/include/linux/input.h" 2 3 4

# 1 "/usr/include/linux/input-event-codes.h" 1 3 4
# 19 "/usr/include/linux/input.h" 2 3 4
...
struct input_event {
 ...
 struct timeval time;
# 42 "/usr/include/linux/input.h" 3 4
 __u16 type;
 __u16 code;
 __s32 value;
};
# 57 "/usr/include/linux/input.h" 3 4
struct input_id {
 __u16 bustype;
 __u16 vendor;
 __u16 product;
...
# 91 "/usr/include/linux/input.h" 3 4
...
# 115 "/usr/include/linux/input.h" 3 4
...
# 308 "/usr/include/linux/input.h" 3 4
struct ff_replay {
 __u16 length;
 __u16 delay;
};
...
# 335 "/usr/include/linux/input.h" 3 4
struct ff_envelope {
 __u16 attack_length;
 __u16 attack_level;
 __u16 fade_length;
...
# 374 "/usr/include/linux/input.h" 3 4
...
# 403 "/usr/include/linux/input.h" 3 4
...
# 424 "/usr/include/linux/input.h" 3 4
struct ff_rumble_effect {
 __u16 strong_magnitude;
 __u16 weak_magnitude;
};
# 452 "/usr/include/linux/input.h" 3 4
struct ff_effect {
 __u16 type;
 __s16 id;
 __u16 direction;
...
# 5 "../subprojects/wlroots/backend/libinput/tablet_tool.c" 2
...
# 13 "../subprojects/wlroots/include/wlr/types/wlr_tablet_tool.h"
...
# 14 "../subprojects/wlroots/include/wlr/types/wlr_tablet_tool.h" 2
...
# 7 "../subprojects/wlroots/backend/libinput/tablet_tool.c" 2
...
# 8 "../subprojects/wlroots/backend/libinput/tablet_tool.c" 2
...
void handle_tablet_pad_strip(struct libinput_event *event,
 struct wlr_tablet_pad *tablet_pad);
# 9 "../subprojects/wlroots/backend/libinput/tablet_tool.c" 2
...
static void tool_destroy(struct tablet_tool *tool) {
 ...
 libinput_tablet_tool_set_user_data(tool->handle, ((void*)0));
...
void finish_device_tablet(struct wlr_libinput_input_device *dev) {
 ...
 for (tool = (__typeof__(tool))((char *)((&dev->tablet_tools)->next) - __builtin_offsetof(__typeof__(*tool), link)), tmp = (__typeof__(tmp))((char *)((tool)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &tool->link != (&dev->tablet_tools); tool = tmp, tmp = (__typeof__(tmp))((char *)(tool->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  tool_destroy(tool);
 }
...
struct wlr_libinput_input_device *device_from_tablet(
 ...
 ((wlr_tablet->impl == &libinput_tablet_impl) ? (void) (0) : __assert_fail ("wlr_tablet->impl == &libinput_tablet_impl", "backend/libinput/tablet_tool.c", 62, __extension__ __PRETTY_FUNCTION__));

 struct wlr_libinput_input_device *dev =
  (__typeof__(dev))((char *)(wlr_tablet) - __builtin_offsetof(__typeof__(*dev), tablet));
 return dev;
}
...
static struct tablet_tool *get_tablet_tool(
 ...
 if (tool == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "failed to allocate wlr_libinput_tablet_tool" ": %s", "backend/libinput/tablet_tool.c", 103, strerror((*__errno_location ())));
  return ((void*)0);
 }
