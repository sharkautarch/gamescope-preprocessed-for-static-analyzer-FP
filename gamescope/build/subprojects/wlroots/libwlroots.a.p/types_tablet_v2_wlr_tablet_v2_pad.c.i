# 1 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c" 2
...
# 3 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c" 2
...
# 7 "subprojects/wlroots/protocol/tablet-unstable-v2-protocol.h" 2
...
struct wlr_tablet_seat_v2 *get_or_create_tablet_seat(
 struct wlr_tablet_manager_v2 *manager,
 struct wlr_seat *wlr_seat);
# 4 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 6 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c" 2
...
struct wlr_tablet *wlr_tablet_from_input_device(
 struct wlr_input_device *input_device);
# 7 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c" 2
...
struct wlr_tablet_pad *wlr_tablet_pad_from_input_device(
 struct wlr_input_device *);
# 8 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_tablet_v2.h" 1
# 9 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c" 2
...
# 10 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_pad.c" 2
...
static void destroy_tablet_pad_ring_v2(struct wl_resource *resource) {
 ...
 aux->pad->rings[aux->index] = ((void*)0);
 free(aux);
...
static void destroy_tablet_pad_strip_v2(struct wl_resource *resource) {
 ...
 aux->pad->strips[aux->index] = ((void*)0);
 free(aux);
 wl_resource_set_user_data(resource, ((void*)0));
}
...
static void destroy_tablet_pad_group_v2(struct wl_resource *resource) {
 ...
 aux->pad->groups[aux->index] = ((void*)0);
 free(aux);
 wl_resource_set_user_data(resource, ((void*)0));
}
...
void add_tablet_pad_client(struct wlr_tablet_seat_client_v2 *seat,
 ...
 const char **path_ptr;
 for (path_ptr = (&pad->wlr_pad->paths)->data; (const char *) path_ptr < ((const char *) (&pad->wlr_pad->paths)->data + (&pad->wlr_pad->paths)->size); (path_ptr)++) {
 ...
 for (group = (__typeof__(group))((char *)((&pad->wlr_pad->groups)->next) - __builtin_offsetof(__typeof__(*group), link)); &group->link != (&pad->wlr_pad->groups); group = (__typeof__(group))((char *)(group->link.next) - __builtin_offsetof(__typeof__(*group), link))) {
...
static void handle_wlr_tablet_pad_destroy(struct wl_listener *listener, void *data) {
 struct wlr_tablet_v2_tablet_pad *pad =
  (__typeof__(pad))((char *)(listener) - __builtin_offsetof(__typeof__(*pad), pad_destroy));

 struct wlr_tablet_pad_client_v2 *client;
 struct wlr_tablet_pad_client_v2 *tmp_client;
 for (client = (__typeof__(client))((char *)((&pad->clients)->next) - __builtin_offsetof(__typeof__(*client), pad_link)), tmp_client = (__typeof__(tmp_client))((char *)((client)->pad_link.next) - __builtin_offsetof(__typeof__(*tmp_client), pad_link)); &client->pad_link != (&pad->clients); client = tmp_client, tmp_client = (__typeof__(tmp_client))((char *)(client->pad_link.next) - __builtin_offsetof(__typeof__(*tmp_client), pad_link))) {
...
struct wlr_tablet_v2_tablet_pad *wlr_tablet_pad_create(
  ...
  struct wlr_seat *wlr_seat,
  struct wlr_input_device *wlr_device) {
 ((wlr_device->type == WLR_INPUT_DEVICE_TABLET_PAD) ? (void) (0) : __assert_fail ("wlr_device->type == WLR_INPUT_DEVICE_TABLET_PAD", "types/tablet_v2/wlr_tablet_v2_pad.c", 365, __extension__ __PRETTY_FUNCTION__));
 ...
 for (pos = (__typeof__(pos))((char *)((&seat->clients)->next) - __builtin_offsetof(__typeof__(*pos), seat_link)); &pos->seat_link != (&seat->clients); pos = (__typeof__(pos))((char *)(pos->seat_link.next) - __builtin_offsetof(__typeof__(*pos), seat_link))) {
...
struct wlr_tablet_pad_client_v2 *tablet_pad_client_from_resource(struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwp_tablet_pad_v2_interface, &tablet_pad_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwp_tablet_pad_v2_interface, &tablet_pad_impl)", "types/tablet_v2/wlr_tablet_v2_pad.c", 409, __extension__ __PRETTY_FUNCTION__));
...
uint32_t wlr_send_tablet_v2_tablet_pad_enter(
 ...
 struct wlr_tablet_client_v2 *tablet_client = ((void*)0);
 for (tablet_tmp = (__typeof__(tablet_tmp))((char *)((&tablet->clients)->next) - __builtin_offsetof(__typeof__(*tablet_tmp), tablet_link)); &tablet_tmp->tablet_link != (&tablet->clients); tablet_tmp = (__typeof__(tablet_tmp))((char *)(tablet_tmp->tablet_link.next) - __builtin_offsetof(__typeof__(*tablet_tmp), tablet_link))) {
 ...
 struct wlr_tablet_pad_client_v2 *pad_tmp = ((void*)0);
 struct wlr_tablet_pad_client_v2 *pad_client = ((void*)0);
 for (pad_tmp = (__typeof__(pad_tmp))((char *)((&pad->clients)->next) - __builtin_offsetof(__typeof__(*pad_tmp), pad_link)); &pad_tmp->pad_link != (&pad->clients); pad_tmp = (__typeof__(pad_tmp))((char *)(pad_tmp->pad_link.next) - __builtin_offsetof(__typeof__(*pad_tmp), pad_link))) {
