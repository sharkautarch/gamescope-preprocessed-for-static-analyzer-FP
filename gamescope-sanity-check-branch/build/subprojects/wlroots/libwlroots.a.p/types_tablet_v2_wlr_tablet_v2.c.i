# 1 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
...
# 3 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
...
# 5 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
...
# 9 "subprojects/wlroots/protocol/tablet-unstable-v2-protocol.h" 2
...
struct wlr_tablet_seat_v2 *get_or_create_tablet_seat(
 struct wlr_tablet_manager_v2 *manager,
 struct wlr_seat *wlr_seat);
# 6 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
# 1 "subprojects/wlroots/include/wlr/config.h" 1
# 7 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_seat.h" 1
# 8 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
...
struct wlr_tablet *wlr_tablet_from_input_device(
 struct wlr_input_device *input_device);
# 9 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_tablet_v2.h" 1
# 10 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
...
# 11 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2.c" 2
...
static void tablet_seat_destroy(struct wlr_tablet_seat_v2 *seat) {
 ...
 for (client = (__typeof__(client))((char *)((&seat->clients)->next) - __builtin_offsetof(__typeof__(*client), seat_link)), client_tmp = (__typeof__(client_tmp))((char *)((client)->seat_link.next) - __builtin_offsetof(__typeof__(*client_tmp), seat_link)); &client->seat_link != (&seat->clients); client = client_tmp, client_tmp = (__typeof__(client_tmp))((char *)(client->seat_link.next) - __builtin_offsetof(__typeof__(*client_tmp), seat_link))) {
...
static void handle_wlr_seat_destroy(struct wl_listener *listener, void *data) {
 struct wlr_tablet_seat_v2 *seat =
  (__typeof__(seat))((char *)(listener) - __builtin_offsetof(__typeof__(*seat), seat_destroy));
...
struct wlr_tablet_seat_v2 *get_or_create_tablet_seat(
 ...
 for (pos = (__typeof__(pos))((char *)((&manager->seats)->next) - __builtin_offsetof(__typeof__(*pos), link)); &pos->link != (&manager->seats); pos = (__typeof__(pos))((char *)(pos->link.next) - __builtin_offsetof(__typeof__(*pos), link))) {
...
struct wlr_tablet_seat_client_v2 *tablet_seat_client_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwp_tablet_seat_v2_interface, &seat_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwp_tablet_seat_v2_interface, &seat_impl)", "types/tablet_v2/wlr_tablet_v2.c", 90, __extension__ __PRETTY_FUNCTION__));
...
void tablet_seat_client_v2_destroy(struct wl_resource *resource) {
 ...
 for (tablet = (__typeof__(tablet))((char *)((&seat->tablets)->next) - __builtin_offsetof(__typeof__(*tablet), seat_link)), tmp_tablet = (__typeof__(tmp_tablet))((char *)((tablet)->seat_link.next) - __builtin_offsetof(__typeof__(*tmp_tablet), seat_link)); &tablet->seat_link != (&seat->tablets); tablet = tmp_tablet, tmp_tablet = (__typeof__(tmp_tablet))((char *)(tablet->seat_link.next) - __builtin_offsetof(__typeof__(*tmp_tablet), seat_link))) {
  destroy_tablet_v2(tablet->resource);
 }

 struct wlr_tablet_pad_client_v2 *pad;
 struct wlr_tablet_pad_client_v2 *tmp_pad;
 for (pad = (__typeof__(pad))((char *)((&seat->pads)->next) - __builtin_offsetof(__typeof__(*pad), seat_link)), tmp_pad = (__typeof__(tmp_pad))((char *)((pad)->seat_link.next) - __builtin_offsetof(__typeof__(*tmp_pad), seat_link)); &pad->seat_link != (&seat->pads); pad = tmp_pad, tmp_pad = (__typeof__(tmp_pad))((char *)(pad->seat_link.next) - __builtin_offsetof(__typeof__(*tmp_pad), seat_link))) {
  destroy_tablet_pad_v2(pad->resource);
 }

 struct wlr_tablet_tool_client_v2 *tool;
 struct wlr_tablet_tool_client_v2 *tmp_tool;
 for (tool = (__typeof__(tool))((char *)((&seat->tools)->next) - __builtin_offsetof(__typeof__(*tool), seat_link)), tmp_tool = (__typeof__(tmp_tool))((char *)((tool)->seat_link.next) - __builtin_offsetof(__typeof__(*tmp_tool), seat_link)); &tool->seat_link != (&seat->tools); tool = tmp_tool, tmp_tool = (__typeof__(tmp_tool))((char *)(tool->seat_link.next) - __builtin_offsetof(__typeof__(*tmp_tool), seat_link))) {
...
static void handle_seat_client_destroy(struct wl_listener *listener, void *data) {
 struct wlr_tablet_seat_client_v2 *seat =
  (__typeof__(seat))((char *)(listener) - __builtin_offsetof(__typeof__(*seat), seat_client_destroy));
...
static void get_tablet_seat(struct wl_client *wl_client, struct wl_resource *resource,
 ...
 if (!manager) {
  ...
  wl_resource_set_implementation(seat_resource, &seat_impl, ((void*)0),
   tablet_seat_client_v2_destroy);
  return;
 }
 struct wl_resource *tablet_seat_resource = wl_resource_create(wl_client,
  &zwp_tablet_seat_v2_interface, 1, id);
 if (tablet_seat_resource == ((void*)0)) {
  wl_client_post_no_memory(wl_client);
  return;
 }
 wl_resource_set_implementation(tablet_seat_resource, &seat_impl, ((void*)0),
  tablet_seat_client_v2_destroy);
 ...
 for (tablet_pos = (__typeof__(tablet_pos))((char *)((&tablet_seat->tablets)->next) - __builtin_offsetof(__typeof__(*tablet_pos), link)); &tablet_pos->link != (&tablet_seat->tablets); tablet_pos = (__typeof__(tablet_pos))((char *)(tablet_pos->link.next) - __builtin_offsetof(__typeof__(*tablet_pos), link))) {
  add_tablet_client(seat_client, tablet_pos);
 }

 struct wlr_tablet_v2_tablet_pad *pad_pos;
 for (pad_pos = (__typeof__(pad_pos))((char *)((&tablet_seat->pads)->next) - __builtin_offsetof(__typeof__(*pad_pos), link)); &pad_pos->link != (&tablet_seat->pads); pad_pos = (__typeof__(pad_pos))((char *)(pad_pos->link.next) - __builtin_offsetof(__typeof__(*pad_pos), link))) {
  add_tablet_pad_client(seat_client, pad_pos);
 }

 struct wlr_tablet_v2_tablet_tool *tool_pos;
 for (tool_pos = (__typeof__(tool_pos))((char *)((&tablet_seat->tools)->next) - __builtin_offsetof(__typeof__(*tool_pos), link)); &tool_pos->link != (&tablet_seat->tools); tool_pos = (__typeof__(tool_pos))((char *)(tool_pos->link.next) - __builtin_offsetof(__typeof__(*tool_pos), link))) {
...
static struct wlr_tablet_manager_client_v2 *tablet_manager_client_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwp_tablet_manager_v2_interface, &manager_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwp_tablet_manager_v2_interface, &manager_impl)", "types/tablet_v2/wlr_tablet_v2.c", 219, __extension__ __PRETTY_FUNCTION__));
...
static void wlr_tablet_manager_v2_destroy(struct wl_resource *resource) {
 ...
 for (pos = (__typeof__(pos))((char *)((&client->tablet_seats)->next) - __builtin_offsetof(__typeof__(*pos), client_link)), tmp = (__typeof__(tmp))((char *)((pos)->client_link.next) - __builtin_offsetof(__typeof__(*tmp), client_link)); &pos->client_link != (&client->tablet_seats); pos = tmp, tmp = (__typeof__(tmp))((char *)(pos->client_link.next) - __builtin_offsetof(__typeof__(*tmp), client_link))) {
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 ...
 for (seat = (__typeof__(seat))((char *)((&manager->seats)->next) - __builtin_offsetof(__typeof__(*seat), link)), tmp = (__typeof__(tmp))((char *)((seat)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &seat->link != (&manager->seats); seat = tmp, tmp = (__typeof__(tmp))((char *)(seat->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  tablet_seat_destroy(seat);
 }
