# 1 "../subprojects/wlroots/types/seat/wlr_seat.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
# 3 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 5 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
# 6 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
void wlr_data_source_dnd_action(struct wlr_data_source *source,
 enum wl_data_device_manager_dnd_action action);
# 7 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
void wlr_seat_set_primary_selection(struct wlr_seat *seat,
 struct wlr_primary_selection_source *source, uint32_t serial);
# 8 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_seat.h" 1
# 9 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 10 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
# 11 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
# 1 "../subprojects/wlroots/include/types/wlr_seat.h" 1




# 1 "../subprojects/wlroots/include/wlr/types/wlr_seat.h" 1
# 6 "../subprojects/wlroots/include/types/wlr_seat.h" 2
...
# 12 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
# 13 "../subprojects/wlroots/types/seat/wlr_seat.c" 2
...
static void seat_client_destroy(struct wlr_seat_client *client) {
 ...
 if (client == client->seat->pointer_state.focused_client) {
  client->seat->pointer_state.focused_client = ((void*)0);
 }
 if (client == client->seat->keyboard_state.focused_client) {
  client->seat->keyboard_state.focused_client = ((void*)0);
 }

 if (client->seat->drag && client == client->seat->drag->seat_client) {
  client->seat->drag->seat_client = ((void*)0);
 }

 struct wl_resource *resource, *tmp;
 for (resource = 0, tmp = 0, resource = wl_resource_from_link((&client->pointers)->next), tmp = wl_resource_from_link((&client->pointers)->next->next); wl_resource_get_link(resource) != (&client->pointers); resource = tmp, tmp = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
  seat_client_destroy_pointer(resource);
 }
 for (resource = 0, tmp = 0, resource = wl_resource_from_link((&client->keyboards)->next), tmp = wl_resource_from_link((&client->keyboards)->next->next); wl_resource_get_link(resource) != (&client->keyboards); resource = tmp, tmp = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
  seat_client_destroy_keyboard(resource);
 }
 for (resource = 0, tmp = 0, resource = wl_resource_from_link((&client->touches)->next), tmp = wl_resource_from_link((&client->touches)->next->next); wl_resource_get_link(resource) != (&client->touches); resource = tmp, tmp = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
  seat_client_destroy_touch(resource);
 }
 for (resource = 0, tmp = 0, resource = wl_resource_from_link((&client->data_devices)->next), tmp = wl_resource_from_link((&client->data_devices)->next->next); wl_resource_get_link(resource) != (&client->data_devices); resource = tmp, tmp = wl_resource_from_link(wl_resource_get_link(resource)->next)) {

  wl_list_remove(wl_resource_get_link(resource));
  wl_list_init(wl_resource_get_link(resource));
  wl_resource_set_user_data(resource, ((void*)0));
 }
 for (resource = 0, tmp = 0, resource = wl_resource_from_link((&client->resources)->next), tmp = wl_resource_from_link((&client->resources)->next->next); wl_resource_get_link(resource) != (&client->resources); resource = tmp, tmp = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
...
static void seat_handle_bind(struct wl_client *client, void *_wlr_seat,
 ...
 wl_resource_set_implementation(wl_resource, &seat_impl, ((void*)0),
...
void wlr_seat_destroy(struct wlr_seat *seat) {
 ...
 wlr_seat_set_keyboard(seat, ((void*)0));

 struct wlr_touch_point *point;
 for (point = (__typeof__(point))((char *)((&seat->touch_state.touch_points)->next) - __builtin_offsetof(__typeof__(*point), link)); &point->link != (&seat->touch_state.touch_points); point = (__typeof__(point))((char *)(point->link.next) - __builtin_offsetof(__typeof__(*point), link))) {
 ...
 for (client = (__typeof__(client))((char *)((&seat->clients)->next) - __builtin_offsetof(__typeof__(*client), link)), tmp = (__typeof__(tmp))((char *)((client)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &client->link != (&seat->clients); client = tmp, tmp = (__typeof__(tmp))((char *)(client->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  seat_client_destroy(client);
 }
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_seat *seat =
  (__typeof__(seat))((char *)(listener) - __builtin_offsetof(__typeof__(*seat), display_destroy));
...
struct wlr_seat *wlr_seat_create(struct wl_display *display, const char *name) {
 ...
 seat->global = wl_global_create(display, &wl_seat_interface,
  9, seat, seat_handle_bind);
 if (seat->global == ((void*)0)) {
  free(touch_grab);
  free(pointer_grab);
  free(keyboard_grab);
  free(seat);
...
struct wlr_seat_client *wlr_seat_client_for_wl_client(struct wlr_seat *wlr_seat,
  struct wl_client *wl_client) {
 struct wlr_seat_client *seat_client;
 for (seat_client = (__typeof__(seat_client))((char *)((&wlr_seat->clients)->next) - __builtin_offsetof(__typeof__(*seat_client), link)); &seat_client->link != (&wlr_seat->clients); seat_client = (__typeof__(seat_client))((char *)(seat_client->link.next) - __builtin_offsetof(__typeof__(*seat_client), link))) {
...
void wlr_seat_set_capabilities(struct wlr_seat *wlr_seat,
 ...
 struct wlr_seat_client *client;
 for (client = (__typeof__(client))((char *)((&wlr_seat->clients)->next) - __builtin_offsetof(__typeof__(*client), link)); &client->link != (&wlr_seat->clients); client = (__typeof__(client))((char *)(client->link.next) - __builtin_offsetof(__typeof__(*client), link))) {
  ...
  if ((capabilities & WL_SEAT_CAPABILITY_POINTER) == 0) {
   ...
   if (focused_client != ((void*)0) && focused_surface != ((void*)0)) {
  ...
  struct wl_resource *resource;
  for (resource = 0, resource = wl_resource_from_link((&client->resources)->next); wl_resource_get_link(resource) != (&client->resources); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
...
struct wlr_seat_client *wlr_seat_client_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_seat_interface, &seat_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_seat_interface, &seat_impl)", "types/seat/wlr_seat.c", 441, __extension__ __PRETTY_FUNCTION__));
...
_Bool wlr_seat_client_validate_event_serial(struct wlr_seat_client *client, uint32_t serial) {
 uint32_t cur = wl_display_get_serial(wl_client_get_display(client->client));
 struct wlr_serial_ringset *set = &client->serials;
 uint32_t rev_dist = cur - serial;

 if (rev_dist >= (4294967295U) / 2) {
