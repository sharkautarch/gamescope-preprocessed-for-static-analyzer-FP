# 1 "../subprojects/wlroots/render/pixman/pixel_format.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/render/pixman/pixel_format.c" 2
...
# 2 "../subprojects/wlroots/render/pixman/pixel_format.c" 2
...
# 3 "../subprojects/wlroots/render/pixman/pixel_format.c" 2
...
struct wlr_pixman_render_pass *begin_pixman_render_pass(
 struct wlr_pixman_buffer *buffer);
# 5 "../subprojects/wlroots/render/pixman/pixel_format.c" 2
...
pixman_format_code_t get_pixman_format_from_drm(uint32_t fmt) {
 ...
 _wlr_log(WLR_ERROR, "[%s:%d] " "DRM format 0x%""X"" has no pixman equivalent", "render/pixman/pixel_format.c", 109, fmt);
 return 0;
}
...
uint32_t get_drm_format_from_pixman(pixman_format_code_t fmt) {
 ...
 _wlr_log(WLR_ERROR, "[%s:%d] " "pixman format 0x%""X"" has no drm equivalent", "render/pixman/pixel_format.c", 120, fmt);
 return 0;
}
