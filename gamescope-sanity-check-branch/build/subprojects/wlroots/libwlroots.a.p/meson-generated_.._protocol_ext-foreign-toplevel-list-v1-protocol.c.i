# 1 "subprojects/wlroots/protocol/ext-foreign-toplevel-list-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/ext-foreign-toplevel-list-v1-protocol.c" 2
# 31 "subprojects/wlroots/protocol/ext-foreign-toplevel-list-v1-protocol.c"
...
# 32 "subprojects/wlroots/protocol/ext-foreign-toplevel-list-v1-protocol.c" 2
...
# 33 "subprojects/wlroots/protocol/ext-foreign-toplevel-list-v1-protocol.c" 2
...
# 34 "subprojects/wlroots/protocol/ext-foreign-toplevel-list-v1-protocol.c" 2
# 45 "subprojects/wlroots/protocol/ext-foreign-toplevel-list-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface ext_foreign_toplevel_list_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface ext_foreign_toplevel_handle_v1_interface = {
