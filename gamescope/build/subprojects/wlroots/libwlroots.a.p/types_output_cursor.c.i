# 1 "../subprojects/wlroots/types/output/cursor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/output/cursor.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/output/cursor.c" 2
...
# 3 "../subprojects/wlroots/types/output/cursor.c" 2
...
# 4 "../subprojects/wlroots/types/output/cursor.c" 2
...
void wlr_output_send_request_state(struct wlr_output *output,
 const struct wlr_output_state *state);
# 5 "../subprojects/wlroots/types/output/cursor.c" 2
...
void wlr_swapchain_set_buffer_submitted(struct wlr_swapchain *swapchain,
 struct wlr_buffer *buffer);
# 6 "../subprojects/wlroots/types/output/cursor.c" 2
# 1 "../subprojects/wlroots/include/wlr/render/wlr_renderer.h" 1
# 7 "../subprojects/wlroots/types/output/cursor.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 8 "../subprojects/wlroots/types/output/cursor.c" 2
...
# 9 "../subprojects/wlroots/types/output/cursor.c" 2
...
# 10 "../subprojects/wlroots/types/output/cursor.c" 2
...
# 11 "../subprojects/wlroots/types/output/cursor.c" 2
...
# 12 "../subprojects/wlroots/types/output/cursor.c" 2
...
# 13 "../subprojects/wlroots/types/output/cursor.c" 2
...
# 14 "../subprojects/wlroots/types/output/cursor.c" 2

static _Bool output_set_hardware_cursor(struct wlr_output *output,
 ...
 output->cursor_front_buffer = ((void*)0);
...
void wlr_output_lock_software_cursors(struct wlr_output *output, _Bool lock) {
 if (lock) {
  ...
  ((output->software_cursor_locks > 0) ? (void) (0) : __assert_fail ("output->software_cursor_locks > 0", "types/output/cursor.c", 41, __extension__ __PRETTY_FUNCTION__));
  --output->software_cursor_locks;
 }
 _wlr_log(WLR_DEBUG, "[%s:%d] " "%s hardware cursors on output '%s' (locks: %d)", "types/output/cursor.c", 46, lock ? "Disabling" : "Enabling", output->name, output->software_cursor_locks);



 if (output->software_cursor_locks > 0 && output->hardware_cursor != ((void*)0)) {
  output_set_hardware_cursor(output, ((void*)0), 0, 0);
  output_cursor_damage_whole(output->hardware_cursor);
  output->hardware_cursor = ((void*)0);
 }
...
static _Bool output_pick_cursor_format(struct wlr_output *output,
  struct wlr_drm_format *format) {
 struct wlr_allocator *allocator = output->allocator;
 ((allocator != ((void*)0)) ? (void) (0) : __assert_fail ("allocator != NULL", "types/output/cursor.c", 162, __extension__ __PRETTY_FUNCTION__));

 const struct wlr_drm_format_set *display_formats = ((void*)0);
 if (output->impl->get_cursor_formats) {
  display_formats =
   output->impl->get_cursor_formats(output, allocator->buffer_caps);
  if (display_formats == ((void*)0)) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Failed to get cursor display formats", "types/output/cursor.c", 169);
   return 0;
  }
 }

 return output_pick_format(output, display_formats, format, ((__u32)('A') | ((__u32)('R') << 8) | ((__u32)('2') << 16) | ((__u32)('4') << 24)));
}
...
static struct wlr_buffer *render_cursor_buffer(struct wlr_output_cursor *cursor) {
 ...
 ((allocator != ((void*)0) && renderer != ((void*)0)) ? (void) (0) : __assert_fail ("allocator != NULL && renderer != NULL", "types/output/cursor.c", 187, __extension__ __PRETTY_FUNCTION__));
 ...
 if (output->impl->get_cursor_size) {
  ...
  if ((int)texture->width > width || (int)texture->height > height) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Cursor texture too large (%dx%d), " "exceeds hardware limitations (%dx%d)", "types/output/cursor.c", 197, texture->width, texture->height, width, height);
 ...
 if (output->cursor_swapchain == ((void*)0) ||
  ...
  if (output->cursor_swapchain == ((void*)0)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to create cursor swapchain", "types/output/cursor.c", 216);
   return ((void*)0);
  }
 }

 struct wlr_buffer *buffer =
  wlr_swapchain_acquire(output->cursor_swapchain, ((void*)0));
 if (buffer == ((void*)0)) {
  return ((void*)0);
 }
 ...
 struct wlr_render_pass *pass = wlr_renderer_begin_buffer_pass(renderer, buffer, ((void*)0));
 if (pass == ((void*)0)) {
...
static _Bool output_cursor_attempt_hardware(struct wlr_output_cursor *cursor) {
 struct wlr_output *output = cursor->output;
 ...
 struct wlr_buffer *buffer = ((void*)0);
 if (texture != ((void*)0)) {
  buffer = render_cursor_buffer(cursor);
  if (buffer == ((void*)0)) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Failed to render cursor buffer", "types/output/cursor.c", 286);
   return 0;
  }
 }
 ...
 _Bool ok = output_set_hardware_cursor(output, buffer, hotspot.x, hotspot.y);
 wlr_buffer_unlock(buffer);
 if (ok) {
  output->hardware_cursor = cursor;
 }
...
_Bool wlr_output_cursor_set_buffer(struct wlr_output_cursor *cursor,
 ...
 ((renderer != ((void*)0)) ? (void) (0) : __assert_fail ("renderer != NULL", "types/output/cursor.c", 310, __extension__ __PRETTY_FUNCTION__));
 ...
 return output_cursor_set_texture(cursor, texture, 1, &src_box,
...
static void output_cursor_handle_renderer_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_output_cursor *cursor = (__typeof__(cursor))((char *)(listener) - __builtin_offsetof(__typeof__(*cursor), renderer_destroy));
 output_cursor_set_texture(cursor, ((void*)0), 0, ((void*)0), 0, 0,
...
_Bool output_cursor_set_texture(struct wlr_output_cursor *cursor,
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Falling back to software cursor on output '%s'", "types/output/cursor.c", 387, cursor->output->name);
...
_Bool wlr_output_cursor_move(struct wlr_output_cursor *cursor,
 ...
 cursor->x = x;
 cursor->y = y;
 _Bool was_visible = cursor->visible;
 output_cursor_update_visible(cursor);
 ...
 ((cursor->output->impl->move_cursor) ? (void) (0) : __assert_fail ("cursor->output->impl->move_cursor", "types/output/cursor.c", 421, __extension__ __PRETTY_FUNCTION__));
...
void wlr_output_cursor_destroy(struct wlr_output_cursor *cursor) {
 ...
 if (cursor->output->hardware_cursor == cursor) {
  ...
  output_set_hardware_cursor(cursor->output, ((void*)0), 0, 0);
  cursor->output->hardware_cursor = ((void*)0);
 }
 wl_list_remove(&cursor->renderer_destroy.link);
 if (cursor->own_texture) {
  wlr_texture_destroy(cursor->texture);
