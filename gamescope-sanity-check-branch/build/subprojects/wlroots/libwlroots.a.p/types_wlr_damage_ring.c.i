# 1 "../subprojects/wlroots/types/wlr_damage_ring.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_damage_ring.c" 2
...
# 2 "../subprojects/wlroots/types/wlr_damage_ring.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_damage_ring.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/wlr_damage_ring.c" 2
...
void pixman_add_triangles (pixman_image_t *image,
       ...
       int n_tris,
       const pixman_triangle_t *tris);
# 5 "../subprojects/wlroots/types/wlr_damage_ring.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_buffer.h" 1
# 13 "../subprojects/wlroots/include/wlr/types/wlr_buffer.h"
...
# 6 "../subprojects/wlroots/types/wlr_damage_ring.c" 2
...
# 7 "../subprojects/wlroots/types/wlr_damage_ring.c" 2
...
# 8 "../subprojects/wlroots/types/wlr_damage_ring.c" 2
...
void wlr_damage_ring_finish(struct wlr_damage_ring *ring) {
 ...
 for (entry = (__typeof__(entry))((char *)((&ring->buffers)->next) - __builtin_offsetof(__typeof__(*entry), link)), tmp_entry = (__typeof__(tmp_entry))((char *)((entry)->link.next) - __builtin_offsetof(__typeof__(*tmp_entry), link)); &entry->link != (&ring->buffers); entry = tmp_entry, tmp_entry = (__typeof__(tmp_entry))((char *)(entry->link.next) - __builtin_offsetof(__typeof__(*tmp_entry), link))) {
...
_Bool wlr_damage_ring_add(struct wlr_damage_ring *ring,
 ...
 _Bool intersects = pixman_region32_not_empty(&clipped);
 if (intersects) {
...
void wlr_damage_ring_get_buffer_damage(struct wlr_damage_ring *ring,
  int buffer_age, pixman_region32_t *damage) {
 if (buffer_age <= 0 || buffer_age - 1 > 2) {
...
static void entry_squash_damage(struct wlr_damage_ring_buffer *entry) {
 ...
 if (entry->link.prev == &entry->ring->buffers) {
  ...
  struct wlr_damage_ring_buffer *last =
   (__typeof__(last))((char *)(entry->link.prev) - __builtin_offsetof(__typeof__(*last), link));
  prev = &last->damage;
 }
...
static void buffer_handle_destroy(struct wl_listener *listener, void *data) {
 struct wlr_damage_ring_buffer *entry = (__typeof__(entry))((char *)(listener) - __builtin_offsetof(__typeof__(*entry), destroy));
...
void wlr_damage_ring_rotate_buffer(struct wlr_damage_ring *ring,
 ...
 for (entry = (__typeof__(entry))((char *)((&ring->buffers)->next) - __builtin_offsetof(__typeof__(*entry), link)); &entry->link != (&ring->buffers); entry = (__typeof__(entry))((char *)(entry->link.next) - __builtin_offsetof(__typeof__(*entry), link))) {
