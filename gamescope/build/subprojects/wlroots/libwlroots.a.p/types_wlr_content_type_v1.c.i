# 1 "../subprojects/wlroots/types/wlr_content_type_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_content_type_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_content_type_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_content_type_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_content_type_v1.h" 1
# 12 "../subprojects/wlroots/include/wlr/types/wlr_content_type_v1.h"
...
# 13 "../subprojects/wlroots/include/wlr/types/wlr_content_type_v1.h" 2
# 1 "subprojects/wlroots/protocol/content-type-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/content-type-v1-protocol.h" 2
...
# 9 "subprojects/wlroots/protocol/content-type-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 48 "subprojects/wlroots/protocol/content-type-v1-protocol.h"
struct wl_surface;
struct wp_content_type_manager_v1;
struct wp_content_type_v1;
# 79 "subprojects/wlroots/protocol/content-type-v1-protocol.h"
extern const struct wl_interface wp_content_type_manager_v1_interface;
# 108 "subprojects/wlroots/protocol/content-type-v1-protocol.h"
...
struct wp_content_type_manager_v1_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 143 "subprojects/wlroots/protocol/content-type-v1-protocol.h"
 void (*get_surface_content_type)(struct wl_client *client,
      struct wl_resource *resource,
      uint32_t id,
      struct wl_resource *surface);
};
# 167 "subprojects/wlroots/protocol/content-type-v1-protocol.h"
...
# 191 "subprojects/wlroots/protocol/content-type-v1-protocol.h"
...
# 215 "subprojects/wlroots/protocol/content-type-v1-protocol.h"
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 232 "subprojects/wlroots/protocol/content-type-v1-protocol.h"
 void (*set_content_type)(struct wl_client *client,
     struct wl_resource *resource,
     uint32_t content_type);
};
# 14 "../subprojects/wlroots/include/wlr/types/wlr_content_type_v1.h" 2
...
# 4 "../subprojects/wlroots/types/wlr_content_type_v1.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 5 "../subprojects/wlroots/types/wlr_content_type_v1.c" 2
...
static struct wlr_content_type_v1_surface *content_type_surface_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wp_content_type_v1_interface, &content_type_surface_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wp_content_type_v1_interface, &content_type_surface_impl)", "types/wlr_content_type_v1.c", 28, __extension__ __PRETTY_FUNCTION__));
...
static struct wlr_content_type_manager_v1 *manager_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wp_content_type_manager_v1_interface, &manager_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wp_content_type_manager_v1_interface, &manager_impl)", "types/wlr_content_type_v1.c", 35, __extension__ __PRETTY_FUNCTION__));
...
static void content_type_surface_handle_set_content_type(struct wl_client *client,
 ...
 if (content_type_surface == ((void*)0)) {
  return;
 }
...
static void content_type_surface_destroy(
 ...
 wl_resource_set_user_data(content_type_surface->resource, ((void*)0));
 free(content_type_surface);
}

static void surface_addon_destroy(struct wlr_addon *addon) {
 struct wlr_content_type_v1_surface *content_type_surface =
  (__typeof__(content_type_surface))((char *)(addon) - __builtin_offsetof(__typeof__(*content_type_surface), addon));
...
static void manager_handle_get_surface_content_type(struct wl_client *client,
 ...
 if (content_type_surface->resource == ((void*)0)) {
  wlr_surface_synced_finish(&content_type_surface->synced);
  free(content_type_surface);
  wl_resource_post_no_memory(manager_resource);
  return;
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 ...
 ((wl_list_empty(&manager->events.destroy.listener_list)) ? (void) (0) : __assert_fail ("wl_list_empty(&manager->events.destroy.listener_list)", "types/wlr_content_type_v1.c", 156, __extension__ __PRETTY_FUNCTION__));
...
struct wlr_content_type_manager_v1 *wlr_content_type_manager_v1_create(
  struct wl_display *display, uint32_t version) {
 ((version <= 1) ? (void) (0) : __assert_fail ("version <= CONTENT_TYPE_VERSION", "types/wlr_content_type_v1.c", 165, __extension__ __PRETTY_FUNCTION__));
