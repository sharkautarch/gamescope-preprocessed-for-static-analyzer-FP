# 1 "../subprojects/wlroots/types/scene/surface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/scene/surface.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/scene/surface.c" 2
...
# 3 "../subprojects/wlroots/types/scene/surface.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 4 "../subprojects/wlroots/types/scene/surface.c" 2
...
# 5 "../subprojects/wlroots/types/scene/surface.c" 2
...
# 6 "../subprojects/wlroots/types/scene/surface.c" 2
...
void wlr_presentation_surface_scanned_out_on_output(struct wlr_surface *surface,
 struct wlr_output *output);
# 7 "../subprojects/wlroots/types/scene/surface.c" 2
...
# 8 "../subprojects/wlroots/types/scene/surface.c" 2
...
# 9 "../subprojects/wlroots/types/scene/surface.c" 2

static void handle_scene_buffer_outputs_update(
  struct wl_listener *listener, void *data) {
 struct wlr_scene_surface *surface =
  (__typeof__(surface))((char *)(listener) - __builtin_offsetof(__typeof__(*surface), outputs_update));

 if (surface->buffer->primary_output == ((void*)0)) {
  return;
 }
...
static void handle_scene_buffer_output_enter(
  struct wl_listener *listener, void *data) {
 struct wlr_scene_surface *surface =
  (__typeof__(surface))((char *)(listener) - __builtin_offsetof(__typeof__(*surface), output_enter));
...
static void handle_scene_buffer_output_leave(
  struct wl_listener *listener, void *data) {
 struct wlr_scene_surface *surface =
  (__typeof__(surface))((char *)(listener) - __builtin_offsetof(__typeof__(*surface), output_leave));
 struct wlr_scene_output *output = data;
...
static void handle_scene_buffer_output_sample(
  struct wl_listener *listener, void *data) {
 struct wlr_scene_surface *surface =
  (__typeof__(surface))((char *)(listener) - __builtin_offsetof(__typeof__(*surface), output_sample));
...
static void handle_scene_buffer_frame_done(
  struct wl_listener *listener, void *data) {
 struct wlr_scene_surface *surface =
  (__typeof__(surface))((char *)(listener) - __builtin_offsetof(__typeof__(*surface), frame_done));
...
static void scene_surface_handle_surface_destroy(
  struct wl_listener *listener, void *data) {
 struct wlr_scene_surface *surface =
  (__typeof__(surface))((char *)(listener) - __builtin_offsetof(__typeof__(*surface), surface_destroy));
...
static void scene_buffer_unmark_client_buffer(struct wlr_scene_buffer *scene_buffer) {
 ...
 ((buffer->n_ignore_locks > 0) ? (void) (0) : __assert_fail ("buffer->n_ignore_locks > 0", "types/scene/surface.c", 93, __extension__ __PRETTY_FUNCTION__));
 buffer->n_ignore_locks--;
}
...
static void surface_reconfigure(struct wlr_scene_surface *scene_surface) {
 ...
 if (width <= 0 || height <= 0) {
  wlr_scene_buffer_set_buffer(scene_buffer, ((void*)0));
...
static void handle_scene_surface_surface_commit(
  struct wl_listener *listener, void *data) {
 struct wlr_scene_surface *surface =
  (__typeof__(surface))((char *)(listener) - __builtin_offsetof(__typeof__(*surface), surface_commit));
 ...
 int lx, ly;
 _Bool enabled = wlr_scene_node_coords(&scene_buffer->node, &lx, &ly);

 if (!wl_list_empty(&surface->surface->current.frame_callback_list) &&
   surface->buffer->primary_output != ((void*)0) && enabled) {
  wlr_output_schedule_frame(surface->buffer->primary_output->output);
 }
}

static _Bool scene_buffer_point_accepts_input(struct wlr_scene_buffer *scene_buffer,
  double *sx, double *sy) {
...
static void surface_addon_destroy(struct wlr_addon *addon) {
 struct wlr_scene_surface *surface = (__typeof__(surface))((char *)(addon) - __builtin_offsetof(__typeof__(*surface), addon));
...
struct wlr_scene_surface *wlr_scene_surface_create(struct wlr_scene_tree *parent,
 ...
 struct wlr_scene_buffer *scene_buffer = wlr_scene_buffer_create(parent, ((void*)0));
 if (!scene_buffer) {
  free(surface);
  return ((void*)0);
 }
