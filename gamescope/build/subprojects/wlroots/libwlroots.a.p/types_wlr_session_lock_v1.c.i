# 1 "../subprojects/wlroots/types/wlr_session_lock_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_session_lock_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_session_lock_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_session_lock_v1.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_session_lock_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_session_lock_v1.h" 1
# 15 "../subprojects/wlroots/include/wlr/types/wlr_session_lock_v1.h"
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 16 "../subprojects/wlroots/include/wlr/types/wlr_session_lock_v1.h" 2
...
struct wlr_session_lock_surface_v1 *wlr_session_lock_surface_v1_try_from_wlr_surface(
 struct wlr_surface *surface);
# 5 "../subprojects/wlroots/types/wlr_session_lock_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_output.h" 1
# 6 "../subprojects/wlroots/types/wlr_session_lock_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_compositor.h" 1
# 7 "../subprojects/wlroots/types/wlr_session_lock_v1.c" 2
...
# 8 "../subprojects/wlroots/types/wlr_session_lock_v1.c" 2
# 1 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 72 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
struct ext_session_lock_manager_v1;
struct ext_session_lock_surface_v1;
struct ext_session_lock_v1;
struct wl_output;
struct wl_surface;
# 93 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
extern const struct wl_interface ext_session_lock_manager_v1_interface;
# 204 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
extern const struct wl_interface ext_session_lock_v1_interface;
# 249 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
...
struct ext_session_lock_manager_v1_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 274 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
 void (*lock)(struct wl_client *client,
       struct wl_resource *resource,
       uint32_t id);
};
# 291 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
...
# 334 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 352 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
 void (*get_lock_surface)(struct wl_client *client,
     struct wl_resource *resource,
     uint32_t id,
     struct wl_resource *surface,
     struct wl_resource *output);
# 385 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
 void (*unlock_and_destroy)(struct wl_client *client,
       struct wl_resource *resource);
};
# 419 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
static inline void
...
# 476 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 508 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
 void (*ack_configure)(struct wl_client *client,
         struct wl_resource *resource,
         uint32_t serial);
};
# 535 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.h"
static inline void
...
# 9 "../subprojects/wlroots/types/wlr_session_lock_v1.c" 2
...
static void lock_surface_destroy(struct wlr_session_lock_surface_v1 *lock_surface) {
 ...
 wl_signal_emit_mutable(&lock_surface->events.destroy, ((void*)0));

 wl_list_remove(&lock_surface->link);

 struct wlr_session_lock_surface_v1_configure *configure, *tmp;
 for (configure = (__typeof__(configure))((char *)((&lock_surface->configure_list)->next) - __builtin_offsetof(__typeof__(*configure), link)), tmp = (__typeof__(tmp))((char *)((configure)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &configure->link != (&lock_surface->configure_list); configure = tmp, tmp = (__typeof__(tmp))((char *)(configure->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  wl_list_remove(&configure->link);
  free(configure);
 }

 ((wl_list_empty(&lock_surface->events.destroy.listener_list)) ? (void) (0) : __assert_fail ("wl_list_empty(&lock_surface->events.destroy.listener_list)", "types/wlr_session_lock_v1.c", 37, __extension__ __PRETTY_FUNCTION__));

 wl_list_remove(&lock_surface->output_destroy.link);
 wlr_surface_synced_finish(&lock_surface->synced);
 wl_resource_set_user_data(lock_surface->resource, ((void*)0));
 free(lock_surface);
}

static struct wlr_session_lock_manager_v1 *lock_manager_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &ext_session_lock_manager_v1_interface, &lock_manager_implementation)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &ext_session_lock_manager_v1_interface, &lock_manager_implementation)", "types/wlr_session_lock_v1.c", 48, __extension__ __PRETTY_FUNCTION__));

 struct wlr_session_lock_manager_v1 *lock_manager =
  wl_resource_get_user_data(resource);
 ((lock_manager != ((void*)0)) ? (void) (0) : __assert_fail ("lock_manager != NULL", "types/wlr_session_lock_v1.c", 51, __extension__ __PRETTY_FUNCTION__));
 return lock_manager;
}

static struct wlr_session_lock_v1 *lock_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &ext_session_lock_v1_interface, &lock_implementation)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &ext_session_lock_v1_interface, &lock_implementation)", "types/wlr_session_lock_v1.c", 58, __extension__ __PRETTY_FUNCTION__));
...
static struct wlr_session_lock_surface_v1 *lock_surface_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &ext_session_lock_surface_v1_interface, &lock_surface_implementation)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &ext_session_lock_surface_v1_interface, &lock_surface_implementation)", "types/wlr_session_lock_v1.c", 65, __extension__ __PRETTY_FUNCTION__));
...
struct wlr_session_lock_surface_v1 *wlr_session_lock_surface_v1_try_from_wlr_surface(
  struct wlr_surface *surface) {
 if (surface->role != &lock_surface_role || surface->role_resource == ((void*)0)) {
  return ((void*)0);
 }
...
static void lock_surface_handle_ack_configure(struct wl_client *client,
 ...
 _Bool found = 0;
 struct wlr_session_lock_surface_v1_configure *configure, *tmp;
 for (configure = (__typeof__(configure))((char *)((&lock_surface->configure_list)->next) - __builtin_offsetof(__typeof__(*configure), link)); &configure->link != (&lock_surface->configure_list); configure = (__typeof__(configure))((char *)(configure->link.next) - __builtin_offsetof(__typeof__(*configure), link))) {
...
static void lock_surface_handle_output_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_session_lock_surface_v1 *lock_surface =
  (__typeof__(lock_surface))((char *)(listener) - __builtin_offsetof(__typeof__(*lock_surface), output_destroy));
 lock_surface_destroy(lock_surface);
}
...
static void lock_handle_get_lock_surface(struct wl_client *client,
 ...
 if (lock_surface_resource == ((void*)0)) {
 ...
 wl_resource_set_implementation(lock_surface_resource,
  &lock_surface_implementation, ((void*)0), ((void*)0));
 ...
 for (other = (__typeof__(other))((char *)((&lock->surfaces)->next) - __builtin_offsetof(__typeof__(*other), link)); &other->link != (&lock->surfaces); other = (__typeof__(other))((char *)(other->link.next) - __builtin_offsetof(__typeof__(*other), link))) {
...
static void lock_handle_unlock_and_destroy(struct wl_client *client,
 ...
 wl_signal_emit_mutable(&lock->events.unlock, ((void*)0));
...
void wlr_session_lock_v1_send_locked(struct wlr_session_lock_v1 *lock) {
 ((!lock->locked_sent) ? (void) (0) : __assert_fail ("!lock->locked_sent", "types/wlr_session_lock_v1.c", 358, __extension__ __PRETTY_FUNCTION__));
 lock->locked_sent = 1;
...
static void lock_destroy(struct wlr_session_lock_v1 *lock) {
 ...
 for (lock_surface = (__typeof__(lock_surface))((char *)((&lock->surfaces)->next) - __builtin_offsetof(__typeof__(*lock_surface), link)), tmp = (__typeof__(tmp))((char *)((lock_surface)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &lock_surface->link != (&lock->surfaces); lock_surface = tmp, tmp = (__typeof__(tmp))((char *)(lock_surface->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  lock_surface_destroy(lock_surface);
 }
 ((wl_list_empty(&lock->surfaces)) ? (void) (0) : __assert_fail ("wl_list_empty(&lock->surfaces)", "types/wlr_session_lock_v1.c", 368, __extension__ __PRETTY_FUNCTION__));

 wl_signal_emit_mutable(&lock->events.destroy, ((void*)0));

 ((wl_list_empty(&lock->events.new_surface.listener_list)) ? (void) (0) : __assert_fail ("wl_list_empty(&lock->events.new_surface.listener_list)", "types/wlr_session_lock_v1.c", 372, __extension__ __PRETTY_FUNCTION__));
 ((wl_list_empty(&lock->events.unlock.listener_list)) ? (void) (0) : __assert_fail ("wl_list_empty(&lock->events.unlock.listener_list)", "types/wlr_session_lock_v1.c", 373, __extension__ __PRETTY_FUNCTION__));
 ((wl_list_empty(&lock->events.destroy.listener_list)) ? (void) (0) : __assert_fail ("wl_list_empty(&lock->events.destroy.listener_list)", "types/wlr_session_lock_v1.c", 374, __extension__ __PRETTY_FUNCTION__));

 wl_resource_set_user_data(lock->resource, ((void*)0));
 free(lock);
}
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_session_lock_manager_v1 *lock_manager =
  (__typeof__(lock_manager))((char *)(listener) - __builtin_offsetof(__typeof__(*lock_manager), display_destroy));
 wl_signal_emit_mutable(&lock_manager->events.destroy, ((void*)0));
 wl_list_remove(&lock_manager->display_destroy.link);

 wl_global_destroy(lock_manager->global);

 ((wl_list_empty(&lock_manager->events.new_lock.listener_list)) ? (void) (0) : __assert_fail ("wl_list_empty(&lock_manager->events.new_lock.listener_list)", "types/wlr_session_lock_v1.c", 450, __extension__ __PRETTY_FUNCTION__));
 ((wl_list_empty(&lock_manager->events.destroy.listener_list)) ? (void) (0) : __assert_fail ("wl_list_empty(&lock_manager->events.destroy.listener_list)", "types/wlr_session_lock_v1.c", 451, __extension__ __PRETTY_FUNCTION__));
