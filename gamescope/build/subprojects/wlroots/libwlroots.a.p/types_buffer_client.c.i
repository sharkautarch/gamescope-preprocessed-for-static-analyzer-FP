# 1 "../subprojects/wlroots/types/buffer/client.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/buffer/client.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/buffer/client.c" 2
...
# 3 "../subprojects/wlroots/types/buffer/client.c" 2
...
# 4 "../subprojects/wlroots/types/buffer/client.c" 2
...
# 5 "../subprojects/wlroots/types/buffer/client.c" 2
...
# 6 "../subprojects/wlroots/types/buffer/client.c" 2
...
# 7 "../subprojects/wlroots/types/buffer/client.c" 2
...
struct wlr_client_buffer *wlr_client_buffer_get(struct wlr_buffer *wlr_buffer) {
 ...
 struct wlr_client_buffer *buffer = (__typeof__(buffer))((char *)(wlr_buffer) - __builtin_offsetof(__typeof__(*buffer), base));
 return buffer;
}
...
static struct wlr_client_buffer *client_buffer_from_buffer(
 ...
 ((client_buffer != ((void*)0)) ? (void) (0) : __assert_fail ("client_buffer != NULL", "types/buffer/client.c", 21, __extension__ __PRETTY_FUNCTION__));
...
static _Bool client_buffer_get_dmabuf(struct wlr_buffer *buffer,
  struct wlr_dmabuf_attributes *attribs) {
 struct wlr_client_buffer *client_buffer = client_buffer_from_buffer(buffer);

 if (client_buffer->source == ((void*)0)) {
  return 0;
 }
...
static void client_buffer_handle_source_destroy(struct wl_listener *listener,
 ...
 struct wlr_client_buffer *client_buffer =
  (__typeof__(client_buffer))((char *)(listener) - __builtin_offsetof(__typeof__(*client_buffer), source_destroy));
 wl_list_remove(&client_buffer->source_destroy.link);
 wl_list_init(&client_buffer->source_destroy.link);
 client_buffer->source = ((void*)0);
}

static void client_buffer_handle_renderer_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_client_buffer *client_buffer =
  (__typeof__(client_buffer))((char *)(listener) - __builtin_offsetof(__typeof__(*client_buffer), renderer_destroy));
 wl_list_remove(&client_buffer->renderer_destroy.link);
 wl_list_init(&client_buffer->renderer_destroy.link);
 client_buffer->texture = ((void*)0);
}
...
struct wlr_client_buffer *wlr_client_buffer_create(struct wlr_buffer *buffer,
 ...
 if (texture == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to create texture", "types/buffer/client.c", 71);
  return ((void*)0);
 }
...
_Bool wlr_client_buffer_apply_damage(struct wlr_client_buffer *client_buffer,
 ...
 if (client_buffer->texture == ((void*)0)) {
  return 0;
 }
