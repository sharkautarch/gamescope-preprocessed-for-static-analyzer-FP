# 1 "../subprojects/wlroots/types/wlr_subcompositor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_subcompositor.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_subcompositor.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_subcompositor.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_subcompositor.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 5 "../subprojects/wlroots/types/wlr_subcompositor.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_subcompositor.c" 2
...
struct wl_resource *region_create(struct wl_client *client,
 uint32_t version, uint32_t id);
# 7 "../subprojects/wlroots/types/wlr_subcompositor.c" 2
...
# 8 "../subprojects/wlroots/types/wlr_subcompositor.c" 2





static _Bool subsurface_is_synchronized(struct wlr_subsurface *subsurface) {
 while (subsurface != ((void*)0)) {
...
static void subsurface_destroy(struct wlr_subsurface *subsurface) {
 ...
 wl_resource_set_user_data(subsurface->resource, ((void*)0));
 free(subsurface);
}
...
static struct wlr_subsurface *subsurface_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_subsurface_interface, &subsurface_implementation)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_subsurface_interface, &subsurface_implementation)", "types/wlr_subcompositor.c", 54, __extension__ __PRETTY_FUNCTION__));
...
static struct wlr_subsurface *subsurface_find_sibling(
 ...
 for (sibling = (__typeof__(sibling))((char *)((&parent->pending.subsurfaces_below)->next) - __builtin_offsetof(__typeof__(*sibling), pending.link)); &sibling->pending.link != (&parent->pending.subsurfaces_below); sibling = (__typeof__(sibling))((char *)(sibling->pending.link.next) - __builtin_offsetof(__typeof__(*sibling), pending.link))) {
  if (sibling->surface == surface && sibling != subsurface) {
   return sibling;
  }
 }
 for (sibling = (__typeof__(sibling))((char *)((&parent->pending.subsurfaces_above)->next) - __builtin_offsetof(__typeof__(*sibling), pending.link)); &sibling->pending.link != (&parent->pending.subsurfaces_above); sibling = (__typeof__(sibling))((char *)(sibling->pending.link.next) - __builtin_offsetof(__typeof__(*sibling), pending.link))) {
  if (sibling->surface == surface && sibling != subsurface) {
   return sibling;
  }
 }
 ...
 if (sibling_surface == subsurface->parent) {
  ...
  if (!sibling) {
   wl_resource_post_error(subsurface->resource,
    ...
    "%s: wl_surface@%" "u" "is not a parent or sibling",
...
static void subsurface_handle_parent_destroy(struct wl_listener *listener,
 ...
 struct wlr_subsurface *subsurface =
  (__typeof__(subsurface))((char *)(listener) - __builtin_offsetof(__typeof__(*subsurface), parent_destroy));
...
static void subsurface_handle_surface_client_commit(
 ...
 struct wlr_subsurface *subsurface =
  (__typeof__(subsurface))((char *)(listener) - __builtin_offsetof(__typeof__(*subsurface), surface_client_commit));
...
struct wlr_subsurface *wlr_subsurface_try_from_wlr_surface(struct wlr_surface *surface) {
 if (surface->role != &subsurface_role || surface->role_resource == ((void*)0)) {
  return ((void*)0);
 }
...
static void subcompositor_handle_get_subsurface(struct wl_client *client,
 ...
 wl_resource_set_implementation(subsurface->resource,
  &subsurface_implementation, subsurface, ((void*)0));
 ...
 for (cached = (__typeof__(cached))((char *)((&parent->cached)->next) - __builtin_offsetof(__typeof__(*cached), cached_state_link)); &cached->cached_state_link != (&parent->cached); cached = (__typeof__(cached))((char *)(cached->cached_state_link.next) - __builtin_offsetof(__typeof__(*cached), cached_state_link))) {
...
static void subcompositor_bind(struct wl_client *client, void *data,
 ...
 wl_resource_set_implementation(resource, &subcompositor_impl,
  subcompositor, ((void*)0));
}

static void subcompositor_handle_display_destroy(
  struct wl_listener *listener, void *data) {
 struct wlr_subcompositor *subcompositor =
  (__typeof__(subcompositor))((char *)(listener) - __builtin_offsetof(__typeof__(*subcompositor), display_destroy));
 wl_signal_emit_mutable(&subcompositor->events.destroy, ((void*)0));
