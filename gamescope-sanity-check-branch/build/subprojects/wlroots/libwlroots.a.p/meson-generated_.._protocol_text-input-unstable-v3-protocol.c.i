# 1 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.c" 2
# 31 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.c"
...
# 32 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.c" 2
...
# 33 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.c" 2
...
# 34 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.c" 2
# 45 "subprojects/wlroots/protocol/text-input-unstable-v3-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_text_input_v3_interface = {
 "zwp_text_input_v3", 1,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_text_input_manager_v3_interface = {
