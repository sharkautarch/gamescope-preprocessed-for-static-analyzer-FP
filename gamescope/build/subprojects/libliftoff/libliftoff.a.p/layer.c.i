# 1 "../subprojects/libliftoff/layer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/libliftoff/layer.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/libliftoff/layer.c" 2
...
# 3 "../subprojects/libliftoff/layer.c" 2
...
# 4 "../subprojects/libliftoff/layer.c" 2
...
# 5 "../subprojects/libliftoff/layer.c" 2
...
# 6 "../subprojects/libliftoff/layer.c" 2
...
# 5 "../subprojects/libliftoff/include/private.h" 2
...
# 14 "../subprojects/libliftoff/include/log.h"
_Bool
...
# 7 "../subprojects/libliftoff/include/private.h" 2
...
# 8 "../subprojects/libliftoff/layer.c" 2
...
liftoff_layer_create(struct liftoff_output *output)
{
 ...
 if (layer->candidate_planes == ((void*)0)) {
  liftoff_log_errno(LIFTOFF_ERROR, "calloc");
  free(layer);
  return ((void*)0);
 }
 liftoff_list_insert(output->layers.prev, &layer->link);
 output->layers_changed = 1;
 return layer;
}
...
liftoff_layer_destroy(struct liftoff_layer *layer)
{
 ...
 layer->output->layers_changed = 1;
 if (layer->plane != ((void*)0)) {
  layer->plane->layer = ((void*)0);
 }
 if (layer->output->composition_layer == layer) {
  layer->output->composition_layer = ((void*)0);
 }
 free(layer->props);
...
layer_get_rect(struct liftoff_layer *layer, struct liftoff_rect *rect)
{
 ...
 rect->x = x_prop != ((void*)0) ? x_prop->value : 0;
 rect->y = y_prop != ((void*)0) ? y_prop->value : 0;
 rect->width = w_prop != ((void*)0) ? w_prop->value : 0;
 rect->height = h_prop != ((void*)0) ? h_prop->value : 0;
}
...
layer_update_priority(struct liftoff_layer *layer, _Bool make_current)
{
 ...
 if (prop != ((void*)0) && prop->prev_value != prop->value) {
  layer->pending_priority++;
 }
...
layer_has_fb(struct liftoff_layer *layer)
{
 ...
 return fb_id_prop != ((void*)0) && fb_id_prop->value != 0;
}
...
layer_is_visible(struct liftoff_layer *layer)
{
 ...
 if (alpha_prop != ((void*)0) && alpha_prop->value == 0) {
  return 0;
 }
...
layer_cache_fb_info(struct liftoff_layer *layer)
{
 ...
 fb_id_prop = layer_get_property(layer, "FB_ID");
 if (fb_id_prop == ((void*)0) || fb_id_prop->value == 0) {
     ...
     struct liftoff_plane *plane)
{
 ...
 ((empty_slot >= 0) ? (void) (0) : __assert_fail ("empty_slot >= 0", "../subprojects/libliftoff/layer.c", 341, __extension__ __PRETTY_FUNCTION__));
