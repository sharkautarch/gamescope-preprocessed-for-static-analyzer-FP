# 1 "../subprojects/wlroots/types/wlr_keyboard.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
# 7 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
void wlr_keyboard_notify_modifiers(struct wlr_keyboard *keyboard,
  ...
  uint32_t group);
# 8 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
# 9 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
# 10 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
# 11 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
# 12 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
# 13 "../subprojects/wlroots/types/wlr_keyboard.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 6 "../subprojects/wlroots/include/util/time.h" 2
...
# 14 "../subprojects/wlroots/types/wlr_keyboard.c" 2

struct wlr_keyboard *wlr_keyboard_from_input_device(
  struct wlr_input_device *input_device) {
 ((input_device->type == WLR_INPUT_DEVICE_KEYBOARD) ? (void) (0) : __assert_fail ("input_device->type == WLR_INPUT_DEVICE_KEYBOARD", "types/wlr_keyboard.c", 17, __extension__ __PRETTY_FUNCTION__));
 return (__typeof__((struct wlr_keyboard *)((void*)0)))((char *)(input_device) - __builtin_offsetof(__typeof__(*(struct wlr_keyboard *)((void*)0)), base));
}

void keyboard_led_update(struct wlr_keyboard *keyboard) {
 if (keyboard->xkb_state == ((void*)0)) {
  return;
 }
...
void keyboard_key_update(struct wlr_keyboard *keyboard,
 ...
 ((keyboard->num_keycodes <= 32) ? (void) (0) : __assert_fail ("keyboard->num_keycodes <= WLR_KEYBOARD_KEYS_CAP", "types/wlr_keyboard.c", 79, __extension__ __PRETTY_FUNCTION__));
}
...
void wlr_keyboard_notify_modifiers(struct wlr_keyboard *keyboard,
 ...
 _Bool updated = keyboard_modifier_update(keyboard);
 if (updated) {
...
void wlr_keyboard_finish(struct wlr_keyboard *kb) {
 ...
 for (size_t i = 0; i < orig_num_keycodes; ++i) {
  ((kb->num_keycodes == orig_num_keycodes - i) ? (void) (0) : __assert_fail ("kb->num_keycodes == orig_num_keycodes - i", "types/wlr_keyboard.c", 158, __extension__ __PRETTY_FUNCTION__));
  struct wlr_keyboard_key_event event = {
...
_Bool wlr_keyboard_set_keymap(struct wlr_keyboard *kb, struct xkb_keymap *keymap) {
 if (keymap == ((void*)0)) {
  keyboard_unset_keymap(kb);
 ...
 if (xkb_state == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to create XKB state", "types/wlr_keyboard.c", 194);
  return 0;
 }

 char *keymap_str = xkb_keymap_get_as_string(keymap, XKB_KEYMAP_FORMAT_TEXT_V1);
 if (keymap_str == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get string version of keymap", "types/wlr_keyboard.c", 200);
 ...
 if (!allocate_shm_file_pair(keymap_size, &rw_fd, &ro_fd)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to allocate shm file for keymap", "types/wlr_keyboard.c", 207);
  goto error_keymap_str;
 }

 void *dst = mmap(((void*)0), keymap_size, 0x1 | 0x2, 0x01, rw_fd, 0);
 close(rw_fd);
 if (dst == ((void *) -1)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "mmap failed" ": %s", "types/wlr_keyboard.c", 214, strerror((*__errno_location ())));
  close(ro_fd);
  goto error_keymap_str;
 }
 ...
 for (size_t i = 0; i < 3; ++i) {
  kb->led_indexes[i] = xkb_keymap_led_get_index(kb->keymap, led_names[i]);
 }
 ...
 for (size_t i = 0; i < 8; ++i) {
  kb->mod_indexes[i] = xkb_keymap_mod_get_index(kb->keymap, mod_names[i]);
 }
...
uint32_t wlr_keyboard_get_modifiers(struct wlr_keyboard *kb) {
 ...
 for (size_t i = 0; i < 8; ++i) {
  if (kb->mod_indexes[i] != (0xffffffff) &&
...
_Bool wlr_keyboard_keymaps_match(struct xkb_keymap *km1,
 ...
 _Bool result = strcmp(km1_str, km2_str) == 0;
 free(km1_str);
 free(km2_str);
 return result;
}
