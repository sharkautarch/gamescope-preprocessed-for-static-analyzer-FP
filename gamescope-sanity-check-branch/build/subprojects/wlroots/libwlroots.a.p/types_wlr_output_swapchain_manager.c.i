# 1 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
# 4 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 5 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
_Bool wlr_backend_commit(struct wlr_backend *backend,
 const struct wlr_backend_output_state *states, size_t states_len);
# 6 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
struct wlr_buffer *wlr_allocator_create_buffer(struct wlr_allocator *alloc,
 int width, int height, const struct wlr_drm_format *format);
# 7 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
void wlr_swapchain_set_buffer_submitted(struct wlr_swapchain *swapchain,
 struct wlr_buffer *buffer);
# 8 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_output_swapchain_manager.h" 1
# 14 "../subprojects/wlroots/include/wlr/types/wlr_output_swapchain_manager.h"
struct wlr_backend;
struct wlr_backend_output_state;
# 30 "../subprojects/wlroots/include/wlr/types/wlr_output_swapchain_manager.h"
...
void wlr_output_swapchain_manager_init(struct wlr_output_swapchain_manager *manager,
 struct wlr_backend *backend);
# 61 "../subprojects/wlroots/include/wlr/types/wlr_output_swapchain_manager.h"
_Bool wlr_output_swapchain_manager_prepare(struct wlr_output_swapchain_manager *manager,
 const struct wlr_backend_output_state *states, size_t states_len);
# 72 "../subprojects/wlroots/include/wlr/types/wlr_output_swapchain_manager.h"
...
# 83 "../subprojects/wlroots/include/wlr/types/wlr_output_swapchain_manager.h"
...
# 9 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
# 10 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
# 11 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
# 12 "../subprojects/wlroots/types/wlr_output_swapchain_manager.c" 2
...
static struct wlr_output_swapchain_manager_output *manager_get_output(
 ...
 for (manager_output = (&manager->outputs)->data; (const char *) manager_output < ((const char *) (&manager->outputs)->data + (&manager->outputs)->size); (manager_output)++) {
...
static _Bool swapchain_is_compatible(struct wlr_swapchain *swapchain,
  int width, int height, const struct wlr_drm_format *format) {
 if (swapchain == ((void*)0)) {
  return 0;
 }
 ...
 ((format->len > 0) ? (void) (0) : __assert_fail ("format->len > 0", "types/wlr_output_swapchain_manager.c", 73, __extension__ __PRETTY_FUNCTION__));
...
static _Bool manager_output_prepare(struct wlr_output_swapchain_manager_output *manager_output,
  struct wlr_output_state *state, _Bool explicit_modifiers) {
 struct wlr_output *output = manager_output->output;
 struct wlr_allocator *allocator = output->allocator;
 ((allocator != ((void*)0)) ? (void) (0) : __assert_fail ("allocator != NULL", "types/wlr_output_swapchain_manager.c", 102, __extension__ __PRETTY_FUNCTION__));

 if (!output_pending_enabled(output, state)) {
  manager_output->pending_swapchain = ((void*)0);
  return 1;
 }
 ...
 if (!explicit_modifiers && (format.len != 1 || format.modifiers[0] != ((((__u64)0) << 56) | ((0) & 0x00ffffffffffffffULL)))) {
  if (!wlr_drm_format_has(&format, ((((__u64)0) << 56) | ((((1ULL << 56) - 1)) & 0x00ffffffffffffffULL)))) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Implicit modifiers not supported", "types/wlr_output_swapchain_manager.c", 126);
   wlr_drm_format_finish(&format);
   return 0;
  }

  format.len = 0;
  if (!wlr_drm_format_add(&format, ((((__u64)0) << 56) | ((((1ULL << 56) - 1)) & 0x00ffffffffffffffULL)))) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Failed to add implicit modifier to format", "types/wlr_output_swapchain_manager.c", 133);
   wlr_drm_format_finish(&format);
   return 0;
  }
 }
...
static _Bool manager_test(struct wlr_output_swapchain_manager *manager,
  struct wlr_backend_output_state *states, size_t states_len,
  _Bool explicit_modifiers) {
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Preparing test commit for %zu outputs with %s modifiers", "types/wlr_output_swapchain_manager.c", 161, states_len, explicit_modifiers ? "explicit": "implicit");


 struct wlr_output_swapchain_manager_output *manager_output;
 for (manager_output = (&manager->outputs)->data; (const char *) manager_output < ((const char *) (&manager->outputs)->data + (&manager->outputs)->size); (manager_output)++) {
  manager_output->test_success = 0;
 }
 ...
 _Bool ok = wlr_backend_test(manager->backend, states, states_len);
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Test commit for %zu outputs %s", "types/wlr_output_swapchain_manager.c", 182, states_len, ok ? "succeeded" : "failed");
 ...
 for (size_t i = 0; i < states_len; i++) {
  ...
  ((manager_output != ((void*)0)) ? (void) (0) : __assert_fail ("manager_output != NULL", "types/wlr_output_swapchain_manager.c", 190, __extension__ __PRETTY_FUNCTION__));
  manager_output->test_success = 1;
 }
...
_Bool wlr_output_swapchain_manager_prepare(struct wlr_output_swapchain_manager *manager,
 ...
 for (size_t i = 0; i < states_len; i++) {
  pending[i] = states[i];
  pending[i].base.buffer = ((void*)0);
 }

 ok = manager_test(manager, pending, states_len, 1);
 if (!ok) {
  ok = manager_test(manager, pending, states_len, 0);
 }
...
struct wlr_swapchain *wlr_output_swapchain_manager_get_swapchain(
 ...
 ((manager_output != ((void*)0) && manager_output->test_success) ? (void) (0) : __assert_fail ("manager_output != NULL && manager_output->test_success", "types/wlr_output_swapchain_manager.c", 226, __extension__ __PRETTY_FUNCTION__));
...
void wlr_output_swapchain_manager_apply(struct wlr_output_swapchain_manager *manager) {
 ...
 for (manager_output = (&manager->outputs)->data; (const char *) manager_output < ((const char *) (&manager->outputs)->data + (&manager->outputs)->size); (manager_output)++) {
  ...
  manager_output->new_swapchain = ((void*)0);
  manager_output->test_success = 0;
 }
}
