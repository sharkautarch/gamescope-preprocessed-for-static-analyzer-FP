# 1 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 5 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_xdg_activation_v1.h" 1
# 14 "../subprojects/wlroots/include/wlr/types/wlr_xdg_activation_v1.h"
...
struct wlr_xdg_activation_token_v1 *wlr_xdg_activation_v1_add_token(
  struct wlr_xdg_activation_v1 *activation, const char *token_str);
# 7 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
...
# 8 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
# 1 "../subprojects/wlroots/include/util/token.h" 1
# 14 "../subprojects/wlroots/include/util/token.h"
_Bool generate_token(char out[static 33]);
# 9 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
# 1 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 91 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
struct wl_seat;
struct wl_surface;
struct xdg_activation_token_v1;
struct xdg_activation_v1;
# 115 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
extern const struct wl_interface xdg_activation_v1_interface;
# 146 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
...
# 163 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
 ...
 void (*get_activation_token)(struct wl_client *client,
         struct wl_resource *resource,
         uint32_t id);
# 191 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
 void (*activate)(struct wl_client *client,
    struct wl_resource *resource,
    const char *token,
    struct wl_resource *surface);
};
# 213 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
...
# 244 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
 void (*set_serial)(struct wl_client *client,
      struct wl_resource *resource,
      uint32_t serial,
      struct wl_resource *seat);
# 257 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
 void (*set_app_id)(struct wl_client *client,
      struct wl_resource *resource,
      const char *app_id);
# 272 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
...
# 328 "subprojects/wlroots/protocol/xdg-activation-v1-protocol.h"
static inline void
xdg_activation_token_v1_send_done(struct wl_resource *resource_, const char *token)
{
 wl_resource_post_event(resource_, 0, token);
}
# 10 "../subprojects/wlroots/types/wlr_xdg_activation_v1.c" 2
...
static struct wlr_xdg_activation_token_v1 *token_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &xdg_activation_token_v1_interface, &token_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &xdg_activation_token_v1_interface, &token_impl)", "types/wlr_xdg_activation_v1.c", 18, __extension__ __PRETTY_FUNCTION__));
...
void wlr_xdg_activation_token_v1_destroy(
 ...
 if (token->resource != ((void*)0)) {
  wl_resource_set_user_data(token->resource, ((void*)0));
 }
 if (token->timeout != ((void*)0)) {
  wl_event_source_remove(token->timeout);
 }

 wl_signal_emit_mutable(&token->events.destroy, ((void*)0));
...
static int token_handle_timeout(void *data) {
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Activation token '%s' has expired", "types/wlr_xdg_activation_v1.c", 46, token->token);
...
static _Bool token_init( struct wlr_xdg_activation_token_v1 *token) {
 char token_str[33] = {0};
 ...
 ((wl_list_empty(&token->link)) ? (void) (0) : __assert_fail ("wl_list_empty(&token->link)", "types/wlr_xdg_activation_v1.c", 86, __extension__ __PRETTY_FUNCTION__));
...
static void token_handle_commit(struct wl_client *client,
 ...
 wl_resource_set_user_data(token->resource, ((void*)0));
 token->resource = ((void*)0);

 if (token->seat != ((void*)0)) {
  struct wlr_seat_client *seat_client =
  ...
  if (seat_client == ((void*)0) ||
   ...
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Rejecting token commit request: " "serial %""u"" was never given to client", "types/wlr_xdg_activation_v1.c", 112, token->serial);

   goto error;
  }

  if (token->surface != ((void*)0) &&
    token->surface != token->seat->keyboard_state.focused_surface &&
    token->surface != token->seat->pointer_state.focused_surface) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Rejecting token commit request: " "surface doesn't have focus", "types/wlr_xdg_activation_v1.c", 120);
...
static void token_handle_seat_destroy(struct wl_listener *listener, void *data) {
 struct wlr_xdg_activation_token_v1 *token =
  (__typeof__(token))((char *)(listener) - __builtin_offsetof(__typeof__(*token), seat_destroy));
 wl_list_remove(&token->seat_destroy.link);
...
static void token_handle_set_serial(struct wl_client *client,
 ...
 if (seat_client == ((void*)0)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Rejecting token set_serial request: seat is inert", "types/wlr_xdg_activation_v1.c", 188);
  return;
 }
...
static void token_handle_surface_destroy(struct wl_listener *listener, void *data) {
 struct wlr_xdg_activation_token_v1 *token =
  (__typeof__(token))((char *)(listener) - __builtin_offsetof(__typeof__(*token), surface_destroy));
 wl_list_remove(&token->surface_destroy.link);
 wl_list_init(&token->surface_destroy.link);
 token->surface = ((void*)0);
}
...
static struct wlr_xdg_activation_v1 *activation_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &xdg_activation_v1_interface, &activation_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &xdg_activation_v1_interface, &activation_impl)", "types/wlr_xdg_activation_v1.c", 241, __extension__ __PRETTY_FUNCTION__));
...
static void activation_handle_activate(struct wl_client *client,
 ...
 struct wlr_xdg_activation_token_v1 *token;
 _Bool found = 0;
 for (token = (__typeof__(token))((char *)((&activation->tokens)->next) - __builtin_offsetof(__typeof__(*token), link)); &token->link != (&activation->tokens); token = (__typeof__(token))((char *)(token->link.next) - __builtin_offsetof(__typeof__(*token), link))) {
 ...
 if (!found) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Rejecting activate request: unknown token", "types/wlr_xdg_activation_v1.c", 305);
  return;
 }
...
static void activation_bind(struct wl_client *client, void *data,
 ...
 wl_resource_set_implementation(resource, &activation_impl, activation, ((void*)0));
}

static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_xdg_activation_v1 *activation =
  (__typeof__(activation))((char *)(listener) - __builtin_offsetof(__typeof__(*activation), display_destroy));
 wl_signal_emit_mutable(&activation->events.destroy, ((void*)0));

 struct wlr_xdg_activation_token_v1 *token, *token_tmp;
 for (token = (__typeof__(token))((char *)((&activation->tokens)->next) - __builtin_offsetof(__typeof__(*token), link)), token_tmp = (__typeof__(token_tmp))((char *)((token)->link.next) - __builtin_offsetof(__typeof__(*token_tmp), link)); &token->link != (&activation->tokens); token = token_tmp, token_tmp = (__typeof__(token_tmp))((char *)(token->link.next) - __builtin_offsetof(__typeof__(*token_tmp), link))) {
  wlr_xdg_activation_token_v1_destroy(token);
 }
...
struct wlr_xdg_activation_v1 *wlr_xdg_activation_v1_create(
 ...
 activation->token_timeout_msec = 30000;
 ...
 activation->global = wl_global_create(display,
  &xdg_activation_v1_interface, 1, activation,
  activation_bind);
 if (activation->global == ((void*)0)) {
  free(activation);
  return ((void*)0);
 }
...
struct wlr_xdg_activation_token_v1 *wlr_xdg_activation_v1_add_token(
  struct wlr_xdg_activation_v1 *activation, const char *token_str) {
 ((token_str) ? (void) (0) : __assert_fail ("token_str", "types/wlr_xdg_activation_v1.c", 416, __extension__ __PRETTY_FUNCTION__));
