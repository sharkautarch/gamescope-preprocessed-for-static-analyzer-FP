# 1 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_shell.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_shell.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_shell.c" 2
...
# 3 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_shell.c" 2
...
# 4 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_shell.c" 2
...
static struct wlr_xdg_client *xdg_client_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &xdg_wm_base_interface, &xdg_shell_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &xdg_wm_base_interface, &xdg_shell_impl)", "types/xdg_shell/wlr_xdg_shell.c", 12, __extension__ __PRETTY_FUNCTION__));
...
static void xdg_client_handle_resource_destroy(struct wl_resource *resource) {
 ...
 struct wlr_xdg_surface *surface, *tmp = ((void*)0);
 for (surface = (__typeof__(surface))((char *)((&client->surfaces)->next) - __builtin_offsetof(__typeof__(*surface), link)), tmp = (__typeof__(tmp))((char *)((surface)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &surface->link != (&client->surfaces); surface = tmp, tmp = (__typeof__(tmp))((char *)(surface->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  destroy_xdg_surface(surface);
 }

 if (client->ping_timer != ((void*)0)) {
...
static int xdg_client_ping_timeout(void *user_data) {
 ...
 struct wlr_xdg_surface *surface;
 for (surface = (__typeof__(surface))((char *)((&client->surfaces)->next) - __builtin_offsetof(__typeof__(*surface), link)); &surface->link != (&client->surfaces); surface = (__typeof__(surface))((char *)(surface->link.next) - __builtin_offsetof(__typeof__(*surface), link))) {
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_xdg_shell *xdg_shell =
  (__typeof__(xdg_shell))((char *)(listener) - __builtin_offsetof(__typeof__(*xdg_shell), display_destroy));
...
struct wlr_xdg_shell *wlr_xdg_shell_create(struct wl_display *display,
  uint32_t version) {
 ((version <= 6) ? (void) (0) : __assert_fail ("version <= WM_BASE_VERSION", "types/xdg_shell/wlr_xdg_shell.c", 139, __extension__ __PRETTY_FUNCTION__));
