# 1 "../subprojects/wlroots/backend/libinput/tablet_pad.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/backend/libinput/tablet_pad.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/backend/libinput/tablet_pad.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 3 "../subprojects/wlroots/backend/libinput/tablet_pad.c" 2
...
# 4 "../subprojects/wlroots/backend/libinput/tablet_pad.c" 2
...
# 13 "../subprojects/wlroots/include/wlr/types/wlr_tablet_pad.h"
...
# 6 "../subprojects/wlroots/backend/libinput/tablet_pad.c" 2
...
# 7 "../subprojects/wlroots/backend/libinput/tablet_pad.c" 2
...
void handle_tablet_pad_strip(struct libinput_event *event,
 struct wlr_tablet_pad *tablet_pad);
# 8 "../subprojects/wlroots/backend/libinput/tablet_pad.c" 2
...
static void add_pad_group_from_libinput(struct wlr_tablet_pad *pad,
 ...
 if (!group) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "failed to allocate wlr_tablet_pad_group" ": %s", "backend/libinput/tablet_pad.c", 26, strerror((*__errno_location ())));
  return;
 }
...
group_fail:
 _wlr_log(WLR_ERROR, "[%s:%d] " "failed to configure wlr_tablet_pad_group", "backend/libinput/tablet_pad.c", 87);
 group_destroy(group);
}
...
void finish_device_tablet_pad(struct wlr_libinput_input_device *dev) {
 ...
 for (group = (__typeof__(group))((char *)((&dev->tablet_pad.groups)->next) - __builtin_offsetof(__typeof__(*group), link)), tmp = (__typeof__(tmp))((char *)((group)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &group->link != (&dev->tablet_pad.groups); group = tmp, tmp = (__typeof__(tmp))((char *)(group->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  group_destroy(group);
 }
...
struct wlr_libinput_input_device *device_from_tablet_pad(
 ...
 ((wlr_tablet_pad->impl == &libinput_tablet_pad_impl) ? (void) (0) : __assert_fail ("wlr_tablet_pad->impl == &libinput_tablet_pad_impl", "backend/libinput/tablet_pad.c", 132, __extension__ __PRETTY_FUNCTION__));

 struct wlr_libinput_input_device *dev =
  (__typeof__(dev))((char *)(wlr_tablet_pad) - __builtin_offsetof(__typeof__(*dev), tablet_pad));
 return dev;
}
