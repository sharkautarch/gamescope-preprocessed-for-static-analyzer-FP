# 1 "../subprojects/wlroots/render/allocator/shm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/render/allocator/shm.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/render/allocator/shm.c" 2
...
# 3 "../subprojects/wlroots/render/allocator/shm.c" 2
...
# 4 "../subprojects/wlroots/render/allocator/shm.c" 2
...
# 5 "../subprojects/wlroots/render/allocator/shm.c" 2
...
# 6 "../subprojects/wlroots/render/allocator/shm.c" 2
...
# 7 "../subprojects/wlroots/render/allocator/shm.c" 2
...
struct wlr_buffer *wlr_allocator_create_buffer(struct wlr_allocator *alloc,
 int width, int height, const struct wlr_drm_format *format);
# 8 "../subprojects/wlroots/render/allocator/shm.c" 2
...
_Bool wlr_drm_format_set_union(struct wlr_drm_format_set *dst,
 const struct wlr_drm_format_set *a, const struct wlr_drm_format_set *b);
# 9 "../subprojects/wlroots/render/allocator/shm.c" 2
...
# 10 "../subprojects/wlroots/render/allocator/shm.c" 2
...
# 12 "../subprojects/wlroots/render/allocator/shm.c" 2
...
# 6 "../subprojects/wlroots/include/render/allocator/shm.h" 2
...
# 13 "../subprojects/wlroots/render/allocator/shm.c" 2
...
# 14 "../subprojects/wlroots/render/allocator/shm.c" 2

static const struct wlr_buffer_impl buffer_impl;

static struct wlr_shm_buffer *shm_buffer_from_buffer(
  struct wlr_buffer *wlr_buffer) {
 ((wlr_buffer->impl == &buffer_impl) ? (void) (0) : __assert_fail ("wlr_buffer->impl == &buffer_impl", "render/allocator/shm.c", 19, __extension__ __PRETTY_FUNCTION__));
...
static _Bool shm_buffer_begin_data_ptr_access(struct wlr_buffer *wlr_buffer,
...
static struct wlr_buffer *allocator_create_buffer(
 ...
 if (info == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Unsupported pixel format 0x%""X", "render/allocator/shm.c", 64, format->format);
  return ((void*)0);
 }
 ...
 if (buffer->data == ((void *) -1)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "mmap failed" ": %s", "render/allocator/shm.c", 92, strerror((*__errno_location ())));
  close(buffer->shm.fd);
  free(buffer);
  return ((void*)0);
 }
...
struct wlr_allocator *wlr_shm_allocator_create(void) {
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Created shm allocator", "render/allocator/shm.c", 118);
