# 1 "../subprojects/wlroots/backend/libinput/keyboard.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/backend/libinput/keyboard.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/backend/libinput/keyboard.c" 2
...
# 3 "../subprojects/wlroots/backend/libinput/keyboard.c" 2
...
void wlr_keyboard_notify_modifiers(struct wlr_keyboard *keyboard,
  ...
  uint32_t group);
# 5 "../subprojects/wlroots/backend/libinput/keyboard.c" 2
...
void handle_tablet_pad_strip(struct libinput_event *event,
 struct wlr_tablet_pad *tablet_pad);
# 6 "../subprojects/wlroots/backend/libinput/keyboard.c" 2

struct wlr_libinput_input_device *device_from_keyboard(
  struct wlr_keyboard *kb) {
 ((kb->impl == &libinput_keyboard_impl) ? (void) (0) : __assert_fail ("kb->impl == &libinput_keyboard_impl", "backend/libinput/keyboard.c", 9, __extension__ __PRETTY_FUNCTION__));

 struct wlr_libinput_input_device *dev = (__typeof__(dev))((char *)(kb) - __builtin_offsetof(__typeof__(*dev), keyboard));
 return dev;
}
