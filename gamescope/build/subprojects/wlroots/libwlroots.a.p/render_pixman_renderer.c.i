# 1 "../subprojects/wlroots/render/pixman/renderer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/render/pixman/renderer.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/render/pixman/renderer.c" 2
...
# 3 "../subprojects/wlroots/render/pixman/renderer.c" 2
...
void pixman_add_triangles (pixman_image_t *image,
       ...
       int n_tris,
       const pixman_triangle_t *tris);
# 4 "../subprojects/wlroots/render/pixman/renderer.c" 2
...
# 5 "../subprojects/wlroots/render/pixman/renderer.c" 2
...
# 6 "../subprojects/wlroots/render/pixman/renderer.c" 2
...
void *wlr_texture_read_pixel_options_get_data(
 const struct wlr_texture_read_pixels_options *options);
# 7 "../subprojects/wlroots/render/pixman/renderer.c" 2
...
# 9 "../subprojects/wlroots/render/pixman/renderer.c" 2

# 1 "../subprojects/wlroots/include/render/pixman.h" 1
...
_Bool wlr_drm_format_set_union(struct wlr_drm_format_set *dst,
 const struct wlr_drm_format_set *a, const struct wlr_drm_format_set *b);
# 5 "../subprojects/wlroots/include/render/pixman.h" 2
# 1 "../subprojects/wlroots/include/wlr/render/interface.h" 1
# 6 "../subprojects/wlroots/include/render/pixman.h" 2
...
# 7 "../subprojects/wlroots/include/render/pixman.h" 2
# 1 "../subprojects/wlroots/include/wlr/render/wlr_renderer.h" 1
# 8 "../subprojects/wlroots/include/render/pixman.h" 2
...
# 9 "../subprojects/wlroots/include/render/pixman.h" 2
...
_Bool begin_pixman_data_ptr_access(struct wlr_buffer *buffer, pixman_image_t **image_ptr,
 uint32_t flags);

struct wlr_pixman_render_pass *begin_pixman_render_pass(
 struct wlr_pixman_buffer *buffer);
# 11 "../subprojects/wlroots/render/pixman/renderer.c" 2
...
# 12 "../subprojects/wlroots/render/pixman/renderer.c" 2
...
static struct wlr_pixman_renderer *get_renderer(
  struct wlr_renderer *wlr_renderer) {
 ((wlr_renderer_is_pixman(wlr_renderer)) ? (void) (0) : __assert_fail ("wlr_renderer_is_pixman(wlr_renderer)", "render/pixman/renderer.c", 21, __extension__ __PRETTY_FUNCTION__));
 struct wlr_pixman_renderer *renderer = (__typeof__(renderer))((char *)(wlr_renderer) - __builtin_offsetof(__typeof__(*renderer), wlr_renderer));
 return renderer;
}

_Bool begin_pixman_data_ptr_access(struct wlr_buffer *wlr_buffer, pixman_image_t **image_ptr,
  uint32_t flags) {
 ...
 if (data != pixman_image_get_data(image)) {
  ...
  ((format != 0) ? (void) (0) : __assert_fail ("format != 0", "render/pixman/renderer.c", 42, __extension__ __PRETTY_FUNCTION__));
...
static struct wlr_pixman_buffer *get_buffer(
 ...
 struct wlr_pixman_buffer *buffer;
 for (buffer = (__typeof__(buffer))((char *)((&renderer->buffers)->next) - __builtin_offsetof(__typeof__(*buffer), link)); &buffer->link != (&renderer->buffers); buffer = (__typeof__(buffer))((char *)(buffer->link.next) - __builtin_offsetof(__typeof__(*buffer), link))) {
...
static struct wlr_pixman_texture *get_texture(
  struct wlr_texture *wlr_texture) {
 ((wlr_texture_is_pixman(wlr_texture)) ? (void) (0) : __assert_fail ("wlr_texture_is_pixman(wlr_texture)", "render/pixman/renderer.c", 78, __extension__ __PRETTY_FUNCTION__));
 struct wlr_pixman_texture *texture = (__typeof__(texture))((char *)(wlr_texture) - __builtin_offsetof(__typeof__(*texture), wlr_texture));
 return texture;
}
...
static _Bool texture_read_pixels(struct wlr_texture *wlr_texture,
  const struct wlr_texture_read_pixels_options *options) {
 struct wlr_pixman_texture *texture = get_texture(wlr_texture);
 ...
 if (fmt == 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Cannot read pixels: unsupported pixel format", "render/pixman/renderer.c", 101);
  return 0;
 }
 ...
 pixman_image_composite32(PIXMAN_OP_SRC, texture->image, ((void*)0), dst,
...
static struct wlr_pixman_buffer *create_buffer(
 ...
 if (buffer == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Allocation failed" ": %s", "render/pixman/renderer.c", 150, strerror((*__errno_location ())));
  return ((void*)0);
 }
 ...
 if (!wlr_buffer_begin_data_ptr_access(wlr_buffer,
   ...
   &data, &drm_format, &stride)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get buffer data", "render/pixman/renderer.c", 162);
  goto error_buffer;
 }
 wlr_buffer_end_data_ptr_access(wlr_buffer);
 ...
 pixman_format_code_t format = get_pixman_format_from_drm(drm_format);
 if (format == 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Unsupported pixman drm format 0x%""X", "render/pixman/renderer.c", 170, drm_format);
 ...
 if (!buffer->image) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to allocate pixman image", "render/pixman/renderer.c", 177);
  goto error_buffer;
 }
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Created pixman buffer %dx%d", "render/pixman/renderer.c", 187, wlr_buffer->width, wlr_buffer->height);
...
static struct wlr_pixman_texture *pixman_texture_create(
 ...
 if (texture == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to allocate pixman texture" ": %s", "render/pixman/renderer.c", 212, strerror((*__errno_location ())));
  return ((void*)0);
 }
 ...
 if (!texture->format_info) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Unsupported drm format 0x%""X", "render/pixman/renderer.c", 221, drm_format);
  free(texture);
  return ((void*)0);
 }
 ...
 if (texture->format == 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Unsupported pixman drm format 0x%""X", "render/pixman/renderer.c", 229, drm_format);
...
static struct wlr_texture *pixman_texture_from_buffer(
 ...
 if (!texture->image) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to create pixman image", "render/pixman/renderer.c", 261);
  wl_list_remove(&texture->link);
  free(texture);
  return ((void*)0);
 }
...
static void pixman_destroy(struct wlr_renderer *wlr_renderer) {
 ...
 for (buffer = (__typeof__(buffer))((char *)((&renderer->buffers)->next) - __builtin_offsetof(__typeof__(*buffer), link)), buffer_tmp = (__typeof__(buffer_tmp))((char *)((buffer)->link.next) - __builtin_offsetof(__typeof__(*buffer_tmp), link)); &buffer->link != (&renderer->buffers); buffer = buffer_tmp, buffer_tmp = (__typeof__(buffer_tmp))((char *)(buffer->link.next) - __builtin_offsetof(__typeof__(*buffer_tmp), link))) {
  destroy_buffer(buffer);
 }

 struct wlr_pixman_texture *tex, *tex_tmp;
 for (tex = (__typeof__(tex))((char *)((&renderer->textures)->next) - __builtin_offsetof(__typeof__(*tex), link)), tex_tmp = (__typeof__(tex_tmp))((char *)((tex)->link.next) - __builtin_offsetof(__typeof__(*tex_tmp), link)); &tex->link != (&renderer->textures); tex = tex_tmp, tex_tmp = (__typeof__(tex_tmp))((char *)(tex->link.next) - __builtin_offsetof(__typeof__(*tex_tmp), link))) {
...
struct wlr_renderer *wlr_pixman_renderer_create(void) {
 ...
 _wlr_log(WLR_INFO, "[%s:%d] " "Creating pixman renderer", "render/pixman/renderer.c", 328);
 ...
 for (size_t i = 0; i < len; ++i) {
  ...
  wlr_drm_format_set_add(&renderer->drm_formats, formats[i],
   ((((__u64)0) << 56) | ((0) & 0x00ffffffffffffffULL)));
 }
