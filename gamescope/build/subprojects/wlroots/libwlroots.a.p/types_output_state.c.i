# 1 "../subprojects/wlroots/types/output/state.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/output/state.c" 2
...
# 2 "../subprojects/wlroots/types/output/state.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 3 "../subprojects/wlroots/types/output/state.c" 2
...
# 4 "../subprojects/wlroots/types/output/state.c" 2
...
# 5 "../subprojects/wlroots/types/output/state.c" 2
...
# 6 "../subprojects/wlroots/types/output/state.c" 2
...
_Bool wlr_output_state_set_gamma_lut(struct wlr_output_state *state,
  size_t ramp_size, const uint16_t *r, const uint16_t *g, const uint16_t *b) {
 uint16_t *gamma_lut = ((void*)0);
 if (ramp_size > 0) {
  gamma_lut = realloc(state->gamma_lut, 3 * ramp_size * sizeof(uint16_t));
  if (gamma_lut == ((void*)0)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Allocation failed" ": %s", "types/output/state.c", 97, strerror((*__errno_location ())));
   return 0;
  }
