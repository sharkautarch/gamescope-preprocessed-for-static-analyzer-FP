# 1 "../subprojects/libliftoff/test/bench.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/libliftoff/test/bench.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 3 "../subprojects/libliftoff/test/bench.c" 2
...
# 4 "../subprojects/libliftoff/test/bench.c" 2
...
# 5 "../subprojects/libliftoff/test/bench.c" 2
...
# 6 "../subprojects/libliftoff/test/bench.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 7 "../subprojects/libliftoff/test/bench.c" 2
...
# 8 "../subprojects/libliftoff/test/bench.c" 2
...
liftoff_mock_plane_add_in_formats(struct liftoff_mock_plane *plane,
      ...
      size_t size);
# 9 "../subprojects/libliftoff/test/bench.c" 2
...
# 10 "../subprojects/libliftoff/test/bench.c" 2
...
main(int argc, char *argv[])
{
 ...
 struct liftoff_mock_plane *mock_planes[128];
 size_t i, j;
 uint64_t plane_type;
 int drm_fd;
 struct liftoff_device *device;
 struct liftoff_output *output;
 struct liftoff_layer *layers[128];
 ...
 ((device != ((void*)0)) ? (void) (0) : __assert_fail ("device != NULL", "../subprojects/libliftoff/test/bench.c", 79, __extension__ __PRETTY_FUNCTION__));
 ...
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/bench.c", 107, __extension__ __PRETTY_FUNCTION__));
