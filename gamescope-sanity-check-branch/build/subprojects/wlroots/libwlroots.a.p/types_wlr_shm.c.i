# 1 "../subprojects/wlroots/types/wlr_shm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_shm.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 4 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_shm.c" 2
# 1 "/usr/lib/clang/17/include/stdatomic.h" 1 3
# 27 "/usr/lib/clang/17/include/stdatomic.h" 3
...
# 28 "/usr/lib/clang/17/include/stdatomic.h" 2 3
...
# 29 "/usr/lib/clang/17/include/stdatomic.h" 2 3
# 67 "/usr/lib/clang/17/include/stdatomic.h" 3
...
# 96 "/usr/lib/clang/17/include/stdatomic.h" 3
...
# 169 "/usr/lib/clang/17/include/stdatomic.h" 3
typedef struct atomic_flag { atomic_bool _Value; } atomic_flag;
# 178 "/usr/lib/clang/17/include/stdatomic.h" 3
_Bool atomic_flag_test_and_set(volatile atomic_flag *);
_Bool atomic_flag_test_and_set_explicit(volatile atomic_flag *, memory_order);

void atomic_flag_clear(volatile atomic_flag *);
void atomic_flag_clear_explicit(volatile atomic_flag *, memory_order);
# 7 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 8 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 9 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 10 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 11 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 12 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 13 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 14 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 15 "../subprojects/wlroots/types/wlr_shm.c" 2
...
# 16 "../subprojects/wlroots/types/wlr_shm.c" 2
# 26 "../subprojects/wlroots/types/wlr_shm.c"
struct wlr_shm_pool {
 struct wl_resource *resource;
 struct wlr_shm *shm;
...
# 42 "../subprojects/wlroots/types/wlr_shm.c"
...
static struct wlr_shm_sigbus_data *_Atomic sigbus_data = ((void*)0);
...
static struct wlr_shm_buffer *buffer_from_resource(struct wl_resource *resource) {
 ((buffer_resource_is_instance(resource)) ? (void) (0) : __assert_fail ("buffer_resource_is_instance(resource)", "types/wlr_shm.c", 81, __extension__ __PRETTY_FUNCTION__));
...
static struct wlr_shm_pool *pool_from_resource(struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_shm_pool_interface, &pool_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_shm_pool_interface, &pool_impl)", "types/wlr_shm.c", 91, __extension__ __PRETTY_FUNCTION__));

 return wl_resource_get_user_data(resource);
}

static struct wlr_shm *shm_from_resource(struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_shm_interface, &shm_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_shm_interface, &shm_impl)", "types/wlr_shm.c", 96, __extension__ __PRETTY_FUNCTION__));
 return wl_resource_get_user_data(resource);
}

static struct wlr_shm_mapping *mapping_create(int fd, size_t size) {
 void *data = mmap(((void*)0), size, 0x1 | 0x2, 0x01, fd, 0);
 if (data == ((void *) -1)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "mmap failed" ": %s", "types/wlr_shm.c", 103, strerror((*__errno_location ())));
  return ((void*)0);
 }
...
static void mapping_consider_destroy(struct wlr_shm_mapping *mapping) {
 ...
 for (struct wlr_shm_sigbus_data *cur = sigbus_data; cur != ((void*)0); cur = cur->next) {
...
static void buffer_destroy(struct wlr_buffer *wlr_buffer) {
 struct wlr_shm_buffer *buffer = (__typeof__(buffer))((char *)(wlr_buffer) - __builtin_offsetof(__typeof__(*buffer), base));
 ((buffer->resource == ((void*)0)) ? (void) (0) : __assert_fail ("buffer->resource == NULL", "types/wlr_shm.c", 157, __extension__ __PRETTY_FUNCTION__));
...
static _Bool buffer_get_shm(struct wlr_buffer *wlr_buffer,
...
static void handle_sigbus(int sig, siginfo_t *info, void *context) {
 ((sigbus_data != ((void*)0)) ? (void) (0) : __assert_fail ("sigbus_data != NULL", "types/wlr_shm.c", 179, __extension__ __PRETTY_FUNCTION__));
 struct sigaction prev_action = sigbus_data->prev_action;



 uintptr_t addr = (uintptr_t)info->_sifields._sigfault.si_addr;
 struct wlr_shm_mapping *mapping = ((void*)0);
 for (struct wlr_shm_sigbus_data *data = sigbus_data; data != ((void*)0); data = data->next) {
 ...
 if (mmap(mapping->data, mapping->size, 0x1 | 0x2,
   0x02 | 0x10 | 0x20, -1, 0) == ((void *) -1)) {
  goto reraise;
 }
...
reraise:
 if (prev_action.sa_flags & 4) {
  prev_action.__sigaction_handler.sa_sigaction(sig, info, context);
 } else {
  prev_action.__sigaction_handler.sa_handler(sig);
 }
}
...
static _Bool buffer_begin_data_ptr_access(struct wlr_buffer *wlr_buffer,
 ...
 if (!__c11_atomic_is_lock_free(sizeof(*(&sigbus_data)))) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Lock-free atomic pointers are required", "types/wlr_shm.c", 221);
  return 0;
 }
 ...
 struct sigaction prev_action;
 if (sigbus_data == ((void*)0)) {
  struct sigaction new_action = {
   .__sigaction_handler.sa_sigaction = handle_sigbus,
   .sa_flags = 4 | 0x40000000,
  };
  if (sigaction(7, &new_action, &prev_action) != 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "sigaction failed" ": %s", "types/wlr_shm.c", 234, strerror((*__errno_location ())));
   return 0;
  }
 } else {
...
static void buffer_end_data_ptr_access(struct wlr_buffer *wlr_buffer) {
 ...
 if (sigbus_data == ((void*)0)) {
  if (sigaction(7, &buffer->sigbus_data.prev_action, ((void*)0)) != 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "sigaction failed" ": %s", "types/wlr_shm.c", 272, strerror((*__errno_location ())));
  }
 }
...
static void buffer_handle_release(struct wl_listener *listener, void *data) {
 struct wlr_shm_buffer *buffer = (__typeof__(buffer))((char *)(listener) - __builtin_offsetof(__typeof__(*buffer), release));
...
static _Bool shm_has_format(struct wlr_shm *shm, uint32_t shm_format);
...
static void pool_consider_destroy(struct wlr_shm_pool *pool) {
 if (pool->resource != ((void*)0) || !wl_list_empty(&pool->buffers)) {
  return;
 }
...
static void shm_bind(struct wl_client *client, void *data, uint32_t version,
 ...
 wl_resource_set_implementation(resource, &shm_impl, shm, ((void*)0));
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_shm *shm = (__typeof__(shm))((char *)(listener) - __builtin_offsetof(__typeof__(*shm), display_destroy));
...
struct wlr_shm *wlr_shm_create(struct wl_display *display, uint32_t version,
 ...
 _Bool has_argb8888 = 0, has_xrgb8888 = 0;
 ...
 ((has_argb8888 && has_xrgb8888) ? (void) (0) : __assert_fail ("has_argb8888 && has_xrgb8888", "types/wlr_shm.c", 505, __extension__ __PRETTY_FUNCTION__));

 struct wlr_shm *shm = calloc(1, sizeof(*shm));
 if (shm == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Allocation failed", "types/wlr_shm.c", 509);
  return ((void*)0);
 }

 shm->formats_len = formats_len;
 shm->formats = malloc(formats_len * sizeof(uint32_t));
 if (shm->formats == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Allocation failed", "types/wlr_shm.c", 516);
  free(shm);
  return ((void*)0);
 }
 for (size_t i = 0; i < formats_len; i++) {
 ...
 shm->global = wl_global_create(display, &wl_shm_interface, 1,
  shm, shm_bind);
 if (shm->global == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "wl_global_create failed", "types/wlr_shm.c", 527);
  free(shm->formats);
  free(shm);
  return ((void*)0);
 }
...
struct wlr_shm *wlr_shm_create_with_renderer(struct wl_display *display,
 ...
 if (formats == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to initialize wl_shm: " "cannot get renderer formats", "types/wlr_shm.c", 548);
