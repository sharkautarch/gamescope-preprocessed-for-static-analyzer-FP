# 1 "subprojects/wlroots/protocol/input-method-unstable-v2-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/input-method-unstable-v2-protocol.c" 2
# 32 "subprojects/wlroots/protocol/input-method-unstable-v2-protocol.c"
...
# 33 "subprojects/wlroots/protocol/input-method-unstable-v2-protocol.c" 2
...
# 34 "subprojects/wlroots/protocol/input-method-unstable-v2-protocol.c" 2
...
# 35 "subprojects/wlroots/protocol/input-method-unstable-v2-protocol.c" 2
# 46 "subprojects/wlroots/protocol/input-method-unstable-v2-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_input_method_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_input_popup_surface_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_input_method_keyboard_grab_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_input_method_manager_v2_interface = {
