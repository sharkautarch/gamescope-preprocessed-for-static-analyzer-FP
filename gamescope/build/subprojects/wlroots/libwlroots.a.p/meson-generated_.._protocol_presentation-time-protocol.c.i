# 1 "subprojects/wlroots/protocol/presentation-time-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/presentation-time-protocol.c" 2
# 26 "subprojects/wlroots/protocol/presentation-time-protocol.c"
...
# 27 "subprojects/wlroots/protocol/presentation-time-protocol.c" 2
...
# 28 "subprojects/wlroots/protocol/presentation-time-protocol.c" 2
...
# 29 "subprojects/wlroots/protocol/presentation-time-protocol.c" 2
# 40 "subprojects/wlroots/protocol/presentation-time-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_presentation_interface = {
 "wp_presentation", 1,
...
__attribute__ ((visibility("hidden"))) const struct wl_interface wp_presentation_feedback_interface = {
