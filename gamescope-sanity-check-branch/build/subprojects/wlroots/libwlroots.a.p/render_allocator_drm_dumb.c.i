# 1 "../subprojects/wlroots/render/allocator/drm_dumb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 3 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 4 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 5 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 6 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 7 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 8 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 9 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
_Bool wlr_backend_commit(struct wlr_backend *backend,
 const struct wlr_backend_output_state *states, size_t states_len);
# 10 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 11 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 12 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
struct wlr_buffer *wlr_allocator_create_buffer(struct wlr_allocator *alloc,
 int width, int height, const struct wlr_drm_format *format);
# 13 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
_Bool wlr_drm_format_set_union(struct wlr_drm_format_set *dst,
 const struct wlr_drm_format_set *a, const struct wlr_drm_format_set *b);
# 14 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 15 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 16 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 17 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2

# 1 "../subprojects/wlroots/include/render/allocator/drm_dumb.h" 1



# 1 "../subprojects/wlroots/include/wlr/render/dmabuf.h" 1
# 5 "../subprojects/wlroots/include/render/allocator/drm_dumb.h" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_buffer.h" 1
# 6 "../subprojects/wlroots/include/render/allocator/drm_dumb.h" 2
...
# 7 "../subprojects/wlroots/include/render/allocator/drm_dumb.h" 2
...
# 19 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 20 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2
...
# 21 "../subprojects/wlroots/render/allocator/drm_dumb.c" 2

static const struct wlr_buffer_impl buffer_impl;

static struct wlr_drm_dumb_buffer *drm_dumb_buffer_from_buffer(
  struct wlr_buffer *wlr_buf) {
 ((wlr_buf->impl == &buffer_impl) ? (void) (0) : __assert_fail ("wlr_buf->impl == &buffer_impl", "render/allocator/drm_dumb.c", 26, __extension__ __PRETTY_FUNCTION__));
 struct wlr_drm_dumb_buffer *buf = (__typeof__(buf))((char *)(wlr_buf) - __builtin_offsetof(__typeof__(*buf), base));
 return buf;
}
...
static struct wlr_drm_dumb_buffer *create_buffer(
 ...
 if (!wlr_drm_format_has(format, ((((__u64)0) << 56) | ((((1ULL << 56) - 1)) & 0x00ffffffffffffffULL))) &&
   !wlr_drm_format_has(format, ((((__u64)0) << 56) | ((0) & 0x00ffffffffffffffULL)))) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "DRM dumb allocator only supports INVALID and " "LINEAR modifiers", "render/allocator/drm_dumb.c", 37);
 ...
 if (info == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "DRM format 0x%""X"" not supported", "render/allocator/drm_dumb.c", 45, format->format);

  return ((void*)0);
 } else if (pixel_format_info_pixels_per_block(info) != 1) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Block formats are not supported", "render/allocator/drm_dumb.c", 48);
  return ((void*)0);
 }
 ...
 if (drmModeCreateDumbBuffer(alloc->drm_fd, width, height, bpp, 0,
  ...
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to create DRM dumb buffer" ": %s", "render/allocator/drm_dumb.c", 64, strerror((*__errno_location ())));
  goto create_destroy;
 }
 ...
 if (drmModeMapDumbBuffer(alloc->drm_fd, buffer->handle, &offset) != 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to map DRM dumb buffer" ": %s", "render/allocator/drm_dumb.c", 74, strerror((*__errno_location ())));
  goto create_destroy;
 }

 buffer->data = mmap(((void*)0), buffer->size, 0x1 | 0x2, 0x01,
  alloc->drm_fd, offset);
 if (buffer->data == ((void *) -1)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to mmap DRM dumb buffer" ": %s", "render/allocator/drm_dumb.c", 81, strerror((*__errno_location ())));
  goto create_destroy;
 }
 ...
 int prime_fd;
 if (drmPrimeHandleToFD(alloc->drm_fd, buffer->handle, 02000000,
   &prime_fd) != 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get PRIME handle from GEM handle" ": %s", "render/allocator/drm_dumb.c", 90, strerror((*__errno_location ())));
  goto create_destroy;
 }
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Allocated %""u""x%""u"" DRM dumb buffer", "render/allocator/drm_dumb.c", 106, buffer->width, buffer->height);
...
static _Bool drm_dumb_buffer_begin_data_ptr_access(struct wlr_buffer *wlr_buffer,
...
static void buffer_destroy(struct wlr_buffer *wlr_buffer) {
 ...
 if (buf->drm_fd >= 0) {
  if (drmModeDestroyDumbBuffer(buf->drm_fd, buf->handle) != 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to destroy DRM dumb buffer" ": %s", "render/allocator/drm_dumb.c", 146, strerror((*__errno_location ())));
  }
 }
...
static struct wlr_drm_dumb_allocator *drm_dumb_alloc_from_alloc(
 ...
 ((wlr_alloc->impl == &allocator_impl) ? (void) (0) : __assert_fail ("wlr_alloc->impl == &allocator_impl", "render/allocator/drm_dumb.c", 165, __extension__ __PRETTY_FUNCTION__));
 struct wlr_drm_dumb_allocator *alloc = (__typeof__(alloc))((char *)(wlr_alloc) - __builtin_offsetof(__typeof__(*alloc), base));
 return alloc;
}
...
static void allocator_destroy(struct wlr_allocator *wlr_alloc) {
 ...
 for (buf = (__typeof__(buf))((char *)((&alloc->buffers)->next) - __builtin_offsetof(__typeof__(*buf), link)), buf_tmp = (__typeof__(buf_tmp))((char *)((buf)->link.next) - __builtin_offsetof(__typeof__(*buf_tmp), link)); &buf->link != (&alloc->buffers); buf = buf_tmp, buf_tmp = (__typeof__(buf_tmp))((char *)(buf->link.next) - __builtin_offsetof(__typeof__(*buf_tmp), link))) {
  buf->drm_fd = -1;
  wl_list_remove(&buf->link);
...
struct wlr_allocator *wlr_drm_dumb_allocator_create(int drm_fd) {
 if (drmGetNodeTypeFromFd(drm_fd) != 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Cannot use DRM dumb buffers with non-primary DRM FD", "render/allocator/drm_dumb.c", 203);
  return ((void*)0);
 }

 uint64_t has_dumb = 0;
 if (drmGetCap(drm_fd, 0x1, &has_dumb) < 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get DRM capabilities", "render/allocator/drm_dumb.c", 209);
  return ((void*)0);
 }

 if (has_dumb == 0) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "DRM dumb buffers not supported", "render/allocator/drm_dumb.c", 214);
  return ((void*)0);
 }
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "Created DRM dumb allocator", "render/allocator/drm_dumb.c", 228);
 return &alloc->base;
}
