# 1 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_surface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_surface.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_surface.c" 2
...
# 3 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_surface.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_surface.c" 2
# 1 "../subprojects/wlroots/include/wlr/util/box.h" 1
# 18 "../subprojects/wlroots/include/wlr/util/box.h"
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 19 "../subprojects/wlroots/include/wlr/util/box.h" 2
...
# 5 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_surface.c" 2
...
# 6 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_surface.c" 2
...
# 17 "../subprojects/wlroots/include/wlr/types/wlr_output.h"
...
# 17 "../subprojects/wlroots/include/wlr/render/pass.h"
struct wlr_renderer;
struct wlr_buffer;
...
# 7 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_surface.c" 2
...
# 26 "../subprojects/wlroots/types/xdg_shell/wlr_xdg_surface.c"
...
static void xdg_surface_handle_ack_configure(struct wl_client *client,
 ...
 switch (surface->role) {
 case WLR_XDG_SURFACE_ROLE_NONE:
  ((0 && "not reached") ? (void) (0) : __assert_fail ("0 && \"not reached\"", "types/xdg_shell/wlr_xdg_surface.c", 103, __extension__ __PRETTY_FUNCTION__));
  break;
 case WLR_XDG_SURFACE_ROLE_TOPLEVEL:
  if (surface->toplevel != ((void*)0)) {
...
static void surface_send_configure(void *user_data) {
 ...
 switch (surface->role) {
 case WLR_XDG_SURFACE_ROLE_NONE:
  ((0 && "not reached") ? (void) (0) : __assert_fail ("0 && \"not reached\"", "types/xdg_shell/wlr_xdg_surface.c", 143, __extension__ __PRETTY_FUNCTION__));
  break;
 case WLR_XDG_SURFACE_ROLE_TOPLEVEL:
   if (surface->toplevel != ((void*)0)) {
   configure->toplevel_configure =
...
uint32_t wlr_xdg_surface_schedule_configure(struct wlr_xdg_surface *surface) {
 ...
 if (!surface->initialized) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "A configure is scheduled for an uninitialized xdg_surface %p", "types/xdg_shell/wlr_xdg_surface.c", 170, surface);

 }

 if (surface->configure_idle == ((void*)0)) {
...
static void xdg_surface_handle_get_popup(struct wl_client *client,
 ...
 ((xdg_surface != ((void*)0)) ? (void) (0) : __assert_fail ("xdg_surface != NULL", "types/xdg_shell/wlr_xdg_surface.c", 190, __extension__ __PRETTY_FUNCTION__));
 struct wlr_xdg_surface *parent = ((void*)0);
...
static void xdg_surface_handle_get_toplevel(struct wl_client *client,
 ...
 struct wlr_xdg_surface *xdg_surface =
  wlr_xdg_surface_from_resource(resource);
 ((xdg_surface != ((void*)0)) ? (void) (0) : __assert_fail ("xdg_surface != NULL", "types/xdg_shell/wlr_xdg_surface.c", 204, __extension__ __PRETTY_FUNCTION__));
...
static void xdg_surface_handle_set_window_geometry(struct wl_client *client,
  ...
  int32_t height) {
 struct wlr_xdg_surface *surface = wlr_xdg_surface_from_resource(resource);
 ((surface != ((void*)0)) ? (void) (0) : __assert_fail ("surface != NULL", "types/xdg_shell/wlr_xdg_surface.c", 212, __extension__ __PRETTY_FUNCTION__));
...
static void xdg_surface_role_client_commit(struct wlr_surface *wlr_surface) {
 ...
 ((surface != ((void*)0)) ? (void) (0) : __assert_fail ("surface != NULL", "types/xdg_shell/wlr_xdg_surface.c", 261, __extension__ __PRETTY_FUNCTION__));
 ...
 switch (surface->role) {
 case WLR_XDG_SURFACE_ROLE_NONE:
  ((0 && "not reached") ? (void) (0) : __assert_fail ("0 && \"not reached\"", "types/xdg_shell/wlr_xdg_surface.c", 277, __extension__ __PRETTY_FUNCTION__));
  return;
 case WLR_XDG_SURFACE_ROLE_TOPLEVEL:
  if (surface->toplevel != ((void*)0)) {
...
static void xdg_surface_role_commit(struct wlr_surface *wlr_surface) {
 struct wlr_xdg_surface *surface = wlr_xdg_surface_try_from_wlr_surface(wlr_surface);
 ((surface != ((void*)0)) ? (void) (0) : __assert_fail ("surface != NULL", "types/xdg_shell/wlr_xdg_surface.c", 294, __extension__ __PRETTY_FUNCTION__));

 if (surface->surface->unmap_commit) {
  reset_xdg_surface_role_object(surface);
  reset_xdg_surface(surface);

  ((!surface->initial_commit) ? (void) (0) : __assert_fail ("!surface->initial_commit", "types/xdg_shell/wlr_xdg_surface.c", 300, __extension__ __PRETTY_FUNCTION__));
 ...
 switch (surface->role) {
 case WLR_XDG_SURFACE_ROLE_NONE:
  ((0 && "not reached") ? (void) (0) : __assert_fail ("0 && \"not reached\"", "types/xdg_shell/wlr_xdg_surface.c", 309, __extension__ __PRETTY_FUNCTION__));
  return;
 case WLR_XDG_SURFACE_ROLE_TOPLEVEL:
  if (surface->toplevel == ((void*)0)) {
   return;
...
struct wlr_xdg_surface *wlr_xdg_surface_try_from_wlr_surface(
  struct wlr_surface *surface) {
 if (surface->role != &xdg_surface_role || surface->role_resource == ((void*)0)) {
  return ((void*)0);
 }
...
void create_xdg_surface(struct wlr_xdg_client *client, struct wlr_surface *wlr_surface,
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "new xdg_surface %p (res %p)", "types/xdg_shell/wlr_xdg_surface.c", 402, surface, surface->resource);

 wl_resource_set_implementation(surface->resource,
  &xdg_surface_implementation, surface, ((void*)0));
...
_Bool set_xdg_surface_role(struct wlr_xdg_surface *surface, enum wlr_xdg_surface_role role) {
 ((role != WLR_XDG_SURFACE_ROLE_NONE) ? (void) (0) : __assert_fail ("role != WLR_XDG_SURFACE_ROLE_NONE", "types/xdg_shell/wlr_xdg_surface.c", 421, __extension__ __PRETTY_FUNCTION__));
 ...
 if (surface->role != WLR_XDG_SURFACE_ROLE_NONE && surface->role != role) {
  wl_resource_post_error(surface->client->resource, XDG_WM_BASE_ERROR_ROLE,
   "Cannot assign role %s to xdg_surface@%" "u" ", already has role %s",
 ...
 if (surface->role_resource != ((void*)0)) {
  wl_resource_post_error(surface->client->resource, XDG_WM_BASE_ERROR_ROLE,
   "Cannot reassign role %s to xdg_surface@%" "u" ", role object still exists",
   role_names[role], wl_resource_get_id(surface->resource));
  return 0;
 }
...
static void destroy_xdg_surface_role_object(struct wlr_xdg_surface *surface) {
 ...
 switch (surface->role) {
 case WLR_XDG_SURFACE_ROLE_NONE:
  ((0 && "not reached") ? (void) (0) : __assert_fail ("0 && \"not reached\"", "types/xdg_shell/wlr_xdg_surface.c", 453, __extension__ __PRETTY_FUNCTION__));
  break;
 case WLR_XDG_SURFACE_ROLE_TOPLEVEL:
  if (surface->toplevel != ((void*)0)) {
...
static void xdg_surface_handle_role_resource_destroy(struct wl_listener *listener, void *data) {
 struct wlr_xdg_surface *surface = (__typeof__(surface))((char *)(listener) - __builtin_offsetof(__typeof__(*surface), role_resource_destroy));
...
void set_xdg_surface_role_object(struct wlr_xdg_surface *surface,
  struct wl_resource *role_resource) {
 ((surface->role != WLR_XDG_SURFACE_ROLE_NONE) ? (void) (0) : __assert_fail ("surface->role != WLR_XDG_SURFACE_ROLE_NONE", "types/xdg_shell/wlr_xdg_surface.c", 480, __extension__ __PRETTY_FUNCTION__));
 ((surface->role_resource == ((void*)0)) ? (void) (0) : __assert_fail ("surface->role_resource == NULL", "types/xdg_shell/wlr_xdg_surface.c", 481, __extension__ __PRETTY_FUNCTION__));
 ((role_resource != ((void*)0)) ? (void) (0) : __assert_fail ("role_resource != NULL", "types/xdg_shell/wlr_xdg_surface.c", 482, __extension__ __PRETTY_FUNCTION__));
...
void destroy_xdg_surface(struct wlr_xdg_surface *surface) {
 ...
 wl_signal_emit_mutable(&surface->events.destroy, ((void*)0));
...
struct wlr_xdg_surface *wlr_xdg_surface_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &xdg_surface_interface, &xdg_surface_implementation)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &xdg_surface_interface, &xdg_surface_implementation)", "types/xdg_shell/wlr_xdg_surface.c", 503, __extension__ __PRETTY_FUNCTION__));
...
void wlr_xdg_popup_get_position(struct wlr_xdg_popup *popup,
 ...
 ((parent != ((void*)0)) ? (void) (0) : __assert_fail ("parent != NULL", "types/xdg_shell/wlr_xdg_surface.c", 524, __extension__ __PRETTY_FUNCTION__));
