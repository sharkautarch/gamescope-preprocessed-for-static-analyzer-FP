# 1 "protocol/gamescope-swapchain-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "protocol/gamescope-swapchain-protocol.c" 2
# 26 "protocol/gamescope-swapchain-protocol.c"
...
# 27 "protocol/gamescope-swapchain-protocol.c" 2
...
# 28 "protocol/gamescope-swapchain-protocol.c" 2
...
# 29 "protocol/gamescope-swapchain-protocol.c" 2
# 40 "protocol/gamescope-swapchain-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface gamescope_swapchain_factory_v2_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface gamescope_swapchain_interface = {
