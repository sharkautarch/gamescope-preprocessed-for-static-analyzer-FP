# 1 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
...
# 3 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 5 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
...
# 6 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 7 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
...
# 8 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
...
# 9 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
# 1 "../subprojects/wlroots/include/util/set.h" 1
# 16 "../subprojects/wlroots/include/util/set.h"
ssize_t set_add(uint32_t values[], size_t *len, size_t cap, uint32_t target);
# 26 "../subprojects/wlroots/include/util/set.h"
ssize_t set_remove(uint32_t values[], size_t *len, size_t cap, uint32_t target);
# 10 "../subprojects/wlroots/types/seat/wlr_seat_pointer.c" 2
...
struct wlr_seat_client *wlr_seat_client_from_pointer_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_pointer_interface, &pointer_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_pointer_interface, &pointer_impl)", "types/seat/wlr_seat_pointer.c", 69, __extension__ __PRETTY_FUNCTION__));
...
static void seat_pointer_handle_surface_destroy(struct wl_listener *listener,
 ...
 struct wlr_seat_pointer_state *state =
  (__typeof__(state))((char *)(listener) - __builtin_offsetof(__typeof__(*state), surface_destroy));
...
void seat_client_send_pointer_leave_raw(struct wlr_seat_client *seat_client,
 ...
 struct wl_resource *resource;
 for (resource = 0, resource = wl_resource_from_link((&seat_client->pointers)->next); wl_resource_get_link(resource) != (&seat_client->pointers); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
  if (wlr_seat_client_from_pointer_resource(resource) == ((void*)0)) {
   continue;
  }
...
void wlr_seat_pointer_enter(struct wlr_seat *wlr_seat,
 ...
 if (client != ((void*)0) && surface != ((void*)0)) {
  uint32_t serial = wlr_seat_client_next_serial(client);
  struct wl_resource *resource;
  for (resource = 0, resource = wl_resource_from_link((&client->pointers)->next); wl_resource_get_link(resource) != (&client->pointers); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
   if (wlr_seat_client_from_pointer_resource(resource) == ((void*)0)) {
    continue;
   }
 ...
 if (surface != ((void*)0)) {
  ...
  wlr_seat_pointer_warp(wlr_seat, (__builtin_nanf ("")), (__builtin_nanf ("")));
 }
...
void wlr_seat_pointer_clear_focus(struct wlr_seat *wlr_seat) {
 wlr_seat_pointer_enter(wlr_seat, ((void*)0), 0, 0);
}
...
static _Bool should_reset_value120_accumulators(int32_t current, int32_t last) {
 if (last == 0) {
  return 1;
 }
 ...
 *low_res_value_discrete = *acc_discrete / 120;
 if (*low_res_value_discrete == 0) {
  *low_res_value = 0;
 } else {
  *acc_discrete -= *low_res_value_discrete * 120;
...
void wlr_seat_pointer_send_axis(struct wlr_seat *wlr_seat, uint32_t time,
 ...
 if (wlr_seat->pointer_state.sent_axis_source) {
  ((wlr_seat->pointer_state.cached_axis_source == source) ? (void) (0) : __assert_fail ("wlr_seat->pointer_state.cached_axis_source == source", "types/seat/wlr_seat_pointer.c", 333, __extension__ __PRETTY_FUNCTION__));
 } else {
  wlr_seat->pointer_state.sent_axis_source = 1;
...
void wlr_seat_pointer_send_frame(struct wlr_seat *wlr_seat) {
 ...
 wlr_seat->pointer_state.sent_axis_source = 0;
...
void wlr_seat_pointer_start_grab(struct wlr_seat *wlr_seat,
  struct wlr_seat_pointer_grab *grab) {
 ((wlr_seat) ? (void) (0) : __assert_fail ("wlr_seat", "types/seat/wlr_seat_pointer.c", 416, __extension__ __PRETTY_FUNCTION__));
 grab->seat = wlr_seat;
...
void wlr_seat_pointer_notify_enter(struct wlr_seat *wlr_seat,
 ...
 ((surface) ? (void) (0) : __assert_fail ("surface", "types/seat/wlr_seat_pointer.c", 438, __extension__ __PRETTY_FUNCTION__));
 struct wlr_seat_pointer_grab *grab = wlr_seat->pointer_state.grab;
...
void wlr_seat_pointer_notify_motion(struct wlr_seat *wlr_seat, uint32_t time,
  double sx, double sy) {
 clock_gettime(1, &wlr_seat->last_event);
 struct wlr_seat_pointer_grab *grab = wlr_seat->pointer_state.grab;
...
void seat_client_create_pointer(struct wlr_seat_client *seat_client,
 ...
 if (focused_client == seat_client && focused_surface != ((void*)0)) {
  ...
  struct wl_resource *resource;
  for (resource = 0, resource = wl_resource_from_link((&focused_client->pointers)->next); wl_resource_get_link(resource) != (&focused_client->pointers); resource = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
...
void seat_client_create_inert_pointer(struct wl_client *client,
 ...
 wl_resource_set_implementation(resource, &pointer_impl, ((void*)0), ((void*)0));
}
...
_Bool wlr_seat_validate_pointer_grab_serial(struct wlr_seat *seat,
 ...
 if (seat->pointer_state.button_count != 1 ||
  ...
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Pointer grab serial validation failed: " "button_count=%zu grab_serial=%""u"" (got %""u"")", "types/seat/wlr_seat_pointer.c", 574, seat->pointer_state.button_count, seat->pointer_state.grab_serial, serial);
 ...
 if (origin != ((void*)0) && seat->pointer_state.focused_surface != origin) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Pointer grab serial validation failed: " "invalid origin surface", "types/seat/wlr_seat_pointer.c", 580);
