# 1 "protocol/gamescope-input-method-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "protocol/gamescope-input-method-protocol.c" 2
# 33 "protocol/gamescope-input-method-protocol.c"
...
# 34 "protocol/gamescope-input-method-protocol.c" 2
...
# 35 "protocol/gamescope-input-method-protocol.c" 2
...
# 36 "protocol/gamescope-input-method-protocol.c" 2
# 47 "protocol/gamescope-input-method-protocol.c"
extern const struct wl_interface gamescope_input_method_interface;
extern const struct wl_interface wl_seat_interface;

static const struct wl_interface *gamescope_input_method_types[] = {
 ((void*)0),
 ((void*)0),
 &wl_seat_interface,
 &gamescope_input_method_interface,
};

static const struct wl_message gamescope_input_method_manager_requests[] = {
 { "destroy", "", gamescope_input_method_types + 0 },
 { "create_input_method", "on", gamescope_input_method_types + 2 },
};

__attribute__ ((visibility("hidden"))) const struct wl_interface gamescope_input_method_manager_interface = {
 "gamescope_input_method_manager", 3,
 2, gamescope_input_method_manager_requests,
 0, ((void*)0),
};

static const struct wl_message gamescope_input_method_requests[] = {
 { "destroy", "", gamescope_input_method_types + 0 },
 { "commit", "u", gamescope_input_method_types + 0 },
 { "set_string", "s", gamescope_input_method_types + 0 },
 { "set_action", "u", gamescope_input_method_types + 0 },
 { "pointer_motion", "3ff", gamescope_input_method_types + 0 },
 { "pointer_warp", "3ff", gamescope_input_method_types + 0 },
 { "pointer_wheel", "3ii", gamescope_input_method_types + 0 },
 { "pointer_button", "3uu", gamescope_input_method_types + 0 },
};

static const struct wl_message gamescope_input_method_events[] = {
 { "unavailable", "", gamescope_input_method_types + 0 },
 { "done", "u", gamescope_input_method_types + 0 },
};

__attribute__ ((visibility("hidden"))) const struct wl_interface gamescope_input_method_interface = {
 "gamescope_input_method", 3,
 8, gamescope_input_method_requests,
 2, gamescope_input_method_events,
};
