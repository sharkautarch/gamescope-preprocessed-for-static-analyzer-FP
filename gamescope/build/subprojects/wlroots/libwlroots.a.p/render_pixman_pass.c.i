# 1 "../subprojects/wlroots/render/pixman/pass.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/render/pixman/pass.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/render/pixman/pass.c" 2
...
# 3 "../subprojects/wlroots/render/pixman/pass.c" 2
# 1 "../subprojects/wlroots/include/render/pixman.h" 1



# 1 "../subprojects/wlroots/include/wlr/render/drm_format_set.h" 1
# 12 "../subprojects/wlroots/include/wlr/render/drm_format_set.h"
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 13 "../subprojects/wlroots/include/wlr/render/drm_format_set.h" 2
...
# 15 "../subprojects/wlroots/include/wlr/render/drm_format_set.h" 2
...
struct wlr_pixman_render_pass *begin_pixman_render_pass(
 struct wlr_pixman_buffer *buffer);
# 4 "../subprojects/wlroots/render/pixman/pass.c" 2

static const struct wlr_render_pass_impl render_pass_impl;

static struct wlr_pixman_render_pass *get_render_pass(struct wlr_render_pass *wlr_pass) {
 ((wlr_pass->impl == &render_pass_impl) ? (void) (0) : __assert_fail ("wlr_pass->impl == &render_pass_impl", "render/pixman/pass.c", 8, __extension__ __PRETTY_FUNCTION__));
 struct wlr_pixman_render_pass *pass = (__typeof__(pass))((char *)(wlr_pass) - __builtin_offsetof(__typeof__(*pass), base));
 return pass;
}

static struct wlr_pixman_texture *get_texture(struct wlr_texture *wlr_texture) {
 ((wlr_texture_is_pixman(wlr_texture)) ? (void) (0) : __assert_fail ("wlr_texture_is_pixman(wlr_texture)", "render/pixman/pass.c", 14, __extension__ __PRETTY_FUNCTION__));
 struct wlr_pixman_texture *texture = (__typeof__(texture))((char *)(wlr_texture) - __builtin_offsetof(__typeof__(*texture), wlr_texture));
 return texture;
}

static _Bool render_pass_submit(struct wlr_render_pass *wlr_pass) {
...
static void render_pass_add_texture(struct wlr_render_pass *wlr_pass,
 ...
 if (texture->buffer != ((void*)0) && !begin_pixman_data_ptr_access(texture->buffer,
 ...
 if (options->transform != WL_OUTPUT_TRANSFORM_NORMAL ||
  ...
  pixman_transform_rotate(&transform, ((void*)0),
   ((pixman_fixed_t) ((uint32_t) (tr_cos) << 16)), ((pixman_fixed_t) ((uint32_t) (tr_sin) << 16)));
  if (options->transform >= WL_OUTPUT_TRANSFORM_FLIPPED) {
   pixman_transform_scale(&transform, ((void*)0),
    ((pixman_fixed_t) ((uint32_t) (-1) << 16)), ((pixman_fixed_t) ((uint32_t) (1) << 16)));
  }
  pixman_transform_translate(&transform, ((void*)0),
   ((pixman_fixed_t) ((uint32_t) (tr_x) << 16)), ((pixman_fixed_t) ((uint32_t) (tr_y) << 16)));
  pixman_transform_translate(&transform, ((void*)0),
   -((pixman_fixed_t) ((uint32_t) (orig_box.x) << 16)), -((pixman_fixed_t) ((uint32_t) (orig_box.y) << 16)));
  pixman_transform_scale(&transform, ((void*)0),
   ((pixman_fixed_t) ((src_box.width / (double)orig_box.width) * 65536.0)),
   ((pixman_fixed_t) ((src_box.height / (double)orig_box.height) * 65536.0)));
  ...
  pixman_image_set_transform(texture->image, ((void*)0));
  dest_x = dst_box.x;
  dest_y = dst_box.y;
  width = src_box.width;
 ...
 case WLR_SCALE_FILTER_BILINEAR:
  pixman_image_set_filter(texture->image, PIXMAN_FILTER_BILINEAR, ((void*)0), 0);
  break;
 case WLR_SCALE_FILTER_NEAREST:
  pixman_image_set_filter(texture->image, PIXMAN_FILTER_NEAREST, ((void*)0), 0);
  break;
 }
 ...
 pixman_image_composite32(op, texture->image, mask,
  ...
  width, height);
 pixman_image_set_clip_region32(buffer->image, ((void*)0));

 pixman_image_set_transform(texture->image, ((void*)0));

 if (texture->buffer != ((void*)0)) {
...
static void render_pass_add_rect(struct wlr_render_pass *wlr_pass,
 ...
 pixman_image_set_clip_region32(buffer->image, (pixman_region32_t *)options->clip);
 pixman_image_composite32(op, fill, ((void*)0), buffer->image,
