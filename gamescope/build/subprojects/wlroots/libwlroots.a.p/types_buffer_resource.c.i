# 1 "../subprojects/wlroots/types/buffer/resource.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/buffer/resource.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/buffer/resource.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 3 "../subprojects/wlroots/types/buffer/resource.c" 2
# 1 "/usr/include/wayland-server.h" 1 3 4
# 39 "/usr/include/wayland-server.h" 3 4
...
# 40 "/usr/include/wayland-server.h" 2 3 4
...
# 4 "../subprojects/wlroots/types/buffer/resource.c" 2
...
# 5 "../subprojects/wlroots/types/buffer/resource.c" 2
...
# 6 "../subprojects/wlroots/types/buffer/resource.c" 2
...
# 7 "../subprojects/wlroots/types/buffer/resource.c" 2
...
void wlr_buffer_register_resource_interface(
  const struct wlr_buffer_resource_interface *iface) {
 ((iface) ? (void) (0) : __assert_fail ("iface", "types/buffer/resource.c", 13, __extension__ __PRETTY_FUNCTION__));
 ((iface->is_instance) ? (void) (0) : __assert_fail ("iface->is_instance", "types/buffer/resource.c", 14, __extension__ __PRETTY_FUNCTION__));
 ((iface->from_resource) ? (void) (0) : __assert_fail ("iface->from_resource", "types/buffer/resource.c", 15, __extension__ __PRETTY_FUNCTION__));

 const struct wlr_buffer_resource_interface **iface_ptr;
 for (iface_ptr = (&buffer_resource_interfaces)->data; (const char *) iface_ptr < ((const char *) (&buffer_resource_interfaces)->data + (&buffer_resource_interfaces)->size); (iface_ptr)++) {
  if (*iface_ptr == iface) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "wlr_resource_buffer_interface %s has already" "been registered", "types/buffer/resource.c", 21, iface->name);
...
struct wlr_buffer *wlr_buffer_try_from_resource(struct wl_resource *resource) {
 ...
 if (!iface) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Unknown buffer type", "types/buffer/resource.c", 50);
  return ((void*)0);
 }

 struct wlr_buffer *buffer = iface->from_resource(resource);
 if (!buffer) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to create %s buffer", "types/buffer/resource.c", 56, iface->name);
  return ((void*)0);
 }
