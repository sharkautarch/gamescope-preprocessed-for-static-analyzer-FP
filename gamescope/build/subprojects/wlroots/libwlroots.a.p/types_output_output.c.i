# 1 "../subprojects/wlroots/types/output/output.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/output/output.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/output/output.c" 2
...
# 3 "../subprojects/wlroots/types/output/output.c" 2
...
# 4 "../subprojects/wlroots/types/output/output.c" 2
...
# 5 "../subprojects/wlroots/types/output/output.c" 2
...
void wlr_output_send_request_state(struct wlr_output *output,
 const struct wlr_output_state *state);
# 6 "../subprojects/wlroots/types/output/output.c" 2
...
void wlr_swapchain_set_buffer_submitted(struct wlr_swapchain *swapchain,
 struct wlr_buffer *buffer);
# 7 "../subprojects/wlroots/types/output/output.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 8 "../subprojects/wlroots/types/output/output.c" 2
...
# 9 "../subprojects/wlroots/types/output/output.c" 2
...
# 10 "../subprojects/wlroots/types/output/output.c" 2
...
# 11 "../subprojects/wlroots/types/output/output.c" 2
...
# 12 "../subprojects/wlroots/types/output/output.c" 2
...
# 13 "../subprojects/wlroots/types/output/output.c" 2
# 1 "../subprojects/wlroots/include/util/global.h" 1
# 12 "../subprojects/wlroots/include/util/global.h"
void wlr_global_destroy_safe(struct wl_global *global);
# 14 "../subprojects/wlroots/types/output/output.c" 2
...
static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_output *output = (__typeof__(output))((char *)(listener) - __builtin_offsetof(__typeof__(*output), display_destroy));
 wlr_output_destroy_global(output);
}

void wlr_output_create_global(struct wlr_output *output, struct wl_display *display) {
 if (output->global != ((void*)0)) {
  return;
 }

 output->global = wl_global_create(display,
  &wl_output_interface, 4, output, output_bind);
 if (output->global == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to allocate wl_output global", "types/output/output.c", 142);
  return;
 }
...
void wlr_output_destroy_global(struct wlr_output *output) {
 ...
 for (resource = 0, tmp = 0, resource = wl_resource_from_link((&output->resources)->next), tmp = wl_resource_from_link((&output->resources)->next->next); wl_resource_get_link(resource) != (&output->resources); resource = tmp, tmp = wl_resource_from_link(wl_resource_get_link(resource)->next)) {
...
struct wlr_output *wlr_output_from_resource(struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_output_interface, &output_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_output_interface, &output_impl)", "types/output/output.c", 191, __extension__ __PRETTY_FUNCTION__));

 return wl_resource_get_user_data(resource);
}

void wlr_output_set_name(struct wlr_output *output, const char *name) {
 ((output->global == ((void*)0)) ? (void) (0) : __assert_fail ("output->global == NULL", "types/output/output.c", 196, __extension__ __PRETTY_FUNCTION__));
...
void wlr_output_set_description(struct wlr_output *output, const char *desc) {
 if (output->description != ((void*)0) && desc != ((void*)0) &&
...
static void output_apply_state(struct wlr_output *output,
 ...
 _Bool scale_updated = state->committed & WLR_OUTPUT_STATE_SCALE;
 if (scale_updated) {
 ...
 _Bool geometry_updated = state->committed &
 ...
 if ((state->committed & WLR_OUTPUT_STATE_ENABLED) && !state->enabled) {
  ...
  output->swapchain = ((void*)0);
  wlr_swapchain_destroy(output->cursor_swapchain);
  output->cursor_swapchain = ((void*)0);
 }
...
void wlr_output_init(struct wlr_output *output, struct wlr_backend *backend,
  const struct wlr_output_impl *impl, struct wl_event_loop *event_loop,
  const struct wlr_output_state *state) {
 ((impl->commit) ? (void) (0) : __assert_fail ("impl->commit", "types/output/output.c", 338, __extension__ __PRETTY_FUNCTION__));
 if (impl->set_cursor || impl->move_cursor) {
  ((impl->set_cursor && impl->move_cursor) ? (void) (0) : __assert_fail ("impl->set_cursor && impl->move_cursor", "types/output/output.c", 340, __extension__ __PRETTY_FUNCTION__));
 }
 ...
 *output = (struct wlr_output){
  ...
  .render_format = ((__u32)('X') | ((__u32)('R') << 8) | ((__u32)('2') << 16) | ((__u32)('4') << 24)),
 ...
 if (output->software_cursor_locks) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "WLR_NO_HARDWARE_CURSORS set, forcing software cursors", "types/output/output.c", 370);
 }
...
void wlr_output_destroy(struct wlr_output *output) {
 ...
 for (cursor = (__typeof__(cursor))((char *)((&output->cursors)->next) - __builtin_offsetof(__typeof__(*cursor), link)), tmp_cursor = (__typeof__(tmp_cursor))((char *)((cursor)->link.next) - __builtin_offsetof(__typeof__(*tmp_cursor), link)); &cursor->link != (&output->cursors); cursor = tmp_cursor, tmp_cursor = (__typeof__(tmp_cursor))((char *)(cursor->link.next) - __builtin_offsetof(__typeof__(*tmp_cursor), link))) {
  wlr_output_cursor_destroy(cursor);
 }

 struct wlr_output_layer *layer, *tmp_layer;
 for (layer = (__typeof__(layer))((char *)((&output->layers)->next) - __builtin_offsetof(__typeof__(*layer), link)), tmp_layer = (__typeof__(tmp_layer))((char *)((layer)->link.next) - __builtin_offsetof(__typeof__(*tmp_layer), link)); &layer->link != (&output->layers); layer = tmp_layer, tmp_layer = (__typeof__(tmp_layer))((char *)(layer->link.next) - __builtin_offsetof(__typeof__(*tmp_layer), link))) {
...
struct wlr_output_mode *wlr_output_preferred_mode(struct wlr_output *output) {
 ...
 return (__typeof__(mode))((char *)(output->modes.next) - __builtin_offsetof(__typeof__(*mode), link));
}
...
# 506 "../subprojects/wlroots/types/output/output.c"
...
static _Bool output_basic_test(struct wlr_output *output,
  const struct wlr_output_state *state) {
 if (state->committed & WLR_OUTPUT_STATE_BUFFER) {
  ...
  if (state->buffer->width != pending_width ||
   ...
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Primary buffer size mismatch", "types/output/output.c", 563);
   return 0;
  }
 } else {
  if (state->tearing_page_flip) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Tried to commit a tearing page flip without a buffer", "types/output/output.c", 568);
   return 0;
  }
  if (state->committed & WLR_OUTPUT_STATE_WAIT_TIMELINE) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Tried to set wait timeline without a buffer", "types/output/output.c", 572);
   return 0;
  }
  if (state->committed & WLR_OUTPUT_STATE_SIGNAL_TIMELINE) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Tried to set signal timeline without a buffer", "types/output/output.c", 576);
   return 0;
  }
 }
 ...
 if (state->committed & WLR_OUTPUT_STATE_RENDER_FORMAT) {
  ...
  ((allocator != ((void*)0)) ? (void) (0) : __assert_fail ("allocator != NULL", "types/output/output.c", 583, __extension__ __PRETTY_FUNCTION__));
  ...
  if (!output_pick_format(output, display_formats, &format, state->render_format)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to pick primary buffer format for output", "types/output/output.c", 589);
   return 0;
  }
 ...
 _Bool enabled = output_pending_enabled(output, state);
 ...
 if (enabled && (state->committed & (WLR_OUTPUT_STATE_ENABLED |
  ...
  if (pending_width == 0 || pending_height == 0) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Tried to enable an output with a zero mode", "types/output/output.c", 604);
   return 0;
  }
 }

 if (!enabled && state->committed & WLR_OUTPUT_STATE_BUFFER) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Tried to commit a buffer on a disabled output", "types/output/output.c", 610);
  return 0;
 }
 if (!enabled && state->committed & WLR_OUTPUT_STATE_MODE) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Tried to modeset a disabled output", "types/output/output.c", 614);
  return 0;
 }
 if (!enabled && state->committed & WLR_OUTPUT_STATE_ADAPTIVE_SYNC_ENABLED) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Tried to enable adaptive sync on a disabled output", "types/output/output.c", 618);
  return 0;
 }
 if (!enabled && state->committed & WLR_OUTPUT_STATE_RENDER_FORMAT) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Tried to set format for a disabled output", "types/output/output.c", 622);
  return 0;
 }
 if (!enabled && state->committed & WLR_OUTPUT_STATE_GAMMA_LUT) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Tried to set the gamma lut on a disabled output", "types/output/output.c", 626);
  return 0;
 }
 if (!enabled && state->committed & WLR_OUTPUT_STATE_SUBPIXEL) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Tried to set the subpixel layout on a disabled output", "types/output/output.c", 630);
  return 0;
 }

 if (state->committed & WLR_OUTPUT_STATE_LAYERS) {
  if (state->layers_len != (size_t)wl_list_length(&output->layers)) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "All output layers must be specified in wlr_output_state.layers", "types/output/output.c", 636);
   return 0;
  }

  for (size_t i = 0; i < state->layers_len; i++) {
   state->layers[i].accepted = 0;
  }
 }

 if ((state->committed & (WLR_OUTPUT_STATE_WAIT_TIMELINE | WLR_OUTPUT_STATE_SIGNAL_TIMELINE)) &&
   !output->timeline) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Wait/signal timelines are not supported for this output", "types/output/output.c", 647);
  return 0;
 }
...
_Bool wlr_output_test_state(struct wlr_output *output,
 ...
 _Bool new_back_buffer = 0;
 if (!output_ensure_buffer(output, &copy, &new_back_buffer)) {
  return 0;
 }

 _Bool success = output->impl->test(output, &copy);
 if (new_back_buffer) {
...
_Bool output_prepare_commit(struct wlr_output *output, const struct wlr_output_state *state) {
 if (!output_basic_test(output, state)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Basic output test failed for %s", "types/output/output.c", 684, output->name);
  return 0;
 }

 if ((state->committed & WLR_OUTPUT_STATE_BUFFER) &&
   output->idle_frame != ((void*)0)) {
  wl_event_source_remove(output->idle_frame);
  output->idle_frame = ((void*)0);
 }
...
_Bool wlr_output_commit_state(struct wlr_output *output,
 ...
 if (!output_basic_test(output, &pending)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Basic output test failed for %s", "types/output/output.c", 737, output->name);
  return 0;
 }
...
void wlr_output_schedule_frame(struct wlr_output *output) {
 ...
 if (output->frame_pending || output->idle_frame != ((void*)0)) {
  return;
 }
...
void wlr_output_send_present(struct wlr_output *output,
  struct wlr_output_event_present *event) {
 ((event) ? (void) (0) : __assert_fail ("event", "types/output/output.c", 799, __extension__ __PRETTY_FUNCTION__));
 event->output = output;

 struct timespec now;
 if (event->presented && event->when == ((void*)0)) {
  if (clock_gettime(1, &now) != 0) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "failed to send output present event: " "failed to read clock" ": %s", "types/output/output.c", 806, strerror((*__errno_location ())));
...
static void deferred_present_event_handle_output_destroy(struct wl_listener *listener, void *data) {
 struct deferred_present_event *deferred = (__typeof__(deferred))((char *)(listener) - __builtin_offsetof(__typeof__(*deferred), output_destroy));
...
const struct wlr_drm_format_set *wlr_output_get_primary_formats(
 ...
 if (formats == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get primary display formats", "types/output/output.c", 895);
...
_Bool wlr_output_is_direct_scanout_allowed(struct wlr_output *output) {
 if (output->attach_render_locks > 0) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Direct scan-out disabled by lock", "types/output/output.c", 906);
  return 0;
 }


 struct wlr_output_cursor *cursor;
 for (cursor = (__typeof__(cursor))((char *)((&output->cursors)->next) - __builtin_offsetof(__typeof__(*cursor), link)); &cursor->link != (&output->cursors); cursor = (__typeof__(cursor))((char *)(cursor->link.next) - __builtin_offsetof(__typeof__(*cursor), link))) {
  if (cursor->enabled && cursor->visible &&
    cursor != output->hardware_cursor) {
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Direct scan-out disabled by software cursor", "types/output/output.c", 916);
