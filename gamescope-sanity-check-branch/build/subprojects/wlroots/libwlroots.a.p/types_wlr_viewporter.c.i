# 1 "../subprojects/wlroots/types/wlr_viewporter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_viewporter.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/wlr_viewporter.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_viewporter.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 4 "../subprojects/wlroots/types/wlr_viewporter.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_viewporter.h" 1
# 25 "../subprojects/wlroots/include/wlr/types/wlr_viewporter.h"
...
# 5 "../subprojects/wlroots/types/wlr_viewporter.c" 2
...
# 6 "../subprojects/wlroots/types/wlr_viewporter.c" 2
...
# 7 "../subprojects/wlroots/types/wlr_viewporter.c" 2
# 1 "subprojects/wlroots/protocol/viewporter-protocol.h" 1
...
# 8 "subprojects/wlroots/protocol/viewporter-protocol.h" 2
...
struct wl_client;
struct wl_resource;
# 47 "subprojects/wlroots/protocol/viewporter-protocol.h"
struct wl_surface;
struct wp_viewport;
struct wp_viewporter;
# 76 "subprojects/wlroots/protocol/viewporter-protocol.h"
extern const struct wl_interface wp_viewporter_interface;
# 201 "subprojects/wlroots/protocol/viewporter-protocol.h"
...
struct wp_viewporter_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 238 "subprojects/wlroots/protocol/viewporter-protocol.h"
 void (*get_viewport)(struct wl_client *client,
        struct wl_resource *resource,
        uint32_t id,
        struct wl_resource *surface);
};
# 256 "subprojects/wlroots/protocol/viewporter-protocol.h"
...
struct wp_viewport_interface {
 ...
 void (*destroy)(struct wl_client *client,
   struct wl_resource *resource);
# 308 "subprojects/wlroots/protocol/viewporter-protocol.h"
 void (*set_source)(struct wl_client *client,
      ...
      wl_fixed_t width,
      wl_fixed_t height);
# 331 "subprojects/wlroots/protocol/viewporter-protocol.h"
 void (*set_destination)(struct wl_client *client,
    struct wl_resource *resource,
    int32_t width,
    int32_t height);
};
# 8 "../subprojects/wlroots/types/wlr_viewporter.c" 2
...
static struct wlr_viewport *viewport_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wp_viewport_interface, &viewport_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wp_viewport_interface, &viewport_impl)", "types/wlr_viewporter.c", 26, __extension__ __PRETTY_FUNCTION__));
...
static void viewport_destroy(struct wlr_viewport *viewport) {
 ...
 wl_resource_set_user_data(viewport->resource, ((void*)0));
 wl_list_remove(&viewport->surface_client_commit.link);
 free(viewport);
}

static void surface_addon_destroy(struct wlr_addon *addon) {
 struct wlr_viewport *viewport = (__typeof__(viewport))((char *)(addon) - __builtin_offsetof(__typeof__(*viewport), addon));
...
static _Bool check_src_buffer_bounds(const struct wlr_surface_state *state) {
...
static void viewport_handle_surface_client_commit(struct wl_listener *listener,
 ...
 struct wlr_viewport *viewport =
  (__typeof__(viewport))((char *)(listener) - __builtin_offsetof(__typeof__(*viewport), surface_client_commit));
 ...
 if (state->viewport.has_src && state->buffer != ((void*)0) &&
...
static void viewporter_handle_get_viewport(struct wl_client *client,
 ...
 if (wlr_addon_find(&surface->addons, ((void*)0), &surface_addon_impl) != ((void*)0)) {
 ...
 wlr_addon_init(&viewport->addon, &surface->addons, ((void*)0), &surface_addon_impl);
...
static void viewporter_bind(struct wl_client *client, void *data,
 ...
 wl_resource_set_implementation(resource, &viewporter_impl, viewporter, ((void*)0));
}

static void handle_display_destroy(struct wl_listener *listener, void *data) {
 struct wlr_viewporter *viewporter =
  (__typeof__(viewporter))((char *)(listener) - __builtin_offsetof(__typeof__(*viewporter), display_destroy));
 wl_signal_emit_mutable(&viewporter->events.destroy, ((void*)0));
...
struct wlr_viewporter *wlr_viewporter_create(struct wl_display *display) {
 ...
 if (viewporter == ((void*)0)) {
  return ((void*)0);
 }

 viewporter->global = wl_global_create(display, &wp_viewporter_interface,
  1, viewporter, viewporter_bind);
 if (viewporter->global == ((void*)0)) {
  free(viewporter);
  return ((void*)0);
 }
