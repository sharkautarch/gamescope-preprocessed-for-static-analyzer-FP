# 1 "protocol/gamescope-control-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 383 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "protocol/gamescope-control-protocol.c" 2
# 26 "protocol/gamescope-control-protocol.c"
...
# 27 "protocol/gamescope-control-protocol.c" 2
...
# 28 "protocol/gamescope-control-protocol.c" 2
...
# 29 "protocol/gamescope-control-protocol.c" 2
# 41 "protocol/gamescope-control-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface gamescope_control_interface = {
 "gamescope_control", 3,
