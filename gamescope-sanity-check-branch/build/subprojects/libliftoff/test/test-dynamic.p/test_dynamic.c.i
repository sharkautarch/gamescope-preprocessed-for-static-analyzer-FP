# 1 "../subprojects/libliftoff/test/test_dynamic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/libliftoff/test/test_dynamic.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/libliftoff/test/test_dynamic.c" 2
...
# 3 "../subprojects/libliftoff/test/test_dynamic.c" 2
...
# 4 "../subprojects/libliftoff/test/test_dynamic.c" 2
...
# 5 "../subprojects/libliftoff/test/test_dynamic.c" 2
...
# 7 "../subprojects/libliftoff/test/test_dynamic.c" 2
...
# 8 "../subprojects/libliftoff/test/test_dynamic.c" 2
...
liftoff_mock_plane_add_in_formats(struct liftoff_mock_plane *plane,
      ...
      size_t size);
# 9 "../subprojects/libliftoff/test/test_dynamic.c" 2
...
first_commit(struct context *ctx)
{
 ...
 ((ctx->commit_count == 0) ? (void) (0) : __assert_fail ("ctx->commit_count == 0", "../subprojects/libliftoff/test/test_dynamic.c", 50, __extension__ __PRETTY_FUNCTION__));

 req = drmModeAtomicAlloc();
 ret = liftoff_output_apply(ctx->output, req, 0);
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_dynamic.c", 54, __extension__ __PRETTY_FUNCTION__));
 ret = drmModeAtomicCommit(ctx->drm_fd, req, 0, ((void*)0));
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_dynamic.c", 56, __extension__ __PRETTY_FUNCTION__));
 ...
 ((ctx->commit_count > 1) ? (void) (0) : __assert_fail ("ctx->commit_count > 1", "../subprojects/libliftoff/test/test_dynamic.c", 65, __extension__ __PRETTY_FUNCTION__));
}

static void
second_commit(struct context *ctx, _Bool want_reuse_prev_alloc)
{
 drmModeAtomicReq *req;
 int ret;
 ...
 req = drmModeAtomicAlloc();
 ret = liftoff_output_apply(ctx->output, req, 0);
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_dynamic.c", 76, __extension__ __PRETTY_FUNCTION__));
 if (want_reuse_prev_alloc) {


  ((liftoff_mock_commit_count == ctx->commit_count + 1) ? (void) (0) : __assert_fail ("liftoff_mock_commit_count == ctx->commit_count + 1", "../subprojects/libliftoff/test/test_dynamic.c", 80, __extension__ __PRETTY_FUNCTION__));
 } else {


  ((liftoff_mock_commit_count > ctx->commit_count + 1) ? (void) (0) : __assert_fail ("liftoff_mock_commit_count > ctx->commit_count + 1", "../subprojects/libliftoff/test/test_dynamic.c", 84, __extension__ __PRETTY_FUNCTION__));
 }
 ret = drmModeAtomicCommit(ctx->drm_fd, req, 0, ((void*)0));
 ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_dynamic.c", 87, __extension__ __PRETTY_FUNCTION__));
 drmModeAtomicFree(req);
}
...
{
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 95, __extension__ __PRETTY_FUNCTION__));

 second_commit(ctx, 1);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 98, __extension__ __PRETTY_FUNCTION__));
}
...
run_change_fb(struct context *ctx)
{
 ...
 fb_info = (drmModeFB2) {
  ...
  .modifier = ((((__u64)0) << 56) | ((0) & 0x00ffffffffffffffULL)),
 };
 liftoff_mock_drm_set_fb_info(&fb_info);
 liftoff_layer_set_property(ctx->layer, "FB_ID", fb_id);

 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 120, __extension__ __PRETTY_FUNCTION__));
 ...
 second_commit(ctx, 1);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 129, __extension__ __PRETTY_FUNCTION__));
}
...
run_change_fb_modifier(struct context *ctx)
{
 ...
 fb_info = (drmModeFB2) {
  ...
  .flags = (1<<1),
  .pixel_format = ((__u32)('A') | ((__u32)('R') << 8) | ((__u32)('2') << 16) | ((__u32)('4') << 24)),
  .modifier = ((((__u64)0x01) << 56) | ((2) & 0x00ffffffffffffffULL)),
 };
 liftoff_mock_drm_set_fb_info(&fb_info);
 liftoff_layer_set_property(ctx->layer, "FB_ID", fb_id);

 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 151, __extension__ __PRETTY_FUNCTION__));




 fb_info.modifier = ((((__u64)0x01) << 56) | ((1) & 0x00ffffffffffffffULL));
 liftoff_mock_drm_set_fb_info(&fb_info);
 liftoff_layer_set_property(ctx->layer, "FB_ID", fb_id);

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 161, __extension__ __PRETTY_FUNCTION__));
}
...
{
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 168, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_set_property(ctx->layer, "FB_ID", 0);

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ((void*)0)) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == NULL", "../subprojects/libliftoff/test/test_dynamic.c", 173, __extension__ __PRETTY_FUNCTION__));
}
...
run_set_fb(struct context *ctx)
{
 liftoff_layer_set_property(ctx->layer, "FB_ID", 0);
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ((void*)0)) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == NULL", "../subprojects/libliftoff/test/test_dynamic.c", 181, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_set_property(ctx->layer, "FB_ID",
       liftoff_mock_drm_create_fb(ctx->layer));

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 187, __extension__ __PRETTY_FUNCTION__));
}
...
{
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 194, __extension__ __PRETTY_FUNCTION__));

 add_layer(ctx->output, 0, 0, 256, 256);

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 199, __extension__ __PRETTY_FUNCTION__));
}
...
{
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 206, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_destroy(ctx->other_layer);
 ctx->other_layer = ((void*)0);

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 212, __extension__ __PRETTY_FUNCTION__));
}
...
{
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 219, __extension__ __PRETTY_FUNCTION__));

 liftoff_output_set_composition_layer(ctx->output, ctx->layer);

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 224, __extension__ __PRETTY_FUNCTION__));
}
...
run_change_alpha(struct context *ctx)
{
 ...
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 233, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_set_property(ctx->layer, "alpha", 43);

 second_commit(ctx, 1);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 238, __extension__ __PRETTY_FUNCTION__));
}

static void
run_set_alpha_from_opaque(struct context *ctx)
{
 liftoff_layer_set_property(ctx->layer, "alpha", 0xFFFF);

 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 247, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_set_property(ctx->layer, "alpha", 42);

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 252, __extension__ __PRETTY_FUNCTION__));
}

static void
run_set_alpha_from_transparent(struct context *ctx)
{
 liftoff_layer_set_property(ctx->layer, "alpha", 0);

 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ((void*)0)) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == NULL", "../subprojects/libliftoff/test/test_dynamic.c", 261, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_set_property(ctx->layer, "alpha", 42);

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 266, __extension__ __PRETTY_FUNCTION__));
}
...
run_unset_alpha_to_opaque(struct context *ctx)
{
 ...
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 275, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_set_property(ctx->layer, "alpha", 0xFFFF);

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 280, __extension__ __PRETTY_FUNCTION__));
}
...
run_unset_alpha_to_transparent(struct context *ctx)
{
 ...
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 289, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_set_property(ctx->layer, "alpha", 0);

 second_commit(ctx, 0);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ((void*)0)) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == NULL", "../subprojects/libliftoff/test/test_dynamic.c", 294, __extension__ __PRETTY_FUNCTION__));
}
...
run_change_in_fence_fd(struct context *ctx)
{
 ...
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 303, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_set_property(ctx->layer, "IN_FENCE_FD", 43);

 second_commit(ctx, 1);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 308, __extension__ __PRETTY_FUNCTION__));
}
...
run_change_fb_damage_clips(struct context *ctx)
{
 ...
 first_commit(ctx);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 317, __extension__ __PRETTY_FUNCTION__));

 liftoff_layer_set_property(ctx->layer, "FB_DAMAGE_CLIPS", 43);

 second_commit(ctx, 1);
 ((liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(ctx->mock_plane) == ctx->layer", "../subprojects/libliftoff/test/test_dynamic.c", 322, __extension__ __PRETTY_FUNCTION__));
}
...
run(const struct test_case *test)
{
 ...
 ctx.mock_plane = liftoff_mock_drm_create_plane(1);

 liftoff_mock_drm_create_plane(2);
 ...
 ((device != ((void*)0)) ? (void) (0) : __assert_fail ("device != NULL", "../subprojects/libliftoff/test/test_dynamic.c", 377, __extension__ __PRETTY_FUNCTION__));
