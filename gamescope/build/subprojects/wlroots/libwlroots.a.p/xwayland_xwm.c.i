# 1 "../subprojects/wlroots/xwayland/xwm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/xwayland/xwm.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/xwayland/xwm.c" 2
...
# 3 "../subprojects/wlroots/xwayland/xwm.c" 2
...
# 4 "../subprojects/wlroots/xwayland/xwm.c" 2
# 1 "subprojects/wlroots/include/wlr/config.h" 1
# 5 "../subprojects/wlroots/xwayland/xwm.c" 2
...
# 14 "../subprojects/wlroots/include/wlr/types/wlr_compositor.h" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 6 "../subprojects/wlroots/xwayland/xwm.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_data_device.h" 1
# 13 "../subprojects/wlroots/include/wlr/types/wlr_data_device.h"
...
void wlr_data_source_dnd_action(struct wlr_data_source *source,
 enum wl_data_device_manager_dnd_action action);
# 7 "../subprojects/wlroots/xwayland/xwm.c" 2
...
void wlr_seat_set_primary_selection(struct wlr_seat *seat,
 struct wlr_primary_selection_source *source, uint32_t serial);
# 8 "../subprojects/wlroots/xwayland/xwm.c" 2
...
# 9 "../subprojects/wlroots/xwayland/xwm.c" 2
...
# 10 "../subprojects/wlroots/xwayland/xwm.c" 2
# 1 "../subprojects/wlroots/include/wlr/xcursor.h" 1
# 52 "../subprojects/wlroots/include/wlr/xcursor.h"
...
# 11 "../subprojects/wlroots/xwayland/xwm.c" 2
# 1 "../subprojects/wlroots/include/wlr/xwayland/shell.h" 1
# 20 "../subprojects/wlroots/include/wlr/xwayland/shell.h"
...
# 12 "../subprojects/wlroots/xwayland/xwm.c" 2
...
# 13 "../subprojects/wlroots/xwayland/xwm.c" 2
# 1 "/usr/include/xcb/composite.h" 1 3 4
# 17 "/usr/include/xcb/composite.h" 3 4
# 1 "/usr/include/xcb/xfixes.h" 1 3 4
# 17 "/usr/include/xcb/xfixes.h" 3 4
...
xcb_xfixes_get_client_disconnect_mode_reply (xcb_connection_t *c,
                                             ...
                                             xcb_generic_error_t **e);
# 18 "/usr/include/xcb/composite.h" 2 3 4
...
# 590 "/usr/include/xcb/res.h" 3 4
xcb_res_query_clients_cookie_t
xcb_res_query_clients (xcb_connection_t *c);
# 604 "/usr/include/xcb/res.h" 3 4
xcb_res_query_clients_cookie_t
...
# 646 "/usr/include/xcb/res.h" 3 4
xcb_res_query_client_resources_cookie_t
xcb_res_query_client_resources (xcb_connection_t *c,
                                uint32_t xid);
# 661 "/usr/include/xcb/res.h" 3 4
xcb_res_query_client_resources_cookie_t
...
# 10 "../subprojects/wlroots/include/xwayland/xwm.h" 2
...
# 18 "../subprojects/wlroots/xwayland/xwm.c" 2
...
struct wlr_xwayland_surface *wlr_xwayland_surface_try_from_wlr_surface(
  struct wlr_surface *surface) {
 struct wlr_addon *addon = wlr_addon_find(&surface->addons, ((void*)0), &surface_addon_impl);
 if (addon == ((void*)0)) {
  return ((void*)0);
 }
 struct wlr_xwayland_surface *xsurface = (__typeof__(xsurface))((char *)(addon) - __builtin_offsetof(__typeof__(*xsurface), surface_addon));
 return xsurface;
}
...
static struct wlr_xwayland_surface *lookup_surface(struct wlr_xwm *xwm,
  xcb_window_t window_id) {
 struct wlr_xwayland_surface *surface;
 for (surface = (__typeof__(surface))((char *)((&xwm->surfaces)->next) - __builtin_offsetof(__typeof__(*surface), link)); &surface->link != (&xwm->surfaces); surface = (__typeof__(surface))((char *)(surface->link.next) - __builtin_offsetof(__typeof__(*surface), link))) {
...
static int xwayland_surface_handle_ping_timeout(void *data) {
 ...
 wl_signal_emit_mutable(&surface->events.ping_timeout, ((void*)0));
 surface->pinging = 0;
 return 1;
}
...
static struct wlr_xwayland_surface *xwayland_surface_create(
  ...
  uint16_t width, uint16_t height, _Bool override_redirect) {
 struct wlr_xwayland_surface *surface = calloc(1, sizeof(*surface));
 if (!surface) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Could not allocate wlr xwayland surface", "xwayland/xwm.c", 167);
  return ((void*)0);
 }
 ...
 xcb_get_geometry_reply_t *geometry_reply =
  xcb_get_geometry_reply(xwm->xcb_conn, geometry_cookie, ((void*)0));
 if (geometry_reply != ((void*)0)) {
 ...
 if (surface->ping_timer == ((void*)0)) {
  free(surface);
  _wlr_log(WLR_ERROR, "[%s:%d] " "Could not add timer to event loop", "xwayland/xwm.c", 238);
  return ((void*)0);
 }
...
static void xwm_set_net_client_list(struct wlr_xwm *xwm) {
 ...
 struct wlr_xwayland_surface *surface;
 for (surface = (__typeof__(surface))((char *)((&xwm->surfaces)->next) - __builtin_offsetof(__typeof__(*surface), link)); &surface->link != (&xwm->surfaces); surface = (__typeof__(surface))((char *)(surface->link.next) - __builtin_offsetof(__typeof__(*surface), link))) {
  if (surface->surface != ((void*)0) && surface->surface->mapped) {
   mapped_surfaces++;
  }
 }

 xcb_window_t *windows = ((void*)0);
...
static void xwm_set_net_client_list_stacking(struct wlr_xwm *xwm) {
 ...
 size_t i = 0;
 struct wlr_xwayland_surface *xsurface;
 for (xsurface = (__typeof__(xsurface))((char *)((&xwm->surfaces_in_stack_order)->next) - __builtin_offsetof(__typeof__(*xsurface), stack_link)); &xsurface->stack_link != (&xwm->surfaces_in_stack_order); xsurface = (__typeof__(xsurface))((char *)(xsurface->stack_link.next) - __builtin_offsetof(__typeof__(*xsurface), stack_link))) {
...
static void xwm_set_focus_window(struct wlr_xwm *xwm,
 ...
 if (xsurface->hints && !xsurface->hints->input) {
  ...
  xcb_void_cookie_t cookie = xcb_set_input_focus(xwm->xcb_conn,
   XCB_INPUT_FOCUS_POINTER_ROOT, xsurface->window_id, 0L);
...
static void xsurface_set_net_wm_state(struct wlr_xwayland_surface *xsurface) {
 ...
 ((i <= sizeof(property) / sizeof(property[0])) ? (void) (0) : __assert_fail ("i <= sizeof(property) / sizeof(property[0])", "xwayland/xwm.c", 427, __extension__ __PRETTY_FUNCTION__));
...
static void xwayland_surface_dissociate(struct wlr_xwayland_surface *xsurface) {
 if (xsurface->surface != ((void*)0)) {
  wlr_surface_unmap(xsurface->surface);
  wl_signal_emit_mutable(&xsurface->events.dissociate, ((void*)0));
...
static void xwayland_surface_destroy(struct wlr_xwayland_surface *xsurface) {
 ...
 wl_signal_emit_mutable(&xsurface->events.destroy, ((void*)0));

 if (xsurface == xsurface->xwm->focus_surface) {
  xwm_surface_activate(xsurface->xwm, ((void*)0));
 }
 ...
 for (child = (__typeof__(child))((char *)((&xsurface->children)->next) - __builtin_offsetof(__typeof__(*child), parent_link)), next = (__typeof__(next))((char *)((child)->parent_link.next) - __builtin_offsetof(__typeof__(*next), parent_link)); &child->parent_link != (&xsurface->children); child = next, next = (__typeof__(next))((char *)(child->parent_link.next) - __builtin_offsetof(__typeof__(*next), parent_link))) {
...
static void read_surface_class(struct wlr_xwm *xwm,
 ...
 if (len > 0 && instance_len < len) {
  ...
  surface->instance = ((void*)0);
 }
 free(surface->class);
 if (len > 0) {
  surface->class = strndup(class, len);
 } else {
  surface->class = ((void*)0);
 }

 wl_signal_emit_mutable(&surface->events.set_class, ((void*)0));
}
...
static void read_surface_startup_id(struct wlr_xwm *xwm,
 ...
 if (len > 0) {
  ...
  xsurface->startup_id = ((void*)0);
 }

 _wlr_log(WLR_DEBUG, "[%s:%d] " "XCB_ATOM_NET_STARTUP_ID: %s", "xwayland/xwm.c", 547, xsurface->startup_id ? xsurface->startup_id: "(null)");

 wl_signal_emit_mutable(&xsurface->events.set_startup_id, ((void*)0));
}
...
static void read_surface_role(struct wlr_xwm *xwm,
 ...
 if (len > 0) {
  ...
  xsurface->role = ((void*)0);
 }

 wl_signal_emit_mutable(&xsurface->events.set_role, ((void*)0));
}
...
static void read_surface_title(struct wlr_xwm *xwm,
 ...
 _Bool is_utf8 = reply->type == xwm->atoms[UTF8_STRING];
 ...
 if (len > 0) {
  ...
  xsurface->title = ((void*)0);
 }
 xsurface->has_utf8_title = is_utf8;

 wl_signal_emit_mutable(&xsurface->events.set_title, ((void*)0));
}

static _Bool has_parent(struct wlr_xwayland_surface *parent,
...
static void read_surface_parent(struct wlr_xwm *xwm,
  struct wlr_xwayland_surface *xsurface,
  xcb_get_property_reply_t *reply) {
 struct wlr_xwayland_surface *found_parent = ((void*)0);
 ...
 if (xid != ((void*)0)) {
  ...
  if (!has_parent(found_parent, xsurface)) {
   ...
   _wlr_log(WLR_INFO, "[%s:%d] " "%p with %p would create a loop", "xwayland/xwm.c", 627, xsurface, found_parent);

  }
 } else {
  xsurface->parent = ((void*)0);
 }


 wl_list_remove(&xsurface->parent_link);
 if (xsurface->parent != ((void*)0)) {
  wl_list_insert(&xsurface->parent->children, &xsurface->parent_link);
 } else {
  wl_list_init(&xsurface->parent_link);
 }

 wl_signal_emit_mutable(&xsurface->events.set_parent, ((void*)0));
}
...
static void read_surface_window_type(struct wlr_xwm *xwm,
 ...
 if (xsurface->window_type == ((void*)0)) {
  return;
 }
 memcpy(xsurface->window_type, atoms, atoms_size);
 xsurface->window_type_len = atoms_len;

 wl_signal_emit_mutable(&xsurface->events.set_window_type, ((void*)0));
}
...
static void read_surface_hints(struct wlr_xwm *xwm,
 ...
 if (!(xsurface->hints->flags & XCB_ICCCM_WM_HINT_INPUT)) {
  ...
  xsurface->hints->input = 1;
 }

 wl_signal_emit_mutable(&xsurface->events.set_hints, ((void*)0));
}
...
static void read_surface_normal_hints(struct wlr_xwm *xwm,
 ...
 if (xsurface->size_hints == ((void*)0)) {
  return;
 }
 xcb_icccm_get_wm_size_hints_from_reply(xsurface->size_hints, reply);

 int32_t flags = xsurface->size_hints->flags;
 _Bool has_min_size_hints = (flags & XCB_ICCCM_SIZE_HINT_P_MIN_SIZE) != 0;
 _Bool has_base_size_hints = (flags & XCB_ICCCM_SIZE_HINT_BASE_SIZE) != 0;
...
# 757 "../subprojects/wlroots/xwayland/xwm.c"
static void read_surface_motif_hints(struct wlr_xwm *xwm,
 ...
 if (motif_hints[0] & (1 << 1)) {
  xsurface->decorations = WLR_XWAYLAND_SURFACE_DECORATIONS_ALL;
  uint32_t decorations = motif_hints[2];
  if ((decorations & (1 << 0)) == 0) {
   if ((decorations & (1 << 1)) == 0) {
    xsurface->decorations |=
     WLR_XWAYLAND_SURFACE_DECORATIONS_NO_BORDER;
   }
   if ((decorations & (1 << 3)) == 0) {
    xsurface->decorations |=
     WLR_XWAYLAND_SURFACE_DECORATIONS_NO_TITLE;
   }
  }
  wl_signal_emit_mutable(&xsurface->events.set_decorations, ((void*)0));
 }
}
...
static void read_surface_strut_partial(struct wlr_xwm *xwm,
 ...
 if (xsurface->strut_partial == ((void*)0)) {
  return;
 }
 xcb_ewmh_get_wm_strut_partial_from_reply(xsurface->strut_partial, reply);
 wl_signal_emit_mutable(&xsurface->events.set_strut_partial, ((void*)0));
}
...
char *xwm_get_atom_name(struct wlr_xwm *xwm, xcb_atom_t atom) {
 ...
 xcb_get_atom_name_reply_t *name_reply =
  xcb_get_atom_name_reply(xwm->xcb_conn, name_cookie, ((void*)0));
 if (name_reply == ((void*)0)) {
  return ((void*)0);
 }
 size_t len = xcb_get_atom_name_name_length(name_reply);
 char *buf = xcb_get_atom_name_name(name_reply);
...
static void read_surface_property(struct wlr_xwm *xwm,
 ...
 if (property == XCB_ATOM_WM_CLASS) {
  ...
  _wlr_log(WLR_DEBUG, "[%s:%d] " "unhandled X11 property %" "u" " (%s) for window %" "u", "xwayland/xwm.c", 868, property, prop_name ? prop_name : "(null)", xsurface->window_id);
...
static void xwayland_surface_handle_commit(struct wl_listener *listener, void *data) {
 struct wlr_xwayland_surface *xsurface = (__typeof__(xsurface))((char *)(listener) - __builtin_offsetof(__typeof__(*xsurface), surface_commit));
...
static void xwayland_surface_handle_map(struct wl_listener *listener, void *data) {
 struct wlr_xwayland_surface *xsurface = (__typeof__(xsurface))((char *)(listener) - __builtin_offsetof(__typeof__(*xsurface), surface_map));
 xwm_set_net_client_list(xsurface->xwm);
}

static void xwayland_surface_handle_unmap(struct wl_listener *listener, void *data) {
 struct wlr_xwayland_surface *xsurface = (__typeof__(xsurface))((char *)(listener) - __builtin_offsetof(__typeof__(*xsurface), surface_unmap));
 xwm_set_net_client_list(xsurface->xwm);
}
...
static void xwayland_surface_associate(struct wlr_xwm *xwm,
 ...
 ((xsurface->surface == ((void*)0)) ? (void) (0) : __assert_fail ("xsurface->surface == NULL", "xwayland/xwm.c", 902, __extension__ __PRETTY_FUNCTION__));
 ...
 wlr_addon_init(&xsurface->surface_addon, &surface->addons, ((void*)0), &surface_addon_impl);
 ...
 for (size_t i = 0; i < sizeof(props) / sizeof(props[0]); i++) {
  xcb_get_property_reply_t *reply =
   xcb_get_property_reply(xwm->xcb_conn, cookies[i], ((void*)0));
  if (reply == ((void*)0)) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get window property", "xwayland/xwm.c", 946);
   continue;
  }
 ...
 wl_signal_emit_mutable(&xsurface->events.associate, ((void*)0));
}
...
static void xwm_update_override_redirect(struct wlr_xwayland_surface *xsurface,
 ...
 if (override_redirect) {
  ...
  wl_list_init(&xsurface->stack_link);
  xwm_set_net_client_list_stacking(xsurface->xwm);
 } else if (xsurface->surface != ((void*)0) && xsurface->surface->mapped) {
  wlr_xwayland_surface_restack(xsurface, ((void*)0), XCB_STACK_MODE_BELOW);
 }

 wl_signal_emit_mutable(&xsurface->events.set_override_redirect, ((void*)0));
}
...
static void xwm_handle_configure_notify(struct wlr_xwm *xwm,
 ...
 if (geometry_changed) {
  wl_signal_emit_mutable(&xsurface->events.set_geometry, ((void*)0));
 }
}
...
void wlr_xwayland_surface_restack(struct wlr_xwayland_surface *xsurface,
 ...
 ((!xsurface->override_redirect) ? (void) (0) : __assert_fail ("!xsurface->override_redirect", "xwayland/xwm.c", 1078, __extension__ __PRETTY_FUNCTION__));



 if (mode == XCB_STACK_MODE_ABOVE && !sibling) {
  sibling = (__typeof__(sibling))((char *)(xwm->surfaces_in_stack_order.prev) - __builtin_offsetof(__typeof__(*sibling), stack_link));
 }
...
static void xwm_handle_map_request(struct wlr_xwm *xwm,
 ...
 wl_signal_emit_mutable(&xsurface->events.map_request, ((void*)0));
...
static void xwm_handle_map_notify(struct wlr_xwm *xwm,
 ...
 if (!xsurface->override_redirect) {
  wlr_xwayland_surface_set_withdrawn(xsurface, 0);
  wlr_xwayland_surface_restack(xsurface, ((void*)0), XCB_STACK_MODE_BELOW);
 }
}
...
static void xwm_handle_unmap_notify(struct wlr_xwm *xwm,
 ...
 if (!xsurface->override_redirect) {
  wlr_xwayland_surface_set_withdrawn(xsurface, 1);
 }
}
...
static void xwm_handle_property_notify(struct wlr_xwm *xwm,
 ...
 xcb_get_property_reply_t *reply =
  xcb_get_property_reply(xwm->xcb_conn, cookie, ((void*)0));
 if (reply == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Failed to get window property", "xwayland/xwm.c", 1172);
  return;
 }
...
static void xwm_handle_surface_id_message(struct wlr_xwm *xwm,
 ...
 struct wlr_xwayland_surface *xsurface = lookup_surface(xwm, ev->window);
 if (xsurface == ((void*)0)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "client message WL_SURFACE_ID but no new window %u ?", "xwayland/xwm.c", 1186, ev->window);
...
static void xwm_handle_surface_serial_message(struct wlr_xwm *xwm,
 ...
 struct wlr_xwayland_surface *xsurface = lookup_surface(xwm, ev->window);
 if (xsurface == ((void*)0)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Received client message WL_SURFACE_SERIAL but no X11 window %u", "xwayland/xwm.c", 1209, ev->window);


  return;
 }
 if (xsurface->serial != 0) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Received multiple client messages WL_SURFACE_SERIAL " "for the same X11 window %u", "xwayland/xwm.c", 1214, ev->window);
...
# 1245 "../subprojects/wlroots/xwayland/xwm.c"
...
static void xwm_handle_net_wm_moveresize_message(struct wlr_xwm *xwm,
 ...
 switch (detail) {
 case 8:
  wl_signal_emit_mutable(&xsurface->events.request_move, ((void*)0));
  break;
 case 0:
 case 1:
 case 2:
...
static _Bool update_state(int action, _Bool *state) {
...
static _Bool xsurface_is_maximized(
  struct wlr_xwayland_surface *xsurface) {
...
static void xwm_handle_net_wm_state_message(struct wlr_xwm *xwm,
 ...
 _Bool fullscreen = xsurface->fullscreen;
 _Bool maximized = xsurface_is_maximized(xsurface);
 _Bool minimized = xsurface->minimized;
 ...
 for (size_t i = 0; i < 2; ++i) {
  ...
  if (property == xwm->atoms[NET_WM_STATE_MODAL]) {
   ...
   char *prop_name = xwm_get_atom_name(xwm, property);
   _wlr_log(WLR_DEBUG, "[%s:%d] " "Unhandled NET_WM_STATE property change " "%""u"" (%s)", "xwayland/xwm.c", 1365, property, prop_name ? prop_name : "(null)");
 ...
 if (fullscreen != xsurface->fullscreen) {
  ...
  wl_signal_emit_mutable(&xsurface->events.request_fullscreen, ((void*)0));
 }
 ...
 if (maximized != xsurface_is_maximized(xsurface)) {
  ...
  wl_signal_emit_mutable(&xsurface->events.request_maximize, ((void*)0));
 }
...
static void xwm_handle_wm_protocols_message(struct wlr_xwm *xwm,
 ...
 if (type == xwm->atoms[NET_WM_PING]) {
  ...
  _wlr_log(WLR_DEBUG, "[%s:%d] " "unhandled WM_PROTOCOLS client message %" "u" " (%s)", "xwayland/xwm.c", 1429, type, type_name ? type_name : "(null)");
...
static void xwm_handle_net_active_window_message(struct wlr_xwm *xwm,
 ...
 wl_signal_emit_mutable(&surface->events.request_activate, ((void*)0));
}
...
static void xwm_handle_net_startup_info_message(struct wlr_xwm *xwm,
  xcb_client_message_event_t *ev) {
 struct pending_startup_id *pending, *curr = ((void*)0);
 for (pending = (__typeof__(pending))((char *)((&xwm->pending_startup_ids)->next) - __builtin_offsetof(__typeof__(*pending), link)); &pending->link != (&xwm->pending_startup_ids); pending = (__typeof__(pending))((char *)(pending->link.next) - __builtin_offsetof(__typeof__(*pending), link))) {
 ...
 for (size_t i = 0; i < buf_len; i++) {
  start[i] = data[i];
  if (start[i] == '\0') {
   if (strncmp(curr->msg, "remove: ID=",
     strlen("remove: ID=")) == 0 &&
     strlen(curr->msg) > strlen("remove: ID=")) {
    id = curr->msg + strlen("remove: ID=");
    break;
   } else {
    _wlr_log(WLR_ERROR, "[%s:%d] " "Unhandled message '%s'\n", "xwayland/xwm.c", 1495, curr->msg);
    pending_startup_id_destroy(curr);
    return;
   }
  }
 ...
 if (id) {
  ...
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Got startup id: %s", "xwayland/xwm.c", 1504, id);
...
static void xwm_handle_wm_change_state_message(struct wlr_xwm *xwm,
 ...
 if (detail == XCB_ICCCM_WM_STATE_ICONIC) {
  ...
  _wlr_log(WLR_DEBUG, "[%s:%d] " "unhandled wm_change_state event %u", "xwayland/xwm.c", 1525, detail);
  return;
 }
...
static void xwm_handle_client_message(struct wlr_xwm *xwm,
 ...
 if (ev->type == xwm->atoms[WL_SURFACE_ID]) {
  ...
  _wlr_log(WLR_DEBUG, "[%s:%d] " "unhandled x11 client message %" "u" " (%s)", "xwayland/xwm.c", 1559, ev->type, type_name ? type_name : "(null)");

  free(type_name);
 }
}

static _Bool validate_focus_serial(uint16_t last_focus_seq, uint16_t event_seq) {
...
# 1595 "../subprojects/wlroots/xwayland/xwm.c"
...
static void xwm_handle_xcb_error(struct wlr_xwm *xwm, xcb_value_error_t *ev) {
 ...
 const char *major_name =
  xcb_errors_get_name_for_major_code(xwm->errors_context,
   ev->major_opcode);
 if (!major_name) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "xcb error happened, but could not get major name", "xwayland/xwm.c", 1611);
  goto log_raw;
 }
 ...
 if (!error_name) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "xcb error happened, but could not get error name", "xwayland/xwm.c", 1624);
  goto log_raw;
 }

 _wlr_log(WLR_ERROR, "[%s:%d] " "xcb error: op %s (%s), code %s (%s), sequence %""u"", value %""u", "xwayland/xwm.c", 1631, major_name, minor_name ? minor_name : "no minor", error_name, extension ? extension : "no extension", ev->sequence, ev->bad_value);
...
log_raw:
 ...
 _wlr_log(WLR_ERROR, "[%s:%d] " "xcb error: op %""u"":%""u"", code %""u"", sequence %""u"", value %""u", "xwayland/xwm.c", 1639, ev->major_opcode, ev->minor_opcode, ev->error_code, ev->sequence, ev->bad_value);
...
static void xwm_handle_unhandled_event(struct wlr_xwm *xwm, xcb_generic_event_t *ev) {
 ...
 const char *event_name =
  xcb_errors_get_name_for_xcb_event(xwm->errors_context,
   ev, &extension);
 if (!event_name) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "no name for unhandled event: %u", "xwayland/xwm.c", 1651, ev->response_type);

  return;
 }

 _wlr_log(WLR_DEBUG, "[%s:%d] " "unhandled X11 event: %s (%u)", "xwayland/xwm.c", 1655, event_name, ev->response_type);
...
static void handle_compositor_new_surface(struct wl_listener *listener,
  void *data) {
 struct wlr_xwm *xwm =
  (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), compositor_new_surface));
 ...
 _wlr_log(WLR_DEBUG, "[%s:%d] " "New xwayland surface: %p", "xwayland/xwm.c", 1747, surface);

 uint32_t surface_id = wl_resource_get_id(surface->resource);
 struct wlr_xwayland_surface *xsurface;
 for (xsurface = (__typeof__(xsurface))((char *)((&xwm->unpaired_surfaces)->next) - __builtin_offsetof(__typeof__(*xsurface), unpaired_link)); &xsurface->unpaired_link != (&xwm->unpaired_surfaces); xsurface = (__typeof__(xsurface))((char *)(xsurface->unpaired_link.next) - __builtin_offsetof(__typeof__(*xsurface), unpaired_link))) {
...
static void handle_compositor_destroy(struct wl_listener *listener,
  void *data) {
 struct wlr_xwm *xwm =
  (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), compositor_destroy));
...
static void handle_shell_v1_new_surface(struct wl_listener *listener,
  void *data) {
 struct wlr_xwm *xwm = (__typeof__(xwm))((char *)(listener) - __builtin_offsetof(__typeof__(*xwm), shell_v1_new_surface));
...
void xwm_destroy(struct wlr_xwm *xwm) {
 ...
 if (xwm->seat) {
  if (xwm->seat->selection_source &&
   ...
   wlr_seat_set_selection(xwm->seat, ((void*)0),
  ...
  if (xwm->seat->primary_selection_source &&
   ...
   wlr_seat_set_primary_selection(xwm->seat, ((void*)0),
    wl_display_next_serial(xwm->xwayland->wl_display));
  }

  wlr_xwayland_set_seat(xwm->xwayland, ((void*)0));
 }
 ...
 for (xsurface = (__typeof__(xsurface))((char *)((&xwm->surfaces)->next) - __builtin_offsetof(__typeof__(*xsurface), link)), tmp = (__typeof__(tmp))((char *)((xsurface)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &xsurface->link != (&xwm->surfaces); xsurface = tmp, tmp = (__typeof__(tmp))((char *)(xsurface->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {
  xwayland_surface_destroy(xsurface);
 }
 for (xsurface = (__typeof__(xsurface))((char *)((&xwm->unpaired_surfaces)->next) - __builtin_offsetof(__typeof__(*xsurface), unpaired_link)), tmp = (__typeof__(tmp))((char *)((xsurface)->unpaired_link.next) - __builtin_offsetof(__typeof__(*tmp), unpaired_link)); &xsurface->unpaired_link != (&xwm->unpaired_surfaces); xsurface = tmp, tmp = (__typeof__(tmp))((char *)(xsurface->unpaired_link.next) - __builtin_offsetof(__typeof__(*tmp), unpaired_link))) {
  xwayland_surface_destroy(xsurface);
 }
 wl_list_remove(&xwm->compositor_new_surface.link);
 wl_list_remove(&xwm->compositor_destroy.link);
 ...
 for (pending = (__typeof__(pending))((char *)((&xwm->pending_startup_ids)->next) - __builtin_offsetof(__typeof__(*pending), link)), next = (__typeof__(next))((char *)((pending)->link.next) - __builtin_offsetof(__typeof__(*next), link)); &pending->link != (&xwm->pending_startup_ids); pending = next, next = (__typeof__(next))((char *)(pending->link.next) - __builtin_offsetof(__typeof__(*next), link))) {
  pending_startup_id_destroy(pending);
 }

 xwm->xwayland->xwm = ((void*)0);
 free(xwm);
}
...
static void xwm_get_resources(struct wlr_xwm *xwm) {
 ...
 for (i = 0; i < ATOM_LAST; i++) {
  ...
  if (error) {
   _wlr_log(WLR_ERROR, "[%s:%d] " "could not resolve atom %s, x11 error code %d", "xwayland/xwm.c", 1944, atom_map[i], error->error_code);
 ...
 if (!xwm->xfixes || !xwm->xfixes->present) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "xfixes not available", "xwayland/xwm.c", 1953);
 }

 xcb_xfixes_query_version_cookie_t xfixes_cookie;
 xcb_xfixes_query_version_reply_t *xfixes_reply;
 xfixes_cookie =
  xcb_xfixes_query_version(xwm->xcb_conn, 6,
   0);
 xfixes_reply =
  xcb_xfixes_query_version_reply(xwm->xcb_conn, xfixes_cookie, ((void*)0));

 _wlr_log(WLR_DEBUG, "[%s:%d] " "xfixes version: %" "u" ".%" "u", "xwayland/xwm.c", 1965, xfixes_reply->major_version, xfixes_reply->minor_version);
 ...
 xcb_res_query_version_cookie_t xres_cookie =
  xcb_res_query_version(xwm->xcb_conn, 1,
   2);
 xcb_res_query_version_reply_t *xres_reply =
  xcb_res_query_version_reply(xwm->xcb_conn, xres_cookie, ((void*)0));
 if (xres_reply == ((void*)0)) {
  return;
 }

 _wlr_log(WLR_DEBUG, "[%s:%d] " "xres version: %" "u" ".%" "u", "xwayland/xwm.c", 1986, xres_reply->server_major, xres_reply->server_minor);
...
static void xwm_get_visual_and_colormap(struct wlr_xwm *xwm) {
 ...
 if (visualtype == ((void*)0)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "No 32 bit visualtype\n", "xwayland/xwm.c", 2064);
  return;
 }
...
static void xwm_get_render_format(struct wlr_xwm *xwm) {
 ...
 xcb_render_query_pict_formats_reply_t *reply =
  xcb_render_query_pict_formats_reply(xwm->xcb_conn, cookie, ((void*)0));
 if (!reply) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Did not get any reply from xcb_render_query_pict_formats", "xwayland/xwm.c", 2083);
  return;
 }
 xcb_render_pictforminfo_iterator_t iter =
  xcb_render_query_pict_formats_formats_iterator(reply);
 xcb_render_pictforminfo_t *format = ((void*)0);
 while (iter.rem > 0) {
 ...
 if (format == ((void*)0)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "No 32 bit render format", "xwayland/xwm.c", 2099);
  free(reply);
  return;
 }
...
void xwm_set_cursor(struct wlr_xwm *xwm, const uint8_t *pixels, uint32_t stride,
 ...
 if (!xwm->render_format_id) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Cannot set xwm cursor: no render format available", "xwayland/xwm.c", 2111);
  return;
 }
 if (xwm->cursor) {
  xcb_free_cursor(xwm->xcb_conn, xwm->cursor);
 ...
 xcb_create_gc(xwm->xcb_conn, gc, pix, 0, ((void*)0));
...
struct wlr_xwm *xwm_create(struct wlr_xwayland *xwayland, int wm_fd) {
 ...
 xwm->xcb_conn = xcb_connect_to_fd(wm_fd, ((void*)0));

 int rc = xcb_connection_has_error(xwm->xcb_conn);
 if (rc) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "xcb connect failed: %d", "xwayland/xwm.c", 2165, rc);
  free(xwm);
  return ((void*)0);
 }
 ...
 if (xcb_errors_context_new(xwm->xcb_conn, &xwm->errors_context)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "Could not allocate error context", "xwayland/xwm.c", 2172);
  xwm_destroy(xwm);
  return ((void*)0);
 }
...
enum wlr_xwayland_icccm_input_model wlr_xwayland_icccm_input_model(
 const struct wlr_xwayland_surface *xsurface) {
 _Bool take_focus = xwm_atoms_contains(xsurface->xwm,
...
xcb_connection_t *wlr_xwayland_get_xwm_connection(
 struct wlr_xwayland *wlr_xwayland) {
 return wlr_xwayland->xwm ? wlr_xwayland->xwm->xcb_conn : ((void*)0);
}
