# 1 "subprojects/wlroots/protocol/pointer-gestures-unstable-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/pointer-gestures-unstable-v1-protocol.c" 2
...
# 4 "subprojects/wlroots/protocol/pointer-gestures-unstable-v1-protocol.c" 2
...
# 5 "subprojects/wlroots/protocol/pointer-gestures-unstable-v1-protocol.c" 2
...
# 6 "subprojects/wlroots/protocol/pointer-gestures-unstable-v1-protocol.c" 2
# 17 "subprojects/wlroots/protocol/pointer-gestures-unstable-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_pointer_gestures_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_pointer_gesture_swipe_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_pointer_gesture_pinch_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface zwp_pointer_gesture_hold_v1_interface = {
