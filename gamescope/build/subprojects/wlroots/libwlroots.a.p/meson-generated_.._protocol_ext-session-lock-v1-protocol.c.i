# 1 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.c" 2
# 25 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.c"
...
# 26 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.c" 2
...
# 27 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.c" 2
...
# 28 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.c" 2
# 39 "subprojects/wlroots/protocol/ext-session-lock-v1-protocol.c"
...
__attribute__ ((visibility("hidden"))) const struct wl_interface ext_session_lock_manager_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface ext_session_lock_v1_interface = {
...
__attribute__ ((visibility("hidden"))) const struct wl_interface ext_session_lock_surface_v1_interface = {
