# 1 "../subprojects/wlroots/types/data_device/wlr_data_device.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
# 3 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
# 5 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
# 6 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
# 7 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 8 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
void wlr_data_source_dnd_action(struct wlr_data_source *source,
 enum wl_data_device_manager_dnd_action action);
# 9 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_seat.h" 1
# 10 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
# 11 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
# 12 "../subprojects/wlroots/types/data_device/wlr_data_device.c" 2
...
struct wlr_seat_client *seat_client_from_data_device_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_data_device_interface, &data_device_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_data_device_interface, &data_device_impl)", "types/data_device/wlr_data_device.c", 20, __extension__ __PRETTY_FUNCTION__));
...
static void data_device_set_selection(struct wl_client *client,
 ...
 struct wlr_client_data_source *source = ((void*)0);
 ...
 struct wlr_data_source *wlr_source =
  source != ((void*)0) ? &source->source : ((void*)0);
...
static void data_device_start_drag(struct wl_client *client,
 ...
 struct wlr_surface *icon = ((void*)0);
 if (icon_resource) {
...
static void device_resource_send_selection(struct wl_resource *device_resource) {
 struct wlr_seat_client *seat_client =
  seat_client_from_data_device_resource(device_resource);
 ((seat_client != ((void*)0)) ? (void) (0) : __assert_fail ("seat_client != NULL", "types/data_device/wlr_data_device.c", 108, __extension__ __PRETTY_FUNCTION__));
 ...
 if (source != ((void*)0)) {
  ...
  wl_data_device_send_selection(device_resource, ((void*)0));
 }
}
...
void seat_client_send_selection(struct wlr_seat_client *seat_client) {
 ...
 for (offer = (__typeof__(offer))((char *)((&seat_client->seat->selection_offers)->next) - __builtin_offsetof(__typeof__(*offer), link)), tmp = (__typeof__(tmp))((char *)((offer)->link.next) - __builtin_offsetof(__typeof__(*tmp), link)); &offer->link != (&seat_client->seat->selection_offers); offer = tmp, tmp = (__typeof__(tmp))((char *)(offer->link.next) - __builtin_offsetof(__typeof__(*tmp), link))) {

  data_offer_destroy(offer);
 }

 struct wl_resource *device_resource;
 for (device_resource = 0, device_resource = wl_resource_from_link((&seat_client->data_devices)->next); wl_resource_get_link(device_resource) != (&seat_client->data_devices); device_resource = wl_resource_from_link(wl_resource_get_link(device_resource)->next)) {
...
void wlr_seat_request_set_selection(struct wlr_seat *seat,
 ...
 if (client && !wlr_seat_client_validate_event_serial(client, serial)) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Rejecting set_selection request, " "serial %""u"" was never given to client", "types/data_device/wlr_data_device.c", 149, serial);

  return;
 }

 if (seat->selection_source &&
   serial - seat->selection_serial > (4294967295U) / 2) {
  _wlr_log(WLR_DEBUG, "[%s:%d] " "Rejecting set_selection request, serial indicates superseded " "(%""u"" < %""u"")", "types/data_device/wlr_data_device.c", 156, serial, seat->selection_serial);
...
static void seat_handle_selection_source_destroy(
 ...
 struct wlr_seat *seat =
  (__typeof__(seat))((char *)(listener) - __builtin_offsetof(__typeof__(*seat), selection_source_destroy));

 wl_list_remove(&seat->selection_source_destroy.link);
 seat->selection_source = ((void*)0);
...
static struct wlr_data_device_manager *data_device_manager_from_resource(
  struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &wl_data_device_manager_interface, &data_device_manager_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &wl_data_device_manager_interface, &data_device_manager_impl)", "types/data_device/wlr_data_device.c", 222, __extension__ __PRETTY_FUNCTION__));
...
struct wlr_data_device_manager *wlr_data_device_manager_create(
 ...
 if (manager == ((void*)0)) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "could not create data device manager", "types/data_device/wlr_data_device.c", 296);
  return ((void*)0);
 }
 ...
 manager->global =
  wl_global_create(display, &wl_data_device_manager_interface,
   3, manager, data_device_manager_bind);
 if (!manager->global) {
  _wlr_log(WLR_ERROR, "[%s:%d] " "could not create data device manager wl_global", "types/data_device/wlr_data_device.c", 307);
  free(manager);
  return ((void*)0);
 }
