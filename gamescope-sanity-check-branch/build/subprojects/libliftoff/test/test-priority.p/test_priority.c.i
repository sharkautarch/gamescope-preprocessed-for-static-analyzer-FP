# 1 "../subprojects/libliftoff/test/test_priority.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/libliftoff/test/test_priority.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/libliftoff/test/test_priority.c" 2
...
# 3 "../subprojects/libliftoff/test/test_priority.c" 2
...
# 4 "../subprojects/libliftoff/test/test_priority.c" 2
...
# 5 "../subprojects/libliftoff/test/test_priority.c" 2
...
# 6 "../subprojects/libliftoff/test/test_priority.c" 2
...
liftoff_mock_plane_add_in_formats(struct liftoff_mock_plane *plane,
      ...
      size_t size);
# 7 "../subprojects/libliftoff/test/test_priority.c" 2
...
main(int argc, char *argv[])
{
 ...
 ((device != ((void*)0)) ? (void) (0) : __assert_fail ("device != NULL", "../subprojects/libliftoff/test/test_priority.c", 52, __extension__ __PRETTY_FUNCTION__));
 ...
 for (size_t i = 0; i < sizeof(layers) / sizeof(layers[0]); i++) {
  ...
  for (int j = 0; j < 600; j++) {
   ...
   ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_priority.c", 80, __extension__ __PRETTY_FUNCTION__));
   ret = drmModeAtomicCommit(drm_fd, req, 0, ((void*)0));
   ((ret == 0) ? (void) (0) : __assert_fail ("ret == 0", "../subprojects/libliftoff/test/test_priority.c", 82, __extension__ __PRETTY_FUNCTION__));
  }

  ((liftoff_mock_plane_get_layer(mock_plane) == layer) ? (void) (0) : __assert_fail ("liftoff_mock_plane_get_layer(mock_plane) == layer", "../subprojects/libliftoff/test/test_priority.c", 85, __extension__ __PRETTY_FUNCTION__));
