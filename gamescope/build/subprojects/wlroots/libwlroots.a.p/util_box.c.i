# 1 "../subprojects/wlroots/util/box.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/util/box.c" 2
...
# 2 "../subprojects/wlroots/util/box.c" 2
...
# 3 "../subprojects/wlroots/util/box.c" 2
# 1 "/usr/lib/clang/17/include/stdbool.h" 1 3
# 4 "../subprojects/wlroots/util/box.c" 2
...
# 5 "../subprojects/wlroots/util/box.c" 2
...
# 6 "../subprojects/wlroots/util/box.c" 2
...
# 7 "../subprojects/wlroots/util/box.c" 2

void wlr_box_closest_point(const struct wlr_box *box, double x, double y,
  double *dest_x, double *dest_y) {

 if (wlr_box_empty(box)) {
  *dest_x = (__builtin_nanf (""));
  *dest_y = (__builtin_nanf (""));
  return;
 }
...
_Bool wlr_box_empty(const struct wlr_box *box) {
 return box == ((void*)0) || box->width <= 0 || box->height <= 0;
}

_Bool wlr_box_intersection(struct wlr_box *dest, const struct wlr_box *box_a,
  const struct wlr_box *box_b) {
 _Bool a_empty = wlr_box_empty(box_a);
 _Bool b_empty = wlr_box_empty(box_b);
