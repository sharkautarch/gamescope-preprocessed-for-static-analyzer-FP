# 1 "../subprojects/wlroots/types/wlr_input_device.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/wlr_input_device.c" 2
...
# 3 "../subprojects/wlroots/types/wlr_input_device.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "../subprojects/wlroots/types/wlr_input_device.c" 2
...
# 5 "../subprojects/wlroots/types/wlr_input_device.c" 2
