# 1 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tablet.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 382 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tablet.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 2 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tablet.c" 2
...
# 3 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tablet.c" 2
...
struct wlr_tablet_seat_v2 *get_or_create_tablet_seat(
 struct wlr_tablet_manager_v2 *manager,
 struct wlr_seat *wlr_seat);
# 4 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tablet.c" 2
...
void wlr_compositor_set_renderer(struct wlr_compositor *compositor,
 struct wlr_renderer *renderer);
# 6 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tablet.c" 2
...
struct wlr_tablet *wlr_tablet_from_input_device(
 struct wlr_input_device *input_device);
# 7 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tablet.c" 2
# 1 "../subprojects/wlroots/include/wlr/types/wlr_tablet_v2.h" 1
# 8 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tablet.c" 2
...
# 9 "../subprojects/wlroots/types/tablet_v2/wlr_tablet_v2_tablet.c" 2
...
static void handle_wlr_tablet_destroy(struct wl_listener *listener, void *data) {
 struct wlr_tablet_v2_tablet *tablet =
  (__typeof__(tablet))((char *)(listener) - __builtin_offsetof(__typeof__(*tablet), tablet_destroy));

 struct wlr_tablet_client_v2 *pos;
 struct wlr_tablet_client_v2 *tmp;
 for (pos = (__typeof__(pos))((char *)((&tablet->clients)->next) - __builtin_offsetof(__typeof__(*pos), tablet_link)), tmp = (__typeof__(tmp))((char *)((pos)->tablet_link.next) - __builtin_offsetof(__typeof__(*tmp), tablet_link)); &pos->tablet_link != (&tablet->clients); pos = tmp, tmp = (__typeof__(tmp))((char *)(pos->tablet_link.next) - __builtin_offsetof(__typeof__(*tmp), tablet_link))) {
...
struct wlr_tablet_v2_tablet *wlr_tablet_create(
  ...
  struct wlr_seat *wlr_seat,
  struct wlr_input_device *wlr_device) {
 ((wlr_device->type == WLR_INPUT_DEVICE_TABLET) ? (void) (0) : __assert_fail ("wlr_device->type == WLR_INPUT_DEVICE_TABLET", "types/tablet_v2/wlr_tablet_v2_tablet.c", 54, __extension__ __PRETTY_FUNCTION__));
...
void add_tablet_client(struct wlr_tablet_seat_client_v2 *seat,
 ...
 const char **path_ptr;
 for (path_ptr = (&tablet->wlr_tablet->paths)->data; (const char *) path_ptr < ((const char *) (&tablet->wlr_tablet->paths)->data + (&tablet->wlr_tablet->paths)->size); (path_ptr)++) {
...
struct wlr_tablet_client_v2 *tablet_client_from_resource(struct wl_resource *resource) {
 ((wl_resource_instance_of(resource, &zwp_tablet_v2_interface, &tablet_impl)) ? (void) (0) : __assert_fail ("wl_resource_instance_of(resource, &zwp_tablet_v2_interface, &tablet_impl)", "types/tablet_v2/wlr_tablet_v2_tablet.c", 129, __extension__ __PRETTY_FUNCTION__));
